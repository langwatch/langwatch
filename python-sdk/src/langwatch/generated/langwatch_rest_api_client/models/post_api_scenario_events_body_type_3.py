...
T = TypeVar("T", bound="PostApiScenarioEventsBodyType3")


@_attrs_define
class PostApiScenarioEventsBodyType3:
    """
    Attributes:
        type_ (Literal['SCENARIO_TEXT_MESSAGE_START']):
        timestamp (float):
        batch_run_id (str):
        scenario_id (str):
        scenario_run_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["SCENARIO_TEXT_MESSAGE_START"], d.pop("type"))
        if type_ != "SCENARIO_TEXT_MESSAGE_START":
            raise ValueError(f"type must match const 'SCENARIO_TEXT_MESSAGE_START', got '{type_}'")
        ...
        post_api_scenario_events_body_type_3 = cls(
            type_=type_,
            timestamp=timestamp,
        ...
        post_api_scenario_events_body_type_3.additional_properties = d
        return post_api_scenario_events_body_type_3
