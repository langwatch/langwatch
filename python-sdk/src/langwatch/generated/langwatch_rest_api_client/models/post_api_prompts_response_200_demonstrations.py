...
class PostApiPromptsResponse200Demonstrations:
    ...
    Attributes:
        ...
        inline (Union[Unset, PostApiPromptsResponse200DemonstrationsInline]):
    """

    id: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    inline: Union[Unset, "PostApiPromptsResponse200DemonstrationsInline"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_prompts_response_200_demonstrations.additional_properties = d
