...
if TYPE_CHECKING:
    from ..models.put_api_evaluators_by_id_response_200_config_type_0 import PutApiEvaluatorsByIdResponse200ConfigType0
    from ..models.put_api_evaluators_by_id_response_200_fields_item import PutApiEvaluatorsByIdResponse200FieldsItem
    from ..models.put_api_evaluators_by_id_response_200_output_fields_item import (
        PutApiEvaluatorsByIdResponse200OutputFieldsItem,
    )


T = TypeVar("T", bound="PutApiEvaluatorsByIdResponse200")


@_attrs_define
class PutApiEvaluatorsByIdResponse200:
    """
    Attributes:
        id (str):
        project_id (str):
        ...
        slug (Union[None, str]):
        type_ (str):
        config (Union['PutApiEvaluatorsByIdResponse200ConfigType0', None]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.config, PutApiEvaluatorsByIdResponse200ConfigType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_config(data: object) -> Union["PutApiEvaluatorsByIdResponse200ConfigType0", None]:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                config_type_0 = PutApiEvaluatorsByIdResponse200ConfigType0.from_dict(data)

                return config_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PutApiEvaluatorsByIdResponse200ConfigType0", None], data)
        ...
        for fields_item_data in _fields:
            fields_item = PutApiEvaluatorsByIdResponse200FieldsItem.from_dict(fields_item_data)
        ...
        for output_fields_item_data in _output_fields:
            output_fields_item = PutApiEvaluatorsByIdResponse200OutputFieldsItem.from_dict(output_fields_item_data)
        ...
        put_api_evaluators_by_id_response_200 = cls(
            id=id,
