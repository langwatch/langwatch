...
T = TypeVar("T", bound="PatchApiDatasetBySlugOrIdBodyColumnTypesItem")


@_attrs_define
class PatchApiDatasetBySlugOrIdBodyColumnTypesItem:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_api_dataset_by_slug_or_id_body_column_types_item = cls(
            name=name,
            type_=type_,
        )

        patch_api_dataset_by_slug_or_id_body_column_types_item.additional_properties = d
        return patch_api_dataset_by_slug_or_id_body_column_types_item
