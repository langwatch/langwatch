...
class PostApiPromptsByIdVersionsBodyConfigDataMessagesItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_prompts_by_id_versions_body_config_data_messages_item = cls(
            role=role,
            content=content,
        )

        post_api_prompts_by_id_versions_body_config_data_messages_item.additional_properties = d
        return post_api_prompts_by_id_versions_body_config_data_messages_item
