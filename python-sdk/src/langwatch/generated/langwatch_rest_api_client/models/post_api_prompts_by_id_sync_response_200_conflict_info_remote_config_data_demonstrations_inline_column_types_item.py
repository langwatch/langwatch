...
@_attrs_define
class PostApiPromptsByIdSyncResponse200ConflictInfoRemoteConfigDataDemonstrationsInlineColumnTypesItem:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        return post_api_prompts_by_id_sync_response_200_conflict_info_remote_config_data_demonstrations_inline_column_types_item
