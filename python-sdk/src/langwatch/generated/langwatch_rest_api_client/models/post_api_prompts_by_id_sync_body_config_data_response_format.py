...
if TYPE_CHECKING:
    from ..models.post_api_prompts_by_id_sync_body_config_data_response_format_json_schema import (
        PostApiPromptsByIdSyncBodyConfigDataResponseFormatJsonSchema,
    )
...
class PostApiPromptsByIdSyncBodyConfigDataResponseFormat:
    ...
    Attributes:
        ...
        json_schema (PostApiPromptsByIdSyncBodyConfigDataResponseFormatJsonSchema):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        json_schema = PostApiPromptsByIdSyncBodyConfigDataResponseFormatJsonSchema.from_dict(d.pop("json_schema"))
