...
class GetApiPromptsByIdVersionsResponse200ConfigData:
    ...
    Attributes:
        ...
        demonstrations (Union[Unset, GetApiPromptsByIdVersionsResponse200ConfigDataDemonstrations]):
    ...
    demonstrations: Union[Unset, "GetApiPromptsByIdVersionsResponse200ConfigDataDemonstrations"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_demonstrations, Unset):
            ...
            demonstrations = GetApiPromptsByIdVersionsResponse200ConfigDataDemonstrations.from_dict(_demonstrations)
