...
T = TypeVar("T", bound="GetApiPromptsByIdVersionsResponse200DemonstrationsInlineColumnTypesItem")


@_attrs_define
class GetApiPromptsByIdVersionsResponse200DemonstrationsInlineColumnTypesItem:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_prompts_by_id_versions_response_200_demonstrations_inline_column_types_item = cls(
            name=name,
            type_=type_,
        )

        get_api_prompts_by_id_versions_response_200_demonstrations_inline_column_types_item.additional_properties = d
        return get_api_prompts_by_id_versions_response_200_demonstrations_inline_column_types_item
