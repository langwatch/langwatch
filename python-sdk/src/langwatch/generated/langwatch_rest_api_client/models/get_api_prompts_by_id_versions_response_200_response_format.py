...
from ..models.get_api_prompts_by_id_versions_response_200_response_format_type import (
...
T = TypeVar("T", bound="GetApiPromptsByIdVersionsResponse200ResponseFormat")


@_attrs_define
class GetApiPromptsByIdVersionsResponse200ResponseFormat:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_prompts_by_id_versions_response_200_response_format.additional_properties = d
        return get_api_prompts_by_id_versions_response_200_response_format
