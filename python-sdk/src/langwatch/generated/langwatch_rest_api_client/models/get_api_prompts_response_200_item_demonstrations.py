...
if TYPE_CHECKING:
    from ..models.get_api_prompts_response_200_item_demonstrations_inline import (
        GetApiPromptsResponse200ItemDemonstrationsInline,
    )


T = TypeVar("T", bound="GetApiPromptsResponse200ItemDemonstrations")
...
class GetApiPromptsResponse200ItemDemonstrations:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_inline, Unset):
            ...
            inline = GetApiPromptsResponse200ItemDemonstrationsInline.from_dict(_inline)

        get_api_prompts_response_200_item_demonstrations = cls(
            id=id,
            name=name,
            inline=inline,
        )

        get_api_prompts_response_200_item_demonstrations.additional_properties = d
        return get_api_prompts_response_200_item_demonstrations
