...
from ..models.post_index_body_outputs_item_type import PostIndexBodyOutputsItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_index_body_outputs_item_json_schema import PostIndexBodyOutputsItemJsonSchema


T = TypeVar("T", bound="PostIndexBodyOutputsItem")


@_attrs_define
class PostIndexBodyOutputsItem:
    """
    Attributes:
        identifier (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_json_schema, Unset):
            ...
            json_schema = PostIndexBodyOutputsItemJsonSchema.from_dict(_json_schema)

        post_index_body_outputs_item = cls(
            identifier=identifier,
            type_=type_,
            json_schema=json_schema,
        )

        post_index_body_outputs_item.additional_properties = d
        return post_index_body_outputs_item
