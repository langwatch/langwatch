...
class PostApiPromptsResponse200OutputsItem:
    ...
    Attributes:
        ...
        json_schema (Union[Unset, PostApiPromptsResponse200OutputsItemJsonSchema]):
    """

    identifier: str
    type_: PostApiPromptsResponse200OutputsItemType
    json_schema: Union[Unset, "PostApiPromptsResponse200OutputsItemJsonSchema"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_prompts_response_200_outputs_item.additional_properties = d
