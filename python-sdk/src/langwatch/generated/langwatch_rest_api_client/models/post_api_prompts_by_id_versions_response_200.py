...
from ..models.post_api_prompts_by_id_versions_response_200_scope import PostApiPromptsByIdVersionsResponse200Scope
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_prompts_by_id_versions_response_200_author_type_0 import (
...
class PostApiPromptsByIdVersionsResponse200:
    ...
    Attributes:
        ...
        scope (PostApiPromptsByIdVersionsResponse200Scope):
        commit_message (Union[None, Unset, str]):
        author (Union['PostApiPromptsByIdVersionsResponse200AuthorType0', None, Unset]):
    """
    ...
    author: Union["PostApiPromptsByIdVersionsResponse200AuthorType0", None, Unset] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.author, Unset):
            author = UNSET
        elif isinstance(self.author, PostApiPromptsByIdVersionsResponse200AuthorType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope = PostApiPromptsByIdVersionsResponse200Scope(d.pop("scope"))
        ...
        def _parse_author(data: object) -> Union["PostApiPromptsByIdVersionsResponse200AuthorType0", None, Unset]:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                author_type_0 = PostApiPromptsByIdVersionsResponse200AuthorType0.from_dict(data)

                return author_type_0
            except:  # noqa: E722
                pass
            return cast(Union["PostApiPromptsByIdVersionsResponse200AuthorType0", None, Unset], data)
