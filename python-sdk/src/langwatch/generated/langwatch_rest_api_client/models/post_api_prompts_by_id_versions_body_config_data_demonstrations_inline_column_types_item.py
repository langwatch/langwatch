...
T = TypeVar("T", bound="PostApiPromptsByIdVersionsBodyConfigDataDemonstrationsInlineColumnTypesItem")


@_attrs_define
class PostApiPromptsByIdVersionsBodyConfigDataDemonstrationsInlineColumnTypesItem:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_prompts_by_id_versions_body_config_data_demonstrations_inline_column_types_item = cls(
            name=name,
            type_=type_,
        )

        post_api_prompts_by_id_versions_body_config_data_demonstrations_inline_column_types_item.additional_properties = d
        return post_api_prompts_by_id_versions_body_config_data_demonstrations_inline_column_types_item
