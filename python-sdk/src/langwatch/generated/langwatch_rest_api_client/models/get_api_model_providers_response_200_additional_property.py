...
if TYPE_CHECKING:
    from ..models.get_api_model_providers_response_200_additional_property_custom_embeddings_models_type_0_item import (
    ...
    from ..models.get_api_model_providers_response_200_additional_property_custom_models_type_0_item import (
        GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0Item,
    )
    from ..models.get_api_model_providers_response_200_additional_property_extra_headers_type_0_item import (
        GetApiModelProvidersResponse200AdditionalPropertyExtraHeadersType0Item,
    )


T = TypeVar("T", bound="GetApiModelProvidersResponse200AdditionalProperty")


@_attrs_define
class GetApiModelProvidersResponse200AdditionalProperty:
    """
    Attributes:
        provider (str):
        enabled (bool):
        ...
        custom_embeddings_models (list[GetApiModelProvidersResponse200AdditionalPropertyCustomEmbeddingsModelsType0Item]
            | None | Unset):
        disabled_by_default (bool | Unset):
        extra_headers (list[GetApiModelProvidersResponse200AdditionalPropertyExtraHeadersType0Item] | None | Unset):
    """
    ...
    custom_embeddings_models: (
        list[GetApiModelProvidersResponse200AdditionalPropertyCustomEmbeddingsModelsType0Item] | None | Unset
    ) = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.custom_keys, GetApiModelProvidersResponse200AdditionalPropertyCustomKeysType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_custom_keys(data: object) -> GetApiModelProvidersResponse200AdditionalPropertyCustomKeysType0 | None:
            if data is None:
                return data
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                custom_keys_type_0 = GetApiModelProvidersResponse200AdditionalPropertyCustomKeysType0.from_dict(data)

                return custom_keys_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(GetApiModelProvidersResponse200AdditionalPropertyCustomKeysType0 | None, data)
        ...
        def _parse_custom_models(
            data: object,
        ) -> list[GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for custom_models_type_0_item_data in _custom_models_type_0:
                    custom_models_type_0_item = (
                        GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0Item] | None | Unset, data
            )
            ...
            try:
                ...
                for custom_embeddings_models_type_0_item_data in _custom_embeddings_models_type_0:
                    custom_embeddings_models_type_0_item = (
                        GetApiModelProvidersResponse200AdditionalPropertyCustomEmbeddingsModelsType0Item.from_dict(
        ...
        def _parse_extra_headers(
            data: object,
        ) -> list[GetApiModelProvidersResponse200AdditionalPropertyExtraHeadersType0Item] | None | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
            try:
                ...
                for extra_headers_type_0_item_data in _extra_headers_type_0:
                    extra_headers_type_0_item = (
                        GetApiModelProvidersResponse200AdditionalPropertyExtraHeadersType0Item.from_dict(
                ...
                pass
            return cast(
                list[GetApiModelProvidersResponse200AdditionalPropertyExtraHeadersType0Item] | None | Unset, data
            )

        extra_headers = _parse_extra_headers(d.pop("extraHeaders", UNSET))

        get_api_model_providers_response_200_additional_property = cls(
            provider=provider,
            enabled=enabled,
