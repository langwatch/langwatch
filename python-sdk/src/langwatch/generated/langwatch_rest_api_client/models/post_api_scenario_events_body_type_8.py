...
T = TypeVar("T", bound="PostApiScenarioEventsBodyType8")


@_attrs_define
class PostApiScenarioEventsBodyType8:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        type_ = cast(Literal["SCENARIO_TOOL_CALL_END"], d.pop("type"))
        if type_ != "SCENARIO_TOOL_CALL_END":
            raise ValueError(f"type must match const 'SCENARIO_TOOL_CALL_END', got '{type_}'")
        ...
        post_api_scenario_events_body_type_8 = cls(
            type_=type_,
            timestamp=timestamp,
        ...
        post_api_scenario_events_body_type_8.additional_properties = d
        return post_api_scenario_events_body_type_8
