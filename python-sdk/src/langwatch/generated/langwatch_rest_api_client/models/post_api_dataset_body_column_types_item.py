...
T = TypeVar("T", bound="PostApiDatasetBodyColumnTypesItem")


@_attrs_define
class PostApiDatasetBodyColumnTypesItem:
    """
    Attributes:
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_dataset_body_column_types_item = cls(
            name=name,
            type_=type_,
        )

        post_api_dataset_body_column_types_item.additional_properties = d
        return post_api_dataset_body_column_types_item
