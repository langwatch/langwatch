...
class PostApiPromptsByIdVersionsBodyConfigDataOutputsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_json_schema, Unset):
            ...
            json_schema = PostApiPromptsByIdVersionsBodyConfigDataOutputsItemJsonSchema.from_dict(_json_schema)

        post_api_prompts_by_id_versions_body_config_data_outputs_item = cls(
            identifier=identifier,
            type_=type_,
            json_schema=json_schema,
        )

        post_api_prompts_by_id_versions_body_config_data_outputs_item.additional_properties = d
        return post_api_prompts_by_id_versions_body_config_data_outputs_item
