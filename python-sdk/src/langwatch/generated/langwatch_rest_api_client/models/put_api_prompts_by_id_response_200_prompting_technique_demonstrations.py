...
class PutApiPromptsByIdResponse200PromptingTechniqueDemonstrations:
    ...
    Attributes:
        ...
        inline (Union[Unset, PutApiPromptsByIdResponse200PromptingTechniqueDemonstrationsInline]):
    """

    id: Union[Unset, str] = UNSET
    name: Union[Unset, str] = UNSET
    inline: Union[Unset, "PutApiPromptsByIdResponse200PromptingTechniqueDemonstrationsInline"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_prompts_by_id_response_200_prompting_technique_demonstrations.additional_properties = d
