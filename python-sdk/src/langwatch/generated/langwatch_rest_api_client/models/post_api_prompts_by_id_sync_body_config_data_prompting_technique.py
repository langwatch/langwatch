...
class PostApiPromptsByIdSyncBodyConfigDataPromptingTechnique:
    ...
    Attributes:
        ...
        demonstrations (PostApiPromptsByIdSyncBodyConfigDataPromptingTechniqueDemonstrations | Unset):
    """

    type_: PostApiPromptsByIdSyncBodyConfigDataPromptingTechniqueType
    demonstrations: PostApiPromptsByIdSyncBodyConfigDataPromptingTechniqueDemonstrations | Unset = UNSET
