...
def sync_detailed(
    *,
    ...
    creation refuses with `trace_project_required` when neither exists.
    ...
    Returns:
        Response[PostApiGatewayV1VirtualKeysResponse201 | PostApiGatewayV1VirtualKeysResponse400 | PostApiGatewayV1VirtualKeysResponse401 | PostApiGatewayV1VirtualKeysResponse403 | PostApiGatewayV1VirtualKeysResponse500]
    """
...
def sync(
    *,
    ...
    Returns:
        PostApiGatewayV1VirtualKeysResponse201 | PostApiGatewayV1VirtualKeysResponse400 | PostApiGatewayV1VirtualKeysResponse401 | PostApiGatewayV1VirtualKeysResponse403 | PostApiGatewayV1VirtualKeysResponse500
    """
