...
from ...models.post_api_evaluations_batch_log_results_response_500 import PostApiEvaluationsBatchLogResultsResponse500
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 500:
        response_500 = PostApiEvaluationsBatchLogResultsResponse500.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        Union[PostApiEvaluationsBatchLogResultsResponse200, PostApiEvaluationsBatchLogResultsResponse400, PostApiEvaluationsBatchLogResultsResponse401, PostApiEvaluationsBatchLogResultsResponse500]
    """
