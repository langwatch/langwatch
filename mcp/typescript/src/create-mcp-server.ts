...
`,
  ...
  server.tool(
    ...
    [
      ...
      "",
      "It is about one of two things: matching traces (send `filters` or `filterQuery`), or a metric crossing a threshold on a graph (send `customGraphId`, `graphAlert` and `alertType`).",
