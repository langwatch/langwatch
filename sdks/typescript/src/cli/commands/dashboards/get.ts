  ...
  try {
    ...
    return {
      ...
      table: () => {
        ...
        console.log(
          `    ${chalk.gray("ID:")}      ${chalk.green(dashboard.id)}`,
        );
        console.log(
          `    ${chalk.gray("Name:")}    ${chalk.cyan(dashboard.name)}`,
        );
        console.log(
          `    ${chalk.gray("Graphs:")}  ${Array.isArray(dashboard.graphs) ? dashboard.graphs.length : 0}`,
        );
        console.log(
          `    ${chalk.gray("Created:")} ${new Date(dashboard.createdAt).toLocaleString()}`,
        );
        console.log(
