      ...
      return {
        ...
        table: () => {
          ...
          if (snapshot.configs.length === 0) {
            console.log(
              chalk.gray("  No configs at any readable scope. Set one with:"),
            );
            console.log(
              chalk.cyan(
                "    langwatch model-default set DEFAULT openai/gpt-5",
              ),
            );
            console.log();
            return;
