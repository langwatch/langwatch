...
describe("connectAgent()", () => {
  ...
  describe("given the parameters are a zod schema", () => {
    describe("when the agent is defined and called", () => {
  ...
  describe("given the parameters are a plain JSON Schema", () => {
    describe("when the agent is defined", () => {
