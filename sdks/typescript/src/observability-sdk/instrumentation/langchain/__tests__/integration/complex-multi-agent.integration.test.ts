...
describe.skipIf(!RUN_EXTERNAL)(
  "LangChain Multi-Agent Integration Tests",
  () => {
          ...
          const tools = [
            ...
            new DynamicStructuredTool({
              ...
              schema: z.object({
                analysis: z
                  .string()
                  .describe("The analysis to generate report from"),
              }),
              func: async ({ analysis }: { analysis: string }) =>
                `Report: ${analysis}`,
            }),
          ];
