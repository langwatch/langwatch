...
describe("setupObservability Integration - Configuration Options", () => {
  ...
  it("uses serviceName and attributes in resource", async () => {
    ...
    expect(provider._config.resource.attributes["service.name"]).toBe(
      "test-service",
    );
    expect(provider._config.resource.attributes["deployment.environment"]).toBe(
      "test",
    );
    expect(provider._config.resource.attributes["service.version"]).toBe(
      "1.0.0",
    );
