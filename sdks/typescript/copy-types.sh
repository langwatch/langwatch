...
cp ../../packages/features/evaluator/contract/src/evaluators.native.ts src/internal/generated/types/evaluators.native.ts
...
const registry = require('../../packages/features/model-provider/contract/src/catalog/model-catalog.json');
...
fs.writeFileSync(out,
  '// Generated by copy-types.sh from packages/features/model-provider/contract/src/catalog/model-catalog.json\n' +
