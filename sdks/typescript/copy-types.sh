...
cp ../../modules/trace/contract/src/trace-format.schemas.ts src/internal/generated/types/tracer.ts
...
cp ../../modules/evaluator/contract/src/evaluators.native.ts src/internal/generated/types/evaluators.native.ts
...
const registry = require('../../modules/model-provider/contract/src/catalog/model-catalog.json');
...
if (!best) {
  console.error('No openai chat flagship found in model-catalog.json');
  process.exit(1);
}
const out = 'src/internal/generated/cli/default-prompt-model.generated.ts';
fs.writeFileSync(out,
  '// Generated by copy-types.sh from modules/model-provider/contract/src/catalog/model-catalog.json\n' +
