...
T = TypeVar("T", bound="ScimListGroupsResponse200ResourcesItemMeta")


@_attrs_define
class ScimListGroupsResponse200ResourcesItemMeta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_list_groups_response_200_resources_item_meta = cls(
            resource_type=resource_type,
            created=created,
            last_modified=last_modified,
        )

        scim_list_groups_response_200_resources_item_meta.additional_properties = d
        return scim_list_groups_response_200_resources_item_meta
