...
T = TypeVar("T", bound="PostApiSuitesByIdDuplicateResponse201TargetsItemRunParameters")


@_attrs_define
class PostApiSuitesByIdDuplicateResponse201TargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_suites_by_id_duplicate_response_201_targets_item_run_parameters = cls()
        ...
        post_api_suites_by_id_duplicate_response_201_targets_item_run_parameters.additional_properties = (
            additional_properties
        )
        return post_api_suites_by_id_duplicate_response_201_targets_item_run_parameters
