...
if TYPE_CHECKING:
    ...
    from ..models.patch_api_suites_by_id_body_targets_item_scenario_mappings import (
...
class PatchApiSuitesByIdBodyTargetsItem:
    ...
    Attributes:
        ...
        reference_id (str):
        scenario_mappings (PatchApiSuitesByIdBodyTargetsItemScenarioMappings | Unset):
    ...
    type_: PatchApiSuitesByIdBodyTargetsItemType
    reference_id: str
    scenario_mappings: PatchApiSuitesByIdBodyTargetsItemScenarioMappings | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_scenario_mappings, Unset):
            ...
            scenario_mappings = PatchApiSuitesByIdBodyTargetsItemScenarioMappings.from_dict(_scenario_mappings)
