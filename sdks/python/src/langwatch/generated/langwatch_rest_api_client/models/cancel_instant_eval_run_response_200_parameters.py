...
T = TypeVar("T", bound="CancelInstantEvalRunResponse200Parameters")
...
class CancelInstantEvalRunResponse200Parameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        cancel_instant_eval_run_response_200_parameters = cls()
        ...
        cancel_instant_eval_run_response_200_parameters.additional_properties = additional_properties
        return cancel_instant_eval_run_response_200_parameters
