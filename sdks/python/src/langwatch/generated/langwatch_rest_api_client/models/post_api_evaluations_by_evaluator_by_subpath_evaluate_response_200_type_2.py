...
T = TypeVar("T", bound="PostApiEvaluationsByEvaluatorBySubpathEvaluateResponse200Type2")


@_attrs_define
class PostApiEvaluationsByEvaluatorBySubpathEvaluateResponse200Type2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_evaluations_by_evaluator_by_subpath_evaluate_response_200_type_2 = cls(
            status=status,
            error_type=error_type,
            details=details,
            passed=passed,
        ...
        post_api_evaluations_by_evaluator_by_subpath_evaluate_response_200_type_2.additional_properties = d
        return post_api_evaluations_by_evaluator_by_subpath_evaluate_response_200_type_2
