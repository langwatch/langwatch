...
T = TypeVar("T", bound="GetApiExperimentsBySlugVersionsResponse400")


@_attrs_define
class GetApiExperimentsBySlugVersionsResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_experiments_by_slug_versions_response_400 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        get_api_experiments_by_slug_versions_response_400.additional_properties = d
        return get_api_experiments_by_slug_versions_response_400
