...
if TYPE_CHECKING:
    from ..models.update_webhook_endpoint_response_200_data import UpdateWebhookEndpointResponse200Data
...
class UpdateWebhookEndpointResponse200:
    """
    Attributes:
        data (UpdateWebhookEndpointResponse200Data):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = UpdateWebhookEndpointResponse200Data.from_dict(d.pop("data"))
