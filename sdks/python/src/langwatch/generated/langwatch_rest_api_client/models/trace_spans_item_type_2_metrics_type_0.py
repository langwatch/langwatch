...
T = TypeVar("T", bound="TraceSpansItemType2MetricsType0")


@_attrs_define
class TraceSpansItemType2MetricsType0:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trace_spans_item_type_2_metrics_type_0 = cls(
        ...
        trace_spans_item_type_2_metrics_type_0.additional_properties = d
        return trace_spans_item_type_2_metrics_type_0
