...
from ..models.get_api_gateway_v1_budgets_response_200_data_item_on_breach import (
    GetApiGatewayV1BudgetsResponse200DataItemOnBreach,
)
from ..models.get_api_gateway_v1_budgets_response_200_data_item_scope_reach import (
    GetApiGatewayV1BudgetsResponse200DataItemScopeReach,
)
from ..models.get_api_gateway_v1_budgets_response_200_data_item_scope_type import (
    GetApiGatewayV1BudgetsResponse200DataItemScopeType,
)
from ..models.get_api_gateway_v1_budgets_response_200_data_item_window import (
    GetApiGatewayV1BudgetsResponse200DataItemWindow,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_api_gateway_v1_budgets_response_200_data_item_metadata import (
        GetApiGatewayV1BudgetsResponse200DataItemMetadata,
    )


T = TypeVar("T", bound="GetApiGatewayV1BudgetsResponse200DataItem")


@_attrs_define
class GetApiGatewayV1BudgetsResponse200DataItem:
    """
    Attributes:
        id (str):
        organization_id (str):
        scope_type (GetApiGatewayV1BudgetsResponse200DataItemScopeType):
        scope_id (str):
        name (str):
        description (None | str):
        window (GetApiGatewayV1BudgetsResponse200DataItemWindow):
        on_breach (GetApiGatewayV1BudgetsResponse200DataItemOnBreach):
        ...
        metadata (GetApiGatewayV1BudgetsResponse200DataItemMetadata):
        ...
        scope_reach (GetApiGatewayV1BudgetsResponse200DataItemScopeReach | Unset): Whether any active key in the
    ...
    scope_reach: GetApiGatewayV1BudgetsResponse200DataItemScopeReach | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope_type = GetApiGatewayV1BudgetsResponse200DataItemScopeType(d.pop("scope_type"))
        ...
        window = GetApiGatewayV1BudgetsResponse200DataItemWindow(d.pop("window"))

        on_breach = GetApiGatewayV1BudgetsResponse200DataItemOnBreach(d.pop("on_breach"))
        ...
        metadata = GetApiGatewayV1BudgetsResponse200DataItemMetadata.from_dict(d.pop("metadata"))
        ...
        scope_reach: GetApiGatewayV1BudgetsResponse200DataItemScopeReach | Unset
        if isinstance(_scope_reach, Unset):
            scope_reach = UNSET
        else:
            scope_reach = GetApiGatewayV1BudgetsResponse200DataItemScopeReach(_scope_reach)

        get_api_gateway_v1_budgets_response_200_data_item = cls(
            id=id,
            organization_id=organization_id,
            scope_type=scope_type,
            scope_id=scope_id,
        ...
        get_api_gateway_v1_budgets_response_200_data_item.additional_properties = d
        return get_api_gateway_v1_budgets_response_200_data_item
