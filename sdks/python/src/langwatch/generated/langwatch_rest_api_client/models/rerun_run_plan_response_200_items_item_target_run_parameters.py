...
T = TypeVar("T", bound="RerunRunPlanResponse200ItemsItemTargetRunParameters")


@_attrs_define
class RerunRunPlanResponse200ItemsItemTargetRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        rerun_run_plan_response_200_items_item_target_run_parameters = cls()
        ...
        rerun_run_plan_response_200_items_item_target_run_parameters.additional_properties = additional_properties
        return rerun_run_plan_response_200_items_item_target_run_parameters
