...
from ..models.patch_api_scenarios_by_id_body_parameters_item_type import PatchApiScenariosByIdBodyParametersItemType
...
class PatchApiScenariosByIdBodyParametersItem:
    ...
    Attributes:
        ...
        secret (bool | Unset):
        type_ (PatchApiScenariosByIdBodyParametersItemType | Unset):
    ...
    type_: PatchApiScenariosByIdBodyParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PatchApiScenariosByIdBodyParametersItemType(_type_)
