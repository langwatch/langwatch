...
T = TypeVar("T", bound="PostApiSuitesByIdRunResponse200ItemsItemTargetRunParameters")


@_attrs_define
class PostApiSuitesByIdRunResponse200ItemsItemTargetRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_suites_by_id_run_response_200_items_item_target_run_parameters = cls()
        ...
        post_api_suites_by_id_run_response_200_items_item_target_run_parameters.additional_properties = (
            additional_properties
        )
        return post_api_suites_by_id_run_response_200_items_item_target_run_parameters
