...
if TYPE_CHECKING:
    from ..models.post_api_v1_query_body_parameters import PostApiV1QueryBodyParameters
    from ..models.post_api_v1_query_body_time_window import PostApiV1QueryBodyTimeWindow


T = TypeVar("T", bound="PostApiV1QueryBody")


@_attrs_define
class PostApiV1QueryBody:
    """
    Attributes:
        sql (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = PostApiV1QueryBodyParameters.from_dict(_parameters)
