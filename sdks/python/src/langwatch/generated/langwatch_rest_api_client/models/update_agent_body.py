...
from ..models.update_agent_body_type import UpdateAgentBodyType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_agent_body_config import UpdateAgentBodyConfig
...
class UpdateAgentBody:
    ...
    type_: UpdateAgentBodyType | Unset = UNSET
    config: UpdateAgentBodyConfig | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UpdateAgentBodyType(_type_)
        ...
        if isinstance(_config, Unset):
            ...
            config = UpdateAgentBodyConfig.from_dict(_config)
