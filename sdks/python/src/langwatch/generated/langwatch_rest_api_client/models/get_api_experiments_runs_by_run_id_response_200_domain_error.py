...
if TYPE_CHECKING:
    from ..models.get_api_experiments_runs_by_run_id_response_200_domain_error_meta import (
        GetApiExperimentsRunsByRunIdResponse200DomainErrorMeta,
    )


T = TypeVar("T", bound="GetApiExperimentsRunsByRunIdResponse200DomainError")


@_attrs_define
class GetApiExperimentsRunsByRunIdResponse200DomainError:
    ...
    Attributes:
        ...
        message (str | Unset):
        meta (GetApiExperimentsRunsByRunIdResponse200DomainErrorMeta | Unset):
    ...
    meta: GetApiExperimentsRunsByRunIdResponse200DomainErrorMeta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = GetApiExperimentsRunsByRunIdResponse200DomainErrorMeta.from_dict(_meta)
        ...
        get_api_experiments_runs_by_run_id_response_200_domain_error = cls(
            code=code,
            kind=kind,
            message=message,
            meta=meta,
        ...
        get_api_experiments_runs_by_run_id_response_200_domain_error.additional_properties = d
        return get_api_experiments_runs_by_run_id_response_200_domain_error
