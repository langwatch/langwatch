...
from ..models.get_agent_response_200_parameters_item_type import GetAgentResponse200ParametersItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetAgentResponse200ParametersItem")


@_attrs_define
class GetAgentResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (GetAgentResponse200ParametersItemType | Unset):
    ...
    type_: GetAgentResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = GetAgentResponse200ParametersItemType(_type_)
        ...
        get_agent_response_200_parameters_item = cls(
            name=name,
        ...
        get_agent_response_200_parameters_item.additional_properties = d
        return get_agent_response_200_parameters_item
