...
T = TypeVar("T", bound="PostApiGovernanceIngestionTemplatesCloneResponse201IngestionTemplate")


@_attrs_define
class PostApiGovernanceIngestionTemplatesCloneResponse201IngestionTemplate:
    """
    Attributes:
        id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_governance_ingestion_templates_clone_response_201_ingestion_template = cls(
            id=id,
            slug=slug,
            source_type=source_type,
            display_name=display_name,
        ...
        post_api_governance_ingestion_templates_clone_response_201_ingestion_template.additional_properties = d
        return post_api_governance_ingestion_templates_clone_response_201_ingestion_template
