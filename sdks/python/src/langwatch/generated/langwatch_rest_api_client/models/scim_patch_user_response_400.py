...
T = TypeVar("T", bound="ScimPatchUserResponse400")


@_attrs_define
class ScimPatchUserResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_patch_user_response_400 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_patch_user_response_400.additional_properties = d
        return scim_patch_user_response_400
