...
T = TypeVar("T", bound="PostApiWorkflowsByWorkflowIdRunResponse404")


@_attrs_define
class PostApiWorkflowsByWorkflowIdRunResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_workflows_by_workflow_id_run_response_404 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        post_api_workflows_by_workflow_id_run_response_404.additional_properties = d
        return post_api_workflows_by_workflow_id_run_response_404
