...
T = TypeVar("T", bound="GetInstantEvalRunResponse200Parameters")


@_attrs_define
class GetInstantEvalRunResponse200Parameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        get_instant_eval_run_response_200_parameters = cls()
        ...
        get_instant_eval_run_response_200_parameters.additional_properties = additional_properties
        return get_instant_eval_run_response_200_parameters
