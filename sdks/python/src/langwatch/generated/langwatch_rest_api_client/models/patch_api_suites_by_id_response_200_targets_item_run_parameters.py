...
T = TypeVar("T", bound="PatchApiSuitesByIdResponse200TargetsItemRunParameters")


@_attrs_define
class PatchApiSuitesByIdResponse200TargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        patch_api_suites_by_id_response_200_targets_item_run_parameters = cls()
        ...
        patch_api_suites_by_id_response_200_targets_item_run_parameters.additional_properties = additional_properties
        return patch_api_suites_by_id_response_200_targets_item_run_parameters
