...
T = TypeVar("T", bound="RunTestSuiteResponse200ItemsItemTargetRunParameters")
...
class RunTestSuiteResponse200ItemsItemTargetRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        run_test_suite_response_200_items_item_target_run_parameters = cls()
        ...
        run_test_suite_response_200_items_item_target_run_parameters.additional_properties = additional_properties
        return run_test_suite_response_200_items_item_target_run_parameters
