...
from ..models.get_api_webhooks_v1_endpoints_by_id_response_200_data_status import (
    GetApiWebhooksV1EndpointsByIdResponse200DataStatus,
)

T = TypeVar("T", bound="GetApiWebhooksV1EndpointsByIdResponse200Data")


@_attrs_define
class GetApiWebhooksV1EndpointsByIdResponse200Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (GetApiWebhooksV1EndpointsByIdResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetApiWebhooksV1EndpointsByIdResponse200DataStatus(d.pop("status"))
        ...
        get_api_webhooks_v1_endpoints_by_id_response_200_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        get_api_webhooks_v1_endpoints_by_id_response_200_data.additional_properties = d
        return get_api_webhooks_v1_endpoints_by_id_response_200_data
