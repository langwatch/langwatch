...
from ..models.post_api_gateway_v1_budgets_response_201_budget_scope_reach import (
...
class PostApiGatewayV1BudgetsResponse201Budget:
    ...
    Attributes:
        ...
        scope_reach (PostApiGatewayV1BudgetsResponse201BudgetScopeReach | Unset): Whether any active key in the
    ...
    scope_reach: PostApiGatewayV1BudgetsResponse201BudgetScopeReach | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope_reach: PostApiGatewayV1BudgetsResponse201BudgetScopeReach | Unset
        if isinstance(_scope_reach, Unset):
            scope_reach = UNSET
        else:
            scope_reach = PostApiGatewayV1BudgetsResponse201BudgetScopeReach(_scope_reach)
