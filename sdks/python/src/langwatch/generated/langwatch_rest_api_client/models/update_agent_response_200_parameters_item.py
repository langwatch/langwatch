...
from ..models.update_agent_response_200_parameters_item_type import UpdateAgentResponse200ParametersItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="UpdateAgentResponse200ParametersItem")


@_attrs_define
class UpdateAgentResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (UpdateAgentResponse200ParametersItemType | Unset):
    ...
    type_: UpdateAgentResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UpdateAgentResponse200ParametersItemType(_type_)
        ...
        update_agent_response_200_parameters_item = cls(
            name=name,
        ...
        update_agent_response_200_parameters_item.additional_properties = d
        return update_agent_response_200_parameters_item
