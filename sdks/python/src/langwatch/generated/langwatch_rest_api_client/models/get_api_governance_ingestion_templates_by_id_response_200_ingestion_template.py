...
T = TypeVar("T", bound="GetApiGovernanceIngestionTemplatesByIdResponse200IngestionTemplate")


@_attrs_define
class GetApiGovernanceIngestionTemplatesByIdResponse200IngestionTemplate:
    """
    Attributes:
        id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_governance_ingestion_templates_by_id_response_200_ingestion_template = cls(
            id=id,
            slug=slug,
            source_type=source_type,
            display_name=display_name,
        ...
        get_api_governance_ingestion_templates_by_id_response_200_ingestion_template.additional_properties = d
        return get_api_governance_ingestion_templates_by_id_response_200_ingestion_template
