...
class UpdateApiKeyResponse200RoleBindingsItem:
    ...
    Attributes:
        id (str | Unset):
        role (UpdateApiKeyResponse200RoleBindingsItemRole | Unset):
        scope_type (UpdateApiKeyResponse200RoleBindingsItemScopeType | Unset):
        scope_id (str | Unset):
    """

    id: str | Unset = UNSET
    role: UpdateApiKeyResponse200RoleBindingsItemRole | Unset = UNSET
    scope_type: UpdateApiKeyResponse200RoleBindingsItemScopeType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_role, Unset):
            ...
            role = UpdateApiKeyResponse200RoleBindingsItemRole(_role)
        ...
        if isinstance(_scope_type, Unset):
            ...
            scope_type = UpdateApiKeyResponse200RoleBindingsItemScopeType(_scope_type)
        ...
        update_api_key_response_200_role_bindings_item.additional_properties = d
