...
T = TypeVar("T", bound="PostApiExperimentsBySlugRunBodyParameters")
...
class PostApiExperimentsBySlugRunBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_experiments_by_slug_run_body_parameters = cls()
        ...
        post_api_experiments_by_slug_run_body_parameters.additional_properties = additional_properties
        return post_api_experiments_by_slug_run_body_parameters
