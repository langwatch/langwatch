...
T = TypeVar("T", bound="ScimCreateGroupResponse400")


@_attrs_define
class ScimCreateGroupResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_create_group_response_400 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_create_group_response_400.additional_properties = d
        return scim_create_group_response_400
