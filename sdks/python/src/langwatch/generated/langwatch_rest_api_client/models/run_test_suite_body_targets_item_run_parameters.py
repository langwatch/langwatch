...
T = TypeVar("T", bound="RunTestSuiteBodyTargetsItemRunParameters")


@_attrs_define
class RunTestSuiteBodyTargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        run_test_suite_body_targets_item_run_parameters = cls()
        ...
        run_test_suite_body_targets_item_run_parameters.additional_properties = additional_properties
        return run_test_suite_body_targets_item_run_parameters
