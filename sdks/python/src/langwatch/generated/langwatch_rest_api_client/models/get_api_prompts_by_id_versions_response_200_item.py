...
if TYPE_CHECKING:
    from ..models.get_api_prompts_by_id_versions_response_200_item_demonstrations import (
        GetApiPromptsByIdVersionsResponse200ItemDemonstrations,
    )
    from ..models.get_api_prompts_by_id_versions_response_200_item_inputs_item import (
        GetApiPromptsByIdVersionsResponse200ItemInputsItem,
    )
    from ..models.get_api_prompts_by_id_versions_response_200_item_messages_item import (
...
T = TypeVar("T", bound="GetApiPromptsByIdVersionsResponse200Item")


@_attrs_define
class GetApiPromptsByIdVersionsResponse200Item:
    """
    Attributes:
        id (str):
        handle (None | str):
        scope (GetApiPromptsByIdVersionsResponse200ItemScope):
        name (str):
        updated_at (str):
        project_id (str):
        organization_id (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope = GetApiPromptsByIdVersionsResponse200ItemScope(d.pop("scope"))
        ...
        for outputs_item_data in _outputs:
            outputs_item = GetApiPromptsByIdVersionsResponse200ItemOutputsItem.from_dict(outputs_item_data)
        ...
        if isinstance(_demonstrations, Unset):
            ...
            demonstrations = GetApiPromptsByIdVersionsResponse200ItemDemonstrations.from_dict(_demonstrations)
        ...
        if isinstance(_prompting_technique, Unset):
            ...
            prompting_technique = GetApiPromptsByIdVersionsResponse200ItemPromptingTechnique.from_dict(
