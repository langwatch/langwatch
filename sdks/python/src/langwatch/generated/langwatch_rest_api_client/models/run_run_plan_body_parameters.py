...
T = TypeVar("T", bound="RunRunPlanBodyParameters")
...
class RunRunPlanBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        run_run_plan_body_parameters = cls()
        ...
        run_run_plan_body_parameters.additional_properties = additional_properties
        return run_run_plan_body_parameters
