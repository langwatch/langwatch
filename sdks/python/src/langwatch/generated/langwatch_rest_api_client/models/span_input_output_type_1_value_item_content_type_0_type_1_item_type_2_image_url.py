...
T = TypeVar("T", bound="SpanInputOutputType1ValueItemContentType0Type1ItemType2ImageUrl")


@_attrs_define
class SpanInputOutputType1ValueItemContentType0Type1ItemType2ImageUrl:
    """
    Attributes:
        url (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        span_input_output_type_1_value_item_content_type_0_type_1_item_type_2_image_url = cls(
            url=url,
            detail=detail,
        )

        span_input_output_type_1_value_item_content_type_0_type_1_item_type_2_image_url.additional_properties = d
        return span_input_output_type_1_value_item_content_type_0_type_1_item_type_2_image_url
