...
from ..models.get_api_webhooks_v1_endpoints_by_id_response_200_data_type_0_status import (
    GetApiWebhooksV1EndpointsByIdResponse200DataType0Status,
)

T = TypeVar("T", bound="GetApiWebhooksV1EndpointsByIdResponse200DataType0")


@_attrs_define
class GetApiWebhooksV1EndpointsByIdResponse200DataType0:
    """
    Attributes:
        ...
        status (GetApiWebhooksV1EndpointsByIdResponse200DataType0Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetApiWebhooksV1EndpointsByIdResponse200DataType0Status(d.pop("status"))
        ...
        get_api_webhooks_v1_endpoints_by_id_response_200_data_type_0 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        get_api_webhooks_v1_endpoints_by_id_response_200_data_type_0.additional_properties = d
        return get_api_webhooks_v1_endpoints_by_id_response_200_data_type_0
