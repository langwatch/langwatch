...
T = TypeVar("T", bound="ScimReplaceUserResponse400")


@_attrs_define
class ScimReplaceUserResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_replace_user_response_400 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_replace_user_response_400.additional_properties = d
        return scim_replace_user_response_400
