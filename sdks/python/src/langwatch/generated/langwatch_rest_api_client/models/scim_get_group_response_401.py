...
T = TypeVar("T", bound="ScimGetGroupResponse401")


@_attrs_define
class ScimGetGroupResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_get_group_response_401 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_get_group_response_401.additional_properties = d
        return scim_get_group_response_401
