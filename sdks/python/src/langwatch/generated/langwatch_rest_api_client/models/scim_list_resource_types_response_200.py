...
if TYPE_CHECKING:
    from ..models.scim_list_resource_types_response_200_resources_item import (
        ScimListResourceTypesResponse200ResourcesItem,
    )


T = TypeVar("T", bound="ScimListResourceTypesResponse200")


@_attrs_define
class ScimListResourceTypesResponse200:
    """
    Attributes:
        ...
        resources (list[ScimListResourceTypesResponse200ResourcesItem] | Unset):
    """
    ...
    resources: list[ScimListResourceTypesResponse200ResourcesItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if _resources is not UNSET:
            ...
            for resources_item_data in _resources:
                resources_item = ScimListResourceTypesResponse200ResourcesItem.from_dict(resources_item_data)

                resources.append(resources_item)

        scim_list_resource_types_response_200 = cls(
            schemas=schemas,
        ...
        scim_list_resource_types_response_200.additional_properties = d
        return scim_list_resource_types_response_200
