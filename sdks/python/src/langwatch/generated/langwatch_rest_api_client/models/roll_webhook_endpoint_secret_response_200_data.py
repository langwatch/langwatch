...
from ..models.roll_webhook_endpoint_secret_response_200_data_status import (
    RollWebhookEndpointSecretResponse200DataStatus,
)

T = TypeVar("T", bound="RollWebhookEndpointSecretResponse200Data")


@_attrs_define
class RollWebhookEndpointSecretResponse200Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (RollWebhookEndpointSecretResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = RollWebhookEndpointSecretResponse200DataStatus(d.pop("status"))
        ...
        roll_webhook_endpoint_secret_response_200_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        roll_webhook_endpoint_secret_response_200_data.additional_properties = d
        return roll_webhook_endpoint_secret_response_200_data
