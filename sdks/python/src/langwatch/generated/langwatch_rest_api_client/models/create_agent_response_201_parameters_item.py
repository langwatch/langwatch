...
from ..models.create_agent_response_201_parameters_item_type import CreateAgentResponse201ParametersItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="CreateAgentResponse201ParametersItem")


@_attrs_define
class CreateAgentResponse201ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (CreateAgentResponse201ParametersItemType | Unset):
    ...
    type_: CreateAgentResponse201ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = CreateAgentResponse201ParametersItemType(_type_)
        ...
        create_agent_response_201_parameters_item = cls(
            name=name,
        ...
        create_agent_response_201_parameters_item.additional_properties = d
        return create_agent_response_201_parameters_item
