...
T = TypeVar("T", bound="ScimGetUserResponse403")


@_attrs_define
class ScimGetUserResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_get_user_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_get_user_response_403.additional_properties = d
        return scim_get_user_response_403
