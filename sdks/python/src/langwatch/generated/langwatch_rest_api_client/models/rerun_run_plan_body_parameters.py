...
T = TypeVar("T", bound="RerunRunPlanBodyParameters")


@_attrs_define
class RerunRunPlanBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        rerun_run_plan_body_parameters = cls()
        ...
        rerun_run_plan_body_parameters.additional_properties = additional_properties
        return rerun_run_plan_body_parameters
