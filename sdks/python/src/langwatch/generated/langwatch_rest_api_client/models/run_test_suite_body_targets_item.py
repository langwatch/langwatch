...
from ..models.run_test_suite_body_targets_item_type import RunTestSuiteBodyTargetsItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.run_test_suite_body_targets_item_run_parameters import RunTestSuiteBodyTargetsItemRunParameters
    from ..models.run_test_suite_body_targets_item_scenario_mappings import RunTestSuiteBodyTargetsItemScenarioMappings


T = TypeVar("T", bound="RunTestSuiteBodyTargetsItem")
...
class RunTestSuiteBodyTargetsItem:
    """
    Attributes:
        type_ (RunTestSuiteBodyTargetsItemType):
        reference_id (str):
        scenario_mappings (RunTestSuiteBodyTargetsItemScenarioMappings | Unset):
        run_parameters (RunTestSuiteBodyTargetsItemRunParameters | Unset):
        run_secret_parameter_names (list[str] | Unset):
    """

    type_: RunTestSuiteBodyTargetsItemType
    reference_id: str
    scenario_mappings: RunTestSuiteBodyTargetsItemScenarioMappings | Unset = UNSET
    run_parameters: RunTestSuiteBodyTargetsItemRunParameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.run_test_suite_body_targets_item_run_parameters import RunTestSuiteBodyTargetsItemRunParameters
        from ..models.run_test_suite_body_targets_item_scenario_mappings import (
            RunTestSuiteBodyTargetsItemScenarioMappings,
        )

        d = dict(src_dict)
        type_ = RunTestSuiteBodyTargetsItemType(d.pop("type"))
        ...
        if isinstance(_scenario_mappings, Unset):
            ...
            scenario_mappings = RunTestSuiteBodyTargetsItemScenarioMappings.from_dict(_scenario_mappings)
        ...
        if isinstance(_run_parameters, Unset):
            ...
            run_parameters = RunTestSuiteBodyTargetsItemRunParameters.from_dict(_run_parameters)

        run_secret_parameter_names = cast(list[str], d.pop("runSecretParameterNames", UNSET))

        run_test_suite_body_targets_item = cls(
            type_=type_,
        ...
        return run_test_suite_body_targets_item
