...
T = TypeVar("T", bound="PostApiExperimentsResponse400")


@_attrs_define
class PostApiExperimentsResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_experiments_response_400 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        post_api_experiments_response_400.additional_properties = d
        return post_api_experiments_response_400
