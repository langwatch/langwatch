...
T = TypeVar("T", bound="GetApiExperimentsRunsByRunIdResponse401")


@_attrs_define
class GetApiExperimentsRunsByRunIdResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_experiments_runs_by_run_id_response_401 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        get_api_experiments_runs_by_run_id_response_401.additional_properties = d
        return get_api_experiments_runs_by_run_id_response_401
