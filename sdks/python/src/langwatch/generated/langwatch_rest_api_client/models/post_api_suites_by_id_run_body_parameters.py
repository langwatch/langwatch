...
T = TypeVar("T", bound="PostApiSuitesByIdRunBodyParameters")


@_attrs_define
class PostApiSuitesByIdRunBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_suites_by_id_run_body_parameters = cls()
        ...
        post_api_suites_by_id_run_body_parameters.additional_properties = additional_properties
        return post_api_suites_by_id_run_body_parameters
