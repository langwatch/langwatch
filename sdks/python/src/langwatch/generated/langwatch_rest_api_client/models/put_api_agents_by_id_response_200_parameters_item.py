...
from ..models.put_api_agents_by_id_response_200_parameters_item_type import (
    PutApiAgentsByIdResponse200ParametersItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApiAgentsByIdResponse200ParametersItem")


@_attrs_define
class PutApiAgentsByIdResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (PutApiAgentsByIdResponse200ParametersItemType | Unset):
    ...
    type_: PutApiAgentsByIdResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PutApiAgentsByIdResponse200ParametersItemType(_type_)
        ...
        put_api_agents_by_id_response_200_parameters_item = cls(
            name=name,
        ...
        put_api_agents_by_id_response_200_parameters_item.additional_properties = d
        return put_api_agents_by_id_response_200_parameters_item
