...
T = TypeVar("T", bound="GetRunPlanResponse200TargetsItemRunParameters")


@_attrs_define
class GetRunPlanResponse200TargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        get_run_plan_response_200_targets_item_run_parameters = cls()
        ...
        get_run_plan_response_200_targets_item_run_parameters.additional_properties = additional_properties
        return get_run_plan_response_200_targets_item_run_parameters
