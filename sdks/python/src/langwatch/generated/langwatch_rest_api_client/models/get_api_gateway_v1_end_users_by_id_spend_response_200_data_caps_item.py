...
class GetApiGatewayV1EndUsersByIdSpendResponse200DataCapsItem:
    ...
    Attributes:
        ...
        limit_usd (str): The cap for this end user. Decimal string, up to 9 fractional digits, trailing zeros trimmed,
            never exponent notation.
        spent_usd (str): Spend against that cap. Decimal string, up to 9 fractional digits, trailing zeros trimmed,
            never exponent notation.
