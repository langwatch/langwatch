...
T = TypeVar("T", bound="ScimGetUserResponse404")


@_attrs_define
class ScimGetUserResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_get_user_response_404 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_get_user_response_404.additional_properties = d
        return scim_get_user_response_404
