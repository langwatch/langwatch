...
T = TypeVar("T", bound="EstimateInstantEvalRunBodyParameters")


@_attrs_define
class EstimateInstantEvalRunBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        estimate_instant_eval_run_body_parameters = cls()
        ...
        estimate_instant_eval_run_body_parameters.additional_properties = additional_properties
        return estimate_instant_eval_run_body_parameters
