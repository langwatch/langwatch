...
if TYPE_CHECKING:
    from ..models.get_api_prompts_by_id_response_200_demonstrations import GetApiPromptsByIdResponse200Demonstrations
    from ..models.get_api_prompts_by_id_response_200_inputs_item import GetApiPromptsByIdResponse200InputsItem
    from ..models.get_api_prompts_by_id_response_200_messages_item import GetApiPromptsByIdResponse200MessagesItem
    from ..models.get_api_prompts_by_id_response_200_outputs_item import GetApiPromptsByIdResponse200OutputsItem
    from ..models.get_api_prompts_by_id_response_200_parameters import GetApiPromptsByIdResponse200Parameters
    from ..models.get_api_prompts_by_id_response_200_prompting_technique import (
    ...
    from ..models.get_api_prompts_by_id_response_200_tags_item import GetApiPromptsByIdResponse200TagsItem
...
class GetApiPromptsByIdResponse200:
    ...
    Attributes:
        ...
        messages (list[GetApiPromptsByIdResponse200MessagesItem] | Unset):
        inputs (list[GetApiPromptsByIdResponse200InputsItem] | Unset):
        ...
        tags (list[GetApiPromptsByIdResponse200TagsItem] | Unset):
        parameters (GetApiPromptsByIdResponse200Parameters | Unset):
    ...
    messages: list[GetApiPromptsByIdResponse200MessagesItem] | Unset = UNSET
    inputs: list[GetApiPromptsByIdResponse200InputsItem] | Unset = UNSET
    ...
    tags: list[GetApiPromptsByIdResponse200TagsItem] | Unset = UNSET
    parameters: GetApiPromptsByIdResponse200Parameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        from ..models.get_api_prompts_by_id_response_200_demonstrations import (
        ...
        for outputs_item_data in _outputs:
            outputs_item = GetApiPromptsByIdResponse200OutputsItem.from_dict(outputs_item_data)
        ...
        if _inputs is not UNSET:
            ...
            for inputs_item_data in _inputs:
                inputs_item = GetApiPromptsByIdResponse200InputsItem.from_dict(inputs_item_data)
        ...
        if _tags is not UNSET:
            ...
            for tags_item_data in _tags:
                tags_item = GetApiPromptsByIdResponse200TagsItem.from_dict(tags_item_data)
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = GetApiPromptsByIdResponse200Parameters.from_dict(_parameters)
