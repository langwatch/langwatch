...
class ScimGetUserResponse200:
    ...
    Attributes:
        ...
        name (ScimGetUserResponse200Name | Unset):
        emails (list[ScimGetUserResponse200EmailsItem] | Unset):
        active (bool | Unset): False once the account is deactivated.
        meta (ScimGetUserResponse200Meta | Unset):
    """

    schemas: list[str] | Unset = UNSET
    id: str | Unset = UNSET
    user_name: str | Unset = UNSET
    name: ScimGetUserResponse200Name | Unset = UNSET
    emails: list[ScimGetUserResponse200EmailsItem] | Unset = UNSET
    active: bool | Unset = UNSET
    meta: ScimGetUserResponse200Meta | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_name, Unset):
            ...
            name = ScimGetUserResponse200Name.from_dict(_name)
        ...
        if isinstance(_meta, Unset):
            ...
            meta = ScimGetUserResponse200Meta.from_dict(_meta)
