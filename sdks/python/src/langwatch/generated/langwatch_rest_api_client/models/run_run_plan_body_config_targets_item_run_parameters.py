...
T = TypeVar("T", bound="RunRunPlanBodyConfigTargetsItemRunParameters")


@_attrs_define
class RunRunPlanBodyConfigTargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        run_run_plan_body_config_targets_item_run_parameters = cls()
        ...
        run_run_plan_body_config_targets_item_run_parameters.additional_properties = additional_properties
        return run_run_plan_body_config_targets_item_run_parameters
