...
if TYPE_CHECKING:
    from ..models.put_api_scenarios_by_id_response_200_fields import PutApiScenariosByIdResponse200Fields
...
class PutApiScenariosByIdResponse200:
    ...
    Attributes:
        ...
        fields (PutApiScenariosByIdResponse200Fields | Unset): The value this scenario carries for each field its test
    ...
    fields: PutApiScenariosByIdResponse200Fields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fields: PutApiScenariosByIdResponse200Fields | Unset
        if isinstance(_fields, Unset):
            fields = UNSET
        else:
            fields = PutApiScenariosByIdResponse200Fields.from_dict(_fields)
