...
T = TypeVar("T", bound="RunRunPlanResponse200ItemsItemTargetRunParameters")


@_attrs_define
class RunRunPlanResponse200ItemsItemTargetRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        run_run_plan_response_200_items_item_target_run_parameters = cls()
        ...
        run_run_plan_response_200_items_item_target_run_parameters.additional_properties = additional_properties
        return run_run_plan_response_200_items_item_target_run_parameters
