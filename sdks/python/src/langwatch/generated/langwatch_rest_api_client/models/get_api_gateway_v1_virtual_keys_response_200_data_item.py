...
from ..models.get_api_gateway_v1_virtual_keys_response_200_data_item_purpose import (
    GetApiGatewayV1VirtualKeysResponse200DataItemPurpose,
)
from ..models.get_api_gateway_v1_virtual_keys_response_200_data_item_routing_mode import (
    GetApiGatewayV1VirtualKeysResponse200DataItemRoutingMode,
)
from ..models.get_api_gateway_v1_virtual_keys_response_200_data_item_status import (
    GetApiGatewayV1VirtualKeysResponse200DataItemStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_api_gateway_v1_virtual_keys_response_200_data_item_metadata import (
        GetApiGatewayV1VirtualKeysResponse200DataItemMetadata,
    )
    from ..models.get_api_gateway_v1_virtual_keys_response_200_data_item_scopes_item import (
        GetApiGatewayV1VirtualKeysResponse200DataItemScopesItem,
    )


T = TypeVar("T", bound="GetApiGatewayV1VirtualKeysResponse200DataItem")


@_attrs_define
class GetApiGatewayV1VirtualKeysResponse200DataItem:
    """
    Attributes:
        id (str):
        organization_id (str):
        ...
        status (GetApiGatewayV1VirtualKeysResponse200DataItemStatus):
        purpose (GetApiGatewayV1VirtualKeysResponse200DataItemPurpose):
        display_prefix (str):
        ...
        metadata (GetApiGatewayV1VirtualKeysResponse200DataItemMetadata):
        scopes (list[GetApiGatewayV1VirtualKeysResponse200DataItemScopesItem]):
        routing_policy_id (None | str):
        routing_mode (GetApiGatewayV1VirtualKeysResponse200DataItemRoutingMode):
        revision (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetApiGatewayV1VirtualKeysResponse200DataItemStatus(d.pop("status"))

        purpose = GetApiGatewayV1VirtualKeysResponse200DataItemPurpose(d.pop("purpose"))
        ...
        metadata = GetApiGatewayV1VirtualKeysResponse200DataItemMetadata.from_dict(d.pop("metadata"))

        scopes = []
        _scopes = d.pop("scopes")
        for scopes_item_data in _scopes:
            scopes_item = GetApiGatewayV1VirtualKeysResponse200DataItemScopesItem.from_dict(scopes_item_data)
        ...
        routing_mode = GetApiGatewayV1VirtualKeysResponse200DataItemRoutingMode(d.pop("routing_mode"))
        ...
        get_api_gateway_v1_virtual_keys_response_200_data_item = cls(
            id=id,
            organization_id=organization_id,
            name=name,
            description=description,
        ...
        get_api_gateway_v1_virtual_keys_response_200_data_item.additional_properties = d
        return get_api_gateway_v1_virtual_keys_response_200_data_item
