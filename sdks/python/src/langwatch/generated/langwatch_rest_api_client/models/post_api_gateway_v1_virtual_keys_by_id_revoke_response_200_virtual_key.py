...
from ..models.post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key_purpose import (
    PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyPurpose,
)
from ..models.post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key_routing_mode import (
    PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyRoutingMode,
)
from ..models.post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key_status import (
    PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key_metadata import (
        PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyMetadata,
    )
    from ..models.post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key_scopes_item import (
        PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyScopesItem,
    )


T = TypeVar("T", bound="PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKey")


@_attrs_define
class PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKey:
    """
    Attributes:
        id (str):
        organization_id (str):
        ...
        status (PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyStatus):
        ...
        routing_mode (PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyRoutingMode):
        revision (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyStatus(d.pop("status"))

        purpose = PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyPurpose(d.pop("purpose"))
        ...
        metadata = PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyMetadata.from_dict(d.pop("metadata"))

        scopes = []
        _scopes = d.pop("scopes")
        for scopes_item_data in _scopes:
            scopes_item = PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyScopesItem.from_dict(
                scopes_item_data
            )
        ...
        routing_mode = PostApiGatewayV1VirtualKeysByIdRevokeResponse200VirtualKeyRoutingMode(d.pop("routing_mode"))
        ...
        post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key = cls(
            id=id,
            organization_id=organization_id,
            name=name,
            description=description,
        ...
        post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key.additional_properties = d
        return post_api_gateway_v1_virtual_keys_by_id_revoke_response_200_virtual_key
