...
from ..models.post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_type_0_status import (
    PostApiWebhooksV1EndpointsByIdRollSecretResponse200Type0Status,
)

T = TypeVar("T", bound="PostApiWebhooksV1EndpointsByIdRollSecretResponse200Type0")


@_attrs_define
class PostApiWebhooksV1EndpointsByIdRollSecretResponse200Type0:
    """
    Attributes:
        ...
        status (PostApiWebhooksV1EndpointsByIdRollSecretResponse200Type0Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApiWebhooksV1EndpointsByIdRollSecretResponse200Type0Status(d.pop("status"))
        ...
        post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_type_0 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        return post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_type_0
