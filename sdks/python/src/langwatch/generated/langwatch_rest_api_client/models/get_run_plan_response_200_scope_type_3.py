...
T = TypeVar("T", bound="GetRunPlanResponse200ScopeType3")
...
class GetRunPlanResponse200ScopeType3:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_run_plan_response_200_scope_type_3.additional_properties = d
        return get_run_plan_response_200_scope_type_3
