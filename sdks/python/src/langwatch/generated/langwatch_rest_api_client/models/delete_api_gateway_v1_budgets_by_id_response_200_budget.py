...
from ..models.delete_api_gateway_v1_budgets_by_id_response_200_budget_on_breach import (
    DeleteApiGatewayV1BudgetsByIdResponse200BudgetOnBreach,
)
from ..models.delete_api_gateway_v1_budgets_by_id_response_200_budget_scope_reach import (
    DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeReach,
)
from ..models.delete_api_gateway_v1_budgets_by_id_response_200_budget_scope_type import (
    DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeType,
)
from ..models.delete_api_gateway_v1_budgets_by_id_response_200_budget_window import (
    DeleteApiGatewayV1BudgetsByIdResponse200BudgetWindow,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.delete_api_gateway_v1_budgets_by_id_response_200_budget_metadata import (
        DeleteApiGatewayV1BudgetsByIdResponse200BudgetMetadata,
    )


T = TypeVar("T", bound="DeleteApiGatewayV1BudgetsByIdResponse200Budget")


@_attrs_define
class DeleteApiGatewayV1BudgetsByIdResponse200Budget:
    """
    Attributes:
        id (str):
        organization_id (str):
        scope_type (DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeType):
        scope_id (str):
        name (str):
        description (None | str):
        window (DeleteApiGatewayV1BudgetsByIdResponse200BudgetWindow):
        on_breach (DeleteApiGatewayV1BudgetsByIdResponse200BudgetOnBreach):
        ...
        metadata (DeleteApiGatewayV1BudgetsByIdResponse200BudgetMetadata):
        ...
        scope_reach (DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeReach | Unset): Whether any active key in the
    ...
    scope_reach: DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeReach | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope_type = DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeType(d.pop("scope_type"))
        ...
        window = DeleteApiGatewayV1BudgetsByIdResponse200BudgetWindow(d.pop("window"))

        on_breach = DeleteApiGatewayV1BudgetsByIdResponse200BudgetOnBreach(d.pop("on_breach"))
        ...
        metadata = DeleteApiGatewayV1BudgetsByIdResponse200BudgetMetadata.from_dict(d.pop("metadata"))
        ...
        scope_reach: DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeReach | Unset
        if isinstance(_scope_reach, Unset):
            scope_reach = UNSET
        else:
            scope_reach = DeleteApiGatewayV1BudgetsByIdResponse200BudgetScopeReach(_scope_reach)

        delete_api_gateway_v1_budgets_by_id_response_200_budget = cls(
            id=id,
            organization_id=organization_id,
            scope_type=scope_type,
            scope_id=scope_id,
        ...
        delete_api_gateway_v1_budgets_by_id_response_200_budget.additional_properties = d
        return delete_api_gateway_v1_budgets_by_id_response_200_budget
