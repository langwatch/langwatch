...
T = TypeVar("T", bound="GetApiGovernanceIngestionTemplatesResponse200DataItem")


@_attrs_define
class GetApiGovernanceIngestionTemplatesResponse200DataItem:
    """
    Attributes:
        id (str):
        slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_governance_ingestion_templates_response_200_data_item = cls(
            id=id,
            slug=slug,
            source_type=source_type,
            display_name=display_name,
        ...
        get_api_governance_ingestion_templates_response_200_data_item.additional_properties = d
        return get_api_governance_ingestion_templates_response_200_data_item
