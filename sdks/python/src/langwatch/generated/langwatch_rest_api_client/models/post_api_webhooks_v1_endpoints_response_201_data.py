...
from ..models.post_api_webhooks_v1_endpoints_response_201_data_status import (
    PostApiWebhooksV1EndpointsResponse201DataStatus,
)

T = TypeVar("T", bound="PostApiWebhooksV1EndpointsResponse201Data")


@_attrs_define
class PostApiWebhooksV1EndpointsResponse201Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (PostApiWebhooksV1EndpointsResponse201DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApiWebhooksV1EndpointsResponse201DataStatus(d.pop("status"))
        ...
        post_api_webhooks_v1_endpoints_response_201_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        post_api_webhooks_v1_endpoints_response_201_data.additional_properties = d
        return post_api_webhooks_v1_endpoints_response_201_data
