...
T = TypeVar("T", bound="ScimDeleteUserResponse404")


@_attrs_define
class ScimDeleteUserResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_delete_user_response_404 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_delete_user_response_404.additional_properties = d
        return scim_delete_user_response_404
