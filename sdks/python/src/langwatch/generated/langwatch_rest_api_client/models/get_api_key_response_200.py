...
from ..models.get_api_key_response_200_permission_mode import GetApiKeyResponse200PermissionMode
...
class GetApiKeyResponse200:
    ...
    Attributes:
        ...
        role_bindings (list[GetApiKeyResponse200RoleBindingsItem] | Unset):
        bindings (list[GetApiKeyResponse200BindingsItem] | Unset):
    """

    id: str | Unset = UNSET
    name: str | Unset = UNSET
    description: None | str | Unset = UNSET
    key_type: GetApiKeyResponse200KeyType | Unset = UNSET
    assigned_to_user_id: None | str | Unset = UNSET
    created_by_user_id: None | str | Unset = UNSET
    permission_mode: GetApiKeyResponse200PermissionMode | Unset = UNSET
    permissions: list[str] | Unset = UNSET
    created_at: datetime.datetime | Unset = UNSET
    expires_at: datetime.datetime | None | Unset = UNSET
    last_used_at: datetime.datetime | None | Unset = UNSET
    revoked_at: datetime.datetime | None | Unset = UNSET
    role_bindings: list[GetApiKeyResponse200RoleBindingsItem] | Unset = UNSET
    bindings: list[GetApiKeyResponse200BindingsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_key_type, Unset):
            ...
            key_type = GetApiKeyResponse200KeyType(_key_type)
        ...
        if isinstance(_permission_mode, Unset):
            ...
            permission_mode = GetApiKeyResponse200PermissionMode(_permission_mode)
