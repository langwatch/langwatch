...
T = TypeVar("T", bound="PostApiAgentsByIdCallBodyParams")


@_attrs_define
class PostApiAgentsByIdCallBodyParams:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_agents_by_id_call_body_params = cls()
        ...
        post_api_agents_by_id_call_body_params.additional_properties = additional_properties
        return post_api_agents_by_id_call_body_params
