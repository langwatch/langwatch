...
T = TypeVar("T", bound="PutApiExperimentsBySlugWorkbenchStateResponse400")


@_attrs_define
class PutApiExperimentsBySlugWorkbenchStateResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        put_api_experiments_by_slug_workbench_state_response_400 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        put_api_experiments_by_slug_workbench_state_response_400.additional_properties = d
        return put_api_experiments_by_slug_workbench_state_response_400
