...
from ..models.patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_1_status import (
    PatchApiWebhooksV1EndpointsByIdResponse200DataType1Status,
)

if TYPE_CHECKING:
    from ..models.patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_1_sqs import (
        PatchApiWebhooksV1EndpointsByIdResponse200DataType1Sqs,
    )


T = TypeVar("T", bound="PatchApiWebhooksV1EndpointsByIdResponse200DataType1")


@_attrs_define
class PatchApiWebhooksV1EndpointsByIdResponse200DataType1:
    """
    Attributes:
        destination_kind (Literal['sqs']):
        url (None):
        sqs (PatchApiWebhooksV1EndpointsByIdResponse200DataType1Sqs):
        id (str):
        enabled_events (list[str]):
        status (PatchApiWebhooksV1EndpointsByIdResponse200DataType1Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sqs = PatchApiWebhooksV1EndpointsByIdResponse200DataType1Sqs.from_dict(d.pop("sqs"))

        id = d.pop("id")

        enabled_events = cast(list[str], d.pop("enabled_events"))

        status = PatchApiWebhooksV1EndpointsByIdResponse200DataType1Status(d.pop("status"))
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_1 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_1.additional_properties = d
        return patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_1
