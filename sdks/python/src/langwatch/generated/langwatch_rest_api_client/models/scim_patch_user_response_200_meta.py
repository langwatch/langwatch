...
T = TypeVar("T", bound="ScimPatchUserResponse200Meta")


@_attrs_define
class ScimPatchUserResponse200Meta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_patch_user_response_200_meta = cls(
            resource_type=resource_type,
            created=created,
            last_modified=last_modified,
        )

        scim_patch_user_response_200_meta.additional_properties = d
        return scim_patch_user_response_200_meta
