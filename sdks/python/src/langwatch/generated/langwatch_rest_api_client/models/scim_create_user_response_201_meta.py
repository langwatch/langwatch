...
T = TypeVar("T", bound="ScimCreateUserResponse201Meta")


@_attrs_define
class ScimCreateUserResponse201Meta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_create_user_response_201_meta = cls(
            resource_type=resource_type,
            created=created,
            last_modified=last_modified,
        )

        scim_create_user_response_201_meta.additional_properties = d
        return scim_create_user_response_201_meta
