...
from ..models.update_api_key_response_200_key_type import UpdateApiKeyResponse200KeyType
from ..models.update_api_key_response_200_permission_mode import UpdateApiKeyResponse200PermissionMode
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.update_api_key_response_200_bindings_item import UpdateApiKeyResponse200BindingsItem
    from ..models.update_api_key_response_200_role_bindings_item import UpdateApiKeyResponse200RoleBindingsItem
...
class UpdateApiKeyResponse200:
    ...
    Attributes:
        ...
        key_type (UpdateApiKeyResponse200KeyType | Unset):
        assigned_to_user_id (None | str | Unset): The member who owns the key; null for a service key.
        created_by_user_id (None | str | Unset):
        permission_mode (UpdateApiKeyResponse200PermissionMode | Unset):
        permissions (list[str] | Unset): The resource:action permissions a restricted key grants. Empty for the other
            modes.
        created_at (datetime.datetime | Unset):
        expires_at (datetime.datetime | None | Unset):
        last_used_at (datetime.datetime | None | Unset):
        revoked_at (datetime.datetime | None | Unset):
        role_bindings (list[UpdateApiKeyResponse200RoleBindingsItem] | Unset):
        bindings (list[UpdateApiKeyResponse200BindingsItem] | Unset):
    """

    id: str | Unset = UNSET
    name: str | Unset = UNSET
    description: None | str | Unset = UNSET
    key_type: UpdateApiKeyResponse200KeyType | Unset = UNSET
    assigned_to_user_id: None | str | Unset = UNSET
    created_by_user_id: None | str | Unset = UNSET
    permission_mode: UpdateApiKeyResponse200PermissionMode | Unset = UNSET
    permissions: list[str] | Unset = UNSET
    created_at: datetime.datetime | Unset = UNSET
    expires_at: datetime.datetime | None | Unset = UNSET
    last_used_at: datetime.datetime | None | Unset = UNSET
    revoked_at: datetime.datetime | None | Unset = UNSET
    role_bindings: list[UpdateApiKeyResponse200RoleBindingsItem] | Unset = UNSET
    bindings: list[UpdateApiKeyResponse200BindingsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_key_type, Unset):
            ...
            key_type = UpdateApiKeyResponse200KeyType(_key_type)

        def _parse_assigned_to_user_id(data: object) -> None | str | Unset:
            if data is None:
                return data
            if isinstance(data, Unset):
                return data
        ...
        assigned_to_user_id = _parse_assigned_to_user_id(d.pop("assignedToUserId", UNSET))
        ...
        if isinstance(_permission_mode, Unset):
            ...
            permission_mode = UpdateApiKeyResponse200PermissionMode(_permission_mode)
        ...
        if _role_bindings is not UNSET:
            ...
            for role_bindings_item_data in _role_bindings:
                role_bindings_item = UpdateApiKeyResponse200RoleBindingsItem.from_dict(role_bindings_item_data)
        ...
        if _bindings is not UNSET:
            ...
            for bindings_item_data in _bindings:
                bindings_item = UpdateApiKeyResponse200BindingsItem.from_dict(bindings_item_data)
