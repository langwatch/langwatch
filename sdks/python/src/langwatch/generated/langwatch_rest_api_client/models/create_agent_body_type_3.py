...
if TYPE_CHECKING:
    from ..models.create_agent_body_type_3_config import CreateAgentBodyType3Config


T = TypeVar("T", bound="CreateAgentBodyType3")


@_attrs_define
class CreateAgentBodyType3:
    """
    Attributes:
        name (str):
        type_ (Literal['http']):
        config (CreateAgentBodyType3Config):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        config = CreateAgentBodyType3Config.from_dict(d.pop("config"))

        workflow_id = d.pop("workflowId", UNSET)

        copied_from_agent_id = d.pop("copiedFromAgentId", UNSET)

        create_agent_body_type_3 = cls(
            name=name,
            type_=type_,
            config=config,
        ...
        create_agent_body_type_3.additional_properties = d
        return create_agent_body_type_3
