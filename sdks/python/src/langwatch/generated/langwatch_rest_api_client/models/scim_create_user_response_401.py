...
T = TypeVar("T", bound="ScimCreateUserResponse401")


@_attrs_define
class ScimCreateUserResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_create_user_response_401 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_create_user_response_401.additional_properties = d
        return scim_create_user_response_401
