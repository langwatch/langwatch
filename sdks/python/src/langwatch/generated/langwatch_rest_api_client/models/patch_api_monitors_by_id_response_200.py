...
@_attrs_define
class PatchApiMonitorsByIdResponse200:
    """
    Attributes:
        id (str):
        name (str):
        ...
        check_type (str):
        enabled (bool):
        execution_mode (PatchApiMonitorsByIdResponse200ExecutionMode):
        sample (float):
        level (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_mode = PatchApiMonitorsByIdResponse200ExecutionMode(d.pop("executionMode"))
        ...
        return patch_api_monitors_by_id_response_200
