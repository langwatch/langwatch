...
if TYPE_CHECKING:
    from ..models.list_run_plans_response_200_item_evaluators_item_mappings import (
        ListRunPlansResponse200ItemEvaluatorsItemMappings,
    )


T = TypeVar("T", bound="ListRunPlansResponse200ItemEvaluatorsItem")


@_attrs_define
class ListRunPlansResponse200ItemEvaluatorsItem:
    ...
    evaluator_id: str
    required: bool
    mappings: ListRunPlansResponse200ItemEvaluatorsItemMappings
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mappings = ListRunPlansResponse200ItemEvaluatorsItemMappings.from_dict(d.pop("mappings"))

        list_run_plans_response_200_item_evaluators_item = cls(
            id=id,
        ...
        list_run_plans_response_200_item_evaluators_item.additional_properties = d
        return list_run_plans_response_200_item_evaluators_item
