...
T = TypeVar("T", bound="GetPullRequestUsageResponse200PullRequest")


@_attrs_define
class GetPullRequestUsageResponse200PullRequest:
    """
    Attributes:
        repository_host (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pull_request_usage_response_200_pull_request = cls(
        ...
        get_pull_request_usage_response_200_pull_request.additional_properties = d
        return get_pull_request_usage_response_200_pull_request
