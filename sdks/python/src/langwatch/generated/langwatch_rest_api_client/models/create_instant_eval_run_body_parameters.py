...
T = TypeVar("T", bound="CreateInstantEvalRunBodyParameters")


@_attrs_define
class CreateInstantEvalRunBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        create_instant_eval_run_body_parameters = cls()
        ...
        create_instant_eval_run_body_parameters.additional_properties = additional_properties
        return create_instant_eval_run_body_parameters
