...
from ..models.create_webhook_endpoint_response_201_data_status import CreateWebhookEndpointResponse201DataStatus

T = TypeVar("T", bound="CreateWebhookEndpointResponse201Data")


@_attrs_define
class CreateWebhookEndpointResponse201Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (CreateWebhookEndpointResponse201DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = CreateWebhookEndpointResponse201DataStatus(d.pop("status"))
        ...
        create_webhook_endpoint_response_201_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        create_webhook_endpoint_response_201_data.additional_properties = d
        return create_webhook_endpoint_response_201_data
