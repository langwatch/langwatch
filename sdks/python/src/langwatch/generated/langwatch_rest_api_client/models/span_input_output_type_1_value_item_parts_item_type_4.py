...
T = TypeVar("T", bound="SpanInputOutputType1ValueItemPartsItemType4")


@_attrs_define
class SpanInputOutputType1ValueItemPartsItemType4:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        span_input_output_type_1_value_item_parts_item_type_4 = cls(
            type_=type_,
            tool_name=tool_name,
        ...
        span_input_output_type_1_value_item_parts_item_type_4.additional_properties = d
        return span_input_output_type_1_value_item_parts_item_type_4
