...
from ..models.patch_api_webhooks_v1_endpoints_by_id_response_200_type_1_status import (
    PatchApiWebhooksV1EndpointsByIdResponse200Type1Status,
)

if TYPE_CHECKING:
    from ..models.patch_api_webhooks_v1_endpoints_by_id_response_200_type_1_sqs import (
        PatchApiWebhooksV1EndpointsByIdResponse200Type1Sqs,
    )


T = TypeVar("T", bound="PatchApiWebhooksV1EndpointsByIdResponse200Type1")


@_attrs_define
class PatchApiWebhooksV1EndpointsByIdResponse200Type1:
    """
    Attributes:
        destination_kind (Literal['sqs']):
        url (None):
        sqs (PatchApiWebhooksV1EndpointsByIdResponse200Type1Sqs):
        id (str):
        enabled_events (list[str]):
        status (PatchApiWebhooksV1EndpointsByIdResponse200Type1Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sqs = PatchApiWebhooksV1EndpointsByIdResponse200Type1Sqs.from_dict(d.pop("sqs"))

        id = d.pop("id")

        enabled_events = cast(list[str], d.pop("enabled_events"))

        status = PatchApiWebhooksV1EndpointsByIdResponse200Type1Status(d.pop("status"))
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_type_1 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        return patch_api_webhooks_v1_endpoints_by_id_response_200_type_1
