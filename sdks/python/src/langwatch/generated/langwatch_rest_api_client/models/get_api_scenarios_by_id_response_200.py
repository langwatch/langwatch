...
if TYPE_CHECKING:
    from ..models.get_api_scenarios_by_id_response_200_fields import GetApiScenariosByIdResponse200Fields
...
class GetApiScenariosByIdResponse200:
    ...
    Attributes:
        ...
        fields (GetApiScenariosByIdResponse200Fields | Unset): The value this scenario carries for each field its test
    ...
    fields: GetApiScenariosByIdResponse200Fields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fields: GetApiScenariosByIdResponse200Fields | Unset
        if isinstance(_fields, Unset):
            fields = UNSET
        else:
            fields = GetApiScenariosByIdResponse200Fields.from_dict(_fields)
