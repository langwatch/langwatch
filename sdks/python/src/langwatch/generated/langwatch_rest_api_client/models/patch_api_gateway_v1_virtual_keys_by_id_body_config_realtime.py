...
T = TypeVar("T", bound="PatchApiGatewayV1VirtualKeysByIdBodyConfigRealtime")


@_attrs_define
class PatchApiGatewayV1VirtualKeysByIdBodyConfigRealtime:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_api_gateway_v1_virtual_keys_by_id_body_config_realtime = cls(
            max_open_sessions=max_open_sessions,
        )

        patch_api_gateway_v1_virtual_keys_by_id_body_config_realtime.additional_properties = d
        return patch_api_gateway_v1_virtual_keys_by_id_body_config_realtime
