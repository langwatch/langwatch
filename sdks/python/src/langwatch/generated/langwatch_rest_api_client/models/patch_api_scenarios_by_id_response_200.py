...
if TYPE_CHECKING:
    from ..models.patch_api_scenarios_by_id_response_200_fields import PatchApiScenariosByIdResponse200Fields
...
class PatchApiScenariosByIdResponse200:
    ...
    Attributes:
        ...
        fields (PatchApiScenariosByIdResponse200Fields | Unset): The value this scenario carries for each field its test
    ...
    fields: PatchApiScenariosByIdResponse200Fields | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        fields: PatchApiScenariosByIdResponse200Fields | Unset
        if isinstance(_fields, Unset):
            fields = UNSET
        else:
            fields = PatchApiScenariosByIdResponse200Fields.from_dict(_fields)
