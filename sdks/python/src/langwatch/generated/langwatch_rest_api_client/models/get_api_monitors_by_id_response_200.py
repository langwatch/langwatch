...
from ..models.get_api_monitors_by_id_response_200_execution_mode import GetApiMonitorsByIdResponse200ExecutionMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetApiMonitorsByIdResponse200")


@_attrs_define
class GetApiMonitorsByIdResponse200:
    """
    Attributes:
        id (str):
        name (str):
        ...
        check_type (str):
        enabled (bool):
        execution_mode (GetApiMonitorsByIdResponse200ExecutionMode):
        sample (float):
        level (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_mode = GetApiMonitorsByIdResponse200ExecutionMode(d.pop("executionMode"))
        ...
        get_api_monitors_by_id_response_200 = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        get_api_monitors_by_id_response_200.additional_properties = d
        return get_api_monitors_by_id_response_200
