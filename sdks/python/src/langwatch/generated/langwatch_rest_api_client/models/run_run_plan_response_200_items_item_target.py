...
class RunRunPlanResponse200ItemsItemTarget:
    ...
    Attributes:
        type_ (RunRunPlanResponse200ItemsItemTargetType): What kind of thing the scenarios run against. A connected
        ...
        run_parameters (RunRunPlanResponse200ItemsItemTargetRunParameters | Unset): Parameter values this target alone
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        run_run_plan_response_200_items_item_target.additional_properties = d
