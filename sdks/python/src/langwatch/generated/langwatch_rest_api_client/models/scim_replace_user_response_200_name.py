...
T = TypeVar("T", bound="ScimReplaceUserResponse200Name")


@_attrs_define
class ScimReplaceUserResponse200Name:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_replace_user_response_200_name = cls(
            given_name=given_name,
            family_name=family_name,
        )

        scim_replace_user_response_200_name.additional_properties = d
        return scim_replace_user_response_200_name
