...
if TYPE_CHECKING:
    from ..models.get_api_webhooks_v1_endpoints_by_id_response_200_data import (
...
class GetApiWebhooksV1EndpointsByIdResponse200:
    """
    Attributes:
        data (GetApiWebhooksV1EndpointsByIdResponse200Data):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = GetApiWebhooksV1EndpointsByIdResponse200Data.from_dict(d.pop("data"))
