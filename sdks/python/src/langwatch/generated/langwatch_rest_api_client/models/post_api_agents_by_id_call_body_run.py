...
T = TypeVar("T", bound="PostApiAgentsByIdCallBodyRun")


@_attrs_define
class PostApiAgentsByIdCallBodyRun:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_agents_by_id_call_body_run = cls(
            scenario_run_id=scenario_run_id,
            scenario_name=scenario_name,
            batch_run_id=batch_run_id,
        )

        post_api_agents_by_id_call_body_run.additional_properties = d
        return post_api_agents_by_id_call_body_run
