...
T = TypeVar("T", bound="PostApiScenariosResponse201Fields")


@_attrs_define
class PostApiScenariosResponse201Fields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_scenarios_response_201_fields = cls()
        ...
        post_api_scenarios_response_201_fields.additional_properties = additional_properties
        return post_api_scenarios_response_201_fields
