...
from ..models.get_webhook_endpoint_response_200_data_status import GetWebhookEndpointResponse200DataStatus

T = TypeVar("T", bound="GetWebhookEndpointResponse200Data")


@_attrs_define
class GetWebhookEndpointResponse200Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (GetWebhookEndpointResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetWebhookEndpointResponse200DataStatus(d.pop("status"))
        ...
        get_webhook_endpoint_response_200_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        get_webhook_endpoint_response_200_data.additional_properties = d
        return get_webhook_endpoint_response_200_data
