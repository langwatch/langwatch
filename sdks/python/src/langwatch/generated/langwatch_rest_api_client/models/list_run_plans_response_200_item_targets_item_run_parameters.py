...
T = TypeVar("T", bound="ListRunPlansResponse200ItemTargetsItemRunParameters")


@_attrs_define
class ListRunPlansResponse200ItemTargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        list_run_plans_response_200_item_targets_item_run_parameters = cls()
        ...
        list_run_plans_response_200_item_targets_item_run_parameters.additional_properties = additional_properties
        return list_run_plans_response_200_item_targets_item_run_parameters
