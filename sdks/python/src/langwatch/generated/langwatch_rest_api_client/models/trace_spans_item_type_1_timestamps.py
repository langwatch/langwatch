...
T = TypeVar("T", bound="TraceSpansItemType1Timestamps")


@_attrs_define
class TraceSpansItemType1Timestamps:
    """
    Attributes:
        started_at (int):
        finished_at (int):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trace_spans_item_type_1_timestamps = cls(
            started_at=started_at,
            finished_at=finished_at,
        ...
        trace_spans_item_type_1_timestamps.additional_properties = d
        return trace_spans_item_type_1_timestamps
