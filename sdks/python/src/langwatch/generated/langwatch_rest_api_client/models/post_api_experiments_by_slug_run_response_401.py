...
T = TypeVar("T", bound="PostApiExperimentsBySlugRunResponse401")


@_attrs_define
class PostApiExperimentsBySlugRunResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_experiments_by_slug_run_response_401 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        post_api_experiments_by_slug_run_response_401.additional_properties = d
        return post_api_experiments_by_slug_run_response_401
