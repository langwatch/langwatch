...
from ..models.get_api_webhooks_v1_endpoints_response_200_data_item_type_0_status import (
    GetApiWebhooksV1EndpointsResponse200DataItemType0Status,
)

T = TypeVar("T", bound="GetApiWebhooksV1EndpointsResponse200DataItemType0")


@_attrs_define
class GetApiWebhooksV1EndpointsResponse200DataItemType0:
    """
    Attributes:
        destination_kind (Literal['http']):
        url (str):
        sqs (None):
        id (str):
        enabled_events (list[str]):
        status (GetApiWebhooksV1EndpointsResponse200DataItemType0Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        destination_kind = cast(Literal["http"], d.pop("destination_kind"))
        if destination_kind != "http":
            raise ValueError(f"destination_kind must match const 'http', got '{destination_kind}'")
        ...
        status = GetApiWebhooksV1EndpointsResponse200DataItemType0Status(d.pop("status"))
        ...
        get_api_webhooks_v1_endpoints_response_200_data_item_type_0 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        get_api_webhooks_v1_endpoints_response_200_data_item_type_0.additional_properties = d
        return get_api_webhooks_v1_endpoints_response_200_data_item_type_0
