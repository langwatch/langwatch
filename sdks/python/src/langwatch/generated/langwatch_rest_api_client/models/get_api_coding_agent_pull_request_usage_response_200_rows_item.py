...
T = TypeVar("T", bound="GetApiCodingAgentPullRequestUsageResponse200RowsItem")


@_attrs_define
class GetApiCodingAgentPullRequestUsageResponse200RowsItem:
    """
    Attributes:
        project_id (str):
        project_slug (str):
        contributor_label (str):
        contributor_is_project (bool):
        agent (str):
        models (list[str]):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        contributor_label = self.contributor_label

        contributor_is_project = self.contributor_is_project
        ...
        field_dict.update(
            {
                ...
                "contributorIsProject": contributor_is_project,
                "agent": agent,
                "models": models,
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        contributor_label = d.pop("contributorLabel")

        contributor_is_project = d.pop("contributorIsProject")
        ...
        get_api_coding_agent_pull_request_usage_response_200_rows_item = cls(
            project_id=project_id,
            project_slug=project_slug,
            contributor_label=contributor_label,
            contributor_is_project=contributor_is_project,
            agent=agent,
            models=models,
        ...
        get_api_coding_agent_pull_request_usage_response_200_rows_item.additional_properties = d
        return get_api_coding_agent_pull_request_usage_response_200_rows_item
