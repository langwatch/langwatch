...
from ..models.get_api_suites_by_id_response_200_targets_item_type import GetApiSuitesByIdResponse200TargetsItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_api_suites_by_id_response_200_targets_item_run_parameters import (
        GetApiSuitesByIdResponse200TargetsItemRunParameters,
    )
    from ..models.get_api_suites_by_id_response_200_targets_item_scenario_mappings import (
        GetApiSuitesByIdResponse200TargetsItemScenarioMappings,
    )


T = TypeVar("T", bound="GetApiSuitesByIdResponse200TargetsItem")


@_attrs_define
class GetApiSuitesByIdResponse200TargetsItem:
    """
    Attributes:
        type_ (GetApiSuitesByIdResponse200TargetsItemType):
        reference_id (str):
        scenario_mappings (GetApiSuitesByIdResponse200TargetsItemScenarioMappings | Unset):
        run_parameters (GetApiSuitesByIdResponse200TargetsItemRunParameters | Unset):
        run_secret_parameter_names (list[str] | Unset):
    """

    type_: GetApiSuitesByIdResponse200TargetsItemType
    reference_id: str
    scenario_mappings: GetApiSuitesByIdResponse200TargetsItemScenarioMappings | Unset = UNSET
    run_parameters: GetApiSuitesByIdResponse200TargetsItemRunParameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = GetApiSuitesByIdResponse200TargetsItemType(d.pop("type"))
        ...
        if isinstance(_scenario_mappings, Unset):
            ...
            scenario_mappings = GetApiSuitesByIdResponse200TargetsItemScenarioMappings.from_dict(_scenario_mappings)
        ...
        if isinstance(_run_parameters, Unset):
            ...
            run_parameters = GetApiSuitesByIdResponse200TargetsItemRunParameters.from_dict(_run_parameters)

        run_secret_parameter_names = cast(list[str], d.pop("runSecretParameterNames", UNSET))

        get_api_suites_by_id_response_200_targets_item = cls(
            type_=type_,
        ...
        return get_api_suites_by_id_response_200_targets_item
