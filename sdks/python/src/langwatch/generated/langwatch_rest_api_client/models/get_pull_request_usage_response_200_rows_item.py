...
T = TypeVar("T", bound="GetPullRequestUsageResponse200RowsItem")


@_attrs_define
class GetPullRequestUsageResponse200RowsItem:
    """
    Attributes:
        project_id (str):
        project_slug (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pull_request_usage_response_200_rows_item = cls(
        ...
        get_pull_request_usage_response_200_rows_item.additional_properties = d
        return get_pull_request_usage_response_200_rows_item
