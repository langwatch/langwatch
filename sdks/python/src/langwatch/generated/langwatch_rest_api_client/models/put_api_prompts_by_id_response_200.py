...
class PutApiPromptsByIdResponse200:
    ...
    Attributes:
        ...
        messages (list[PutApiPromptsByIdResponse200MessagesItem] | Unset):
        inputs (list[PutApiPromptsByIdResponse200InputsItem] | Unset):
        ...
        tags (list[PutApiPromptsByIdResponse200TagsItem] | Unset):
        parameters (PutApiPromptsByIdResponse200Parameters | Unset):
    ...
    messages: list[PutApiPromptsByIdResponse200MessagesItem] | Unset = UNSET
    inputs: list[PutApiPromptsByIdResponse200InputsItem] | Unset = UNSET
    ...
    tags: list[PutApiPromptsByIdResponse200TagsItem] | Unset = UNSET
    parameters: PutApiPromptsByIdResponse200Parameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = PutApiPromptsByIdResponse200Parameters.from_dict(_parameters)
