...
if TYPE_CHECKING:
    from ..models.get_webhook_endpoint_response_200_data import GetWebhookEndpointResponse200Data
...
class GetWebhookEndpointResponse200:
    """
    Attributes:
        data (GetWebhookEndpointResponse200Data):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        data = GetWebhookEndpointResponse200Data.from_dict(d.pop("data"))
