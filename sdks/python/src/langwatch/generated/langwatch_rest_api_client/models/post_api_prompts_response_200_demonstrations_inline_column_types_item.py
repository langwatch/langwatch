...
from ..models.post_api_prompts_response_200_demonstrations_inline_column_types_item_type import (
...
class PostApiPromptsResponse200DemonstrationsInlineColumnTypesItem:
    ...
    Attributes:
        name (str):
        type_ (PostApiPromptsResponse200DemonstrationsInlineColumnTypesItemType):
        id (str | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_ = PostApiPromptsResponse200DemonstrationsInlineColumnTypesItemType(d.pop("type"))
