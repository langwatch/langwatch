...
from ..models.update_organization_response_200_primary_intent_type_0 import (
...
class UpdateOrganizationResponse200:
    ...
    Attributes:
        ...
        primary_intent (None | UpdateOrganizationResponse200PrimaryIntentType0):
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.primary_intent, UpdateOrganizationResponse200PrimaryIntentType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_primary_intent(data: object) -> None | UpdateOrganizationResponse200PrimaryIntentType0:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                primary_intent_type_0 = UpdateOrganizationResponse200PrimaryIntentType0(data)

                return primary_intent_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | UpdateOrganizationResponse200PrimaryIntentType0, data)
