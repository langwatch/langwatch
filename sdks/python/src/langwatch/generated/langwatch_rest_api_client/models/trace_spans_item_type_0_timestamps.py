...
T = TypeVar("T", bound="TraceSpansItemType0Timestamps")
...
class TraceSpansItemType0Timestamps:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        trace_spans_item_type_0_timestamps = cls(
            started_at=started_at,
            finished_at=finished_at,
        ...
        trace_spans_item_type_0_timestamps.additional_properties = d
        return trace_spans_item_type_0_timestamps
