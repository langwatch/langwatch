...
from ..models.patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_0_status import (
    PatchApiWebhooksV1EndpointsByIdResponse200DataType0Status,
)

T = TypeVar("T", bound="PatchApiWebhooksV1EndpointsByIdResponse200DataType0")


@_attrs_define
class PatchApiWebhooksV1EndpointsByIdResponse200DataType0:
    """
    Attributes:
        ...
        status (PatchApiWebhooksV1EndpointsByIdResponse200DataType0Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PatchApiWebhooksV1EndpointsByIdResponse200DataType0Status(d.pop("status"))
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_0 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_0.additional_properties = d
        return patch_api_webhooks_v1_endpoints_by_id_response_200_data_type_0
