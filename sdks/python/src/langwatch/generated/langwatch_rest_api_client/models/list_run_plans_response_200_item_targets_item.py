...
from ..models.list_run_plans_response_200_item_targets_item_type import ListRunPlansResponse200ItemTargetsItemType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.list_run_plans_response_200_item_targets_item_run_parameters import (
        ListRunPlansResponse200ItemTargetsItemRunParameters,
    )
    from ..models.list_run_plans_response_200_item_targets_item_scenario_mappings import (
        ListRunPlansResponse200ItemTargetsItemScenarioMappings,
    )


T = TypeVar("T", bound="ListRunPlansResponse200ItemTargetsItem")


@_attrs_define
class ListRunPlansResponse200ItemTargetsItem:
    """
    Attributes:
        type_ (ListRunPlansResponse200ItemTargetsItemType):
        reference_id (str):
        scenario_mappings (ListRunPlansResponse200ItemTargetsItemScenarioMappings | Unset):
        run_parameters (ListRunPlansResponse200ItemTargetsItemRunParameters | Unset):
        run_secret_parameter_names (list[str] | Unset):
    """

    type_: ListRunPlansResponse200ItemTargetsItemType
    reference_id: str
    scenario_mappings: ListRunPlansResponse200ItemTargetsItemScenarioMappings | Unset = UNSET
    run_parameters: ListRunPlansResponse200ItemTargetsItemRunParameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = ListRunPlansResponse200ItemTargetsItemType(d.pop("type"))
        ...
        if isinstance(_scenario_mappings, Unset):
            ...
            scenario_mappings = ListRunPlansResponse200ItemTargetsItemScenarioMappings.from_dict(_scenario_mappings)
        ...
        if isinstance(_run_parameters, Unset):
            ...
            run_parameters = ListRunPlansResponse200ItemTargetsItemRunParameters.from_dict(_run_parameters)

        run_secret_parameter_names = cast(list[str], d.pop("runSecretParameterNames", UNSET))

        list_run_plans_response_200_item_targets_item = cls(
            type_=type_,
        ...
        return list_run_plans_response_200_item_targets_item
