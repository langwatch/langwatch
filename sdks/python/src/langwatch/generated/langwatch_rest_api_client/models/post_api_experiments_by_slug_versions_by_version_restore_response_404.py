...
T = TypeVar("T", bound="PostApiExperimentsBySlugVersionsByVersionRestoreResponse404")


@_attrs_define
class PostApiExperimentsBySlugVersionsByVersionRestoreResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_experiments_by_slug_versions_by_version_restore_response_404 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        post_api_experiments_by_slug_versions_by_version_restore_response_404.additional_properties = d
        return post_api_experiments_by_slug_versions_by_version_restore_response_404
