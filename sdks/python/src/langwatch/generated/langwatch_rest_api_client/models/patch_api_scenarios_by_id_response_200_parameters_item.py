...
from ..models.patch_api_scenarios_by_id_response_200_parameters_item_type import (
    PatchApiScenariosByIdResponse200ParametersItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchApiScenariosByIdResponse200ParametersItem")


@_attrs_define
class PatchApiScenariosByIdResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (PatchApiScenariosByIdResponse200ParametersItemType | Unset):
    ...
    type_: PatchApiScenariosByIdResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PatchApiScenariosByIdResponse200ParametersItemType(_type_)
        ...
        patch_api_scenarios_by_id_response_200_parameters_item = cls(
            name=name,
        ...
        patch_api_scenarios_by_id_response_200_parameters_item.additional_properties = d
        return patch_api_scenarios_by_id_response_200_parameters_item
