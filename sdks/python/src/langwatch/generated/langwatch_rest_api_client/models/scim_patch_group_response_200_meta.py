...
T = TypeVar("T", bound="ScimPatchGroupResponse200Meta")


@_attrs_define
class ScimPatchGroupResponse200Meta:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_patch_group_response_200_meta = cls(
            resource_type=resource_type,
            created=created,
            last_modified=last_modified,
        )

        scim_patch_group_response_200_meta.additional_properties = d
        return scim_patch_group_response_200_meta
