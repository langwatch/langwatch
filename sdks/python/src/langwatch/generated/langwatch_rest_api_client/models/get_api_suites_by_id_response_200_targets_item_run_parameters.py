...
T = TypeVar("T", bound="GetApiSuitesByIdResponse200TargetsItemRunParameters")


@_attrs_define
class GetApiSuitesByIdResponse200TargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        get_api_suites_by_id_response_200_targets_item_run_parameters = cls()
        ...
        get_api_suites_by_id_response_200_targets_item_run_parameters.additional_properties = additional_properties
        return get_api_suites_by_id_response_200_targets_item_run_parameters
