...
T = TypeVar("T", bound="PostApiExperimentsBySlugVersionsByVersionRestoreResponse400")


@_attrs_define
class PostApiExperimentsBySlugVersionsByVersionRestoreResponse400:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_experiments_by_slug_versions_by_version_restore_response_400 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        post_api_experiments_by_slug_versions_by_version_restore_response_400.additional_properties = d
        return post_api_experiments_by_slug_versions_by_version_restore_response_400
