...
T = TypeVar("T", bound="PostApiOptimizationByWorkflowIdByVersionIdResponse403")


@_attrs_define
class PostApiOptimizationByWorkflowIdByVersionIdResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_optimization_by_workflow_id_by_version_id_response_403 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        post_api_optimization_by_workflow_id_by_version_id_response_403.additional_properties = d
        return post_api_optimization_by_workflow_id_by_version_id_response_403
