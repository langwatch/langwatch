...
T = TypeVar("T", bound="ScimListGroupsResponse403")


@_attrs_define
class ScimListGroupsResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_list_groups_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_list_groups_response_403.additional_properties = d
        return scim_list_groups_response_403
