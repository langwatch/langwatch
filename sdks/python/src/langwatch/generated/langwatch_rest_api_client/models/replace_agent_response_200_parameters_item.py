...
from ..models.replace_agent_response_200_parameters_item_type import ReplaceAgentResponse200ParametersItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="ReplaceAgentResponse200ParametersItem")


@_attrs_define
class ReplaceAgentResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (ReplaceAgentResponse200ParametersItemType | Unset):
    ...
    type_: ReplaceAgentResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ReplaceAgentResponse200ParametersItemType(_type_)
        ...
        replace_agent_response_200_parameters_item = cls(
            name=name,
        ...
        replace_agent_response_200_parameters_item.additional_properties = d
        return replace_agent_response_200_parameters_item
