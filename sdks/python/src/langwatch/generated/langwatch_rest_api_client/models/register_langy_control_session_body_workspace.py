...
T = TypeVar("T", bound="RegisterLangyControlSessionBodyWorkspace")


@_attrs_define
class RegisterLangyControlSessionBodyWorkspace:
    """
    Attributes:
        root (str):
        name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        register_langy_control_session_body_workspace = cls(
            root=root,
            name=name,
            os=os,
