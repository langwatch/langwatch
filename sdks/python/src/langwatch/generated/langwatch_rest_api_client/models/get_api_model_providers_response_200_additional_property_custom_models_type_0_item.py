...
from ..models.get_api_model_providers_response_200_additional_property_custom_models_type_0_item_multimodal_inputs_item import (
    GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0ItemMultimodalInputsItem,
)
from ..models.get_api_model_providers_response_200_additional_property_custom_models_type_0_item_supported_parameters_item import (
    GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0ItemSupportedParametersItem,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0Item")


@_attrs_define
class GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0Item:
    """
    Attributes:
        model_id (str):
        display_name (str):
        mode (GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0ItemMode):
        max_tokens (float | None | Unset):
        supported_parameters
            (list[GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0ItemSupportedParametersItem] | Unset):
        multimodal_inputs
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        mode = GetApiModelProvidersResponse200AdditionalPropertyCustomModelsType0ItemMode(d.pop("mode"))
        ...
        get_api_model_providers_response_200_additional_property_custom_models_type_0_item = cls(
            model_id=model_id,
