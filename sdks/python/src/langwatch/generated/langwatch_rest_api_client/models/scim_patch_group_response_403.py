...
T = TypeVar("T", bound="ScimPatchGroupResponse403")


@_attrs_define
class ScimPatchGroupResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_patch_group_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_patch_group_response_403.additional_properties = d
        return scim_patch_group_response_403
