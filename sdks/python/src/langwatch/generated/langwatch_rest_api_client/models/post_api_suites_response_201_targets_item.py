...
class PostApiSuitesResponse201TargetsItem:
    """
    Attributes:
        type_ (PostApiSuitesResponse201TargetsItemType): What kind of thing the scenarios run against. A connected agent
        ...
        run_parameters (PostApiSuitesResponse201TargetsItemRunParameters | Unset): Parameter values this target alone
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_suites_response_201_targets_item.additional_properties = d
