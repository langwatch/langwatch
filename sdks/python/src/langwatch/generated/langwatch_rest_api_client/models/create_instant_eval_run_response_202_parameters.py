...
T = TypeVar("T", bound="CreateInstantEvalRunResponse202Parameters")


@_attrs_define
class CreateInstantEvalRunResponse202Parameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        create_instant_eval_run_response_202_parameters = cls()
        ...
        create_instant_eval_run_response_202_parameters.additional_properties = additional_properties
        return create_instant_eval_run_response_202_parameters
