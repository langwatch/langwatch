...
from ..models.patch_api_webhooks_v1_endpoints_by_id_response_200_data_status import (
    PatchApiWebhooksV1EndpointsByIdResponse200DataStatus,
)

T = TypeVar("T", bound="PatchApiWebhooksV1EndpointsByIdResponse200Data")


@_attrs_define
class PatchApiWebhooksV1EndpointsByIdResponse200Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (PatchApiWebhooksV1EndpointsByIdResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PatchApiWebhooksV1EndpointsByIdResponse200DataStatus(d.pop("status"))
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        patch_api_webhooks_v1_endpoints_by_id_response_200_data.additional_properties = d
        return patch_api_webhooks_v1_endpoints_by_id_response_200_data
