...
T = TypeVar("T", bound="ScimCreateUserResponse403")


@_attrs_define
class ScimCreateUserResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_create_user_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_create_user_response_403.additional_properties = d
        return scim_create_user_response_403
