...
from ..models.patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key_purpose import (
    PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyPurpose,
)
from ..models.patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key_routing_mode import (
    PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyRoutingMode,
)
from ..models.patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key_status import (
    PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyStatus,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key_metadata import (
        PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyMetadata,
    )
    from ..models.patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key_scopes_item import (
        PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyScopesItem,
    )


T = TypeVar("T", bound="PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKey")


@_attrs_define
class PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKey:
    """
    Attributes:
        id (str):
        organization_id (str):
        ...
        status (PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyStatus):
        purpose (PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyPurpose):
        display_prefix (str):
        ...
        metadata (PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyMetadata):
        scopes (list[PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyScopesItem]):
        routing_policy_id (None | str):
        routing_mode (PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyRoutingMode):
        revision (str):
        created_at (str):
        updated_at (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyStatus(d.pop("status"))

        purpose = PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyPurpose(d.pop("purpose"))
        ...
        metadata = PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyMetadata.from_dict(d.pop("metadata"))

        scopes = []
        _scopes = d.pop("scopes")
        for scopes_item_data in _scopes:
            scopes_item = PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyScopesItem.from_dict(scopes_item_data)
        ...
        routing_mode = PatchApiGatewayV1VirtualKeysByIdResponse200VirtualKeyRoutingMode(d.pop("routing_mode"))
        ...
        patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key = cls(
            id=id,
            organization_id=organization_id,
            name=name,
            description=description,
        ...
        patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key.additional_properties = d
        return patch_api_gateway_v1_virtual_keys_by_id_response_200_virtual_key
