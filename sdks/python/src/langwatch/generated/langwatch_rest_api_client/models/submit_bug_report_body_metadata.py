...
T = TypeVar("T", bound="SubmitBugReportBodyMetadata")


@_attrs_define
class SubmitBugReportBodyMetadata:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        submit_bug_report_body_metadata = cls()
        ...
        submit_bug_report_body_metadata.additional_properties = additional_properties
        return submit_bug_report_body_metadata
