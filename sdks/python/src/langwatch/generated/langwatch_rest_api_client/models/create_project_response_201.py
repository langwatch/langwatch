...
class CreateProjectResponse201:
    ...
    Attributes:
        ...
        service_api_key (str | Unset): Scoped service API key with ADMIN on this project (sk-lw-..._...). Store securely
            — shown only once.
        service_api_key_id (str | Unset): ID of the auto-created service key, for management via DELETE /api/api-
            keys/{id}.
    """
    ...
    service_api_key: str | Unset = UNSET
    service_api_key_id: str | Unset = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if service_api_key is not UNSET:
            field_dict["serviceApiKey"] = service_api_key
        if service_api_key_id is not UNSET:
            field_dict["serviceApiKeyId"] = service_api_key_id
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        service_api_key = d.pop("serviceApiKey", UNSET)

        service_api_key_id = d.pop("serviceApiKeyId", UNSET)
