...
from ..models.rerun_run_plan_response_200_items_item_target_type import RerunRunPlanResponse200ItemsItemTargetType
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.rerun_run_plan_response_200_items_item_target_run_parameters import (
        RerunRunPlanResponse200ItemsItemTargetRunParameters,
    )
    from ..models.rerun_run_plan_response_200_items_item_target_scenario_mappings import (
        RerunRunPlanResponse200ItemsItemTargetScenarioMappings,
    )


T = TypeVar("T", bound="RerunRunPlanResponse200ItemsItemTarget")


@_attrs_define
class RerunRunPlanResponse200ItemsItemTarget:
    """What it was run against.

    Attributes:
        type_ (RerunRunPlanResponse200ItemsItemTargetType):
        reference_id (str):
        scenario_mappings (RerunRunPlanResponse200ItemsItemTargetScenarioMappings | Unset):
        run_parameters (RerunRunPlanResponse200ItemsItemTargetRunParameters | Unset):
        run_secret_parameter_names (list[str] | Unset):
    """

    type_: RerunRunPlanResponse200ItemsItemTargetType
    reference_id: str
    scenario_mappings: RerunRunPlanResponse200ItemsItemTargetScenarioMappings | Unset = UNSET
    run_parameters: RerunRunPlanResponse200ItemsItemTargetRunParameters | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        type_ = RerunRunPlanResponse200ItemsItemTargetType(d.pop("type"))
        ...
        if isinstance(_scenario_mappings, Unset):
            ...
            scenario_mappings = RerunRunPlanResponse200ItemsItemTargetScenarioMappings.from_dict(_scenario_mappings)
        ...
        if isinstance(_run_parameters, Unset):
            ...
            run_parameters = RerunRunPlanResponse200ItemsItemTargetRunParameters.from_dict(_run_parameters)

        run_secret_parameter_names = cast(list[str], d.pop("runSecretParameterNames", UNSET))

        rerun_run_plan_response_200_items_item_target = cls(
            type_=type_,
        ...
        return rerun_run_plan_response_200_items_item_target
