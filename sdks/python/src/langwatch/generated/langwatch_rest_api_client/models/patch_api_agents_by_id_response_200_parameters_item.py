...
from ..models.patch_api_agents_by_id_response_200_parameters_item_type import (
    PatchApiAgentsByIdResponse200ParametersItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="PatchApiAgentsByIdResponse200ParametersItem")


@_attrs_define
class PatchApiAgentsByIdResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (PatchApiAgentsByIdResponse200ParametersItemType | Unset):
    ...
    type_: PatchApiAgentsByIdResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PatchApiAgentsByIdResponse200ParametersItemType(_type_)
        ...
        patch_api_agents_by_id_response_200_parameters_item = cls(
            name=name,
        ...
        patch_api_agents_by_id_response_200_parameters_item.additional_properties = d
        return patch_api_agents_by_id_response_200_parameters_item
