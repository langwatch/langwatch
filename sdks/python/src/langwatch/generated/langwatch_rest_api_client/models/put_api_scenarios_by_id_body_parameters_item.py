...
from ..models.put_api_scenarios_by_id_body_parameters_item_type import PutApiScenariosByIdBodyParametersItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PutApiScenariosByIdBodyParametersItem")


@_attrs_define
class PutApiScenariosByIdBodyParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (PutApiScenariosByIdBodyParametersItemType | Unset):
    ...
    type_: PutApiScenariosByIdBodyParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PutApiScenariosByIdBodyParametersItemType(_type_)
        ...
        put_api_scenarios_by_id_body_parameters_item = cls(
            name=name,
        ...
        put_api_scenarios_by_id_body_parameters_item.additional_properties = d
        return put_api_scenarios_by_id_body_parameters_item
