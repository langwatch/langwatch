...
T = TypeVar("T", bound="PutApiScenariosByIdResponse200Fields")


@_attrs_define
class PutApiScenariosByIdResponse200Fields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        put_api_scenarios_by_id_response_200_fields = cls()
        ...
        put_api_scenarios_by_id_response_200_fields.additional_properties = additional_properties
        return put_api_scenarios_by_id_response_200_fields
