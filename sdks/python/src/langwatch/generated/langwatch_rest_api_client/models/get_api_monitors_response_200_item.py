...
from ..models.get_api_monitors_response_200_item_execution_mode import GetApiMonitorsResponse200ItemExecutionMode
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetApiMonitorsResponse200Item")


@_attrs_define
class GetApiMonitorsResponse200Item:
    """
    Attributes:
        id (str):
        name (str):
        ...
        check_type (str):
        enabled (bool):
        execution_mode (GetApiMonitorsResponse200ItemExecutionMode):
        sample (float):
        level (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        execution_mode = GetApiMonitorsResponse200ItemExecutionMode(d.pop("executionMode"))
        ...
        get_api_monitors_response_200_item = cls(
            id=id,
            name=name,
            slug=slug,
        ...
        get_api_monitors_response_200_item.additional_properties = d
        return get_api_monitors_response_200_item
