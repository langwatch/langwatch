...
if TYPE_CHECKING:
    ...
    from ..models.get_run_plan_response_200_scope_type_3 import GetRunPlanResponse200ScopeType3
    from ..models.get_run_plan_response_200_targets_item import GetRunPlanResponse200TargetsItem


T = TypeVar("T", bound="GetRunPlanResponse200")


@_attrs_define
class GetRunPlanResponse200:
    """
    Attributes:
    ...
    targets: list[GetRunPlanResponse200TargetsItem]
    repeat_count: float
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        scope: dict[str, Any]
        if isinstance(self.scope, GetRunPlanResponse200ScopeType0):
            scope = self.scope.to_dict()
        elif isinstance(self.scope, GetRunPlanResponse200ScopeType1):
            scope = self.scope.to_dict()
        elif isinstance(self.scope, GetRunPlanResponse200ScopeType2):
            scope = self.scope.to_dict()
        else:
            scope = self.scope.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_scope(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                scope_type_0 = GetRunPlanResponse200ScopeType0.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                scope_type_1 = GetRunPlanResponse200ScopeType1.from_dict(data)
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                scope_type_2 = GetRunPlanResponse200ScopeType2.from_dict(data)
            ...
            if not isinstance(data, dict):
                raise TypeError()
            scope_type_3 = GetRunPlanResponse200ScopeType3.from_dict(data)
        ...
        for targets_item_data in _targets:
            targets_item = GetRunPlanResponse200TargetsItem.from_dict(targets_item_data)
        ...
        return get_run_plan_response_200
