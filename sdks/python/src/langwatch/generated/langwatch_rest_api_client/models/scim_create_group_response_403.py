...
T = TypeVar("T", bound="ScimCreateGroupResponse403")


@_attrs_define
class ScimCreateGroupResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_create_group_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_create_group_response_403.additional_properties = d
        return scim_create_group_response_403
