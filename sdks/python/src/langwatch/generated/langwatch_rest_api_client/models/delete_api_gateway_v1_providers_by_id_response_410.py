...
from ..models.delete_api_gateway_v1_providers_by_id_response_410_fault import (
    DeleteApiGatewayV1ProvidersByIdResponse410Fault,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.delete_api_gateway_v1_providers_by_id_response_410_meta import (
...
class DeleteApiGatewayV1ProvidersByIdResponse410:
    ...
    Attributes:
        ...
        message (str):
        retryable (bool):
        meta (DeleteApiGatewayV1ProvidersByIdResponse410Meta | Unset):
        trace_id (str | Unset):
        span_id (str | Unset):
        tips (list[str] | Unset):
        docs_url (str | Unset):
        fault (DeleteApiGatewayV1ProvidersByIdResponse410Fault | Unset):
    ...
    message: str
    retryable: bool
    meta: DeleteApiGatewayV1ProvidersByIdResponse410Meta | Unset = UNSET
    trace_id: str | Unset = UNSET
    span_id: str | Unset = UNSET
    tips: list[str] | Unset = UNSET
    docs_url: str | Unset = UNSET
    fault: DeleteApiGatewayV1ProvidersByIdResponse410Fault | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = DeleteApiGatewayV1ProvidersByIdResponse410Meta.from_dict(_meta)
        ...
        if isinstance(_fault, Unset):
            ...
            fault = DeleteApiGatewayV1ProvidersByIdResponse410Fault(_fault)
