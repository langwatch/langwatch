...
from ..models.get_api_webhooks_v1_endpoints_response_200_item_type_1_status import (
    GetApiWebhooksV1EndpointsResponse200ItemType1Status,
)

if TYPE_CHECKING:
    from ..models.get_api_webhooks_v1_endpoints_response_200_item_type_1_sqs import (
        GetApiWebhooksV1EndpointsResponse200ItemType1Sqs,
    )


T = TypeVar("T", bound="GetApiWebhooksV1EndpointsResponse200ItemType1")


@_attrs_define
class GetApiWebhooksV1EndpointsResponse200ItemType1:
    """
    Attributes:
        destination_kind (Literal['sqs']):
        url (None):
        sqs (GetApiWebhooksV1EndpointsResponse200ItemType1Sqs):
        id (str):
        enabled_events (list[str]):
        status (GetApiWebhooksV1EndpointsResponse200ItemType1Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sqs = GetApiWebhooksV1EndpointsResponse200ItemType1Sqs.from_dict(d.pop("sqs"))

        id = d.pop("id")

        enabled_events = cast(list[str], d.pop("enabled_events"))

        status = GetApiWebhooksV1EndpointsResponse200ItemType1Status(d.pop("status"))
        ...
        get_api_webhooks_v1_endpoints_response_200_item_type_1 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        get_api_webhooks_v1_endpoints_response_200_item_type_1.additional_properties = d
        return get_api_webhooks_v1_endpoints_response_200_item_type_1
