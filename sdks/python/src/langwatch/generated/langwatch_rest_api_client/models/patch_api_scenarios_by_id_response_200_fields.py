...
T = TypeVar("T", bound="PatchApiScenariosByIdResponse200Fields")


@_attrs_define
class PatchApiScenariosByIdResponse200Fields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        patch_api_scenarios_by_id_response_200_fields = cls()
        ...
        patch_api_scenarios_by_id_response_200_fields.additional_properties = additional_properties
        return patch_api_scenarios_by_id_response_200_fields
