...
from ..models.get_webhook_endpoint_health_response_200_data_status import GetWebhookEndpointHealthResponse200DataStatus

T = TypeVar("T", bound="GetWebhookEndpointHealthResponse200Data")


@_attrs_define
class GetWebhookEndpointHealthResponse200Data:
    """
    Attributes:
        status (GetWebhookEndpointHealthResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        status = GetWebhookEndpointHealthResponse200DataStatus(d.pop("status"))
        ...
        get_webhook_endpoint_health_response_200_data = cls(
            status=status,
            disabled_reason=disabled_reason,
            failing_since=failing_since,
            last_success_at=last_success_at,
        ...
        get_webhook_endpoint_health_response_200_data.additional_properties = d
        return get_webhook_endpoint_health_response_200_data
