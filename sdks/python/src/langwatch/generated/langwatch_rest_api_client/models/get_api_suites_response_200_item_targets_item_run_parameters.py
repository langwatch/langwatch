...
T = TypeVar("T", bound="GetApiSuitesResponse200ItemTargetsItemRunParameters")


@_attrs_define
class GetApiSuitesResponse200ItemTargetsItemRunParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        get_api_suites_response_200_item_targets_item_run_parameters = cls()
        ...
        get_api_suites_response_200_item_targets_item_run_parameters.additional_properties = additional_properties
        return get_api_suites_response_200_item_targets_item_run_parameters
