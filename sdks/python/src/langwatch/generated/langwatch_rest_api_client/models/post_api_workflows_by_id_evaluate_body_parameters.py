...
T = TypeVar("T", bound="PostApiWorkflowsByIdEvaluateBodyParameters")


@_attrs_define
class PostApiWorkflowsByIdEvaluateBodyParameters:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_workflows_by_id_evaluate_body_parameters = cls()
        ...
        post_api_workflows_by_id_evaluate_body_parameters.additional_properties = additional_properties
        return post_api_workflows_by_id_evaluate_body_parameters
