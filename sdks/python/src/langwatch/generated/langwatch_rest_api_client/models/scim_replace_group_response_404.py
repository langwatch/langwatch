...
T = TypeVar("T", bound="ScimReplaceGroupResponse404")


@_attrs_define
class ScimReplaceGroupResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_replace_group_response_404 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_replace_group_response_404.additional_properties = d
        return scim_replace_group_response_404
