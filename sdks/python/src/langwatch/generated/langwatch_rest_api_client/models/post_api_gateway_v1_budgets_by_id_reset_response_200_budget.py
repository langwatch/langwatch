...
from ..models.post_api_gateway_v1_budgets_by_id_reset_response_200_budget_on_breach import (
    PostApiGatewayV1BudgetsByIdResetResponse200BudgetOnBreach,
)
from ..models.post_api_gateway_v1_budgets_by_id_reset_response_200_budget_scope_reach import (
    PostApiGatewayV1BudgetsByIdResetResponse200BudgetScopeReach,
)
from ..models.post_api_gateway_v1_budgets_by_id_reset_response_200_budget_scope_type import (
    PostApiGatewayV1BudgetsByIdResetResponse200BudgetScopeType,
)
from ..models.post_api_gateway_v1_budgets_by_id_reset_response_200_budget_window import (
    PostApiGatewayV1BudgetsByIdResetResponse200BudgetWindow,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_gateway_v1_budgets_by_id_reset_response_200_budget_metadata import (
        PostApiGatewayV1BudgetsByIdResetResponse200BudgetMetadata,
    )


T = TypeVar("T", bound="PostApiGatewayV1BudgetsByIdResetResponse200Budget")


@_attrs_define
class PostApiGatewayV1BudgetsByIdResetResponse200Budget:
    """
    Attributes:
        id (str):
        organization_id (str):
        scope_type (PostApiGatewayV1BudgetsByIdResetResponse200BudgetScopeType):
        scope_id (str):
        name (str):
        description (None | str):
        window (PostApiGatewayV1BudgetsByIdResetResponse200BudgetWindow):
    ...
    scope_reach: PostApiGatewayV1BudgetsByIdResetResponse200BudgetScopeReach | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope_type = PostApiGatewayV1BudgetsByIdResetResponse200BudgetScopeType(d.pop("scope_type"))
        ...
        window = PostApiGatewayV1BudgetsByIdResetResponse200BudgetWindow(d.pop("window"))

        on_breach = PostApiGatewayV1BudgetsByIdResetResponse200BudgetOnBreach(d.pop("on_breach"))
        ...
        metadata = PostApiGatewayV1BudgetsByIdResetResponse200BudgetMetadata.from_dict(d.pop("metadata"))
        ...
        if isinstance(_scope_reach, Unset):
            ...
            scope_reach = PostApiGatewayV1BudgetsByIdResetResponse200BudgetScopeReach(_scope_reach)

        post_api_gateway_v1_budgets_by_id_reset_response_200_budget = cls(
            id=id,
            organization_id=organization_id,
            scope_type=scope_type,
            scope_id=scope_id,
        ...
        post_api_gateway_v1_budgets_by_id_reset_response_200_budget.additional_properties = d
        return post_api_gateway_v1_budgets_by_id_reset_response_200_budget
