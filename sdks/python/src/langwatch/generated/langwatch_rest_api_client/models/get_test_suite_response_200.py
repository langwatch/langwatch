...
T = TypeVar("T", bound="GetTestSuiteResponse200")


@_attrs_define
class GetTestSuiteResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for scenarios_item_data in _scenarios:
            scenarios_item = GetTestSuiteResponse200ScenariosItem.from_dict(scenarios_item_data)
        ...
        return get_test_suite_response_200
