...
from ..models.replace_agent_response_200_not_selectable_reason_type_0 import (
...
class ReplaceAgentResponse200:
    ...
    Attributes:
        ...
        not_selectable_reason (None | ReplaceAgentResponse200NotSelectableReasonType0): Why the agent cannot be run by
    ...
    selectable: bool
    not_selectable_reason: None | ReplaceAgentResponse200NotSelectableReasonType0
    created_at: datetime.datetime
    updated_at: datetime.datetime
    platform_url: str
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if isinstance(self.not_selectable_reason, ReplaceAgentResponse200NotSelectableReasonType0):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_not_selectable_reason(data: object) -> None | ReplaceAgentResponse200NotSelectableReasonType0:
            if data is None:
                return data
            try:
                if not isinstance(data, str):
                    raise TypeError()
                not_selectable_reason_type_0 = ReplaceAgentResponse200NotSelectableReasonType0(data)

                return not_selectable_reason_type_0
            except (TypeError, ValueError, AttributeError, KeyError):
                pass
            return cast(None | ReplaceAgentResponse200NotSelectableReasonType0, data)
