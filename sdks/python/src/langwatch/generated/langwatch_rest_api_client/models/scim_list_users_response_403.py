...
T = TypeVar("T", bound="ScimListUsersResponse403")


@_attrs_define
class ScimListUsersResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_list_users_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_list_users_response_403.additional_properties = d
        return scim_list_users_response_403
