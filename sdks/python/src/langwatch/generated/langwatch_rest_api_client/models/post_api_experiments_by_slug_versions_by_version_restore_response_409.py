...
T = TypeVar("T", bound="PostApiExperimentsBySlugVersionsByVersionRestoreResponse409")


@_attrs_define
class PostApiExperimentsBySlugVersionsByVersionRestoreResponse409:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_experiments_by_slug_versions_by_version_restore_response_409 = cls(
            error=error,
        ...
        post_api_experiments_by_slug_versions_by_version_restore_response_409.additional_properties = d
        return post_api_experiments_by_slug_versions_by_version_restore_response_409
