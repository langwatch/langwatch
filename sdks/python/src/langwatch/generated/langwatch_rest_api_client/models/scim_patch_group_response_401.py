...
T = TypeVar("T", bound="ScimPatchGroupResponse401")


@_attrs_define
class ScimPatchGroupResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_patch_group_response_401 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_patch_group_response_401.additional_properties = d
        return scim_patch_group_response_401
