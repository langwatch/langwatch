...
from ..models.get_api_gateway_v1_budgets_by_id_response_200_budget_window import (
    GetApiGatewayV1BudgetsByIdResponse200BudgetWindow,
)
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.get_api_gateway_v1_budgets_by_id_response_200_budget_metadata import (
        GetApiGatewayV1BudgetsByIdResponse200BudgetMetadata,
    )


T = TypeVar("T", bound="GetApiGatewayV1BudgetsByIdResponse200Budget")


@_attrs_define
class GetApiGatewayV1BudgetsByIdResponse200Budget:
    """
    Attributes:
        id (str):
        organization_id (str):
        scope_type (GetApiGatewayV1BudgetsByIdResponse200BudgetScopeType):
        scope_id (str):
        name (str):
        description (None | str):
        window (GetApiGatewayV1BudgetsByIdResponse200BudgetWindow):
        on_breach (GetApiGatewayV1BudgetsByIdResponse200BudgetOnBreach):
        ...
        metadata (GetApiGatewayV1BudgetsByIdResponse200BudgetMetadata):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scope_type = GetApiGatewayV1BudgetsByIdResponse200BudgetScopeType(d.pop("scope_type"))
        ...
        window = GetApiGatewayV1BudgetsByIdResponse200BudgetWindow(d.pop("window"))

        on_breach = GetApiGatewayV1BudgetsByIdResponse200BudgetOnBreach(d.pop("on_breach"))
        ...
        metadata = GetApiGatewayV1BudgetsByIdResponse200BudgetMetadata.from_dict(d.pop("metadata"))
        ...
        return get_api_gateway_v1_budgets_by_id_response_200_budget
