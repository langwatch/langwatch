...
from ..models.post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_data_status import (
    PostApiWebhooksV1EndpointsByIdRollSecretResponse200DataStatus,
)

T = TypeVar("T", bound="PostApiWebhooksV1EndpointsByIdRollSecretResponse200Data")


@_attrs_define
class PostApiWebhooksV1EndpointsByIdRollSecretResponse200Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (PostApiWebhooksV1EndpointsByIdRollSecretResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = PostApiWebhooksV1EndpointsByIdRollSecretResponse200DataStatus(d.pop("status"))
        ...
        post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_data.additional_properties = d
        return post_api_webhooks_v1_endpoints_by_id_roll_secret_response_200_data
