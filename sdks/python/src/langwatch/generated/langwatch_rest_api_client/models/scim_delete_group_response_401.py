...
T = TypeVar("T", bound="ScimDeleteGroupResponse401")


@_attrs_define
class ScimDeleteGroupResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_delete_group_response_401 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_delete_group_response_401.additional_properties = d
        return scim_delete_group_response_401
