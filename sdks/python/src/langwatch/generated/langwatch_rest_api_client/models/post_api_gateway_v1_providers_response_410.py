...
from ..models.post_api_gateway_v1_providers_response_410_fault import PostApiGatewayV1ProvidersResponse410Fault
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.post_api_gateway_v1_providers_response_410_meta import PostApiGatewayV1ProvidersResponse410Meta
...
class PostApiGatewayV1ProvidersResponse410:
    ...
    Attributes:
        ...
        message (str):
        retryable (bool):
        meta (PostApiGatewayV1ProvidersResponse410Meta | Unset):
        trace_id (str | Unset):
        span_id (str | Unset):
        tips (list[str] | Unset):
        docs_url (str | Unset):
        fault (PostApiGatewayV1ProvidersResponse410Fault | Unset):
    ...
    message: str
    retryable: bool
    meta: PostApiGatewayV1ProvidersResponse410Meta | Unset = UNSET
    trace_id: str | Unset = UNSET
    span_id: str | Unset = UNSET
    tips: list[str] | Unset = UNSET
    docs_url: str | Unset = UNSET
    fault: PostApiGatewayV1ProvidersResponse410Fault | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = PostApiGatewayV1ProvidersResponse410Meta.from_dict(_meta)
        ...
        if isinstance(_fault, Unset):
            ...
            fault = PostApiGatewayV1ProvidersResponse410Fault(_fault)
