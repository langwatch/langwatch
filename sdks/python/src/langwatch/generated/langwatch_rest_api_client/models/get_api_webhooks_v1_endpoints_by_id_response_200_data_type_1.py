...
from ..models.get_api_webhooks_v1_endpoints_by_id_response_200_data_type_1_status import (
    GetApiWebhooksV1EndpointsByIdResponse200DataType1Status,
)

if TYPE_CHECKING:
    from ..models.get_api_webhooks_v1_endpoints_by_id_response_200_data_type_1_sqs import (
        GetApiWebhooksV1EndpointsByIdResponse200DataType1Sqs,
    )


T = TypeVar("T", bound="GetApiWebhooksV1EndpointsByIdResponse200DataType1")


@_attrs_define
class GetApiWebhooksV1EndpointsByIdResponse200DataType1:
    """
    Attributes:
        destination_kind (Literal['sqs']):
        url (None):
        sqs (GetApiWebhooksV1EndpointsByIdResponse200DataType1Sqs):
        id (str):
        enabled_events (list[str]):
        status (GetApiWebhooksV1EndpointsByIdResponse200DataType1Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sqs = GetApiWebhooksV1EndpointsByIdResponse200DataType1Sqs.from_dict(d.pop("sqs"))

        id = d.pop("id")

        enabled_events = cast(list[str], d.pop("enabled_events"))

        status = GetApiWebhooksV1EndpointsByIdResponse200DataType1Status(d.pop("status"))
        ...
        get_api_webhooks_v1_endpoints_by_id_response_200_data_type_1 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        get_api_webhooks_v1_endpoints_by_id_response_200_data_type_1.additional_properties = d
        return get_api_webhooks_v1_endpoints_by_id_response_200_data_type_1
