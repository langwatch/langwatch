...
from ..models.get_api_gateway_v1_budgets_by_id_response_401_error_fault import (
...
class GetApiGatewayV1BudgetsByIdResponse401Error:
    ...
    Attributes:
        ...
        tips (list[str] | Unset):
        docs_url (str | Unset):
        fault (GetApiGatewayV1BudgetsByIdResponse401ErrorFault | Unset):
    ...
    fault: GetApiGatewayV1BudgetsByIdResponse401ErrorFault | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_fault, Unset):
            ...
            fault = GetApiGatewayV1BudgetsByIdResponse401ErrorFault(_fault)
