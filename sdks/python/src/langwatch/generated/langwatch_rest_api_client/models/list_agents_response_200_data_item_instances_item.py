...
T = TypeVar("T", bound="ListAgentsResponse200DataItemInstancesItem")


@_attrs_define
class ListAgentsResponse200DataItemInstancesItem:
    """
    Attributes:
        instance_id (str):
        hostname (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        list_agents_response_200_data_item_instances_item = cls(
