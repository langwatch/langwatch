...
T = TypeVar("T", bound="PostApiWebhooksV1EndpointsBodySqs")


@_attrs_define
class PostApiWebhooksV1EndpointsBodySqs:
    """
    Attributes:
        queue_url (str):
        role_arn (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_webhooks_v1_endpoints_body_sqs = cls(
            queue_url=queue_url,
            role_arn=role_arn,
        ...
        post_api_webhooks_v1_endpoints_body_sqs.additional_properties = d
        return post_api_webhooks_v1_endpoints_body_sqs
