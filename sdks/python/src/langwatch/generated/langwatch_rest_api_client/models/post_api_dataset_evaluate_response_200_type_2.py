...
T = TypeVar("T", bound="PostApiDatasetEvaluateResponse200Type2")


@_attrs_define
class PostApiDatasetEvaluateResponse200Type2:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_dataset_evaluate_response_200_type_2 = cls(
            status=status,
            error_type=error_type,
            details=details,
            passed=passed,
        ...
        post_api_dataset_evaluate_response_200_type_2.additional_properties = d
        return post_api_dataset_evaluate_response_200_type_2
