...
from ..models.update_webhook_endpoint_response_200_data_status import UpdateWebhookEndpointResponse200DataStatus

T = TypeVar("T", bound="UpdateWebhookEndpointResponse200Data")


@_attrs_define
class UpdateWebhookEndpointResponse200Data:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (UpdateWebhookEndpointResponse200DataStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = UpdateWebhookEndpointResponse200DataStatus(d.pop("status"))
        ...
        update_webhook_endpoint_response_200_data = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        update_webhook_endpoint_response_200_data.additional_properties = d
        return update_webhook_endpoint_response_200_data
