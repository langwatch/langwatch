...
class GetApiKeyResponse200BindingsItem:
    """
    Attributes:
        role (GetApiKeyResponse200BindingsItemRole | Unset):
        scope_type (GetApiKeyResponse200BindingsItemScopeType | Unset):
        scope_id (str | Unset):
    """

    role: GetApiKeyResponse200BindingsItemRole | Unset = UNSET
    scope_type: GetApiKeyResponse200BindingsItemScopeType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_role, Unset):
            ...
            role = GetApiKeyResponse200BindingsItemRole(_role)
        ...
        if isinstance(_scope_type, Unset):
            ...
            scope_type = GetApiKeyResponse200BindingsItemScopeType(_scope_type)
        ...
        get_api_key_response_200_bindings_item.additional_properties = d
