...
T = TypeVar("T", bound="PostApiGatewayV1VirtualKeysBodyConfigRateLimits")


@_attrs_define
class PostApiGatewayV1VirtualKeysBodyConfigRateLimits:
    """
    Attributes:
        rpm (int | None | Unset):
        tpm (int | None | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_api_gateway_v1_virtual_keys_body_config_rate_limits = cls(
            rpm=rpm,
            tpm=tpm,
            rpd=rpd,
        )

        post_api_gateway_v1_virtual_keys_body_config_rate_limits.additional_properties = d
        return post_api_gateway_v1_virtual_keys_body_config_rate_limits
