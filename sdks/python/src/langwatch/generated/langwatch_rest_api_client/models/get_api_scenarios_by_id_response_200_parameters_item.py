...
from ..models.get_api_scenarios_by_id_response_200_parameters_item_type import (
    GetApiScenariosByIdResponse200ParametersItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetApiScenariosByIdResponse200ParametersItem")


@_attrs_define
class GetApiScenariosByIdResponse200ParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (GetApiScenariosByIdResponse200ParametersItemType | Unset):
    ...
    type_: GetApiScenariosByIdResponse200ParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = GetApiScenariosByIdResponse200ParametersItemType(_type_)
        ...
        get_api_scenarios_by_id_response_200_parameters_item = cls(
            name=name,
        ...
        get_api_scenarios_by_id_response_200_parameters_item.additional_properties = d
        return get_api_scenarios_by_id_response_200_parameters_item
