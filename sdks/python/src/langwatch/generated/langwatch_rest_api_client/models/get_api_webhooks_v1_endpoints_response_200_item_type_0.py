...
from ..models.get_api_webhooks_v1_endpoints_response_200_item_type_0_status import (
    GetApiWebhooksV1EndpointsResponse200ItemType0Status,
)

T = TypeVar("T", bound="GetApiWebhooksV1EndpointsResponse200ItemType0")


@_attrs_define
class GetApiWebhooksV1EndpointsResponse200ItemType0:
    """
    Attributes:
        ...
        status (GetApiWebhooksV1EndpointsResponse200ItemType0Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = GetApiWebhooksV1EndpointsResponse200ItemType0Status(d.pop("status"))
        ...
        get_api_webhooks_v1_endpoints_response_200_item_type_0 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        get_api_webhooks_v1_endpoints_response_200_item_type_0.additional_properties = d
        return get_api_webhooks_v1_endpoints_response_200_item_type_0
