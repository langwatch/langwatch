...
class ScimReplaceGroupResponse200:
    ...
    Attributes:
        ...
        id (str):
        display_name (str):
        meta (ScimReplaceGroupResponse200Meta):
        external_id (str | Unset):
        members (list[ScimReplaceGroupResponse200MembersItem] | Unset):
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        meta = ScimReplaceGroupResponse200Meta.from_dict(d.pop("meta"))
