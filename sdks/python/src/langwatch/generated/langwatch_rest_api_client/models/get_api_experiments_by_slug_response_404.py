...
T = TypeVar("T", bound="GetApiExperimentsBySlugResponse404")


@_attrs_define
class GetApiExperimentsBySlugResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_experiments_by_slug_response_404 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        get_api_experiments_by_slug_response_404.additional_properties = d
        return get_api_experiments_by_slug_response_404
