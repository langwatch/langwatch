...
from ..models.post_api_scenarios_body_parameters_item_type import PostApiScenariosBodyParametersItemType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostApiScenariosBodyParametersItem")


@_attrs_define
class PostApiScenariosBodyParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (PostApiScenariosBodyParametersItemType | Unset):
    ...
    type_: PostApiScenariosBodyParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PostApiScenariosBodyParametersItemType(_type_)
        ...
        post_api_scenarios_body_parameters_item = cls(
            name=name,
        ...
        post_api_scenarios_body_parameters_item.additional_properties = d
        return post_api_scenarios_body_parameters_item
