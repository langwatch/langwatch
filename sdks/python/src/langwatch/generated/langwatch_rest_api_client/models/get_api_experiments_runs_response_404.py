...
T = TypeVar("T", bound="GetApiExperimentsRunsResponse404")


@_attrs_define
class GetApiExperimentsRunsResponse404:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_api_experiments_runs_response_404 = cls(
            error=error,
            message=message,
            fault=fault,
            tips=tips,
        ...
        get_api_experiments_runs_response_404.additional_properties = d
        return get_api_experiments_runs_response_404
