...
T = TypeVar("T", bound="ScimReplaceGroupResponse403")


@_attrs_define
class ScimReplaceGroupResponse403:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_replace_group_response_403 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_replace_group_response_403.additional_properties = d
        return scim_replace_group_response_403
