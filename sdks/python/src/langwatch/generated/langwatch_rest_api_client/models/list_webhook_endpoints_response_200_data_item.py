...
from ..models.list_webhook_endpoints_response_200_data_item_status import ListWebhookEndpointsResponse200DataItemStatus

T = TypeVar("T", bound="ListWebhookEndpointsResponse200DataItem")


@_attrs_define
class ListWebhookEndpointsResponse200DataItem:
    """
    Attributes:
        id (str):
        url (str):
        enabled_events (list[str]):
        status (ListWebhookEndpointsResponse200DataItemStatus):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        status = ListWebhookEndpointsResponse200DataItemStatus(d.pop("status"))
        ...
        list_webhook_endpoints_response_200_data_item = cls(
            id=id,
            url=url,
            enabled_events=enabled_events,
            status=status,
        ...
        list_webhook_endpoints_response_200_data_item.additional_properties = d
        return list_webhook_endpoints_response_200_data_item
