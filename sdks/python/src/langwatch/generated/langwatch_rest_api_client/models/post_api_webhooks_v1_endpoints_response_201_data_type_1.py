...
from ..models.post_api_webhooks_v1_endpoints_response_201_data_type_1_status import (
    PostApiWebhooksV1EndpointsResponse201DataType1Status,
)

if TYPE_CHECKING:
    from ..models.post_api_webhooks_v1_endpoints_response_201_data_type_1_sqs import (
        PostApiWebhooksV1EndpointsResponse201DataType1Sqs,
    )


T = TypeVar("T", bound="PostApiWebhooksV1EndpointsResponse201DataType1")


@_attrs_define
class PostApiWebhooksV1EndpointsResponse201DataType1:
    """
    Attributes:
        destination_kind (Literal['sqs']):
        url (None):
        sqs (PostApiWebhooksV1EndpointsResponse201DataType1Sqs):
        id (str):
        enabled_events (list[str]):
        status (PostApiWebhooksV1EndpointsResponse201DataType1Status):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        sqs = PostApiWebhooksV1EndpointsResponse201DataType1Sqs.from_dict(d.pop("sqs"))

        id = d.pop("id")

        enabled_events = cast(list[str], d.pop("enabled_events"))

        status = PostApiWebhooksV1EndpointsResponse201DataType1Status(d.pop("status"))
        ...
        post_api_webhooks_v1_endpoints_response_201_data_type_1 = cls(
            destination_kind=destination_kind,
            url=url,
            sqs=sqs,
            id=id,
        ...
        post_api_webhooks_v1_endpoints_response_201_data_type_1.additional_properties = d
        return post_api_webhooks_v1_endpoints_response_201_data_type_1
