...
if TYPE_CHECKING:
    from ..models.create_agent_body_type_2_config import CreateAgentBodyType2Config


T = TypeVar("T", bound="CreateAgentBodyType2")


@_attrs_define
class CreateAgentBodyType2:
    """
    Attributes:
        name (str):
        type_ (Literal['workflow']):
        config (CreateAgentBodyType2Config):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        create_agent_body_type_2.additional_properties = d
        return create_agent_body_type_2
