...
from ..models.list_agents_response_200_data_item_parameters_item_type import (
    ListAgentsResponse200DataItemParametersItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="ListAgentsResponse200DataItemParametersItem")


@_attrs_define
class ListAgentsResponse200DataItemParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (ListAgentsResponse200DataItemParametersItemType | Unset):
    ...
    type_: ListAgentsResponse200DataItemParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ListAgentsResponse200DataItemParametersItemType(_type_)
        ...
        list_agents_response_200_data_item_parameters_item = cls(
            name=name,
        ...
        list_agents_response_200_data_item_parameters_item.additional_properties = d
        return list_agents_response_200_data_item_parameters_item
