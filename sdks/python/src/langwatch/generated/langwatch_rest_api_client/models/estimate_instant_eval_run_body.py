...
from ..models.estimate_instant_eval_run_body_target import EstimateInstantEvalRunBodyTarget
from ..types import UNSET, Unset

if TYPE_CHECKING:
    from ..models.estimate_instant_eval_run_body_parameters import EstimateInstantEvalRunBodyParameters
    from ..models.estimate_instant_eval_run_body_questions_item import EstimateInstantEvalRunBodyQuestionsItem
...
class EstimateInstantEvalRunBody:
    ...
    Attributes:
        ...
        target (EstimateInstantEvalRunBodyTarget | Unset): What one judged row is, in place of a statement: a trace, a
        ...
        questions (list[EstimateInstantEvalRunBodyQuestionsItem] | Unset): With target: what to ask of each row. One
            classification asks them all per row, and the question text is part of what that classification is priced on;
            the estimate endpoint prices the exact set.
    ...
    target: EstimateInstantEvalRunBodyTarget | Unset = UNSET
    filter_: str | Unset = UNSET
    start: datetime.datetime | Unset = UNSET
    end: datetime.datetime | Unset = UNSET
    questions: list[EstimateInstantEvalRunBodyQuestionsItem] | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        target: EstimateInstantEvalRunBodyTarget | Unset
        if isinstance(_target, Unset):
            target = UNSET
        else:
            target = EstimateInstantEvalRunBodyTarget(_target)
        ...
        if _questions is not UNSET:
            ...
            for questions_item_data in _questions:
                questions_item = EstimateInstantEvalRunBodyQuestionsItem.from_dict(questions_item_data)
