...
T = TypeVar("T", bound="ScimListUsersResponse401")


@_attrs_define
class ScimListUsersResponse401:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        scim_list_users_response_401 = cls(
            schemas=schemas,
            status=status,
            detail=detail,
        )

        scim_list_users_response_401.additional_properties = d
        return scim_list_users_response_401
