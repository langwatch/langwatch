...
if TYPE_CHECKING:
    ...
    from ..models.get_run_plan_response_200_targets_item_scenario_mappings import (
...
class GetRunPlanResponse200TargetsItem:
    ...
    Attributes:
        ...
        reference_id (str):
        scenario_mappings (GetRunPlanResponse200TargetsItemScenarioMappings | Unset):
    ...
    type_: GetRunPlanResponse200TargetsItemType
    reference_id: str
    scenario_mappings: GetRunPlanResponse200TargetsItemScenarioMappings | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_scenario_mappings, Unset):
            ...
            scenario_mappings = GetRunPlanResponse200TargetsItemScenarioMappings.from_dict(_scenario_mappings)
