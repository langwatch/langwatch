...
T = TypeVar("T", bound="PostApiV1QueryBodyParameters")


@_attrs_define
class PostApiV1QueryBodyParameters:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        post_api_v1_query_body_parameters = cls()
        ...
        post_api_v1_query_body_parameters.additional_properties = additional_properties
        return post_api_v1_query_body_parameters
