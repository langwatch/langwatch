...
T = TypeVar("T", bound="GetApiScenariosResponse200ItemFields")


@_attrs_define
class GetApiScenariosResponse200ItemFields:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        get_api_scenarios_response_200_item_fields = cls()
        ...
        get_api_scenarios_response_200_item_fields.additional_properties = additional_properties
        return get_api_scenarios_response_200_item_fields
