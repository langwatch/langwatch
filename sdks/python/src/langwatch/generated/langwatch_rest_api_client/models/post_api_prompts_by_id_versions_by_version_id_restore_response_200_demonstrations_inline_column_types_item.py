...
T = TypeVar("T", bound="PostApiPromptsByIdVersionsByVersionIdRestoreResponse200DemonstrationsInlineColumnTypesItem")


@_attrs_define
class PostApiPromptsByIdVersionsByVersionIdRestoreResponse200DemonstrationsInlineColumnTypesItem:
    """
    Attributes:
        name (str):
