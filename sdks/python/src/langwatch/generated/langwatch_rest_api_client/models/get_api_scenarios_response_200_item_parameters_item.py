...
from ..models.get_api_scenarios_response_200_item_parameters_item_type import (
    GetApiScenariosResponse200ItemParametersItemType,
)
from ..types import UNSET, Unset

T = TypeVar("T", bound="GetApiScenariosResponse200ItemParametersItem")


@_attrs_define
class GetApiScenariosResponse200ItemParametersItem:
    """
    Attributes:
        name (str):
        ...
        secret (bool | Unset):
        type_ (GetApiScenariosResponse200ItemParametersItemType | Unset):
    ...
    type_: GetApiScenariosResponse200ItemParametersItemType | Unset = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = GetApiScenariosResponse200ItemParametersItemType(_type_)
        ...
        get_api_scenarios_response_200_item_parameters_item = cls(
            name=name,
        ...
        get_api_scenarios_response_200_item_parameters_item.additional_properties = d
        return get_api_scenarios_response_200_item_parameters_item
