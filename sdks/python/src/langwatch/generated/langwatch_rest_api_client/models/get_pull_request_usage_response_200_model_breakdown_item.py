...
T = TypeVar("T", bound="GetPullRequestUsageResponse200ModelBreakdownItem")


@_attrs_define
class GetPullRequestUsageResponse200ModelBreakdownItem:
    """
    Attributes:
        model (str):
        input_tokens (float):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_pull_request_usage_response_200_model_breakdown_item = cls(
            model=model,
        ...
        get_pull_request_usage_response_200_model_breakdown_item.additional_properties = d
        return get_pull_request_usage_response_200_model_breakdown_item
