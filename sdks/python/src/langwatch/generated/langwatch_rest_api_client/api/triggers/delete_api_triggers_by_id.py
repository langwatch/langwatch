...
) -> DeleteApiTriggersByIdResponse200 | DeleteApiTriggersByIdResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteApiTriggersByIdResponse200 | DeleteApiTriggersByIdResponse404]:
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteApiTriggersByIdResponse200 | DeleteApiTriggersByIdResponse404
    """
