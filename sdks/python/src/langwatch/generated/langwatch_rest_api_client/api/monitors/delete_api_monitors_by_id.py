...
) -> DeleteApiMonitorsByIdResponse200 | DeleteApiMonitorsByIdResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteApiMonitorsByIdResponse200 | DeleteApiMonitorsByIdResponse404]:
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteApiMonitorsByIdResponse200 | DeleteApiMonitorsByIdResponse404
    """
