...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/monitors/{id}/toggle".format(
...
) -> PostApiMonitorsByIdToggleResponse200 | PostApiMonitorsByIdToggleResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PostApiMonitorsByIdToggleResponse200 | PostApiMonitorsByIdToggleResponse404]:
...
def sync(
    ...
    *,
    ...
    Returns:
        PostApiMonitorsByIdToggleResponse200 | PostApiMonitorsByIdToggleResponse404
    """
