...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 409:
        response_409 = PostApiGatewayV1CacheRulesResponse409.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    /changes long-poll. Send `Idempotency-Key` to make a retry safe.
    ...
    Returns:
        Response[PostApiGatewayV1CacheRulesResponse201 | PostApiGatewayV1CacheRulesResponse400 | PostApiGatewayV1CacheRulesResponse401 | PostApiGatewayV1CacheRulesResponse403 | PostApiGatewayV1CacheRulesResponse409 | PostApiGatewayV1CacheRulesResponse500]
    """
...
def sync(
    *,
    ...
    Returns:
        PostApiGatewayV1CacheRulesResponse201 | PostApiGatewayV1CacheRulesResponse400 | PostApiGatewayV1CacheRulesResponse401 | PostApiGatewayV1CacheRulesResponse403 | PostApiGatewayV1CacheRulesResponse409 | PostApiGatewayV1CacheRulesResponse500
    """
