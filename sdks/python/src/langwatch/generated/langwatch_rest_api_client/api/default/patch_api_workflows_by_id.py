...
) -> PatchApiWorkflowsByIdResponse200 | PatchApiWorkflowsByIdResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[PatchApiWorkflowsByIdResponse200 | PatchApiWorkflowsByIdResponse404]:
...
def sync(
    ...
    *,
    ...
    Returns:
        PatchApiWorkflowsByIdResponse200 | PatchApiWorkflowsByIdResponse404
    """
