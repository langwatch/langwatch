...
) -> DeleteApiEvaluatorsByIdResponse200 | DeleteApiEvaluatorsByIdResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteApiEvaluatorsByIdResponse200 | DeleteApiEvaluatorsByIdResponse404]:
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteApiEvaluatorsByIdResponse200 | DeleteApiEvaluatorsByIdResponse404
    """
