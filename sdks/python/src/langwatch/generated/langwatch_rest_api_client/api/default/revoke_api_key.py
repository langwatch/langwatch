...
) -> Any | RevokeApiKeyResponse200 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Any | RevokeApiKeyResponse200]:
...
def sync_detailed(
    ...
    *,
    ...
    """Revoke an API key
     ...
     Revoke (soft-delete) an API key. Revoked keys can no longer authenticate. Requires
