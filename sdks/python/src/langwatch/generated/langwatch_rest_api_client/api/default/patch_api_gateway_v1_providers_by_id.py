...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[Any | PatchApiGatewayV1ProvidersByIdResponse400 | PatchApiGatewayV1ProvidersByIdResponse401 | PatchApiGatewayV1ProvidersByIdResponse403 | PatchApiGatewayV1ProvidersByIdResponse410 | PatchApiGatewayV1ProvidersByIdResponse500]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        Any | PatchApiGatewayV1ProvidersByIdResponse400 | PatchApiGatewayV1ProvidersByIdResponse401 | PatchApiGatewayV1ProvidersByIdResponse403 | PatchApiGatewayV1ProvidersByIdResponse410 | PatchApiGatewayV1ProvidersByIdResponse500
    """
