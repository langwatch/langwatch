...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[GetApiGatewayV1VirtualKeysByIdResponse200 | GetApiGatewayV1VirtualKeysByIdResponse400 | GetApiGatewayV1VirtualKeysByIdResponse401 | GetApiGatewayV1VirtualKeysByIdResponse403 | GetApiGatewayV1VirtualKeysByIdResponse500]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        GetApiGatewayV1VirtualKeysByIdResponse200 | GetApiGatewayV1VirtualKeysByIdResponse400 | GetApiGatewayV1VirtualKeysByIdResponse401 | GetApiGatewayV1VirtualKeysByIdResponse403 | GetApiGatewayV1VirtualKeysByIdResponse500
    """
