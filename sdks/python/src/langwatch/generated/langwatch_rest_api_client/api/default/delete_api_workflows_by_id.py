...
) -> DeleteApiWorkflowsByIdResponse200 | DeleteApiWorkflowsByIdResponse404 | None:
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[DeleteApiWorkflowsByIdResponse200 | DeleteApiWorkflowsByIdResponse404]:
...
def sync(
    ...
    *,
    ...
    Returns:
        DeleteApiWorkflowsByIdResponse200 | DeleteApiWorkflowsByIdResponse404
    """
