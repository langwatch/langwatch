...
from ...models.get_pull_request_usage_response_400 import GetPullRequestUsageResponse400
from ...models.get_pull_request_usage_response_401 import GetPullRequestUsageResponse401
from ...models.get_pull_request_usage_response_422 import GetPullRequestUsageResponse422
from ...models.get_pull_request_usage_response_500 import GetPullRequestUsageResponse500
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = GetPullRequestUsageResponse400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = GetPullRequestUsageResponse401.from_dict(response.json())

        return response_401

    if response.status_code == 422:
        response_422 = GetPullRequestUsageResponse422.from_dict(response.json())

        return response_422

    if response.status_code == 500:
        response_500 = GetPullRequestUsageResponse500.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    Returns:
        Response[GetPullRequestUsageResponse200 | GetPullRequestUsageResponse400 | GetPullRequestUsageResponse401 | GetPullRequestUsageResponse422 | GetPullRequestUsageResponse500]
    """
...
def sync(
    *,
    ...
    Returns:
        GetPullRequestUsageResponse200 | GetPullRequestUsageResponse400 | GetPullRequestUsageResponse401 | GetPullRequestUsageResponse422 | GetPullRequestUsageResponse500
    """
