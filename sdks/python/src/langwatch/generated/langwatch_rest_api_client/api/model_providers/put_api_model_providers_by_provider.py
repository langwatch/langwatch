...
from ...models.put_api_model_providers_by_provider_response_409 import PutApiModelProvidersByProviderResponse409
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 409:
        response_409 = PutApiModelProvidersByProviderResponse409.from_dict(response.json())
...
def sync_detailed(
    ...
    *,
    ...
    Returns:
        Response[PutApiModelProvidersByProviderResponse200 | PutApiModelProvidersByProviderResponse400 | PutApiModelProvidersByProviderResponse401 | PutApiModelProvidersByProviderResponse409 | PutApiModelProvidersByProviderResponse422 | PutApiModelProvidersByProviderResponse500]
    """
...
def sync(
    ...
    *,
    ...
    Returns:
        PutApiModelProvidersByProviderResponse200 | PutApiModelProvidersByProviderResponse400 | PutApiModelProvidersByProviderResponse401 | PutApiModelProvidersByProviderResponse409 | PutApiModelProvidersByProviderResponse422 | PutApiModelProvidersByProviderResponse500
    """
