...
from ...models.post_api_analytics_body import PostApiAnalyticsBody
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 400:
        response_400 = PostApiAnalyticsResponse400.from_dict(response.json())

        return response_400

    if response.status_code == 401:
        response_401 = PostApiAnalyticsResponse401.from_dict(response.json())
...
def sync_detailed(
    *,
    ...
    /api/analytics/timeseries`, which is the path to use in new integrations; this one stays for callers
    written against it.
