...
<Tip>
  The conversation tab uses your current prompt configuration, including model settings
  and variables. Changes to your prompt are reflected in real-time.
</Tip>
...
<Tip>Use this feature to debug and improve prompts based on actual production usage.</Tip>
...
<Note>
  Restoring a version loads it into the editor but doesn't create a new version until you
  save.
</Note>
