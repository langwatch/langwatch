...
LangWatch's prompt management integrates with GitHub through the [Prompts CLI](/prompt-management/cli), so you can version control your prompts alongside your code and automatically sync changes with the LangWatch platform.

## How It Works

The CLI creates standard YAML files that you commit like any other file:
...
Create local prompts that are versioned with your code:
