...
<Tip>
Combine these settings with [Workflows](/workflows/overview),
where you can evaluate different configurations on the same dataset and compare the results.
</Tip>
...
<Card title="Use prompts in workflows" icon="diagram-project" href="/prompt-management/features/advanced/workflows">
