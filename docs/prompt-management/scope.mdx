...
Scope determines where your prompts are accessible and how they can be shared across your LangWatch projects and organization.
...
curl -X POST "https://app.langwatch.ai/api/v1/prompts" \
