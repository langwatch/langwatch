...
<Frame>
<img src="/images/annotations/annotation-scores-settings.png" alt="The Annotation Scoring settings page with Add new score metric and the table of two score metrics: Issues as Checkbox with three options and Accuracy as Multiple choice with three options, both Enabled" />
</Frame>
...
<Frame>
<img src="/images/annotations/annotation-score-drawer.png" alt="The Add Score Metric drawer with a Name, a Description, Score Type set to Multiple choice, three options, Add Option and the Add Score Metric button" />
</Frame>
