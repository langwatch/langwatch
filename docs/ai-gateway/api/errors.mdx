...
```json
{
  "error": {
    ...
    "message": "The project spending limit (per month) for this request has been reached. Contact your LangWatch admin to raise it.",
    "meta": {
    ...
    "tips": ["Contact your LangWatch admin to raise the project spending limit", "Switch to a cheaper model or reduce request volume to stay within the limit"],
