...
The keys list shows a **Spent this month** column for every key, read from the same cost data the Usage tab reports, and clicking it opens Usage pre-filtered to that key over the past 30 days, so the number you click and the page you land on agree.
