...
<CardGroup cols={2}>
  <Card
    title="Quickstart, first request in 5 min"
    icon="rocket"
  ...
  <Card
    title="Use your VK from Python, TypeScript"
    icon="code"
    href="/ai-gateway/sdks/python"
  >
  ...
  <Card
    title="Manage VKs from the terminal"
    icon="keyboard"
    href="/integration/cli#virtual-keys"
  >
