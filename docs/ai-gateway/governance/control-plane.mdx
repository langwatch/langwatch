...
| `/settings/governance/anomaly-rules` — placeholder until the detection backend ships | placeholder (real backend stub persists rules; eval engine is the next slice) | [open](https://i.img402.dev/rcgdx6lio6.png) |
