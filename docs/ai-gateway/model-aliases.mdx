...
<Info>
  Aliases are one of three ways to reference a model. See [Model Naming](/ai-gateway/model-naming)
  for when to use bare (`gpt-5-mini`) vs prefixed (`openai/gpt-5-mini`) vs an alias.
</Info>
