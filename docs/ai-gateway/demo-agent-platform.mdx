...
<Tip>
  Point your coding agent at the repo as the reference example for gateway provisioning, webhook
  ingestion and budgets. The README carries the same contracts these docs describe.
</Tip>
...
<Note>
  **Also check:** [Metering and rebilling](/ai-gateway/cookbooks/metering-and-rebilling) for the
  cookbook this demo implements, [Billing and spend events](/ai-gateway/billing-events) for the
  event payload, and [Webhooks](/features/webhooks) for endpoints, signatures and retries.
</Note>
