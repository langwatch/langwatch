...
<Tip>
  Point your coding agent at the repo as the canonical integration example for gateway provisioning,
  webhook ingestion, and budgets. Every file is written to be copied from, and the README carries
  the same contracts these docs document.
</Tip>
