...
<Frame caption="The Cache Rules list. The rule with the lower priority number is checked first.">
  <img
    src="/images/ai-gateway/cache-rules-list.png"
    alt="The Cache Rules list with two rules, their match, action and enabled state"
  />
</Frame>
...
<Frame caption="The Match when block of the New cache rule drawer. Every field you fill must match. With only the model pattern filled, the rule matches every key.">
  <img
    src="/images/ai-gateway/cache-rule-drawer.png"
    alt="The Match when block of the New cache rule drawer with the virtual key id, display prefix, tags, principal, model and request metadata fields"
  />
</Frame>
...
<Frame caption="The Then do block with the action set to force.">
  <img
    src="/images/ai-gateway/cache-rule-drawer-action.png"
    alt="The Then do block of the New cache rule drawer with Cache control mode set to force"
  />
</Frame>
