...
- **Virtual keys** — LangWatch-issued credentials (`lw_vk_live_<ulid>`) with project/team/org scope. Show-once secrets, argon2id-hashed, rotatable, revokable within 60 seconds.
