...
<Info>
  **~11 µs of gateway-side overhead at 5k RPS sustained.** Written in Go with chi +
  in-process JWT verification. The hot path sits in front of every LLM call, it has to be
  close to free.
</Info>
