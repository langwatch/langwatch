...
<Steps>
  ...
  <Step title="Failover between providers">
    Name a model that more than one bound provider serves. The gateway carries the same model name
    to the next provider in the chain. See [Fallback Chains](/ai-gateway/providers/fallback-chains).
  </Step>
</Steps>
