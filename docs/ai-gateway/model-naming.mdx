...
See [Model Aliases](/ai-gateway/model-aliases) for the full story, including how an alias is judged against `models_allowed` and the `GET /v1/models` discovery endpoint.
