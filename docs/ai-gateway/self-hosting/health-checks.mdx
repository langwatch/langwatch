...
Cheap by design. Never does network I/O. If this returns non-200 the kubelet kills the pod. Chart default ([`infra/charts/gateway/templates/deployment.yaml`](https://github.com/langwatch/langwatch/blob/main/infra/charts/gateway/templates/deployment.yaml)):
