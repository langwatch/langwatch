...
from_ms, to_ms = 1782950400000, 1785628800000
...
The full vocabulary and the one grouping that is refused rather than served approximately are in [Narrowing and grouping](/ai-gateway/cookbooks/metering-and-rebilling#narrowing-and-grouping).
