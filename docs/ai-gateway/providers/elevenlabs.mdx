...
<Frame caption="The ElevenLabs row: ELEVENLABS_API_KEY, the optional webhook secret and base URL, and the routing handle elevenlabs.">
  <img src="/images/ai-gateway/model-provider-elevenlabs-form.png" alt="The ElevenLabs model provider drawer with ELEVENLABS_API_KEY, ELEVENLABS_WEBHOOK_SECRET, ELEVENLABS_BASE_URL and the routing handle elevenlabs" />
</Frame>
