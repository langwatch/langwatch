...
- **Region availability.** Anthropic-on-Vertex is not in every GCP region; `us-central1`, `us-east5`, `europe-west1`, and `asia-southeast1` serve it. A 404 with "publisher not found" means wrong region.
