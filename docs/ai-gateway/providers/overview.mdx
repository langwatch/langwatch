...
The gateway delegates provider-specific dispatch to [`bifrost/core`](https://github.com/maximhq/bifrost), which LangWatch embeds as a Go library.
...
Pick one or two fallback providers. Guidelines:
...
- **Azure-first** with OpenAI direct fallback. Keeps traffic inside Azure data-residency except when a regional Azure outage moves it to OpenAI direct.
