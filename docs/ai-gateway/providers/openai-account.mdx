...
<Frame caption="The Codex (OpenAI account) row: no key field, a Sign in with OpenAI button and the routing handle openai_codex.">
  <img src="/images/ai-gateway/model-provider-openai-account-form.png" alt="The Codex OpenAI account model provider drawer with the Sign in with OpenAI button and the routing handle openai_codex" />
</Frame>
