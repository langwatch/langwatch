...
## `cache_control` passthrough, the 90-percent discount
...
See [Claude Code](/ai-gateway/cli/claude-code): set `ANTHROPIC_BASE_URL=https://gateway.langwatch.ai` and `ANTHROPIC_AUTH_TOKEN=vk-lw-…` and it works.
