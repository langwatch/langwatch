...
- **Model access enablement**: Bedrock requires manual model-access opt-in per account + region (console: _Bedrock → Model access_). A 403 with body "you don't have access to the model" means the AWS account needs to enable that model.
