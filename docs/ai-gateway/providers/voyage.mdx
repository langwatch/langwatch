...
<Frame caption="The Voyage AI row: name, scope, VOYAGE_API_KEY and the routing handle voyage.">
  <img src="/images/ai-gateway/model-provider-voyage-form.png" alt="The Voyage AI model provider drawer with the VOYAGE_API_KEY field and the routing handle voyage" />
</Frame>
