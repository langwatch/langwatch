...
Audit logs are visible to organization admins under **/settings/audit-log** (filter by resource type to narrow to gateway mutations). Retention: 7 years default, extendable on request.
