...
<Note>
  **Terminology crosswalk.** Portkey and LangWatch use overlapping names for different concepts
  (e.g. "virtual key" means different things). The table below is the single source of truth, refer
  back to it whenever a section feels ambiguous.
</Note>
