...
- At least one healthy ModelProvider configured under **Settings → Model Providers** at ORG, TEAM, or PROJECT scope. Set the rate-limit / fallback fields in its Advanced (Gateway) section if you want CI to exercise them.
