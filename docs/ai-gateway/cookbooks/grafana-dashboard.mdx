...
```json
{
  ...
  "panels": [
    ...
    },
    {
      ...
      "description": "The gateway does not debit budgets: cost rides the OTel span and the control plane's trace-fold reactor writes the ledger. This counter is the only gateway-side signal that a hard cap actually rejected traffic.",
      "datasource": "$datasource",
