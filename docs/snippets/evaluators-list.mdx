...
| Evaluator | Description |
| --------- | ----------- |
| [Ragas Faithfulness](/api-reference/evaluators/ragas-faithfulness-1) | This evaluator assesses the extent to which the generated answer is consistent with the provided context. Higher scores indicate better faithfulness to the context, useful for detecting hallucinations. |
