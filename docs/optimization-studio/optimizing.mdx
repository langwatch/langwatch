---
title: Optimizing
description: Optimize prompts using DSPy in LangWatch to find the best-performing variants for AI agent evaluation workflows.
---
...
The Optimization Studio runs DSPy optimizers to improve your LLM workflow performance. Starting from a basic setup with baseline performance, you improve the results through automated optimization techniques.
...
- Teacher LLM selection (can use a more capable LLM to teach a cheaper one)
