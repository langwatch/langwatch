---
title: Evaluating
description: Measure workflow quality using LangWatch’s evaluation tools to ensure reliable LLM pipeline and agent test performance.
---
...
The ability to properly evaluate LLM outputs sets the foundation for automated optimization, which is covered in the next tutorial.