...
[Flowise](https://flowiseai.com/) is a low-code tool for building LLM pipelines. If you are using Flowise, you can enable LangWatch from their UI for analytics and evaluations.
...
Send a message to your agent or chatflow, then open LangWatch to see the trace.
</Step>
</Steps>
