...
description: Instrument Grok (xAI) API calls in Go using LangWatch to capture traces and improve AI agent evaluations.
...
<Info>Set `LANGWATCH_API_KEY` and `XAI_API_KEY` environment variables before running.</Info>
