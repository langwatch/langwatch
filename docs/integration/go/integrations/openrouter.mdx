...
[OpenRouter](https://openrouter.ai) provides a unified API to access LLMs from many providers. LangWatch traces calls made through OpenRouter using its OpenAI-compatible endpoint.
...
<Note>
  Using OpenRouter is a great way to experiment with different models without changing your core
  instrumentation logic. All calls will be traced by LangWatch, regardless of the underlying model
  you choose.
</Note>
