...
<Step title="Instrument Your OpenAI Client">
  Add the LangWatch middleware to your OpenAI client. The middleware captures request **and** response content by default — there is nothing else to enable:
...
- Remember the OpenAI client is now `github.com/openai/openai-go/v3` (and `/v3/option`)
