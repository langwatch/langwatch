...
title: Capturing RAG
sidebarTitle: Python
description: LangWatch captures Retrieval-Augmented Generation (RAG) data for evaluations and agent testing.
icon: python
...
Capturing the `contexts` (retrieved documents) used by the LLM enables the following in LangWatch:
