...
<Info>
This page covers the LiteLLM Python SDK inside your own code. To trace everything that goes through a LiteLLM Proxy (gateway) instead, see [LiteLLM Proxy](/integration/litellm-proxy).
</Info>
