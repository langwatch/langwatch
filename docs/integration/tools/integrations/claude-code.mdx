...
Claude Code supports OpenTelemetry (OTel) traces for monitoring and observability. Send that trace data to LangWatch to see usage patterns and performance.
