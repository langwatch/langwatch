...
```
```bash JavaScript
npm install langwatch ai @ai-sdk/otel @ai-sdk/openai @vercel/otel @opentelemetry/api-logs @opentelemetry/instrumentation @opentelemetry/sdk-logs
```
    </CodeGroup>
  </Step>
...
export function register() {
  ...
  // AI SDK 7 emits no spans until an integration is registered
  registerTelemetry(new OpenTelemetry());
}

// ./src/index.ts - every call now reports automatically
