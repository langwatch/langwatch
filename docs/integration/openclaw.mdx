...
<Note>
  **⚠️ Experimental**: OpenClaw's `diagnostics-otel` plugin is under active development. The
  instrumentation spec is stabilizing but may change. Follow the discussion at [PR
  #11100](https://github.com/openclaw/openclaw/pull/11100) for the latest.
</Note>
