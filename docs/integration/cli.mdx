...
│                                                                           │
│   Enter to confirm · ↑↓ to choose · Esc to deny · or answer on the card   │
│   in LangWatch                                                            │
╰───────────────────────────────────────────────────────────────────────────╯
```

Enter confirms the option that is highlighted, the arrow keys and the digits move the highlight, and Escape denies with no reason. Choosing the third option reads one line of text and sends it to Langy as the reason, so you can say what to do instead.
