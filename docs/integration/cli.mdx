...
- **Permissions**: everything you can do day to day (traces, datasets, prompts, evaluations, the AI Gateway, model providers). Management access stays off by default: the key cannot manage teams, manage the organization's settings, members and roles, or delete the organization.
