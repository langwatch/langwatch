...
<Note>
  If you stream through the Vercel AI SDK with `experimental_telemetry` enabled, TTFT is
  captured automatically from `ai.response.msToFirstChunk`, nothing to do.
</Note>
