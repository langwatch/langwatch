...
<Info>Introduced in `langwatch@0.8.0`.</Info>
...
<Tip>
  Use simple matchers (`equals`, `startsWith`) where possible; regex matches more patterns
  but is slower and harder to read.
</Tip>
