...
npm install @ai-sdk/openai @ai-sdk/otel ai
```

<Note>
The `@ai-sdk/openai`, `@ai-sdk/otel`, and `ai` packages are only required for the example in this guide. You can skip this step if you're only looking to install the LangWatch SDK.
</Note>
