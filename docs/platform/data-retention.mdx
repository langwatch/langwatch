...
<Note>
  When you retain data longer than your plan's included window, the additional storage is billed per GB — you only pay for what you actually store. See the [pricing page](/pricing#extending-retention) for the current rate.
</Note>
