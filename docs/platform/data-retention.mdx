...
<Note>
  Paid plans configure data retention. On the Free plan every project uses the platform default window of 49 days. See the [pricing page](/pricing) for the window each plan can set and how extended retention is billed.
</Note>
...
Paid plans set 35 or 63 days. Enterprise plans set any whole number of weeks from 49 days up, to several years. Periods always round to whole weeks, because deletion is partition-aligned (see [How deletion works](#how-deletion-works)).
...
<Steps>
  ...
  <Step title="Pick a retention period">
    Choose one of the preset windows. Enterprise plans also enter a custom value in weeks, months, or years.
  </Step>
  <Step title="Create">
...
Without a license, a self-hosted deployment keeps the platform default of 49 days and cannot add a policy. An Enterprise license opens the same windows as the Enterprise plan. See [Editions and licensing](/self-hosting/licensing).
