...
People the sync provisioned who have never signed in count as members too, so
they need to sign in through the new connection once before you can finish.
They can do that while the update is in progress: the sync's word that they
belong is enough for the new connection to recognize them.
