...
<Frame>
<img src="/images/platform/command-bar.png" alt="The command bar with prompt typed, showing the Navigation and Actions matches" />
</Frame>
...
<Frame>
<img src="/images/platform/command-bar-jump-id.png" alt="The command bar with a trace id pasted and the Open trace entry under Jump to ID" />
</Frame>
