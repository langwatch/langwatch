...
See [AI Gateway → Providers](/ai-gateway/providers/overview#where-credentials-live) for the gateway-side story.
...
- [AI Gateway → Providers](/ai-gateway/providers/overview): how the gateway resolves a virtual key's provider across scopes.
