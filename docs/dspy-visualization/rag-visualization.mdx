...
<Frame caption="DSPy Experiment Dashboard">
  <img
    className="block"
    src="/images/screenshot-rag-dspy-tutorial.png"
    alt="DSPy Experiment Dashboard"
  />
</Frame>
...
<Frame caption="DSPy LLM calls">
  <img
    className="block"
    src="/images/screenshot-dspy-llm-calls.png"
    alt="DSPy LLM calls"
  />
</Frame>
...
<Card
  ...
  icon="github"
  href="https://github.com/langwatch/langevals/blob/main/notebooks/tutorials/dspy_rag.ipynb"
>
