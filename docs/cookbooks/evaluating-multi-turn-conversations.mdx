...
description: A simulation-based approach for evaluating multi-turn customer support agents, with success criteria on outcomes rather than specific steps.
keywords:
  [
