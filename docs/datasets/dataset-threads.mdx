...
<Step title="Select multiple traces">
You can select multiple traces to add to the dataset. When you use the thread mapping option, all traces are grouped by the thread ID.
</Step>
</Steps>