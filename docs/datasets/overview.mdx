...
To create a dataset, go to the datasets page and click the "Upload or Create Dataset" button. You can then select the type of dataset you want as well as the columns you want to include.

<Frame caption="Create dataset">
  <img className="block" src="/images/dataset-screenshot-new.png" alt="LangWatch" />
</Frame>
## Adding data
...
To add data manually, click the "Add to Dataset" button on the messages page after selecting a message. You can then choose the dataset type and preview the data before adding it.

<Frame caption="Add to dataset manually">
  <img className="block" src="/images/dataset-screenshot-single.png" alt="LangWatch" />
</Frame>

### From traces

To add data by selecting a group, click the "Add to Dataset" button after choosing the desired messages in the table view. You can then select the type of dataset you wish to add to and preview the data before including it.

<Frame caption="Add to dataset from traces">
  <img className="block" src="/images/dataset-screenshot-group.png" alt="LangWatch" />
</Frame>
...
<Frame caption="Add dataset from CSV">
  <img className="block" src="/images/dataset-screenshot-csv.png" alt="LangWatch" />
</Frame>
