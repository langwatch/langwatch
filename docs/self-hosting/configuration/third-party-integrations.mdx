...
<Note>
  You don't need to configure evaluator providers to use LangWatch. They're only required
  if you want to use built-in evaluators that rely on specific LLM providers. You can
  always configure your own LLM provider API keys in the LangWatch UI for evaluations.
</Note>
