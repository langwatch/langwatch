...
| Variable | Description | Default |
|----------|-------------|---------|
| `STORED_OBJECTS_BACKEND` | Explicit write-destination toggle. `s3` (implicit default) or `azure` | — |
...
| `AZURE_BLOB_ENDPOINT` | Custom endpoint — only for the Azurite emulator or sovereign-cloud deployments | — |
