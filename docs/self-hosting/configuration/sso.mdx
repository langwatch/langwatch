...
Anything that publishes an OpenID Connect discovery document works without being named above: Keycloak, Authentik, Zitadel, Ping, JumpCloud, a self-hosted IdP, whatever you run.
