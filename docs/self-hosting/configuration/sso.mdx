...
Before upgrading an installation where everyone uses SSO, activate the license
or verify email recovery works. See [Editions and licensing](/self-hosting/licensing).
</Warning>
...
|----------|--------------------------|----------|
| Email/Password | `email` (default) | No additional configuration |
