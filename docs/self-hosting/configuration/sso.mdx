...
Identity and access migrations run automatically before the upgraded runtime
starts serving. Keep the current provider configuration and credentials during
the upgrade. See the [upgrade guide](/self-hosting/upgrade#automatic-identity-and-access-migration)
