...
docker pull platform/app/langwatch_nlp:3.0.0
...
docker tag platform/app/langwatch_nlp:3.0.0 registry.example.com/platform/app/langwatch_nlp:3.0.0
...
docker push registry.example.com/platform/app/langwatch_nlp:3.0.0
...
images:
  app:
    ...
    tag: "3.0.0"
  langwatch_nlp:
    repository: registry.example.com/platform/app/langwatch_nlp
    tag: "3.0.0"
  langevals:
