...
> **Developing LangWatch itself?** `make quickstart` in the repo root starts only the services you pick and is faster for day-to-day development. This Kind workflow is for testing the Helm chart packaging and Kubernetes-specific behavior.
...
> **Note:** The first image build (especially the app image) is memory-intensive and can take 15-30 minutes. Subsequent builds reuse Docker cache and are much faster.
