...
The Helm chart includes a Makefile that automates cluster creation, image building, and installation:
...
2. Build all Docker images locally (if not already built)
3. Load images into the Kind cluster
4. Install the Helm chart with `values-local.yaml`
