...
| `langwatch_nlp` | `platform/app/langwatch_nlp:latest` | 5561 | NLP processing, workflows |
...
Edit `platform/app/.env` to customize your deployment. Key variables:
...
If you don't need NLP or evaluators, comment them out in `infra/compose.yml`:
