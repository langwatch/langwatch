...
<Tip>
  Metrics marked in red indicate an active problem, non-zero failure rates or blocked
  groups. Orange indicates a warning state, such as items in the DLQ.
</Tip>
...
Both modes deliver the same data; SSE provides lower-latency updates.
