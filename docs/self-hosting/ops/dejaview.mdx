...
The left panel lists the **fold projections** and **event subscribers** registered for the aggregate type. Select a fold projection to compute its state at the current event position.
