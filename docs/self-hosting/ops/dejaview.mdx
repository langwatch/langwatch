...
<Frame>
  <img
    src="/images/ops/dejaview-detail.png"
    alt="Deja View showing event timeline and projection state"
  />
</Frame>
...
The left panel lists all available **projections** and **subscribers** for the aggregate type. Select a projection to compute its state at the current event position.
