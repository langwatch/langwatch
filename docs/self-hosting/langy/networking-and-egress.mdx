...
<Info>
  **Also check:** [Self-hosting overview](/self-hosting/langy/overview), [Environment
  variables](/self-hosting/langy/environment-variables), [The sandbox](/langy/security/sandbox).
</Info>
...
Everything above is outbound. The one inbound path GitHub uses is the webhook, delivered to `<BASE_URL>/api/v1/github/webhook`.
