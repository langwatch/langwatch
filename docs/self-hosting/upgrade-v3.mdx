...
LangWatch v3 replaces Elasticsearch/OpenSearch with **ClickHouse** as the primary data store. The migration is the same whether you're coming from v1.x or v2.x.
