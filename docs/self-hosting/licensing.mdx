...
<Note>
Volume is bounded by your own hardware, not by us. Self-hosted deployments are not metered and send no usage back to LangWatch, unless you switch on [Connect](/self-hosting/connect), which meters the hosted services you turn on there.
</Note>
...
A licensed install can also call LangWatch-hosted services, the Instant Evals judge and managed models, over one outbound connection. It is off until an operator turns it on, each service is switched on per organization, and what you spend is metered and capped on the LangWatch side against your contract. See [Connect](/self-hosting/connect).
...
No, unless you switch on [Connect](/self-hosting/connect) and turn a hosted service on: LangWatch then meters what that service judges or serves, and the daily license sync reports your seat counts. With Connect off, a self-hosted deployment is not metered. [Billable events](/pricing/billable-events) apply to LangWatch Cloud.
</Accordion>
</AccordionGroup>
