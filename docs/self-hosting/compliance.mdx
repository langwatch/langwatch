...
<Info>
  **Pairs with:** [AI Governance → Compliance architecture](/ai-governance/compliance-architecture).
  That page documents the underlying substrate; this page narrows it to "what runs in *your*
  self-hosted box without buying anything else".
</Info>
...
the _common-criteria_ baseline:
...
## What's _intentionally_ unavailable on Apache 2.0
...
- **OCSF/SIEM export** is Enterprise. Apache 2.0 customers can still
  ...
  uses; what's gated is the _normalised OCSF event stream_ with cursor
