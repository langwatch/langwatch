...
<Info>
  **Pairs with:** [AI Governance → Compliance
  architecture](/ai-governance/compliance-architecture). That page documents the
  underlying substrate; this page narrows it to "what runs in *your* self-hosted box
