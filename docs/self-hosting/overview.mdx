...
<Note>
Running [Langy](/langy/overview), the automated AI engineer? It ships as a separate agent pod in the same umbrella chart, deployed by default and removable with one value. See [Self-hosting Langy](/self-hosting/langy/overview).
</Note>
