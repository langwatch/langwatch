...
<Note>
  Looking for a managed solution? [LangWatch Cloud](https://langwatch.ai) is fully
  maintained by the LangWatch team and is the fastest way to get started.
</Note>
...
<Tip>
  LangWatch v3 is a major architecture upgrade. If you are migrating from v2, review the
  deployment guides for updated requirements.
</Tip>
