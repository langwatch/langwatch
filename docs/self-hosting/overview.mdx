...
Without a license, self-hosted LangWatch is uncapped: unlimited members, teams, projects, and everything you create on your own infrastructure. An Enterprise license unlocks SSO, RBAC, SCIM, audit logs and support in the same deployment. See [Editions and licensing](/self-hosting/licensing).
