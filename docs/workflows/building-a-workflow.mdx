...
- **Secrets**: the editor lists the secrets of the project and inserts `secrets.NAME` at the cursor. The value reaches the code at run time only; the editor and the saved workflow hold the name. Manage the values under **Settings**, **Secrets**, described in [Secrets](/platform/secrets).
