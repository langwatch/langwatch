...
<CardGroup cols={2}>
  <Card
    title="Experiments"
    description="Batch test your prompts and models on datasets."
    icon="flask"
    href="/evaluations/experiments/overview"
  />
  <Card
    title="Scenarios"
    description="Define simulation tests for your agent."
    icon="play"
    href="/agent-testing/overview"
  />
  <Card
    title="Prompt Playground"
    description="Edit, test, and iterate on prompts."
    icon="code"
  ...
  <Card
    title="Evaluators"
    description="Browse and configure scoring functions."
    icon="check-double"
    href="/evaluations/evaluators/overview"
  />
  <Card
    title="Analytics"
    description="View costs, latency, and usage trends."
    icon="chart-line"
