  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        ...
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/tracing"} data-track="docs_copy_skill_install" data-track-title={"Instrument my code with LangWatch"} data-track-skill={"langwatch/skills/tracing"}>
      ...
      <div className="lw-accordion-cmd-col">
        ...
        <div className="lw-accordion-cmd-box" data-copy={"/tracing"} data-track="docs_copy_slash_command" data-track-title={"Instrument my code with LangWatch"} data-track-command={"/tracing"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Instrument my code with LangWatch"} data-track-skill={"langwatch/skills/tracing"}>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/tracing/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"Instrument my code with LangWatch"} data-track-skill={"langwatch/skills/tracing"}>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/evaluations"} data-track="docs_copy_skill_install" data-track-title={"Set up evaluations for my agent"} data-track-skill={"langwatch/skills/evaluations"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/evaluations"} data-track="docs_copy_slash_command" data-track-title={"Set up evaluations for my agent"} data-track-command={"/evaluations"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Set up evaluations for my agent"} data-track-skill={"langwatch/skills/evaluations"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/evaluations/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"Set up evaluations for my agent"} data-track-skill={"langwatch/skills/evaluations"}>
        <span className="lw-accordion-action-icon"><svg width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3.75H2.75C1.64543 3.75 0.75 4.64543 0.75 5.75V12.25C0.75 13.3546 1.64543 14.25 2.75 14.25H15.25C16.3546 14.25 17.25 13.3546 17.25 12.25V5.75C17.25 4.64543 16.3546 3.75 15.25 3.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M8.75 11.25V6.75H8.356L6.25 9.5L4.144 6.75H3.75V11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M11.5 9.5L13.25 11.25L15 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.25 11.25V6.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Download SKILL.md</span>
          <span className="lw-accordion-action-subtitle">Manual installation</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/scenarios"} data-track="docs_copy_skill_install" data-track-title={"Add scenario tests for my agent"} data-track-skill={"langwatch/skills/scenarios"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/scenarios"} data-track="docs_copy_slash_command" data-track-title={"Add scenario tests for my agent"} data-track-command={"/scenarios"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Add scenario tests for my agent"} data-track-skill={"langwatch/skills/scenarios"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/scenarios/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"Add scenario tests for my agent"} data-track-skill={"langwatch/skills/scenarios"}>
        <span className="lw-accordion-action-icon"><svg width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3.75H2.75C1.64543 3.75 0.75 4.64543 0.75 5.75V12.25C0.75 13.3546 1.64543 14.25 2.75 14.25H15.25C16.3546 14.25 17.25 13.3546 17.25 12.25V5.75C17.25 4.64543 16.3546 3.75 15.25 3.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M8.75 11.25V6.75H8.356L6.25 9.5L4.144 6.75H3.75V11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M11.5 9.5L13.25 11.25L15 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.25 11.25V6.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Download SKILL.md</span>
          <span className="lw-accordion-action-subtitle">Manual installation</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/prompts"} data-track="docs_copy_skill_install" data-track-title={"Version my prompts with LangWatch"} data-track-skill={"langwatch/skills/prompts"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/prompts"} data-track="docs_copy_slash_command" data-track-title={"Version my prompts with LangWatch"} data-track-command={"/prompts"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Version my prompts with LangWatch"} data-track-skill={"langwatch/skills/prompts"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/prompts/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"Version my prompts with LangWatch"} data-track-skill={"langwatch/skills/prompts"}>
        <span className="lw-accordion-action-icon"><svg width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3.75H2.75C1.64543 3.75 0.75 4.64543 0.75 5.75V12.25C0.75 13.3546 1.64543 14.25 2.75 14.25H15.25C16.3546 14.25 17.25 13.3546 17.25 12.25V5.75C17.25 4.64543 16.3546 3.75 15.25 3.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M8.75 11.25V6.75H8.356L6.25 9.5L4.144 6.75H3.75V11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M11.5 9.5L13.25 11.25L15 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.25 11.25V6.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Download SKILL.md</span>
          <span className="lw-accordion-action-subtitle">Manual installation</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/datasets"} data-track="docs_copy_skill_install" data-track-title={"Generate a realistic evaluation dataset"} data-track-skill={"langwatch/skills/datasets"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/datasets"} data-track="docs_copy_slash_command" data-track-title={"Generate a realistic evaluation dataset"} data-track-command={"/datasets"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Generate a realistic evaluation dataset"} data-track-skill={"langwatch/skills/datasets"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/datasets/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"Generate a realistic evaluation dataset"} data-track-skill={"langwatch/skills/datasets"}>
        <span className="lw-accordion-action-icon"><svg width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3.75H2.75C1.64543 3.75 0.75 4.64543 0.75 5.75V12.25C0.75 13.3546 1.64543 14.25 2.75 14.25H15.25C16.3546 14.25 17.25 13.3546 17.25 12.25V5.75C17.25 4.64543 16.3546 3.75 15.25 3.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M8.75 11.25V6.75H8.356L6.25 9.5L4.144 6.75H3.75V11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M11.5 9.5L13.25 11.25L15 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.25 11.25V6.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Download SKILL.md</span>
          <span className="lw-accordion-action-subtitle">Manual installation</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/level-up"} data-track="docs_copy_skill_install" data-track-title={"Take my agent to the next level"} data-track-skill={"langwatch/skills/level-up"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/level-up"} data-track="docs_copy_slash_command" data-track-title={"Take my agent to the next level"} data-track-command={"/level-up"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Take my agent to the next level"} data-track-skill={"langwatch/skills/level-up"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/level-up/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"Take my agent to the next level"} data-track-skill={"langwatch/skills/level-up"}>
        <span className="lw-accordion-action-icon"><svg width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3.75H2.75C1.64543 3.75 0.75 4.64543 0.75 5.75V12.25C0.75 13.3546 1.64543 14.25 2.75 14.25H15.25C16.3546 14.25 17.25 13.3546 17.25 12.25V5.75C17.25 4.64543 16.3546 3.75 15.25 3.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M8.75 11.25V6.75H8.356L6.25 9.5L4.144 6.75H3.75V11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M11.5 9.5L13.25 11.25L15 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.25 11.25V6.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Download SKILL.md</span>
          <span className="lw-accordion-action-subtitle">Manual installation</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/recipes/improve-setup"} data-track="docs_copy_skill_install" data-track-title={"What should I do next to improve my agent?"} data-track-skill={"langwatch/skills/recipes/improve-setup"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/improve-setup"} data-track="docs_copy_slash_command" data-track-title={"What should I do next to improve my agent?"} data-track-command={"/improve-setup"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"What should I do next to improve my agent?"} data-track-skill={"langwatch/skills/recipes/improve-setup"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/analytics"} data-track="docs_copy_skill_install" data-track-title={"How is my agent performing?"} data-track-skill={"langwatch/skills/analytics"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/analytics"} data-track="docs_copy_slash_command" data-track-title={"How is my agent performing?"} data-track-command={"/analytics"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"How is my agent performing?"} data-track-skill={"langwatch/skills/analytics"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
````
      ...
      <div className="lw-accordion-action" data-download-url="https://raw.githubusercontent.com/langwatch/skills/main/analytics/SKILL.md" data-download-name="SKILL.md" data-track="docs_download_skill" data-track-title={"How is my agent performing?"} data-track-skill={"langwatch/skills/analytics"}>
        <span className="lw-accordion-action-icon"><svg width="16" height="16" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15.25 3.75H2.75C1.64543 3.75 0.75 4.64543 0.75 5.75V12.25C0.75 13.3546 1.64543 14.25 2.75 14.25H15.25C16.3546 14.25 17.25 13.3546 17.25 12.25V5.75C17.25 4.64543 16.3546 3.75 15.25 3.75Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M8.75 11.25V6.75H8.356L6.25 9.5L4.144 6.75H3.75V11.25" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M11.5 9.5L13.25 11.25L15 9.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /><path d="M13.25 11.25V6.75" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Download SKILL.md</span>
          <span className="lw-accordion-action-subtitle">Manual installation</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/recipes/debug-instrumentation"} data-track="docs_copy_skill_install" data-track-title={"Debug and improve my agent instrumentation"} data-track-skill={"langwatch/skills/recipes/debug-instrumentation"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/debug-instrumentation"} data-track="docs_copy_slash_command" data-track-title={"Debug and improve my agent instrumentation"} data-track-command={"/debug-instrumentation"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Debug and improve my agent instrumentation"} data-track-skill={"langwatch/skills/recipes/debug-instrumentation"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/recipes/evaluate-multimodal"} data-track="docs_copy_skill_install" data-track-title={"Evaluate my multimodal agent"} data-track-skill={"langwatch/skills/recipes/evaluate-multimodal"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/evaluate-multimodal"} data-track="docs_copy_slash_command" data-track-title={"Evaluate my multimodal agent"} data-track-command={"/evaluate-multimodal"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Evaluate my multimodal agent"} data-track-skill={"langwatch/skills/recipes/evaluate-multimodal"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/recipes/generate-rag-dataset"} data-track="docs_copy_skill_install" data-track-title={"Generate an evaluation dataset from my RAG knowledge base"} data-track-skill={"langwatch/skills/recipes/generate-rag-dataset"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/generate-rag-dataset"} data-track="docs_copy_slash_command" data-track-title={"Generate an evaluation dataset from my RAG knowledge base"} data-track-command={"/generate-rag-dataset"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Generate an evaluation dataset from my RAG knowledge base"} data-track-skill={"langwatch/skills/recipes/generate-rag-dataset"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/recipes/test-compliance"} data-track="docs_copy_skill_install" data-track-title={"Check my agent doesn't give prescriptive advice"} data-track-skill={"langwatch/skills/recipes/test-compliance"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/test-compliance"} data-track="docs_copy_slash_command" data-track-title={"Check my agent doesn't give prescriptive advice"} data-track-command={"/test-compliance"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Check my agent doesn't give prescriptive advice"} data-track-skill={"langwatch/skills/recipes/test-compliance"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
...
<div className="lw-accordion">
  ...
  <div className="lw-accordion-body">
    <div className="lw-accordion-commands">
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Install via CLI</div>
        <div className="lw-accordion-cmd-box" data-copy={"npx skills add langwatch/skills/recipes/test-cli-usability"} data-track="docs_copy_skill_install" data-track-title={"Test my CLI is well usable by AI agents"} data-track-skill={"langwatch/skills/recipes/test-cli-usability"}>
      ...
      <div className="lw-accordion-cmd-col">
        <div className="lw-accordion-cmd-label">Skill Usage</div>
        <div className="lw-accordion-cmd-box" data-copy={"/test-cli-usability"} data-track="docs_copy_slash_command" data-track-title={"Test my CLI is well usable by AI agents"} data-track-command={"/test-cli-usability"}>
    ...
    <div className="lw-accordion-actions">
      <div className="lw-accordion-action" data-copy-source="prompt" data-track="docs_copy_prompt" data-track-title={"Test my CLI is well usable by AI agents"} data-track-skill={"langwatch/skills/recipes/test-cli-usability"}>
        <span className="lw-accordion-action-icon lw-copy-line-icon"><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="9" y="9" width="13" height="13" rx="2" ry="2" /><path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" /></svg></span>
        <span className="lw-accordion-action-icon lw-copy-line-check" style={{ display: "none" }}><svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#059669" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 6L9 17L4 12" /></svg></span>
        <span className="lw-accordion-action-text">
          <span className="lw-accordion-action-title">Copy Full Prompt</span>
