...
<Tip>
  **Don't have an agent yet?** Use [Better Agents](/better-agents/overview) to scaffold a
  new agent project.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    description="Validate agent behavior with realistic multi-turn conversations."
    icon="masks-theater"
