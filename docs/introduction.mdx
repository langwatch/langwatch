...
<CardGroup cols={2}>
  ...
  <Card title="AI Gateway · Governance" description="One control plane above the gateway: SSO, per-user identity, attribution, audit-log ingestion, anomaly rules. The admin home for rolling LangWatch out company-wide." icon="shield-halved" href="/ai-gateway/governance/overview" />
</CardGroup>
