...
An agent not seen for 30 days no longer appears in the list. It comes back when the process connects again, with the same row and its history. Deleting an agent also hides it only until the process connects again.
