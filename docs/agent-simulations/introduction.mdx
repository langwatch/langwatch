...
- **Trace-informed judging** - The judge reads your agent's own traces before its verdict, so it verifies tool calls and writes as evidence. [See Remote Traces](/agent-simulations/remote-traces)
...
- [Remote traces](/agent-simulations/remote-traces) - How the judge reads your agent's traces
