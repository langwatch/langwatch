...
<CardGroup cols={2}>
  ...
  <Card title="Visualize in LangWatch" icon="chart-line" href="/agent-simulations/overview">
    Organize runs into sets and batches, step through conversations, and track pass/fail over time across your whole team.
  </Card>
</CardGroup>
...
See [Viewing in LangWatch](/agent-simulations/overview) to learn how to inspect, replay, and compare your runs in the simulation visualizer.
...
- [Viewing in LangWatch](/agent-simulations/overview) - Inspect and debug your runs in the simulation visualizer
