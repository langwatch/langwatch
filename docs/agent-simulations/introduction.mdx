...
<Tip>
  **Quick setup?** Paste the [Connect your agent prompt](/agent-simulations/connect-your-agent) into your coding agent to connect your agent's HTTP endpoint and run a first suite, or the [scenarios prompt](/skills/code-prompts#add-scenario-tests) to add code-first simulation tests.
</Tip>
