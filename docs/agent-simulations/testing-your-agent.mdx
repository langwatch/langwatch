...
<Note>
  One technical step happens before this guide: a developer connects the agent to
  LangWatch, so simulations can talk to it and the judge can see what the agent did
  internally. Send your developer the [Connect your
  agent](/agent-simulations/connect-your-agent) guide. It is a one-time setup and usually
  takes under an hour.
</Note>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/scenario-library.png"
    alt="The Scenario Library with scenarios and their labels"
  />
</Frame>
...
<Note>
  A scenario is saved in your project, and everyone with access to the project can read
  it. The AI draft step also sends the text you give it to a model. Remove names, contact
  details, account numbers and other personal data before you paste, or replace them with
  invented equivalents. The test works the same way with invented details.
</Note>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/scenario-create-with-ai.png"
    alt="The Create new scenario dialog with a behavior description ready to draft with AI"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/scenario-editor.png"
    alt="The scenario editor with a situation and two criteria filled in"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/langy-creates-scenario.png"
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/scenario-run-target.png"
    alt="The target picker with the registered agent to run the scenario against"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/scenario-choose-models.png"
    alt="The model picker for the user simulator and the judge"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/run-plan.png"
    alt="A run plan with its scenarios, pass rate and run history"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/run-plan-confirm.png"
    alt="The run confirmation with the scenario count and the run parameters"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/run-live.png"
    alt="A run in progress with two conversations running live"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/run-detail-conversation.png"
    alt="The run detail with the full conversation transcript"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-simulations/run-detail-verdict.png"
    alt="The run results with the pass verdict and the judge reasoning"
  />
</Frame>
