...
<Info>
  Use guardrails when you need to **prevent** something from happening. Use monitors when you need
...
Click **Set up Guardrail** on the [Online Evaluations](https://app.langwatch.ai/@project/online-evaluations) page to open the **New Guardrail** drawer. Pick a saved evaluator and copy the **Integration Code** for your language.

<Frame>
<img src="/images/evaluations/guardrail-drawer.png" alt="The New Guardrail drawer with an evaluator selected and the Python integration code" />
</Frame>
...
@langwatch.trace()
def my_chatbot(user_input): # Input guardrail - check for jailbreak attempts
...
Tell the user why the request was blocked and how to rephrase it:
