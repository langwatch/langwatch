...
| Monitors | Guardrails |
|----------|------------|
| **Measure** quality metrics | **Block** harmful content |
| Run **asynchronously** after response | Run **synchronously** during request |
| Feed dashboards and alerts | Return errors or safe responses |
| No impact on response time | Add latency to requests |
