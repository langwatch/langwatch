...
Saved evaluators are pre-configured evaluation setups that you create on the LangWatch platform. Once saved, you can reuse them in experiments, monitors, guardrails, or through the API without reconfiguring settings each time.
...
1. Go to **Evaluators** in your LangWatch project
...
<Frame>
<img src="/images/evaluations/evaluators-list.png" alt="The Evaluators page with three saved evaluators and the New Evaluator button" />
</Frame>
...
@langwatch.span()
def my_llm_step(user_input: str): # Use your saved evaluator as a guardrail
...
curl -X POST "https://app.langwatch.ai/api/v1/evaluations/evaluators/my-tone-checker/evaluate" \
