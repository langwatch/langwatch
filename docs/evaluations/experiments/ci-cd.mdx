...
Test suite runs also accept a `parameters` field. There the values apply to every scenario in the run. See [Scenario run parameters](/agent-simulations/scenario-parameters).
