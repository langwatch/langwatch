...
For the complete list, including exactly how many events an experiment sweep or a scenario run produces and what is never billed, see [What counts as a billable event](/pricing/billable-events).
...
<AccordionGroup>
  ...
  <Accordion title="What counts as a billable event?">
    A billable event is either a span within a trace or a scenario run used to test your AI agents. Pricing is based on the total number of ingested events per billing period. [The full list is here](/pricing/billable-events), including what is never billed and how retries are deduplicated.
  </Accordion>
