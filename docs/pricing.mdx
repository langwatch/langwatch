...
Spans dominate the count for most customers, but testing is not free: an experiment over 100 rows with 2 evaluators is roughly 300 events. There are no separate charges per feature on top of this, and everything you create (prompts, evaluators, datasets, dashboards) is free.
