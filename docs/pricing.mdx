...
Self-hosted deployments keep the same 49-day default. An Enterprise license unlocks the same windows as the Enterprise plan, and a platform administrator can then keep data indefinitely. See [Editions and licensing](/self-hosting/licensing).
