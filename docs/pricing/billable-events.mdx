...
<Note>
  Self-hosted deployments are not metered and send no usage data to LangWatch. This page applies to
  LangWatch Cloud. See [Editions and licensing](/self-hosting/licensing).
</Note>
