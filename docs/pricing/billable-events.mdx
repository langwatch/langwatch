...
- Logs and metrics. A coding assistant sends these alongside its spans, and LangWatch stores them and joins them onto the trace, but only the spans are counted.
