...
| -------- | ------------------ | ------------------------------------------------------- |
| `GET`    | `/api/v1/groups`      | List all groups in the organization                     |
| `POST`   | `/api/v1/groups`      | Create a new group (with optional members and bindings) |
| `GET`    | `/api/v1/groups/{id}` | Get group details with members and bindings             |
| `PATCH`  | `/api/v1/groups/{id}` | Rename a group                                          |
| `DELETE` | `/api/v1/groups/{id}` | Delete a group and all its memberships/bindings         |
...
| Method   | Path                                    | Description                        |
| -------- | --------------------------------------- | ---------------------------------- |
| `GET`    | `/api/v1/groups/{id}/bindings`             | List role bindings for a group     |
| `POST`   | `/api/v1/groups/{id}/bindings`             | Add a role binding to a group      |
| `DELETE` | `/api/v1/groups/{id}/bindings/{bindingId}` | Remove a role binding from a group |
...
```bash
curl -X POST https://app.langwatch.ai/api/v1/groups \
