...
- The last active administrator cannot be disabled or demoted: `cannot_disable_last_admin` and `cannot_demote_last_admin`. An organization with nobody who can administer it cannot be recovered from inside the product.
