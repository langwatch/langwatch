...
The three discovery endpoints (`/ServiceProviderConfig`, `/ResourceTypes`, `/Schemas`) are unauthenticated, as RFC 7644 requires: a provider reads them before it has anywhere to put a credential.
