...
- `GET /api/v1/annotations` - Get a list of annotations
- `GET /api/v1/annotations/:id` - Get a single annotation
- `DELETE /api/v1/annotations/:id` - Delete a single annotation
- `PATCH /api/v1/annotations/:id` - Update a single annotation
- `GET /api/v1/annotations/trace/:id` - Get the annotations for a single trace
- `POST /api/v1/annotations/trace/:id` - Create annotations for traces to support domain labeling, evaluation scoring, and agent testing workflows.
