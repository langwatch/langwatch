...
description: 'Update metadata on an existing trace by trace ID. Supports deep merge for custom metadata; labels are fully replaced, user identity and thread ID are mapped to canonical attributes.'
---
