...
| ------- | ------------------- | --------------------- | --------------------------------------- |
| `GET`   | `/api/v1/organization` | `organization:view`   | Read the organization profile           |
| `PATCH` | `/api/v1/organization` | `organization:manage` | Update part of the organization profile |
...
```bash
# Read the profile
curl https://app.langwatch.ai/api/v1/organization \
  -H "Authorization: Bearer sk-lw-..."

# Rename it and set a support contact, leaving everything else alone
curl -X PATCH https://app.langwatch.ai/api/v1/organization \
  -H "Authorization: Bearer sk-lw-..." \
