...
| -------- | ------------------------ | ------------------------------------------- |
| `GET`    | `/api/v1/roles/permissions` | The permission catalog roles are built from |
| `GET`    | `/api/v1/roles`             | List the organization's custom roles        |
| `POST`   | `/api/v1/roles`             | Create a custom role                        |
| `GET`    | `/api/v1/roles/{id}`        | Read one custom role                        |
...
```bash
curl https://app.langwatch.ai/api/v1/roles/permissions \
...
```bash
curl -X POST https://app.langwatch.ai/api/v1/roles \
  -H "Authorization: Bearer sk-lw-..." \
