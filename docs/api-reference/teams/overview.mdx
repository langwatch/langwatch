...
| -------- | ---------------------------------- | ---------------------------------- |
| `GET`    | `/api/v1/teams`                       | List all teams in the organization |
| `POST`   | `/api/v1/teams`                       | Create a new team                  |
| `GET`    | `/api/v1/teams/{id}`                  | Get team details                   |
| `PATCH`  | `/api/v1/teams/{id}`                  | Update a team                      |
| `DELETE` | `/api/v1/teams/{id}`                  | Archive a team (soft-delete)       |
...
| `GET`    | `/api/v1/teams/{id}/projects`         | List projects in the team          |
...
2. Call `POST /api/v1/teams` with a team name
...
```bash
# Create team
curl -X POST https://app.langwatch.ai/api/v1/teams \
