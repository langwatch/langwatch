...
| -------- | ------------------------- | --------------------------------------------- |
| `GET`    | `/api/v1/role-bindings`      | List bindings, filtered by principal or scope |
| `POST`   | `/api/v1/role-bindings`      | Grant one role to one principal at one scope  |
| `PATCH`  | `/api/v1/role-bindings/{id}` | Change the role a binding grants              |
| `DELETE` | `/api/v1/role-bindings/{id}` | Delete a binding                              |
...
curl -X POST https://app.langwatch.ai/api/v1/role-bindings \
