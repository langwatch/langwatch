...
description: Rewrite your agent's instructions and tool descriptions with a DSPy optimizer that scores every candidate by running your scenario suite and reads the judge's reasoning as feedback.
---
