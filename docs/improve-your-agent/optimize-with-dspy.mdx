...
description: Rewrite your agent's instructions and tool descriptions with a DSPy optimizer scored by your scenario suite, where GEPA also reads the judge's reasoning as feedback.
---
