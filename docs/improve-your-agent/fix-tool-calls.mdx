...
1. **The accepted values are in the parameter description, or better, in the schema.** Put an enum in the schema and the model stops guessing; a description that lists the values is the next best thing.
