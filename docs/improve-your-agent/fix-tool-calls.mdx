...
Finding those calls and fixing the contract is work for Langy or your coding agent; your part is the suite, the criteria that catch the retries, and the review of the change.
