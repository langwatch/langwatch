...
Langy answers with a pull request, and the suite runs in your CI on it; your coding agent answers with the change in your working tree. Both come with the cause and the conversations it was found in, so you review the reasoning and the diff together.
