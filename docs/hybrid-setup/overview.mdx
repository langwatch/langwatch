...
- Self-hosted on your Kubernetes cluster using our [clickhouse-serverless helm chart](https://github.com/langwatch/langwatch/tree/main/infra/charts/clickhouse-serverless)
- Self-hosted on VMs
