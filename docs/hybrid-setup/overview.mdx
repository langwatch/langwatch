---
title: Hybrid Setup
description: Use LangWatch Cloud with your own data plane, keep full data ownership while using LangWatch's managed control plane.
---

## Control Plane and Data Plane

The hybrid setup splits the deployment: LangWatch manages the **control plane** (application, UI, evaluations, prompt management), while your sensitive data stays in **your own infrastructure**.
...
<Card
  title="Interested in hybrid setup?"
  icon="envelope"
  href="mailto:support@langwatch.ai"
>
