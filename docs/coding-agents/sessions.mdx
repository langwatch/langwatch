...
<Frame caption="Session detail with the Cache health section. This session compacted once, missed its cache twice, and re-sent 22k tokens on its biggest rebuild.">
