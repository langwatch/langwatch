...
The first question to settle: can your manager read what you typed? The short answer: your sessions land in a project only you own, an administrator reads them only through an audited path that shows a banner for the whole visit, and an organization can drop the content before it is ever stored.
