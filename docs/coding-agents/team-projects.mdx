...
**Also check:** [Headless machines and CI](/coding-agents/headless-and-ci) for machines that never log in, and [Access Control (RBAC)](/platform/rbac) for what `traces:create` covers.
