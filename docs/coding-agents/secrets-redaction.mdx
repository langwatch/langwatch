...
It is on by default. A [data privacy rule](/platform/data-privacy#secrets-redaction) can turn redaction off for its scope.
...
**Also check:** [Privacy](/coding-agents/privacy) for who can read what, and [Data privacy policy](/platform/data-privacy) for PII redaction and the drop controls.
