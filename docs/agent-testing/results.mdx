...
Under the transcript: **FAILED CRITERIA**, **PASSED CRITERIA** and **JUDGE REASONING**, then **Parameters** with the values the run used, a secret parameter masked. **Open Scenario** opens the scenario in the editor.
