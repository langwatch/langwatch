...
<Frame>
  <img
    ...
    alt="The Results tab grouped by run plan, with the pass rate and the trend of each plan"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/results-charts.png"
    alt="The Charts block with the four tiles and the pass rate over time"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-detail-table.png"
    alt="A run plan with its runs in the sidebar, the summary pills and the table of results"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-detail-grid.png"
    alt="The Grid view of a run, one card per scenario execution"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-drawer-failed.png"
    alt="The conversation drawer of a failed run, with the failed criteria and the judge reasoning"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-drawer-unreachable.png"
    alt="The conversation drawer of a run whose target could not be reached, with the error"
  />
</Frame>
