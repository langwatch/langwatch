...
Under the transcript, the **RESULTS** block lists the met criteria, the unmet criteria and the judge's reasoning, then **PARAMETERS** shows the values the run used, a secret parameter masked. **Edit Scenario** opens the scenario in the editor.
