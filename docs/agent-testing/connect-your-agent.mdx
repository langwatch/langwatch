...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-detail-conversation.png"
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-detail-verdict.png"
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-trace.png"
...
<CardGroup cols={2}>
  <Card
    ...
    icon="laptop-code"
    href="/agent-testing/environments"
  >
