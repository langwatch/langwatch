...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/scenarios-tab.png"
    alt="The Scenarios tab with the test suite rail on the left and the scenarios of the Refunds test suite, with their labels"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/scenario-editor.png"
    alt="The scenario editor with a title, a situation and three criteria filled in"
  />
</Frame>
...
<Note>
  Everyone with access to the project can read a scenario. Remove names, contact details, account
  numbers and other personal data before you paste real material, or replace them with invented
  ones. The test works the same with invented details.
</Note>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/langy-creates-scenario.png"
    alt="Langy creating a scenario from a pasted snippet of a customer chat"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-dialog.png"
    alt="The run dialog with the run name, the agent to be tested and the Customize your run chips"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-detail-running.png"
    alt="A run in progress, with scenarios still running and the first results in"
  />
</Frame>
...
Press a row of a finished run. The drawer shows the conversation, then the verdict: **FAILED CRITERIA**, **PASSED CRITERIA** and **JUDGE REASONING**. The reasoning cites what the agent did, for example which lookup it made before answering.

<Frame>
  <img
    className="block"
    src="/images/agent-testing/run-drawer-passed.png"
    alt="The conversation drawer of a passed run, with the transcript, the passed criteria and the judge reasoning"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/results-tab.png"
    alt="The Results tab with the run plans of the project, their pass rates and trends"
  />
</Frame>
