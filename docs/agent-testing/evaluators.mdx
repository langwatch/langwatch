...
A test suite declares [fields](/agent-testing/test-suites#fields) for the values an evaluator compares against, and every scenario in the suite carries one value per field.
