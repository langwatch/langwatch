...
The drawer on that attachment: one mapping per input under **Variables**, and the **Required to pass** switch under them. The step by step is in [Grade runs with evaluators](/agent-testing/grade-runs-with-evaluators).
