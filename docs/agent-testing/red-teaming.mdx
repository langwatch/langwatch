...
New to Scenario? Start with [Getting Started](/agent-testing/scenarios-in-code) to write your agent's `call()` adapter, then swap in an attacker instead of the user simulator.
