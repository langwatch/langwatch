...
New to Scenario? Start with [Getting Started](/agent-testing/scenarios-in-code) for the basics (API key, writing your agent's `call()` adapter), then come back for the voice specifics.
