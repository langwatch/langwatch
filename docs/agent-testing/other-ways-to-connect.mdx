...
<Note>
  **Also check:** [Testing agents behind authentication](/agent-testing/authenticated-agents) lists
  exactly which fields resolve secret references, and covers an OAuth2 client-credentials exchange.
</Note>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/register-http-agent.png"
    alt="The HTTP agent editor with the endpoint URL, request body template and output path"
  />
</Frame>
...
<Frame>
  <img
    className="block"
    src="/images/agent-testing/agent-test-request.png"
    alt="The Test tab showing a 200 response from the agent endpoint and the extracted reply"
  />
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/agent-testing/linking-your-traces"
  >
