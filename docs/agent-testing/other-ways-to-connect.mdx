...
| `{{ params.NAME }}` | A [run parameter](/agent-testing/scenario-parameters) |
| `{{ traceId }}`, `{{ traceparent }}` | The turn's trace identifiers, see [Linking your traces](/agent-testing/remote-traces) |
...
<CardGroup cols={2}>
  ...
  <Card title="Linking your traces" icon="diagram-project" href="/agent-testing/remote-traces">
