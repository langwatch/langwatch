...
<Frame>
<img className="block" src="/images/agent-testing/run-dialog-compare.png" alt="The run dialog with two targets, checkout-prod and checkout-staging, and the Run button counting both" />
</Frame>
...
<Frame>
<img className="block" src="/images/agent-testing/results-group-by-target.png" alt="The Results tab grouped by target, with the two parameter variants of checkout-prod as separate rows" />
</Frame>
...
A connected agent is named the same way: `connected:<name>?plan=free`, or `connected:<name>@<environment>?plan=free` to pick the environment.
