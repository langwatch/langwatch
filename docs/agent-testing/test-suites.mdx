...
description: A test suite is a named group of scenarios that you run together. It holds no targets, no models and no repeat count; those belong to the run plan.
---
...
| **Rename** | Changes the name. Runs keep the name they ran under. |
...
**Move to suite...** in the row menu of a scenario moves one. Select several rows and press **Move to suite** in the bar that appears to move them together. A scenario belongs to exactly one test suite.

<Frame>
<img className="block" src="/images/agent-testing/move-to-test-suite.png" alt="The Move to suite dialog with the test suites of the project" />
</Frame>
