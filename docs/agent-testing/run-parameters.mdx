...
<img src="/images/agent-testing/run-drawer-parameters.png" alt="The conversation drawer with the Parameters block showing the value the run used and a masked secret" width="100%" />
