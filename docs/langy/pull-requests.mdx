...
Langy changes code in exactly one way: it opens a pull request. It never commits directly, never pushes to a branch you have not reviewed, and never merges its own PR.
