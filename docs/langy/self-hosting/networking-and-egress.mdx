...
<Info>
**Also check:** [Self-hosting overview](/langy/self-hosting/overview), [Environment variables](/langy/self-hosting/environment-variables), [The sandbox](/langy/security/sandbox).
</Info>
