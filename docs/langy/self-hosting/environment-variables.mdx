...
<Info>
**Also check:** [Enable Langy via Helm](/langy/self-hosting/helm), [Register the GitHub App](/langy/self-hosting/github-app), [Networking and egress](/langy/self-hosting/networking-and-egress).
</Info>
