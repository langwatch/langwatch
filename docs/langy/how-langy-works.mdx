...
<Info>
  **Also check:** [Security and the sandbox](/langy/security/sandbox), [Self-hosting overview](/langy/self-hosting/overview)
</Info>
...
The agent service is cluster-internal only, never exposed outside; auth and networking details are on the [self-hosting overview](/langy/self-hosting/overview).
