...
<Note>
  Codex uses your OpenAI subscription via OAuth device sign-in. Every other provider,
  including Anthropic, is configured with an API key. See [Models and bring your own
  key](/langy/models).
</Note>
