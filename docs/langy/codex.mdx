...
<Frame caption="When Langy asks for a model, Codex leads the provider grid with a Recommended badge. Every other provider takes an API key; Codex takes a sign-in.">
  ![The Langy panel's model setup, with Codex recommended at the top of the provider
  grid](/images/langy/codex/onboarding-recommended.png)
</Frame>
...
<Frame caption="The Langy model menu after connecting. The gpt-5.6 models carry the Codex icon; gpt-5.6-terra is the default.">
  ![The Langy model menu with gpt-5.6 models carrying the Codex
  icon](/images/langy/models/model-menu-codex-icon.png)
</Frame>
...
<Note>
  Codex uses your OpenAI subscription via OAuth device sign-in. Every other provider, including
  Anthropic, is configured with an API key. See [Models and bring your own key](/langy/models).
</Note>
...
<Info>
  **Also check:** [Models and bring your own key](/langy/models), [Token usage and
  cost](/langy/token-usage-and-cost).
</Info>
