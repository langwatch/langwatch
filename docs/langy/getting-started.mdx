...
<Steps>
  <Step title="Open the Langy panel">
    ...
    - **On a self-hosted install:** an admin enables the Langy agent pod through the chart first. Once the pod is running, Langy is available. See [self-hosting enablement](/self-hosting/langy/overview).
  </Step>
