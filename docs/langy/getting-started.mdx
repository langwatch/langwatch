...
There is nothing to install: the only setup is a model, and the GitHub App for pull requests.

<Info>
  **Also check:** [How Langy works](/langy/how-langy-works), [Models and Codex](/langy/models), [Pull requests](/langy/pull-requests)
</Info>
