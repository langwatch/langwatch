...
Langy contributes to your code in exactly one way: **bot-authored pull requests through a GitHub App**. Langy never pushes to a branch you have not reviewed and never merges its own PR. A human reviews and merges.
...
The app subscribes to no events beyond the installation lifecycle that GitHub sends automatically (`installation`, `installation_repositories`).
...
<Info>
**Pairs with:** [How Langy is isolated](/langy/security/sandbox), [Data flow and privacy](/langy/security/data-flow-and-privacy), [Register the Langy GitHub App](/langy/self-hosting/github-app).
</Info>

## Reference

- [Register the Langy GitHub App](/langy/self-hosting/github-app) for the setup steps (registering the app, plumbing the secrets, and installing it).
