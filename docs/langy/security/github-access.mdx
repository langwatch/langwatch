...
<Info>
**Also check:** [How Langy is isolated](/langy/security/sandbox), [Data flow and privacy](/langy/security/data-flow-and-privacy), [Register the Langy GitHub App](/langy/self-hosting/github-app).
</Info>
