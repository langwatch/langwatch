...
For the full picture of what the sandbox can and cannot reach, and why the stock L7 adapter is cooperative rather than mandatory, see [How Langy is isolated](/langy/security/sandbox).
...
<Note>
  ...
  `langyagent.mirror.existingSecretName` names a Secret with the mirror project's API key,
  and you choose the tier. On LangWatch SaaS the default is the `content` tier, with
  specific organizations restricted. If you are self-hosting and do not want any operator
  copy of Langy's traces, leave the mirror Secret unset.
</Note>

<Info>
  **Also check:** [How Langy is isolated](/langy/security/sandbox), [What Langy can do in
  your GitHub](/langy/security/github-access), [Models and bring your own
  key](/langy/models).
</Info>
