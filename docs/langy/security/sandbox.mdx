...
Opting out (setting `runtimeClassName: ""`) is documented in the chart as not recommended, because you then lose the pod-to-host boundary and keep only the in-pod walls below.
...
<Info>
**Also check:** [Data flow and privacy](/langy/security/data-flow-and-privacy), [What Langy can do in your GitHub](/langy/security/github-access), [Self-hosting: networking and egress](/langy/self-hosting/networking-and-egress).
</Info>
