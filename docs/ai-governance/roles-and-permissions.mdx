...
<Info>
  **Pairs with:** [Members & invites](/ai-governance/members-and-invites) (assigning roles
  when inviting), [Audit log](/ai-governance/audit-log) (every role binding mutation
  records a row), and [AI Gateway → RBAC](/ai-gateway/rbac) (the gateway-side enforcement
  of permissions).
</Info>
...
<Note>
  Trace **viewing** is included in a lite seat. If you want someone who cannot open a
  trace at all, build a custom role that withholds `traces:view` and bind it to them.
</Note>
