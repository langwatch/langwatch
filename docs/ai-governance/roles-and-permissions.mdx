...
ADMIN and MEMBER are always full seats. EXTERNAL is a lite seat, unless you assign it a custom role granting anything beyond viewing, in which case that person can change things and counts as a full seat from then on.
...
Annotations are the exception: a lite member can leave and edit them, so reviewers can mark up what they read without needing a full seat.
