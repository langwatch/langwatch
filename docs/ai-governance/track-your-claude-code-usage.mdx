...
- **Use LangWatch MCP to have your agent automatically self-improving by inspecting its own traces**
...
Open **Settings → Model providers** (URL: `/[project]/settings/model-providers`), click the **Anthropic** tile, paste your `sk-ant-` key.
