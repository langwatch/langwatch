...
| `governance_ingestion_keys_mint` | `ingestionKey.mint` (`metadata.surface = "mcp"`) |
| `governance_ingestion_keys_revoke` | `ingestionKey.revoke` (`metadata.surface = "mcp"`) |
