...
`/governance/tool-catalog` sees a starter-pack import CTA
...
- `aiTools:manage`, granted to ADMIN by default. Required to access
  `/governance/tool-catalog` and to run any catalog
...
- **Admin:** [Admin catalog](/ai-governance/personal-portal/admin-catalog)
  ...
  `/governance/tool-catalog`, including starter-pack import,
