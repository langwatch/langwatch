...
![Portal grid populated, admin home with all three tile classes](/images/ai-governance/portal/portal-hero-populated.png)
...
`/governance/inventory?tab=catalog` sees a starter-pack import CTA
...
![Portal empty state, end-user view before admin publishes the catalog](/images/ai-governance/portal/portal-empty.png)
...
- `aiTools:manage`, granted to ADMIN by default. Required to access
  `/governance/inventory?tab=catalog` and to run any catalog
...
- **Admin:** [Admin catalog](/ai-governance/personal-portal/admin-catalog)
  ...
  `/governance/inventory?tab=catalog`, including starter-pack import,
