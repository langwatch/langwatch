...
| [AI Tools Portal at `/me`](/ai-governance/personal-portal/overview) | Apache 2.0 | Always available. Catalog editor at `/governance/inventory?tab=catalog`, three tile classes, admin-curated.                                                                                |
...
| Inside `packages/enterprise/`                         | Enterprise (LangWatch EE) | `LicenseRef-LangWatch-Enterprise` |
...
Turning on the Enterprise feature surface takes a real signed license key. There is no environment-variable bypass. See [Editions and licensing](/self-hosting/licensing) for how to request a key and where to set it.
