...
If your deployment is self-hosted and you have not yet stood it up, follow [AI Gateway → Self-hosting → Helm](/ai-gateway/self-hosting/helm) first — the same Helm chart deploys both the gateway data plane and the governance control plane.
...
- **Self-host or scale** — same Helm chart, both planes: [AI Gateway → Self-hosting → Helm](/ai-gateway/self-hosting/helm).
