...
<Info>
  **Pairs with:** [LangWatch Self-Hosting](/self-hosting/overview). The S3 puller path
  requires bucket + IAM trust setup that overlaps with self-hosted deployment IAM; see
  your hosting playbook for the AWS-side prerequisites.
</Info>
