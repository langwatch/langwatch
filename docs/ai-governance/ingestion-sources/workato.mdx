...
<Info>**Pairs with:** [Ingestion Sources index](/ai-governance/ingestion-sources/index). Webhook envelope shape is shared with [`s3_custom`](/ai-governance/ingestion-sources/s3-custom) callback mode.</Info>
