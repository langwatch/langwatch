...
<Info>
  **Pairs with:** [AI Gateway → Anthropic provider](/ai-gateway/providers/anthropic).
  Direct Anthropic API traffic flows through the gateway data plane; Anthropic Enterprise
  Compliance API exports are a separate bulk feed routed through this ingestion source.
</Info>
