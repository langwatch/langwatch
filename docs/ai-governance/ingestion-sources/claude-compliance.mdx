...
This page documents the configuration contract so admins can pre-stage workspace keys; the matching adapter is on the [roadmap](/ai-governance/ingestion-sources/index#adapter-roadmap).
