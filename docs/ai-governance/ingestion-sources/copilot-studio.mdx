...
<Info>
  **Pairs with:** [Ingestion Sources index](/ai-governance/ingestion-sources/index).
  Microsoft Copilot Studio is on the adapter roadmap; configuration contract is captured
  today, the Purview poller worker is pending.
</Info>
