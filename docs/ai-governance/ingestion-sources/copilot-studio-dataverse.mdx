...
### In Azure and Power Platform

1. **App registrations** (Azure portal): register one application (e.g. `langwatch-copilot-reader`).
2. **Certificates & secrets** (Azure portal): create a client secret and copy the value.
