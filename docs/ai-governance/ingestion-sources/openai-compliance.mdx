...
<Info>
  **Pairs with:** [AI Gateway → OpenAI provider](/ai-gateway/providers/openai). Direct
  OpenAI API traffic flows through the gateway data plane; OpenAI Enterprise Compliance
  API exports are a separate bulk feed routed through this ingestion source.
</Info>
