...
This page documents the configuration contract so admins can pre-stage IAM trust policies and bucket access; the matching adapter is on the [roadmap](/ai-governance/ingestion-sources/index#adapter-roadmap).
