...
![/me Trace Ingest section — 4 tiles populated](/images/ai-governance/ingestion-templates/me-trace-ingest-tile-grid.png)
...
![Install drawer — Connect Claude Code](/images/ai-governance/ingestion-templates/me-install-drawer-claude-code.png)
...
![/me/traces — Claude Code traces with tokens + model populated](/images/ai-governance/ingestion-templates/me-traces-claude-code-trace-detail.png)
...
![Personal OTLP Endpoint panel on /me/settings](/images/ai-governance/ingestion-templates/me-settings-personal-otlp-panel.png)
