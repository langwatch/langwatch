...
Per-template rituals live at `platform/app/ee/governance/ingestion-templates/<slug>/dogfood.md`.
...
`platform/app/e2e/admin-ottl-dogfood.ts` (~30s loop), 8 steps end-to-end:
...
`platform/app/ee/governance/services/__tests__/ingestionTemplate.authoring.integration.test.ts`
