...
By default, *other users' Personal Workspaces are invisible to you*, outside the admin-only surfaces listed at the end of this section. The privacy contract is enforced at four layers:
