...
The chrome's [Workspace Switcher](#workspace-switcher) shows you the workspaces you can see; the [admin catalog](/ai-governance/personal-portal/admin-catalog) at `/governance/tool-catalog` controls which ones developers see entries for.
