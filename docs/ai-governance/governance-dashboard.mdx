...
<Info>**Pairs with:** [Control plane & integration tiers](/ai-governance/control-plane) for the surface map, [Anomaly rules](/ai-governance/anomaly-rules) for what populates the anomalies strip, and [Cost centers](/ai-governance/cost-centers) for how the **Spend by cost center** card attributes spend across the org.</Info>
