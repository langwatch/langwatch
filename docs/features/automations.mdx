...
<Frame>
  <img className="block" src="/images/automation-screenshot-button.png" alt="LangWatch" />
</Frame>

**Automation actions**

<Frame>
  <img className="block" src="/images/trigger-screenshot-drawer.png" alt="LangWatch" />
</Frame>
...
<Frame>
  <img className="block" src="/images/trigger-screenshot-settings.png" alt="LangWatch" />
</Frame>
