...
1) Click the message you want to annotate on and a [Trace](/concepts#traces-one-task-end-to-end) details drawer will open.
...
Once you’ve completed the final item in the queue, you’ll see that all tasks are done.
...
You can now annotate messages and add your custom score metrics to them.
