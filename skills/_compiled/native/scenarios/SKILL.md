...
Steps 2 and 4 are questions **for the user**. Ask them in the same reply that reports the created scenario (its name, its id and the proposed target), so one answer starts the run. Wait for the answer and do not guess.
