  ...
  it.skipIf(isCI)(
    ...
    async () => {
      ...
      fs.writeFileSync(
        ...
        [
          `LANGWATCH_ORG_API_KEY=${process.env.LANGWATCH_ORG_API_KEY ?? ""}`,
...
export $(grep LANGWATCH_ORG_API_KEY .env)
...
First: \`export PATH="./bin:$PATH" && export $(grep LANGWATCH_ORG_API_KEY .env)\`
