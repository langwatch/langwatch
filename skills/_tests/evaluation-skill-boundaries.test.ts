...
describe("evaluation skill boundaries", () => {
  ...
  it("keeps experiments focused on batch testing", () => {
    ...
    expect(source).toContain("npx skills@1.5.19 add langwatch/skills/online-evaluations");
  ...
  it("keeps online evaluations focused on production traffic", () => {
    ...
    expect(source).toContain("npx skills@1.5.19 add langwatch/skills/experiments");
