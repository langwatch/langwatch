...
| Getting "Cannot find module '.prisma/client/index'" errors | Run `pnpm prisma:generate:typescript` in the `langwatch/` directory to regenerate Prisma types. This is needed after fresh clones, worktree creation, or any schema changes |
