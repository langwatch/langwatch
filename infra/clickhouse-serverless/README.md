...
| --------------------------------- | ------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `CLICKHOUSE_PASSWORD`             | _(required)_ | Default user password (or `CLICKHOUSE_PASSWORD_FILE`)                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
[ADR-159](../../dev/docs/adr/159-the-app-owns-the-lwql-access-model.md)):
