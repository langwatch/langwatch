...
const SERVICE = "modules/agent/process/src/services/agent-presence.service.ts";
const TEST = "modules/agent/process/src/services/__tests__/agent-presence.unit.test.ts";
