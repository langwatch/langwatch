...
<<<<<<< HEAD:packages/clickhouse-client/src/tasks/ttl.reconciler.ts
...
>>>>>>> origin/main:platform/app/src/server/clickhouse/ttlReconciler.ts
...
<<<<<<< HEAD:packages/clickhouse-client/src/tasks/ttl.reconciler.ts
      ...
      const retentionMissing = isManaged && retentionTTLExpr && !hasRetentionTTL(engineFull);
=======
...
<<<<<<< HEAD:packages/clickhouse-client/src/tasks/ttl.reconciler.ts
      ...
      const ttlClauses = [coldTTLExpr, isManaged && retentionTTLExpr ? retentionTTLExpr : null]
=======
