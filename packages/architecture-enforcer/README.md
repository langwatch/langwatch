...
@langwatch/architecture-enforcer lint` checks the workspace; the report is described
...
- `expires` — optional review date. Two policies refuse a row past it; the rest
  ...
  `dev/docs/plans/architecture-enforcer-review-2026-09-08.md`, and it is one field
