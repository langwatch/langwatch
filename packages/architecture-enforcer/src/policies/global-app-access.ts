...
const BASELINE_PATH = "packages/architecture-enforcer/src/global-app-access-baseline.json";
// The global accessor the rule forbids. Both the file and the alias belonged
// to the deleted platform application and resolve to nothing now — kept as
// STRINGS so a reintroduction under either name is caught the moment it lands.
