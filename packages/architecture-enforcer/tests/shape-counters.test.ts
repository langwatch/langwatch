...
const PORTS_BASELINE = "packages/architecture-enforcer/src/ports-and-adapters-folders-baseline.json";
const DOORS_BASELINE = "packages/architecture-enforcer/src/rest-door-without-mount-baseline.json";
const MOUNT_BASELINE = "packages/architecture-enforcer/src/mount-file-is-one-call-baseline.json";
const BUDGET_FILE = "packages/architecture-enforcer/src/composition-root-line-budget.json";
