...
tester.run("package-boundaries", plugin.rules["package-boundaries"], {
  valid: [
    ...
    },
    {
      ...
      code: 'import { AgentMigration } from "@langwatch/agent-process"; export { AgentMigration };',
    },
    {
    ...
    },
    {
      ...
      code: 'import { GovernanceService } from "@langwatch/enterprise-governance-process"; export { GovernanceService };',
    },
    {
    ...
    {
      filename: "modules/project/process/tests/agent.integration.test.ts",
      code: 'import { fixture } from "@langwatch/agent-process/testing"; export { fixture };',
    },
  ],
  invalid: [
    {
    ...
    {
      filename: "modules/agent/process/src/services/example.ts",
      code: 'import type { PrismaClient } from "@prisma/client"; export type Db = PrismaClient;',
    ...
    {
      filename: "modules/agent/process/src/api/internal/agent.api.ts",
...
tester.run("feature-module-classes", plugin.rules["feature-module-classes"], {
  valid: [
    ...
    {
      filename: "modules/agent/process/src/repositories/agent.repository.ts",
      code: "export abstract class AgentRepository {}",
    },
    {
      filename: "modules/api-key/process/src/ports/credential.port.ts",
      code: "export type CredentialId = string; export abstract class CredentialPort { abstract load(id: CredentialId): Promise<void>; }",
    },
    {
      filename: "modules/automation/process/src/ports/automation-graph.port.ts",
      code: "export abstract class AutomationGraphNotifierPort { abstract dispatch(): Promise<void>; }",
    },
    {
      filename: "modules/agent/process/src/repositories/prisma/prisma.agent.repository.ts",
  ...
  invalid: [
    ...
    {
      filename: "modules/agent/process/src/projections/agent.projection.ts",
...
tester.run("service-dependencies", plugin.rules["service-dependencies"], {
  valid: [
    ...
    {
      filename: "modules/organization/process/src/services/organization.service.ts",
  ...
  invalid: [
    ...
    {
      filename: "modules/organization/process/src/services/organization.service.ts",
      code: 'import type { ProjectRepository } from "@langwatch/project-process"; export class OrganizationService {}',
      errors: [{ messageId: "foreignRepository" }],
    },
    {
      filename: "apps/api/src/services/organization.service.ts",
...
tester.run("boolean-wall", plugin.rules["boolean-wall"], {
  valid: [
    {
      filename: "packages/architecture-enforcer/src/feature-catalogue.ts",
...
tester.run("awaited-return-chain", plugin.rules["awaited-return-chain"], {
  valid: [
    {
      filename: "modules/api-key/process/src/services/api-key.service.ts",
...
tester.run("package-boundaries: portable contracts", plugin.rules["package-boundaries"], {
  ...
  invalid: [
    ...
    {
      filename: "modules/agent/contract/src/agent.service.ts",
      code: 'import { AgentCard } from "@langwatch/agent-browser/screens/agent-management"; export { AgentCard };',
      errors: [{ messageId: "contractRuntime" }],
    },
  ],
});
...
tester.run("package-boundaries: web feature surfaces", plugin.rules["package-boundaries"], {
  valid: [
    {
      filename: "modules/prompt/browser/src/ui/elements/browser-panel.tsx",
      code: 'import { BrowserPort } from "@langwatch/agent-browser/surfaces/browser-port"; export { BrowserPort };',
    },
    {
      filename: "enterprise/modules/billing/browser/src/ui/elements/scope-row.tsx",
      code: 'import { ScopePicker } from "@langwatch/authz-browser/surfaces/scope-picker"; export { ScopePicker };',
    },
    {
      filename: "apps/ui/src/routes/agents.tsx",
      code: 'import { AgentManagementScreen } from "@langwatch/agent-browser/screens/agent-management"; export { AgentManagementScreen };',
    },
  ],
  invalid: [
    {
      filename: "modules/prompt/browser/src/ui/elements/briefing.tsx",
      code: 'import { Langy } from "@langwatch/langy-browser"; export { Langy };',
      errors: [{ messageId: "crossFeature" }],
    },
    {
      filename: "modules/prompt/browser/src/ui/elements/briefing.tsx",
      code: 'import { TraceDrawers } from "@langwatch/trace-browser/drawers"; export { TraceDrawers };',
      errors: [{ messageId: "crossFeature" }],
    },
    {
      filename: "modules/prompt/browser/src/ui/elements/agents.tsx",
      code: 'import { AgentManagementScreen } from "@langwatch/agent-browser/screens/agent-management"; export { AgentManagementScreen };',
      errors: [{ messageId: "crossFeature" }],
    },
  ],
...
tester.run("package-boundaries: web test seam", plugin.rules["package-boundaries"], {
  valid: [
    {
      filename:
        "modules/scenario/browser/src/behavior/suites/__tests__/cancel-button.integration.test.tsx",
      code: 'import { makeScenarioRunData } from "@langwatch/suite-browser/testing"; export { makeScenarioRunData };',
    },
    {
  ...
  invalid: [
    {
      filename: "modules/scenario/browser/src/behavior/suites/run-history.ts",
      code: 'import { makeScenarioRunData } from "@langwatch/suite-browser/testing"; export { makeScenarioRunData };',
      errors: [{ messageId: "crossFeature" }],
    },
  ],
...
tester.run("feature-source-layout", plugin.rules["feature-source-layout"], {
  valid: [
    ...
    {
      filename: "modules/project/process/src/transport/api-rest/project.api.ts",
      code: "export const value = 1;",
    },
    {
  ...
  invalid: [
    ...
    {
      filename: "modules/project/process/src/helpers/project-helper.ts",
      code: "export const value = 1;",
      errors: [{ messageId: "serverPath" }],
    },
    {
      // A test outside a `__tests__` directory is still a server source path.
      filename: "modules/project/process/src/services/project.service.unit.test.ts",
      code: "export const covered = true;",
      errors: [{ messageId: "serverPath" }],
    },
    {
      filename: "modules/project/process/src/repositories/prisma/prisma.project.extra.repository.ts",
      code: "export const value = 1;",
      errors: [{ messageId: "serverPath" }],
    },
    {
...
tester.run("feature-source-subject", plugin.rules["feature-source-subject"], {
  ...
  invalid: [
    ...
    {
      filename: "modules/evaluator/process/src/adapters/prisma.audit-log.adapter.ts",
      code: "export const value = 1;",
      errors: [{ messageId: "foreignSubject" }],
    },
  ],
...
tester.run("prisma-containment", plugin.rules["prisma-containment"], {
  valid: [
    ...
    {
      filename: "modules/project/process/src/adapters/postgres.project.adapter.ts",
      code: "import { PrismaClient } from '@langwatch/prisma-client/generated'; export type Db = PrismaClient;",
    },
    {
      filename: "apps/api/src/app/api-production.composition.ts",
...
tester.run("typed-prisma-seam", plugin.rules["typed-prisma-seam"], {
  valid: [
    ...
    },
    {
      ...
      filename: "modules/automation/process/src/adapters/postgres.automation.adapter.ts",
      code: "export const db = client as PrismaClient;",
    },
  ],
  invalid: [
...
tester.run("no-raw-hono-mount", plugin.rules["no-raw-hono-mount"], {
  valid: [
    ...
    },
    {
      ...
      filename: "modules/monitor/process/src/app/__tests__/monitor.transport.unit.test.ts",
...
tester.run("layer-class", plugin.rules["layer-class"], {
  ...
  e(input: In): Out { return this.repository.e(input); }
    ...
    {
      filename: "modules/project/process/src/app/example.app.ts",
  ...
  e(input: In): Out { return this.deps.example.e(input); }
    ...
    {
      filename: "modules/project/process/src/repositories/routed/routed.example.repository.ts",
