...
`@langwatch/architecture-enforcer`. Root lint runs the Oxlint source rules first,
then the deterministic workspace CLI.

The CLI admits at most two architecture-enforcer runs per machine, across worktrees
