...
export const SELECT_MIGRATION_ROUTE_COMMAND_TYPE =
  "lw.identity.select_migration_route" as const;
export const BEGIN_MIGRATION_FINALIZATION_COMMAND_TYPE =
  "lw.identity.begin_migration_finalization" as const;
export const FINALIZE_MIGRATION_COMMAND_TYPE =
  "lw.identity.finalize_migration" as const;
...
export const registerReplacementConnectionCommandDataSchema =
  commandDataSchema({
    type: ssoConnectionTypeSchema,
    idp: ssoIdpMetadataSchema,
    arrivalPolicy: ssoArrivalPolicySchema,
...
export type SelectMigrationRouteCommandData = z.infer<
  typeof selectMigrationRouteCommandDataSchema
>;

export const beginMigrationFinalizationCommandDataSchema =
  commandDataSchema({});
...
export type FinalizeMigrationCommandData = z.infer<
  typeof finalizeMigrationCommandDataSchema
>;
