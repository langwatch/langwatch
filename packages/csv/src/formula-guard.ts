 ...
 *
 * It lives in its own framework-free package because the rule had been written
 * twice independently and bypassed seven times. Server-side serializers import
 * it as readily as browser-side ones; nothing in this file touches the DOM.
 */
