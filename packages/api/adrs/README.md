...
- [RPC and REST share one fluent handler contract](./001-rpc-first-fluent-registration.md) (the RPC half is withdrawn)
...
- [HEAD is answered from GET](./007-head-is-answered-from-get.md)
