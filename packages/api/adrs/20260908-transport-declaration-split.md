...
whole thing again by hand — `modules/annotation/browser/src/behavior/annotation-api.ts`
...
`modules/annotation/process/src/transport/__tests__/annotation.trpc.declaration.unit.test.ts`,
