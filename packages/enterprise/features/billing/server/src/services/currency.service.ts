 ...
 */
const getClientIp = (req: CurrencyRequest | undefined): string | null => {
 ...
 */
const detectCurrencyFromRequest = (
  req: CurrencyRequest | undefined,
): { currency: CurrencyType; country: string | null } => {
...
export class CurrencyService {
  ...
  detect(request: CurrencyRequest | undefined): {
    ...
    return detectCurrencyFromRequest(request);
  }
}
