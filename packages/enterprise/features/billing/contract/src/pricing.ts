...
export function getGrowthSeatPriceCents(
  ...
  return {
    [Currency.EUR]: {
      ...
      annual: getUnitAmountCents("GROWTH_SEAT_EUR_ANNUAL", prices),
    },
    [Currency.USD]: {
      monthly: getUnitAmountCents("GROWTH_SEAT_USD_MONTHLY", prices),
      annual: getUnitAmountCents("GROWTH_SEAT_USD_ANNUAL", prices),
    },
  };
}
