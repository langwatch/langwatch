/**
 * Relative time, as the ingestion-source pages say it.
 *
 * A family-local copy of `platform/app/src/utils/formatTimeAgo.ts`, trimmed to
 * the one export the governance screens call. The platform module keeps the
 * rest for its own callers and dies with them.
 */
