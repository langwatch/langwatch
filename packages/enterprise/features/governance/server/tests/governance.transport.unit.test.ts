...
import { GovernanceApp, type GovernancePersonalVirtualKeyPorts } from "../src/app/governance.app";
import { createGovernanceRestApp } from "../src/transport/api-rest/governance.api";
