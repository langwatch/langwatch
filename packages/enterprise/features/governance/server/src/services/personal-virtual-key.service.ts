import {
  ...
  type GovernanceRoutingPolicyService,
...
export class DefaultGovernancePersonalVirtualKeyService extends GovernancePersonalVirtualKeyService {
  private constructor(
    private readonly repository: PersonalVirtualKeyRepository,
    private readonly issuer: PersonalVirtualKeyIssuerPort,
    private readonly organizations: OrganizationService,
    private readonly policies: GovernanceRoutingPolicyService,
  ...
  async issue(
    ...
    } else if (parsed.routingPolicyId === undefined) {
    ...
    if (
      parsed.routingPolicyId &&
      (!policy || policy.organizationId !== parsed.organizationId)
    ) {
