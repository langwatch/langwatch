...
export type ConfigureIngestionPullCommand = z.infer<
  typeof configureIngestionPullCommandSchema
>;
export type DisableIngestionPullCommand = z.infer<
  typeof disableIngestionPullCommandSchema
>;
