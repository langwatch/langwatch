 ...
 * organization has — see the class docblock, and the SCIM provisioning
 * service for the same note where the membership facts are stamped.
 */
...
export class ScimSyncLifecycle extends ScimSyncLifecyclePort {
  ...
  private async commit(command: ScimSyncCommand, facts: ScimSyncFactInput[]): Promise<void> {
