# Group Queue architecture decisions

These decisions define the reusable Group Queue framework:

- [Group Queue framework boundary](./20260820-group-queue-framework-boundary.md)
- [Redis Cluster hash tags](./006-redis-cluster-hash-tags.md)
- [Canonical payload envelope](./026-canonical-payload-envelope.md)
