...
export async function assertCanManageAllScopes(ctx: RBACContext, scopes: Scope[]): Promise<void> {
...
export function isVisibleToMembership(membership: MembershipSet, scopes: Scope[]): boolean {
