...
import { GatewayAuditAdapter } from "./gateway-audit.repository";
import { serializeRowForAudit } from "../gatewayAuditSerializer";
import type {
  BudgetBucketBoundary,
  GatewayBudgetClickHouseRepository,
} from "../gateway-budget-clickhouse.repository";
import { budgetPeriodFloorMs } from "../gatewayPeriod";
import {
  attributedUserBucketScopeId,
  bucketScopeIdFor,
  budgetAppliesToProvider,
  resolveApplicableBudgets,
} from "../gatewayResolution";
import {
...
import { identityPatchData, type ResourceMetadata } from "../gatewayResourceMetadata";
import {
  type BudgetScopeTargetInfo,
  resolveScopeTargetsBatch,
  scopeTargetKey,
} from "../gatewayScopeTargets";
import { organizationSpendTenantIds } from "../gatewaySpendTenants";
import { usdToNanoUsd } from "../gatewayWireMoney";
import { keysetAfter } from "../gatewayWirePagination";
...
export class PrismaGatewayBudgetRepository {
  constructor(
  ...
  private async assertScopeIsReachable(
    ...
    throw new GatewayBudgetScopeUnreachableError({
      scopeType: PrismaGatewayBudgetRepository.REACH_CHECKED_SCOPE_NAMES[kind],
