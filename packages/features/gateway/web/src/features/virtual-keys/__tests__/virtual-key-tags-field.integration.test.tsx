...
/** An organization with nothing in it: the tags field cares about none of it. */
...
describe("given the New virtual key drawer is open", () => {
  ...
  describe("when the Tags label's information icon is opened", () => {
    ...
    it("links out to the cache-rules docs", async () => {
      ...
      // Found through the popover it belongs to rather than by role. An open
      // drawer marks everything outside itself `aria-hidden`, and the popover
      // portals to the document body, so every one of the form's docs links
      // reads as inaccessible to a role query. Scoping to this popover is also
