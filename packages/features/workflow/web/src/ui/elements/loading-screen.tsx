/**
 * A FAMILY-LOCAL COPY of `platform/app/src/components/LoadingScreen.tsx`,
 * which thirteen platform modules early-return and deletes-only forbids
 * repointing. Copied whole, including the ghost-on-unmount dissolve: the chat
 * address is a full-page wait with nothing else on the screen, so the way it
 * leaves is the whole of what a reader sees happen.
 */
