...
export const RESULTS_VIEW_PARAMS = ["groupBy", "scenarios", "labels", "targets", "status"] as const;
...
export function writeResultsViewQuery({
  ...
  if (filters.scenarioIds.length) query.scenarios = filters.scenarioIds.join(",");
