...
export function ConnectedAgentDrawer(props: ConnectedAgentDrawerProps) {
  ...
  return (
    <Drawer.Root open={true} onOpenChange={({ open }) => !open && closeDrawer()}>
      <Drawer.Content bg="bg">
        ...
        <Drawer.Footer>
          <HStack width="full">
            <Spacer />
            <Button colorPalette="blue" onClick={closeDrawer} data-testid="connected-agent-close">
              Close
            </Button>
          </HStack>
        </Drawer.Footer>
...
function AgentTitle({ agent }: { agent: ConnectedAgentView | null | undefined }) {
  return (
