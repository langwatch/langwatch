...
import { useScenarioTarget } from "../../hooks/use-scenario-target";
...
import { CaseVersionChip } from "../agent-testing/shared/case-version-chip";
...
import { hasScenarioInputMapping } from "../suites/scenario-input-mapping-section";
