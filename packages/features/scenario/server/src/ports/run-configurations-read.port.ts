 ...
 *
 * The cap applies AFTER the store has already folded runs into distinct
...
/**
 * One configuration as the store folds it, before the plan row is joined.
 *
 ...
 *
 * A sibling of {@link ResultAtomsReadPort} rather than a method on it: the
 * atom reads answer "what happened", this one answers "what was it asked to
 * do".
 */
