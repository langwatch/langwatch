...
export function ScoreChip({
  ...
  const [draftSelection, setDraftSelection] = useState<string[]>(() => toSelection(value));
  ...
  return (
    ...
    >
      ...
      <Popover.Content width="240px" bg="bg.panel/92" onClick={(e) => e.stopPropagation()}>
...
function ScoreOptionList({
  ...
  if (isMulti) {
    return (
      <CheckboxGroup value={selection} onValueChange={(next: string[]) => onSelectionChange(next)}>
