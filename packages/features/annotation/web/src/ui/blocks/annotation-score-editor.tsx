...
export function AnnotationScoreEditor({
  ...
  const scoreTypeHelper = scoreTypeHelperText({ isOption, isCheckbox });
  ...
  return (
    <VStack gap={2} align="start">
      ...
      <EditorField label="Score Type" helper={scoreTypeHelper} invalid={!!dataTypeError}>
        <HStack width="full">
