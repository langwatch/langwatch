 ...
 */
export class PostgresAnnotationBackfillAdapter extends AnnotationBackfillSourcePort {
  private constructor(private readonly prisma: PrismaClient) {
    super();
  }

  static create({ prisma }: { prisma: PrismaClient }): PostgresAnnotationBackfillAdapter {
    return new PostgresAnnotationBackfillAdapter(prisma);
  }
