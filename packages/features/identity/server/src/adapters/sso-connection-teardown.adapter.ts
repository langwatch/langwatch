/**
 * The directory side of a teardown, narrowed to the one call this makes. The
 * SCIM service that satisfies it is ENTERPRISE; identity is core and may not
 * depend on it, so what the wake needs is stated here and the composition
 * binds the enterprise service to it.
 */
