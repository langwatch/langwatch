...
export abstract class EvaluationService {
  ...
  abstract findRunsByTraceId(input: EvaluationRunsByTraceQuery): Promise<EvaluationRunData[]>;
  ...
  abstract tryGetInputs(input: EvaluationInputsQuery): Promise<Record<string, unknown> | null>;
