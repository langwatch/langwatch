...
export class EvaluationThreadMappingService {
  static create(): EvaluationThreadMappingService {
    return new EvaluationThreadMappingService();
  }

  /**
   * Check if any mapping in the state has type "thread".
   */
  static hasThreadMappings(mappingState: MappingState | null): boolean {
