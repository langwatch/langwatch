import type { CreateSuiteCommand, Suite, SuiteIdInput, UpdateSuiteCommand } from "@langwatch/suite-contract";
...
export abstract class SuiteRepository {
  ...
  abstract archive(input: SuiteIdInput & { archivedAt: Date; archivedSlug: string }): Promise<Suite>;
}
