...
import { api, type RouterOutputs } from "@langwatch/workflow-web/studio-host/api";
import { useSearchParams } from "@langwatch/workflow-web/utils/compat/next-navigation";
...
import { useDraggableTabsBrowserStore } from "../prompt-playground-store/draggable-tabs-browser-store";
