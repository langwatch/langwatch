...
export function RuntimeParametersField() {
  ...
  const lastRecordJsonRef = useRef(JSON.stringify((parameters as Record<string, unknown>) ?? {}));
  ...
  return (
    <VStack align="stretch" gap={3} width="full">
      <HStack width="full">
        ...
        <Spacer />
        <Button size="xs" variant="outline" onClick={handleAdd} data-testid="add-parameter-button">
          <Plus size={14} />
          Add
        </Button>
      </HStack>
