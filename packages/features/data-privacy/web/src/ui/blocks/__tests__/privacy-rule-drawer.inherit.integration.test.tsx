...
function baseline(
  categoryDispositions: Partial<Record<keyof ResolvedDataPrivacy["categories"], Disposition>> = {},
): ResolvedDataPrivacy {
...
describe("PrivacyRuleDrawer inherit controls", () => {
  ...
  describe("when adding a rule at the organization scope", () => {
    ...
    it("shows every inheriting control resolving to the platform default", () => {
      ...
      expect(screen.getByRole("radio", { name: /Inherit.*Essential/ })).toBeInTheDocument();
