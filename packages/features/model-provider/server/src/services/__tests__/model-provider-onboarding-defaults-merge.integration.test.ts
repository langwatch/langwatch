...
describe.skipIf(!DB_URL)("ModelProviderOnboardingDefaultsService.seed merge (real Postgres)", () => {
  ...
  const onboardingDefaults = ModelProviderOnboardingDefaultsService.create({ defaults, ids: idService, scopes });
