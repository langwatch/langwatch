...
export const modelProviderScopeSchema = z.object({
...
export const modelProviderSummarySchema = modelProviderSchema.extend({
...
export const modelProviderTenantInputSchema = z.object({
  projectId: z.string().min(1).optional(),
  organizationId: z.string().min(1).optional(),
}).strict().refine((value) => Boolean(value.projectId || value.organizationId), {
...
export const modelProviderWriteInputSchema = modelProviderTenantInputSchema.extend({
  ...
  extraHeaders: z.array(z.object({ key: z.string(), value: z.string() }).strict()).nullable().optional(),
  routingHandle: z.string().max(32).regex(/^[a-z0-9][a-z0-9_-]*$/).nullable().optional(),
...
export const modelProviderDeleteInputSchema = modelProviderTenantInputSchema.extend({
  id: z.string().min(1).optional(),
  provider: z.string().min(1),
}).strict();
export type ModelProviderDeleteInput = z.infer<typeof modelProviderDeleteInputSchema>;

export const modelProviderListProjectInputSchema = z.object({ projectId: z.string().min(1) }).strict();
export type ModelProviderListProjectInput = z.infer<typeof modelProviderListProjectInputSchema>;
export const modelDefaultSnapshotInputSchema = z.object({ projectId: z.string().min(1), actorId: z.string().min(1).optional() }).strict();
export type ModelDefaultSnapshotInput = z.infer<typeof modelDefaultSnapshotInputSchema>;
export const modelProviderListOrganizationInputSchema = z.object({ organizationId: z.string().min(1) }).strict();
export type ModelProviderListOrganizationInput = z.infer<typeof modelProviderListOrganizationInputSchema>;

export const modelProviderTestConnectionInputSchema = modelProviderTenantInputSchema.extend({
  modelProviderId: z.string().min(1),
}).strict();
export type ModelProviderTestConnectionInput = z.infer<typeof modelProviderTestConnectionInputSchema>;

export const modelProviderCodexStatusInputSchema = z.object({
...
export const modelProviderApiKeyValidationInputSchema = modelProviderTenantInputSchema.extend({
  provider: z.string().min(1),
  customKeys: providerCredentialSchema,
}).strict();
export type ModelProviderApiKeyValidationInput = z.infer<typeof modelProviderApiKeyValidationInputSchema>;

export const modelProviderApiKeyValidationSchema = z.object({ valid: z.boolean(), message: z.string().optional() }).strict();
...
export const modelDefaultConfigSchema = z.object({
  id: z.string().min(1),
...
export const modelDefaultEffectiveSchema = z.object({
...
export const modelDefaultConfigSnapshotSchema = z.object({
  id: z.string().min(1), config: z.record(z.string(), z.string()),
  createdAt: z.date(), updatedAt: z.date(), authorId: z.string().nullable(),
  scopes: z.array(z.object({
    type: modelProviderScopeTypeSchema, id: z.string().min(1), name: z.string(),
  }).strict()),
}).strict();
export type ModelDefaultConfigSnapshot = z.infer<typeof modelDefaultConfigSnapshotSchema>;

export const modelDefaultAvailableScopesSchema = z.object({
...
export const modelDefaultFeatureSchema = z.object({
  key: z.string(), role: z.enum(["DEFAULT", "FAST", "LANGY", "EMBEDDINGS"]),
  displayName: z.string(), description: z.string(),
}).strict();
export type ModelDefaultFeature = z.infer<typeof modelDefaultFeatureSchema>;

export const modelDefaultSnapshotSchema = z.object({
  projectId: z.string(), teamId: z.string().nullable(),
  organizationId: z.string().nullable(), organizationName: z.string().nullable(),
...
export const modelDefaultResolveInputSchema = z.object({ projectId: z.string().min(1), featureKey: z.string().min(1) }).strict();
export type ModelDefaultResolveInput = z.infer<typeof modelDefaultResolveInputSchema>;
export const modelDefaultAssignmentInputSchema = z.object({
...
export const modelDefaultConfigWriteInputSchema = z.object({
  id: z.string().min(1).optional(),
...
export const modelDefaultDeleteInputSchema = z.object({ id: z.string().min(1), actorId: z.string().min(1).optional() }).strict();
export type ModelDefaultDeleteInput = z.infer<typeof modelDefaultDeleteInputSchema>;

export const modelDefaultInheritedValuesSchema = z.object({
...
export const modelCostSchema = z.object({
  ...
  scopeType: modelProviderScopeTypeSchema, scopeId: z.string().min(1),
  model: z.string().min(1), regex: z.string().min(1),
  inputCostPerToken: z.number().nullable(), outputCostPerToken: z.number().nullable(),
  cacheReadCostPerToken: z.number().nullable(), cacheCreationCostPerToken: z.number().nullable(),
  cacheCreation1hCostPerToken: z.number().nullable(), createdAt: z.date(), updatedAt: z.date(),
}).strict();
export type ModelCost = z.infer<typeof modelCostSchema>;

/** A catalog rate used to price one observed model invocation. */
export const modelCostRateSchema = z.object({
  model: z.string(),
  regex: z.string(),
...
export const modelCostEstimateInputSchema = z.object({
...
export const modelCostWriteInputSchema = z.object({
  id: z.string().min(1).optional(), projectId: z.string().min(1),
  actorId: z.string().min(1).optional(),
  scopeType: modelProviderScopeTypeSchema.optional(), scopeId: z.string().min(1).optional(),
  model: z.string().min(1), regex: z.string().min(1),
  inputCostPerToken: z.number().nullable().optional(), outputCostPerToken: z.number().nullable().optional(),
  cacheReadCostPerToken: z.number().nullable().optional(), cacheCreationCostPerToken: z.number().nullable().optional(),
...
export const modelCostDeleteInputSchema = z.object({ projectId: z.string().min(1), id: z.string().min(1), actorId: z.string().min(1).optional() }).strict();
export type ModelCostDeleteInput = z.infer<typeof modelCostDeleteInputSchema>;

export const translateInputSchema = z.object({ projectId: z.string().min(1), text: z.string().max(100_000) }).strict();
