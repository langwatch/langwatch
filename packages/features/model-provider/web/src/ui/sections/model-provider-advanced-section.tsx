          ...
          {!modelProviderId ? (
            ...
            <VStack align="start" width="full" gap={3} paddingTop={2}>
              ...
              <Field.Root>
                ...
                />
                <Field.HelperText>
                  Order used when a Virtual Key has no Routing Policy. Lower tries first. Tiebreak
                  by creation order.
                </Field.HelperText>
              </Field.Root>
              ...
              <Field.Root>
                ...
                {jsonError ? (
                  ...
                  <Field.HelperText>
                    Provider-specific routing hints. Bedrock region, Azure deployment override, etc.
                  </Field.HelperText>
                )}
              </Field.Root>
