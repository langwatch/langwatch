...
import { ReportScheduleField } from "../src/authoring/report-schedule-field";
...
vi.mock("../src/logic/report-schedule", async (importOriginal) => {
  const actual = await importOriginal<typeof import("../src/logic/report-schedule")>();
