...
export abstract class DataRetentionService {
  ...
  abstract getRetentionDays(input: { projectId: string; category: RetentionCategory }): Promise<number>;
  ...
  abstract removeForScope(input: { scope: ScopeAssignment; category: RetentionCategory }): Promise<void>;
}
