...
/**
 * The real LangWatchQL validator with no executor. Validation needs no
...
describe("SavedWorkbenchChartPolicyService", () => {
  ...
  it("names a duplicate id on the established 409 envelope", () => {
    expect(new SavedWorkbenchChartAlreadyExistsError()).toMatchObject({
