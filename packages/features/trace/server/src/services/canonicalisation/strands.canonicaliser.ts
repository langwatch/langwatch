...
import { extractOutputMessages, recordValueType } from "../canonical-extraction.rules";
import { isRecord, safeJsonParse } from "../canonical-guard.rules";
import {
...
export class StrandsCanonicaliser implements CanonicalAttributesPort {
  readonly id = "strands";
