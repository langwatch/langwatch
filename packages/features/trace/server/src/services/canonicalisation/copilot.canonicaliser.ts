...
export class CopilotCanonicaliser implements CanonicalAttributesPort {
  readonly id = "copilot";
  ...
  apply(ctx: ExtractorContext): void {
    ...
    const spanType = typeof operation === "string" ? OPERATION_TO_SPAN_TYPE[operation] : void 0;
    if (spanType !== void 0) {
  ...
  /**
   * GenAICanonicaliser runs before this one and lifts native gen_ai.usage.*
