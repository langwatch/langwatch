...
export class ClaudeCodeResponse {
   ...
   */
  static extractAssistantTextFromResponseBody(raw: unknown): string | null {
   ...
   */
  static extractSessionTitleFromResponseBody(raw: string): string | null {
    const text = ClaudeCodeResponse.extractAssistantTextFromResponseBody(raw);
    if (text === null) {
      return null;
    }
   ...
   */
  static extractCacheCreationTtlSplit(raw: unknown): {
   ...
   * @internal exported for unit testing
   */
  static extractAssistantOutputFromResponseBody(raw: unknown): string | null {
    const parsed = ClaudeCodeResponse.parseJsonBody(raw);
    if (parsed === null) {
      return null;
    }
