 ...
 */
export function mastraSpanTypeToCanonical(
  mastraType: unknown,
  isOrphan: boolean,
): string {
  if (isOrphan) {
 ...
 */
export function extractBodyFromModelStepInput(
  input: unknown,
 ...
 */
export function extractModelFromMetadata(attrs: {
 ...
 */
export function extractSystemPromptFromBody(
