 ...
 * Spec: packages/features/trace/specs/partial-trace-id-resolution.feature — an
...
import { AmbiguousTraceIdPrefixError, TraceService } from "../trace-legacy-read.service";
