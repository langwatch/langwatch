 ...
 * leaf to {@link TraceQueryTranslatorsAdapter}, which turns it into a predicate, with
 * {@link TraceQueryValuesAdapter} binding whatever values ride along. Free text is
