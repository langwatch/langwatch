...
import { SPAN_NAME_FACET } from "./trace-facet-span-name.clickhouse.adapter";
import { SPAN_STATUS_FACET } from "./trace-facet-span-status.clickhouse.adapter";
import type { CategoricalRead, RangeRead } from "./trace-query-evaluation.adapter";
