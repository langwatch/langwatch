...
import { recordValueType } from "../services/canonical-extraction.service";
...
} from "../services/mastra-value.service";
import type {
  CanonicalAttributesPort,
  ExtractorContext,
} from "../ports/canonical-attributes.port";

export class MastraCanonicalisationAdapter implements CanonicalAttributesPort {
  readonly id = "mastra";
  ...
  private mapSpanType(
    ...
    ctx.setAttr(
      ATTR_KEYS.SPAN_TYPE,
      mastraSpanTypeToCanonical(mastraType, isEvalModelStep),
    );
