...
// Copilot CLI's root invoke_agent span usage is the EXACT rollup of its chat
// children (1.0.79 wire: one turn emits chat=15560/153 AND
// invoke_agent=15560/153). The canonicaliser flags the rollup with
// langwatch.reserved.skip_token_accumulation so the fold counts the turn
// once — that fold behaviour is what this test pins.
