...
import { LangWatchCanonicalisationAdapter } from "../../../src/adapters/langwatch-canonicalisation.adapter";
import { createExtractorContext } from "./test-helpers";

describe("LangWatchCanonicalisationAdapter", () => {
  const extractor = new LangWatchCanonicalisationAdapter();
