...
import { FACET_REGISTRY } from "../src/adapters/trace-facet-registry.clickhouse.adapter";
import { SPAN_STATUS_FACET } from "../src/adapters/trace-facet-span-status.clickhouse.adapter";
