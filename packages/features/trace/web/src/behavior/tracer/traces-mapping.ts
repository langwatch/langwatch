...
import type { AnnotationWithUser as Annotation } from "@langwatch/annotation-web";
import { getSpanNameOrModel } from "../../model/trace";
import {
...
export const TRACE_MAPPINGS = {
  ...
  events: {
    ...
    mapping: (trace: TraceWithAnnotations, key: string, subkey: string) => {
      ...
      // `apps/ui` compiles this package under `noImplicitReturns`, and a
      // subkey naming neither namespace maps to nothing.
      return undefined;
    },
