      ...
      content={
        <VStack align="stretch" gap={1.5} minWidth="220px" maxWidth="320px">
          ...
          <Text textStyle="2xs" color="fg.muted" lineHeight="1.4">
            The OpenTelemetry library that produced these spans — useful to tell apart spans coming
            from different SDKs or auto-instrumentations within the same trace.
          </Text>
