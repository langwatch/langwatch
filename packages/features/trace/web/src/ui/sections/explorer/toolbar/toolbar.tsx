...
import { useIsNewAccount } from "../hooks/use-is-new-account";
import { useProjectHasTraces } from "../../../../behavior/explorer/use-project-has-traces";
import { useTourEntryPoints } from "../onboarding";
import { useTraceExplorerTourPreference } from "../onboarding/hooks/use-trace-explorer-tour-preference";
...
import { KeyboardShortcutsButton } from "./keyboard-shortcuts-button";
