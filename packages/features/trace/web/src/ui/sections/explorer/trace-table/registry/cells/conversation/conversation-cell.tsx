...
/**
 * The conversation's label, a button styled as a link that scopes the All lens to just
 * this conversation. It filters rather than navigates, so it is a button and not an
 * anchor.
 */
