...
/**
 * Whether the evaluator answered with a category and nothing else — a label, no numeric
 * score, no pass/fail. `langevals/llm_category` is the archetype: it classifies
 * ("resolved", "escalated") rather than judging.
 */
