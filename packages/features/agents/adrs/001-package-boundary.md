...
├── contract/                              # @langwatch/agents-contract
│   ├── package.json
│   ├── tsconfig.json
│   ├── src/
...
│   └── tests/
│
├── server/                                # @langwatch/agents-server
│   ├── package.json
│   ├── tsconfig.json
│   ├── src/
│   │   ├── services/
...
`@langwatch/agents-contract`. tRPC uses them for runtime input validation and
