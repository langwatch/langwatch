...
export { PresenceAvatarStack, type PresenceAvatarStackProps } from "./presence-avatar-stack";
...
export { TracePresenceAvatars, type TracePresenceAvatarsProps } from "./trace-presence-avatars";
export {
  usePresenceStore,
  selectPeerSessions,
  selectPeersOnTrace,
