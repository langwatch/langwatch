import { z } from "zod";
import { storedObjectIdSchema, storedObjectOperationIdSchema } from "./ids";
import {
...
export const storedObjectsCreateUploadInputSchema =
  storedObjectUploadMetadataSchema;
...
export function createStoredObjectsCreateUploadInputSchema(
  ...
  return createStoredObjectUploadMetadataSchema(maximumUploadBytes);
}
...
export const storedObjectsConfirmUploadInputSchema = z
  .object({ uploadToken: storedObjectUploadTokenSchema })
  .strict();
