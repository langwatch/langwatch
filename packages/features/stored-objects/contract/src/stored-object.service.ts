...
export interface CreateStoredObjectUploadInput extends StoredObjectsCreateUploadInput {
  projectId: StoredObjectProjectId;
}

export interface ConfirmStoredObjectUploadInput extends StoredObjectsConfirmUploadInput {
  projectId: StoredObjectProjectId;
}
...
export interface DeleteStoredObjectInput {
  projectId: StoredObjectProjectId;
  id: StoredObjectId;
  idempotencyKey: StoredObjectIdempotencyKey;
}
 ...
 */
export abstract class StoredObjectsService {
  ...
  abstract resolveDelivery(input: {
    projectId: StoredObjectProjectId;
    id: StoredObjectId;
    audience: StoredObjectDeliveryAudience;
