...
import { ClickHouseCanonicalLogRecordRepository } from "../src/repositories/clickhouse/clickhouse.canonical-log-record.repository";
import type { LogClickHouseClient } from "../src/repositories/clickhouse/clickhouse.canonical-log-record.repository";
