...
import { AzureDatasetStorageAdapter } from "../src/adapters/azure.dataset-storage.adapter";
import { S3DatasetStorageAdapter } from "../src/adapters/s3.dataset-storage.adapter";
import {
...
} from "../src/ports/dataset-storage.port";
