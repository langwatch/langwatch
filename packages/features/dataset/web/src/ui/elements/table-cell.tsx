...
export const TableCell = <TData extends DatasetTableRowData>({
  ...
  const { selectedCell, setSelectedCell, setEditingCell, toggleRowSelection } = useDatasetTable();
  ...
  const isSelected = selectedCell?.row === rowIndex && selectedCell?.columnId === columnId;
