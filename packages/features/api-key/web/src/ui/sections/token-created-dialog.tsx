...
export function TokenCreatedDialog({
  ...
  const basicBlob = newToken && activeProjectId ? btoa(`${activeProjectId}:${newToken}`) : "";
  ...
  const activeAssistant =
    CODE_ASSISTANTS.find((assistant) => assistant.key === assistantKey) ?? CODE_ASSISTANTS[0]!;
                      ...
                      <HStack
                        ...
                        onClick={() => {
                          void host.copyToClipboard({
                            ...
                            succeeded: {
                              title: "Copied",
                              description: `${ep.label} config path copied`,
                            },
                          });
                        }}
                      >
