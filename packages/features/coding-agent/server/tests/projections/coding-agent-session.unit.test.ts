...
import {
  ...
  MAX_SET,
} from "../../src/projections/coding-agent-session-state.projection";
import { CodingAgentSessionSpanProjection } from "../../src/projections/coding-agent-session-span.projection";
import {
...
} from "../../src/projections/coding-agent-session.projection";
