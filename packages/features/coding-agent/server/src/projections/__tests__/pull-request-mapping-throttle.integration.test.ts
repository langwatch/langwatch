...
const subscriber = buildTestCodingAgentProcessingPipeline(
  TestGithubService.create(),
...
async function stageMappingJob(payload: ReturnType<typeof payloadFor>, stagedJobId: string) {
