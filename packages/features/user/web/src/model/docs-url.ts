 ...
 *
 * The gateway and governance families carry the same copy. A third copy rather
 * than a shared module because no family owns the others, and the shared home
 * this wants is the Design System or a docs contract — a promotion, not a move.
 */
