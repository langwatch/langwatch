...
/**
 * Hidden SVG defining Langy's gradient paint server. Rendered once at the root of the
 * Langy tree.
 */
...
/**
 * The AI gradient as a surface wash — an oversized gradient drifting slowly behind an
 * affordance so a solid fill breathes.
 */
