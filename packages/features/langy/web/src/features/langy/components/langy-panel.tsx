...
import { useProjectReach } from "../../../components/home/use-project-reach";
...
import { useLangyConversationCommands } from "../data/use-langy-conversation-commands";
import { useLangyConversationList } from "../data/use-langy-conversation-list";
import { useLangyMessages } from "../data/use-langy-messages";
import { useLangyChatEngine } from "../hooks/use-langy-chat-engine";
import { useLangyExternalLinkGuard } from "../hooks/use-langy-external-link-guard";
import { useLangyFreshness } from "../hooks/use-langy-freshness";
import { useLangyPageContext } from "../hooks/use-langy-page-context";
import { useLangyStickToBottom } from "../hooks/use-langy-stick-to-bottom";
import { turnHadSideEffects, useLangyTurnRecovery } from "../hooks/use-langy-turn-recovery";
import { useLangyWarmWorker } from "../hooks/use-langy-warm-worker";
import { syncLangyAfterDefaultModelWrite } from "../logic/coding-default-sync";
import {
  createLangyChatTransport,
  type LangyTurnRequestContext,
} from "../logic/langy-chat-transport";
...
} from "../logic/langy-error-explainer";
import { type MakeDefaultWritePlan, makeDefaultOffer } from "../logic/langy-make-default-offer";
import { langyToolNarrator } from "../adapters/langy-tool-narrator.adapter";
import { buildTimeTravelView } from "../logic/langy-time-travel";
import { isInternalHref } from "../logic/spa-link";
import { tapeForConversation, useLangyDevLog } from "../stores/langy-dev-log";
...
import { LangyExternalLinkDialog } from "./langy-external-link-dialog";
import { LangyMakeDefaultDialog } from "./langy-make-default-dialog";
...
function LangyPanel({
  ...
  // from the recorded lanes and the durable history (see langy-time-travel.ts).
