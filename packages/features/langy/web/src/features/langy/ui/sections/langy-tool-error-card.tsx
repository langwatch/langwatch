...
function toolErrorTitle(presentation: LangyToolErrorPresentation): ReactNode {
  return (
...
function toolErrorActions(presentation: LangyToolErrorPresentation): ReactNode {
  return (
...
function toolErrorBody(presentation: LangyToolErrorPresentation): ReactNode {
  return (
...
export function LangyToolErrorCard({ presentation }: { presentation: LangyToolErrorPresentation }) {
  ...
  return (
    <LangyCard
      intent="change"
      role="alert"
      title={toolErrorTitle(presentation)}
      actions={hasActions ? toolErrorActions(presentation) : null}
    >
      {hasBody ? toolErrorBody(presentation) : null}
    </LangyCard>
  );
}
