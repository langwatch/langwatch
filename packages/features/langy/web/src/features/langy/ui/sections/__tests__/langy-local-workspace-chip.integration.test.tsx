...
describe("given a connected folder", () => {
  ...
  it("names the folder, and carries the machine and the branch", () => {
    ...
    expect(screen.getByTestId("langy-workspace-chip").getAttribute("title")).toBe(
      "/Users/rogerio/Projects/acme-app, on rogerio-mbp, branch main",
    );
  });
  ...
  it("asks before it ends the share, then ends it", () => {
    ...
    expect(
      screen.getByText("Disconnect this folder? Langy stops working on your machine."),
    ).toBeDefined();
