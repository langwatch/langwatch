import { abortableDelay } from "./langy-turn-settlement-waiter";
import type { LangyStreamEntry, LangyStreamRead } from "./langy-token-buffer";
import type { SettlementOutcome, TurnHealth } from "./langy-turn-settlement";
import { advanceSettlement, NO_SETTLEMENT_STREAKS } from "./langy-turn-settlement";
