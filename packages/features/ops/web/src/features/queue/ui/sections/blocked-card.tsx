  ...
  return (
    <>
              ...
              <HStack gap={1.5} flexWrap="wrap">
                ...
                <HStack gap={1}>
                  ...
                  <Input
                    ...
                    value={canaryCount}
                    onChange={(e) =>
                      setCanaryCount(Math.max(1, Math.min(100, parseInt(e.target.value) || 5)))
                    }
                    width="50px"
                  />
                  {queuesWithBlocked.map((q) => (
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          if (unblockAllTarget) unblockAllMutation.mutate({ queueName: unblockAllTarget });
        }}
        title="Unblock All"
      ...
      <ConfirmDialog
        ...
        onConfirm={() => {
          if (moveToDlqTarget) moveAllToDlqMutation.mutate({ queueName: moveToDlqTarget });
        }}
