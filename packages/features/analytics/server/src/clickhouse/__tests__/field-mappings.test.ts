...
describe("field-mappings", () => {
  describe("fieldMappings", () => {
    ...
    it("has mappings for metadata fields", () => {
      ...
      expect(fieldMappings["metadata.user_id"]?.column).toBe("Attributes['langwatch.user_id']");
    ...
    it("has mappings for span fields with stored_spans table", () => {
      ...
      expect(fieldMappings["spans.model"]?.column).toBe("SpanAttributes['gen_ai.request.model']");
    });
  ...
  describe("getColumnExpression", () => {
    ...
    it("returns map access expression for metadata fields", () => {
      expect(getColumnExpression("metadata.user_id")).toBe("Attributes['langwatch.user_id']");
    });
