...
import { DEFAULT_LWQL_RESOURCE_LIMITS } from "../adapters/clickhouse.lwql-provisioning.adapter";
 ...
 */
export function createLangWatchQLExecutor(connection: LangWatchQLConnection): LangWatchQLExecutor {
