...
export class LangWatchQLCatalogShapesService {
  static create(): LangWatchQLCatalogShapesService {
    return new LangWatchQLCatalogShapesService();
  }
   ...
   */
  grainColumns(view: LangWatchQLViewDefinition): readonly string[] {
   ...
   */
  viewSourceColumns(view: LangWatchQLViewDefinition): readonly string[] {
    return [
      ...new Set([
  ...
  postgresViews(
    ...
    return views.filter((view) => this.isPostgresResident(view));
  }
  ...
  contentGatedColumns(views: readonly LangWatchQLViewDefinition[]): readonly string[] {
    return [
      ...new Set(
        views.flatMap((view) =>
