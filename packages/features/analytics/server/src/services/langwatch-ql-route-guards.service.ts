...
export class LangWatchQLRouteGuardsService {
  ...
  /**
   * The project a LangWatchQL analytics SQL request runs for: the credential's,
   * once the path has been checked against it and the surface has been found
   * switched on.
   *
   ...
   * @throws {LangWatchQLNotEnabledError} — see {@link assertEnabled}.
   */
  async project({
    project,
    featureFlags,
