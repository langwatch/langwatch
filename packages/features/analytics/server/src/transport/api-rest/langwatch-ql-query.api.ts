...
function registerQuery(secured: LangWatchQLApp, ports: LangWatchQLRestPorts): void {
...
function registerSchema(secured: LangWatchQLApp, ports: LangWatchQLRestPorts): void {
