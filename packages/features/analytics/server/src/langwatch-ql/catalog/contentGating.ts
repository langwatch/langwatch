/**
 * LangWatchQL analytics SQL — where captured content lives, derived rather than
 * listed.
 *
 * The LangWatchQL views must never smuggle captured customer content past the
 ...
 *
 * The union of all four categories on purpose: a LangWatchQL view has no viewer,
 ...
 *
 * The map is the one place a LangWatchQL view can leak content without naming a
