...
import { LWQL_QUERY_RESULT_DATASET } from "../visualization/lwql-dataset-names";
import { starterVegaLiteSpecText } from "../visualization/starter-vega-lite-spec";
import {
  parseVegaLiteSpecText,
  validateVegaLiteSpec,
} from "../visualization/validate-vega-lite-spec";
import { isPlainObject } from "../visualization/vega-lite-structure";
import { ALLOWED_VEGA_LITE_TRANSFORMS } from "../visualization/vega-lite-policy";
import type {
...
import { LangWatchQLChartFailure } from "./langwatch-ql-chart-failure";
import { LangWatchQLVegaLiteChart } from "./langwatch-ql-vega-lite-chart";
import { VegaLiteSpecEditor } from "./vega-lite-spec-editor";
...
function useSpecValidation({
  ...
  const datasets = useMemo(
    () => ({ [LWQL_QUERY_RESULT_DATASET]: result.rows }),
    [result.rows],
  );
