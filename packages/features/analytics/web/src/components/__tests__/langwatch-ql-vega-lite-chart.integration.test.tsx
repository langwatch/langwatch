...
import { LangWatchQLVegaLoadBlockedError } from "../../visualization/no-network-vega-loader";
import type {
  LangWatchQLDataset,
...
vi.mock(
  "../../visualization/build-langwatch-ql-vega-spec",
  async (importOriginal) => {
    const original =
      await importOriginal<
        typeof import("../../visualization/build-langwatch-ql-vega-spec")
      >();
    return {
      ...original,
