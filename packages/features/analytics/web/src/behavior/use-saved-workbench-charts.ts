...
export function useSavedWorkbenchCharts({
  ...
  const list = analyticsApi.analytics.savedWorkbenchCharts.getAll.useQuery(
    { projectId },
  ...
  const createChart = analyticsApi.analytics.savedWorkbenchCharts.create.useMutation();
  const updateChart = analyticsApi.analytics.savedWorkbenchCharts.update.useMutation();
  const deleteChart = analyticsApi.analytics.savedWorkbenchCharts.delete.useMutation();
...
type CreateChartMutation = ReturnType<
  typeof analyticsApi.analytics.savedWorkbenchCharts.create.useMutation
>;
type UpdateChartMutation = ReturnType<
  typeof analyticsApi.analytics.savedWorkbenchCharts.update.useMutation
>;
...
function useOpenChart({
  ...
  utils: ReturnType<typeof analyticsApi.useUtils>;
...
function useRenameChart({
  ...
  updateChart: ReturnType<typeof analyticsApi.analytics.savedWorkbenchCharts.update.useMutation>;
}) {
  return useCallback(
...
function useRemoveChart({
  ...
  deleteChart: ReturnType<typeof analyticsApi.analytics.savedWorkbenchCharts.delete.useMutation>;
}) {
  return useCallback(
    async (chartId: string) => {
      try {
