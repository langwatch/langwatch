 ...
 */
interface LangWatchQLVegaLimits {
  readonly maxSpecBytes: number;
  readonly maxNestingDepth: number;
  readonly maxUnitViews: number;
  readonly maxLayersPerView: number;
  readonly maxTransforms: number;
  readonly maxExpressionBytes: number;
  readonly maxTotalExpressionBytes: number;
  readonly maxInteractiveParams: number;
  readonly maxRowsPerDataset: number;
  readonly maxRowsAllDatasets: number;
}

export const LWQL_VEGA_LIMITS: LangWatchQLVegaLimits = {
...
const LIMIT_RULES: Record<LangWatchQLVegaLimitName, LangWatchQLVegaRuleId> = {
  maxSpecBytes: "limit.maxSpecBytes",
  maxNestingDepth: "limit.maxNestingDepth",
  maxUnitViews: "limit.maxUnitViews",
  maxLayersPerView: "limit.maxLayersPerView",
  maxTransforms: "limit.maxTransforms",
  maxExpressionBytes: "limit.maxExpressionBytes",
  maxTotalExpressionBytes: "limit.maxTotalExpressionBytes",
  maxInteractiveParams: "limit.maxInteractiveParams",
  maxRowsPerDataset: "limit.maxRowsPerDataset",
  maxRowsAllDatasets: "limit.maxRowsAllDatasets",
};
