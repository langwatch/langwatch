...
export interface LangWatchQLVegaLiteChartProps {
  ...
  /** Resolved application theme values; the package does not read Chakra or DOM state. */
...
export const VEGA_VALIDATION_ERROR_CODES: readonly VegaValidationErrorCode[] = [
 ...
 */
export type LangWatchQLVegaRuleId =
  | "spec.not-json"
  | "spec.not-object"
...
export const LWQL_VEGA_RULE_IDS: readonly LangWatchQLVegaRuleId[] = [
  "spec.not-json",
  "spec.not-object",
  "spec.unsupported-schema-version",
  "spec.schema-invalid",
...
export type VegaValidationWarningCode = "transform-fields-unverifiable" | "unrepresentable-value";

export const VEGA_VALIDATION_WARNING_CODES: readonly VegaValidationWarningCode[] = [
  /**
