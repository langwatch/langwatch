...
export const analyticsPipelineSchema = z.object({
...
export const analyticsTimeseriesInputSchema = z.object({
  projectId: z.string(),
...
export const analyticsTimeseriesBucketSchema = z.object({
  date: z.string(),
}).catchall(
  z.union([
    z.number(),
...
export const analyticsTimeseriesResultSchema = z.object({
  previousPeriod: z.array(analyticsTimeseriesBucketSchema),
  currentPeriod: z.array(analyticsTimeseriesBucketSchema),
}).strict();

export const analyticsReadInputSchema = z.object({
  projectId: z.string(),
  startDate: z.number().positive(),
  endDate: z.number().positive(),
  filters: z
    .record(z.string(), analyticsFilterValueSchema)
    .optional(),
}).strict();
...
export type AnalyticsTimeseriesInput = z.infer<
  typeof analyticsTimeseriesInputSchema
>;
export type AnalyticsTable = z.infer<typeof analyticsTableSchema>;
export type AnalyticsTimeseriesBucket = z.infer<
  typeof analyticsTimeseriesBucketSchema
>;
export type AnalyticsTimeseriesResult = z.infer<
  typeof analyticsTimeseriesResultSchema
>;
...
export const analyticsTimeseriesRowSchema = z.object({
...
export type AnalyticsTimeseriesRow = z.infer<
  typeof analyticsTimeseriesRowSchema
>;
