...
import { bigint, isGap } from "./metric-rollup-sequence.adapter";
...
export class MetricRollupRowAdapter {
  private constructor() {}

  static create(): MetricRollupRowAdapter {
    return new MetricRollupRowAdapter();
  }
}
