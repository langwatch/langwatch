...
import {
  ...
  mergeMap,
  subtractMaps,
} from "./metric-rollup-exponential-buckets.adapter";
import { type BucketEntry, extendExtrema, resetOrGap } from "./metric-rollup-row.adapter";
import {
  bigint,
  previousPoint,
  startsNewSequence,
} from "./metric-rollup-sequence.adapter";
...
export class MetricRollupExponentialHistogramAdapter {
  private constructor() {}

  static create(): MetricRollupExponentialHistogramAdapter {
    return new MetricRollupExponentialHistogramAdapter();
  }
}

export { buildExponentialHistogramRow };
