import { buildHistogramRow } from "./metric-rollup-explicit-histogram.adapter";
import { buildExponentialHistogramRow } from "./metric-rollup-exponential-histogram.adapter";
import { type BucketEntry, baseRow } from "./metric-rollup-row.adapter";
import { buildGaugeRow, buildSumRow } from "./metric-rollup-scalar.adapter";
import {
  comparePoints,
  floorBucket,
...
import { buildSummaryRow } from "./metric-rollup-summary.adapter";
import type {
...
export class MetricRollupAdapter {
  private constructor() {}

  static create(): MetricRollupAdapter {
    return new MetricRollupAdapter();
  }
}
