...
import type { RecordMetricDataPointCommandData } from "@langwatch/telemetry-contract";
import { recordMetricDataPointCommandDataSchema } from "@langwatch/telemetry-contract";
import {
...
import type { MetricDataPointReceivedEvent } from "./telemetry-event.adapter";
...
export class RecordMetricDataPointAdapter {
  private constructor() {}

  static create(): RecordMetricDataPointAdapter {
    return new RecordMetricDataPointAdapter();
  }
}
