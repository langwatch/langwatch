...
function denseBuckets(map: BucketMap): {
  offset: number;
  counts: string[];
} {
...
function mergeMap(target: BucketMap, source: BucketMap): void {
...
export class MetricRollupExponentialBucketsAdapter {
  private constructor() {}

  static create(): MetricRollupExponentialBucketsAdapter {
    return new MetricRollupExponentialBucketsAdapter();
  }
}
