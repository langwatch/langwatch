...
export class MetricRollupExplicitHistogramAdapter {
  private constructor() {}

  static create(): MetricRollupExplicitHistogramAdapter {
    return new MetricRollupExplicitHistogramAdapter();
  }
}

export { buildHistogramRow };
