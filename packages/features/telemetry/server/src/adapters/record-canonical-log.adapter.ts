...
import type { CanonicalLogRecordReceivedEvent } from "./telemetry-event.adapter";
...
export class RecordCanonicalLogAdapter {
  private constructor() {}

  static create(): RecordCanonicalLogAdapter {
    return new RecordCanonicalLogAdapter();
  }
}
