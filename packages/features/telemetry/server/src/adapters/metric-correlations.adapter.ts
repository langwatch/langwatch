...
import type { MetricKind, MetricTraceCorrelation } from "@langwatch/telemetry-contract";
import { finiteNumber, timestampDecimal, timestampMs } from "./metric-numbers.adapter";
