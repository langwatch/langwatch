...
import { type BucketEntry, resetOrGap } from "./metric-rollup-row.adapter";
import {
  bigint,
  previousPoint,
  startsNewSequence,
...
export class MetricRollupSummaryAdapter {
  private constructor() {}

  static create(): MetricRollupSummaryAdapter {
    return new MetricRollupSummaryAdapter();
  }
}
