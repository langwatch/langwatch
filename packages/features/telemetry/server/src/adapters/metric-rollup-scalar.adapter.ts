...
import { addStats, type BucketEntry, resetOrGap } from "./metric-rollup-row.adapter";
import {
  numberValue,
  previousPoint,
  startsNewSequence,
...
export class MetricRollupScalarAdapter {
  private constructor() {}

  static create(): MetricRollupScalarAdapter {
    return new MetricRollupScalarAdapter();
  }
}
