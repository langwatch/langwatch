...
The former trace-pipeline `recordLog` command and its storage projection are not
registered. Canonical log records are emitted by this pipeline; trace
correlation remains a separate contribution command as described above.
