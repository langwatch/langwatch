...
abstract class MetricStoreBase implements AppendStore<CanonicalMetricDataPoint> {
  ...
  abstract append(point: CanonicalMetricDataPoint, context: ProjectionStoreContext): Promise<void>;
...
export class MetricDataPointAppendStore extends MetricStoreBase {
  ...
  async append(point: CanonicalMetricDataPoint, context: ProjectionStoreContext): Promise<void> {
  ...
  async bulkAppend(points: CanonicalMetricDataPoint[], context: BulkAppendContext): Promise<void> {
