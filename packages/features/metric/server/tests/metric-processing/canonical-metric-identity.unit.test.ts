...
import { prepareMetricDataPoints } from "../../src/adapters/canonical-metric.adapter";
import type { MetricRedactionPort } from "../../src/ports/metric-redaction.port";
...
describe("canonical metric identity", () => {
  ...
  describe("when the redaction policy rewrites nested values", () => {
    it("redacts nested AnyValue strings without flattening their types", async () => {
      const redactionService: MetricRedactionPort = {
