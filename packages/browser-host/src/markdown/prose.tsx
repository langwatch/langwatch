...
export const Prose = chakra("div", {
  base: {
    ...
    [inWhere("& a")]: {
      ...
      fontWeight: "500",
      // Chakra's link recipe creates an atomic inline box, so long autolinked
      // URLs can overflow instead of using the prose container's wrapping.
      // Keep prose links in the normal inline formatting context.
      display: "inline",
