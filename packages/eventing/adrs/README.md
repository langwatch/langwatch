# Eventing architecture decisions

These decisions define the reusable Eventing framework:

- [Eventing framework boundary](./20260820-eventing-framework-boundary.md)
