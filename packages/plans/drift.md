...
- Alternative: `modules/automation/process/src/services/__tests__/automation.service.unit.test.ts:293`
...
- **The Free tier's counting unit.** Billing's Free states no `usageUnit`;
  ...
  (`modules/entitlement/process/src/services/usage-meter-policy.service.ts`).
