 ...
 * client configuration is asked for and its answer is the region alone. The
 * SDK itself is mocked above, so nothing here needs a real credential chain.
 */
