...
export const ABSENT_API_TRPC_NAMESPACES = [
  ...
  },
  {
    ...
    module: "organization",
    consequence: "no organization is administered",
  },
  { namespace: "group", module: "organization", consequence: "no group is listed" },
  { namespace: "joinRequests", module: "organization", consequence: "no join request is answered" },
  { namespace: "onboarding", module: "organization", consequence: "the sign-up ceremony stops" },
  { namespace: "team", module: "organization", consequence: "no team is listed" },
  {
    namespace: "personalWorkspaceFeatures",
    module: "organization",
    consequence: "a personal workspace switches nothing on",
  },
