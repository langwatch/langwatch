...
import type { GroupQueueContextMetadata, GroupQueueContext } from "@langwatch/group-queue";
 ...
 */
export class ApiGroupQueueContextAdapter implements GroupQueueContext {
