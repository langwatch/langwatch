// OpenAPI document checker. Compares generated vs frozen document.
...
// Debt list: operations in the frozen document with no current declaration.
...
// Operations where security requirement moved. Only `security` field is compared.
