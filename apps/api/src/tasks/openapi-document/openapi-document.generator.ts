 ...
 * route stated. A response loses that schema-less entry; a request body
 * keeps its media type but stops claiming `required: true` (the middleware's
 * blanket default) — a required body of unstated shape satisfies no reader.
 */
