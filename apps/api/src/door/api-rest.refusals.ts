...
/**
 * A door whose secret this deployment named and left blank: not an absent
 * door, which the 404 above is for, but a mis-set key, said out loud.
 */
export class ApiRestDoorBlankSecretError extends HandledError {
  declare readonly code: "internal_error";
  ...
  constructor(door: string) {
    ...
    this.name = "ApiRestDoorBlankSecretError";
  }
}
