...
export const expectedUiRouteTranscript: readonly string[] = [
  ...
  "    route /settings/authentication/provider -> pages/settings/authentication/provider",
  "    route /settings/authentication/connectors -> pages/settings/authentication/connectors",
  ...
  "    route /settings/profile -> pages/settings/profile",
  ...
  "    route /governance/agents -> pages/governance/agents",
  "    route /governance/costs -> pages/governance/costs",
  "    route /governance/billed -> pages/governance/billed",
  "    route /governance/insights -> pages/governance/insights",
  "    route /governance/analytics -> pages/governance/analytics",
  "    route /governance/signals -> pages/governance/signals",
