...
import { UiLangyHost } from "../../behavior/host.adapter";
      ...
      UiLangyHost.create(
        {
          ...
          featureFlag: (flag: string) => session.featureFlag(flag),
           ...
           *
           * `IS_SAAS` is the application's own public configuration; the dock
           * only ever needs the destination it implies.
           */
