 ...
 * of how this family differs from every one before it. There is NO guard here,
 * and there must not be: these are the addresses a person reaches with no
 * session at all, so a permission gate in front of them would be a gate in
 * front of the way in. The guard exists to refuse; the front door exists to
 * admit.
 *
