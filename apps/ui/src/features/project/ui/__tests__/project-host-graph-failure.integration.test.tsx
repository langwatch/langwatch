 ...
 *
 * `ProjectHost` read the organization graph without checking for a
 * refusal, so a failed `organization.getAll` left the settings screen with
 * no organization and no error — same gap `TraceHost` and `OrganizationHost`
 * had.
 *
