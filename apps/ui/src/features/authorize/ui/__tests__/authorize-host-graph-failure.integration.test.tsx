...
vi.mock("@langwatch/api-key-web/authorize", async () => {
  const actual = await vi.importActual<typeof import("@langwatch/api-key-web/authorize")>(
    "@langwatch/api-key-web/authorize",
  );
  return {
    ...actual,
    apiKeyApi: {
