...
import { UiDataRetentionHost } from "../../behavior/data-retention-host.adapter";
...
function DataRetentionHost({ children }: { children: ReactNode }) {
...
/** Wraps the Data Retention screen in the host its package asks for. */
export function withDataRetentionHost<P extends object>(
  ...
  Mounted.displayName = `withDataRetentionHost(${Screen.displayName ?? Screen.name ?? "Screen"})`;
  return Mounted;
}
