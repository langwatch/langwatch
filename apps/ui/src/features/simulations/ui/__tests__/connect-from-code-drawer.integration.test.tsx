...
<<<<<<< HEAD:apps/ui/src/features/simulations/ui/__tests__/connect-from-code-drawer.integration.test.tsx
...
>>>>>>> origin/main:platform/app/src/components/agents/connected/__tests__/ConnectFromCodeDrawer.integration.test.tsx
  useDrawer: () => ({
    closeDrawer: vi.fn(),
    openDrawer: vi.fn(),
    canGoBack: false,
