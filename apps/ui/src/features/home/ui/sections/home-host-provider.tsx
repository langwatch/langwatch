...
import { UiProjectHomeHost } from "../../behavior/home-host.adapter";
...
/** Wraps the screen in the host the home package asks for. */
export function withProjectHomeHost<P extends object>(
  ...
  Mounted.displayName = `withProjectHomeHost(${Screen.displayName ?? Screen.name ?? "Screen"})`;
  return Mounted;
}
