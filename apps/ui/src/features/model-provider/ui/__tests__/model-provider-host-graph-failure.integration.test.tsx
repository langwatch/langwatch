...
vi.mock("@langwatch/model-provider-web/model-providers", async () => {
  const actual = await vi.importActual<
    typeof import("@langwatch/model-provider-web/model-providers")
  >("@langwatch/model-provider-web/model-providers");
  return {
    ...actual,
    modelProviderApi: {
      organization: {
