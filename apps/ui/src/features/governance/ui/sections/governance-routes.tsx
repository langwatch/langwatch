...
export const governancePageLoaders: UiPageLoaderRegistry = {
  ...
  "pages/governance/agents": governancePage("agents", SECTION),
  "pages/governance/costs": governancePage("costs", BILLED),
  "pages/governance/billed": governancePage("billed", BILLED),
  "pages/governance/insights": governancePage("insights", BILLED),
  "pages/governance/analytics": governancePage("analytics", BILLED),
  "pages/governance/signals": governancePage("signals", BILLED),
