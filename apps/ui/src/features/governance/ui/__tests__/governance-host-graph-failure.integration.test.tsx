/**
 * `GovernanceHost` read the organization graph without checking for a
 * refusal, so a failed `organization.getAll` left it with no error at all.
...
vi.mock("@langwatch/enterprise-governance-web/governance", async () => {
  const actual = await vi.importActual<
    typeof import("@langwatch/enterprise-governance-web/governance")
  >("@langwatch/enterprise-governance-web/governance");
  return {
    ...actual,
    governanceApi: {
      organization: {
