...
tslsp-cli tidy organise-imports --changed  # auto-fix changed files
```
...
tslsp-cli diagnostics --changed              # check git changes
```
...
5. **--changed is magical** - uses git diff to find edited files
