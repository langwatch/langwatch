 ...
 *
 * The third arm of the same rule as {@link ./prisma.azure-bill-ownership.repository.ts} and
 * {@link ./prisma.environment-ownership.repository.ts}, and the one that cannot read its identity
 ...
 * {@link ./prisma.provider-account-lookup.repository.ts}.
 */
