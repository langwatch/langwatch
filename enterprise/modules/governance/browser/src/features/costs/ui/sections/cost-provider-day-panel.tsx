...
import { aggregateBuckets, bucketStartOf } from "../../model/costs-window.ts";
import { type DailyBucket } from "../../model/sample-series.ts";
import { type TimeInterval } from "../../model/time-controls.ts";
import { CostStackedBars, formatDayTick } from "../blocks/cost-charts.tsx";
import { providerName } from "../blocks/cost-provider-breakdown.tsx";
      ...
      */}
      {records.isError ? (
        <HStack gap={2}>
          ...
          */}
          <Button size="xs" variant="outline" onClick={() => void records.refetch()}>
            Try again
          </Button>
        </HStack>
      ) : rows === null ? (
