 ...
 */
export function SampleSaidOnce({ said, children }: { said: boolean; children: ReactNode }) {
  return <SampleAlreadySaid.Provider value={said}>{children}</SampleAlreadySaid.Provider>;
}
