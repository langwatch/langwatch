...
function ScheduleRows({ draft, patch }: DraftProps) {
  return (
    <>
      <SettingRow label="Runs" hint="How often the background job messages Langy">
        <ChoiceSelect
      ...
      <SettingRow label="Volume" hint="Few insights that matter beat fifteen that don't">
        <ChoiceSelect
  ...
  return (
    <VStack align="stretch" gap={2} paddingY={4}>
      ...
      <Text fontSize="xs" color="fg.muted">
        What steering left behind. Complain about an insight and the correction lands here.
      </Text>
      <VStack
        align="stretch"
        gap={0}
