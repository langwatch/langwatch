...
<<<<<<< HEAD:enterprise/modules/governance/server/src/services/__tests__/ingestion-pull-worker.ocsf-mapping.unit.test.ts
...
// import alias.
function loadWorker(): typeof IngestionPullWorkerService {
  return IngestionPullWorkerService;
}
...
>>>>>>> origin/main:platform/app/ee/governance/services/pullers/__tests__/pullerWorker.ocsfMapping.unit.test.ts
...
describe("PullerWorker — OCSF mapping (semantic contract)", () => {
  it("loads the worker module without crashing", async () => {
    expect(loadWorker()).toBeTypeOf("function");
=======
