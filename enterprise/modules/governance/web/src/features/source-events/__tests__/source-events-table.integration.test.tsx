...
function Harness({
  ...
  return (
<<<<<<< HEAD:enterprise/modules/governance/web/src/features/source-events/__tests__/source-events-table.integration.test.tsx
...
=======
    ...
    />
>>>>>>> origin/main:platform/app/ee/governance/dashboard/components/__tests__/SourceEventsTable.integration.test.tsx
  );
}
