...
<<<<<<< HEAD:enterprise/modules/governance/web/src/ui/sections/governance/governance-inventory.screen.tsx
import {
  groupForMode,
...
>>>>>>> origin/main:platform/app/ee/governance/dashboard/pages/inventory.tsx
  routesConversations,
  SOURCE_TYPE_LABEL,
  SOURCE_TYPE_OPTIONS,
  type SourceType,
...
function resolvePullConfig(
  ...
  }: { toaster: GovernanceToaster; shouldRequireCredentials?: boolean },
...
export function buildCreateInput({
  ...
  /** Named which field is wrong when a pull config will not build. */
...
function AddSourceControl({
  ...
  return (
    <AddIngestionSourceMenu
      ...
      onPick={onAdd}
      renderSourceIcon={(sourceType, size) => (
        <SourceTypeIconGlyph sourceType={sourceType} size={size} />
      )}
    >
...
export function buildEditSubmission({
  ...
  if (isPullMode) {
    ...
    const resolved = resolvePullConfig(
      ...
      { toaster, shouldRequireCredentials: false },
    );
