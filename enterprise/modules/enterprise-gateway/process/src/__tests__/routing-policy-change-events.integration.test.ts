...
import { createEnterpriseGatewayTestPrismaConnection } from "./support/enterprise-gateway-prisma.fixture.ts";

const databaseUrl = process.env.LANGWATCH_TEST_DATABASE_URL ?? process.env.DATABASE_URL;
const connection = databaseUrl ? createEnterpriseGatewayTestPrismaConnection(databaseUrl) : null;
