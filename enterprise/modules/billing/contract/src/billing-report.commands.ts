...
/**
 * Command type constants for the billing-reporting pipeline. The string is
 * the wire identity of every job and event_log row the monthly roll-up has
 * ever written — pinned, never derived.
 */
