 ...
 */
export class BillingErrorReporterService extends BillingErrorReporter {
  static create(target: Pick<Logger, "error"> = defaultLogger): BillingErrorReporterService {
    return new BillingErrorReporterService(target);
  }
