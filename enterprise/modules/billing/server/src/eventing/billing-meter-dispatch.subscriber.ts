 ...
 */
export class BillingMeterDispatchSubscriber {
  static create(options: {
    ...
    return new BillingMeterDispatchSubscriber(
  ...
  build(): SubscriberDispatchDefinition<Event> {
    return {
      ...
      options: {
        runIn: ["worker"],
        groupKeyFn: (payload) => BillingMeterDispatchSubscriber.groupKey(payload.event),
        ...
        makeJobId: (payload) => BillingMeterDispatchSubscriber.jobId(payload.event),
