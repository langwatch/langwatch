...
import { BillingWebhookOrganizationPort } from "../ports/billing-webhook-organization.port.ts";

export type BillingWebhookOrganizationDatabase = Pick<PrismaClient, "organization">;

export class PostgresBillingWebhookOrganizationAdapter extends BillingWebhookOrganizationPort {
  ...
  static create(options: {
    ...
    return new PostgresBillingWebhookOrganizationAdapter(options.database);
  }
