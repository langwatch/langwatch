 ...
 * step rather than passing a whole `BrowserSessionApi` to reach one method.
 */
export type ScimSessionRevocation = Pick<BrowserSessionApi, "revokeAllBrowserSessions">;
