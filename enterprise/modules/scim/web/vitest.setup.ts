// Global test setup: DOM matchers from @testing-library/jest-dom, and browser APIs
// jsdom doesn't ship (ResizeObserver, matchMedia, etc.) that Chakra overlays need.
