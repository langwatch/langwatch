...
export class AppGovernanceKpisAdapter implements AnomalySpendReader {
  ...
  async findSpendTotals(input: {
    ...
    const result = await client.query({
      query: `
        SELECT
<<<<<<< HEAD:enterprise/packages/composition/api/src/governance/governance-kpis.clickhouse.repository.ts
...
>>>>>>> origin/main:platform/app/ee/governance/services/governanceKpis.clickhouse.repository.ts
      `,
      query_params: {
