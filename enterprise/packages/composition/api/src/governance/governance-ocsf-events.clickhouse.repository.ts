 ...
 */
<<<<<<< HEAD:enterprise/packages/composition/api/src/governance/governance-ocsf-events.clickhouse.repository.ts
...
>>>>>>> origin/main:platform/app/ee/governance/services/governanceOcsfEvents.clickhouse.repository.ts
...
>>>>>>> origin/main:platform/app/ee/governance/services/governanceOcsfEvents.clickhouse.repository.ts
  ...
  async insertEvents(rows: GovernanceOcsfEventInput[]): Promise<void> {
    ...
    if (rows.some((row) => row.tenantId !== tenantId)) {
      throw new Error(
<<<<<<< HEAD:enterprise/packages/composition/api/src/governance/governance-ocsf-events.clickhouse.repository.ts
        "AppGovernanceOcsfEventsAdapter.insertEvent: tenantId / eventId are required",
      );
    }
    try {
