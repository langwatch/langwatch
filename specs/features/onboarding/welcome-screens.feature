Feature: Welcome Onboarding Screen for Scenarios
  ...
  # modules/scenario/browser/src/behavior/__tests__/use-new-scenario-flow.unit.test.ts
  # and modules/scenario/browser/src/ui/elements/scenarios/__tests__/scenario-welcome-screen.integration.test.tsx.
