Feature: Topic clustering runs on langevals
  ...
  # platform/app/src/server/app-layer/topic-clustering/clustering.ts (always
  # langevals, warn-and-skip when unconfigured, engine attribution log).
  # Existing tests in
  # platform/app/src/server/app-layer/topic-clustering/__tests__/clustering.unit.test.ts
