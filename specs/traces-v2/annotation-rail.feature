...
#
# Implementation:
#   modules/trace/browser/src/annotation-draft.store.ts
#   modules/trace/browser/src/ui/sections/explorer/hooks/use-conversation-annotations.ts
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/use-rail-layout.ts
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/annotated-turn-row.tsx
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/turn-annotation-rail.tsx
