...
#
# Implementation:
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/chat-turn-row.tsx
#   modules/suite/browser/src/formatters.ts (formatRelativeTimeAgo)
#
