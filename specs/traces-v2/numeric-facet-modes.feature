...
#   modules/trace/browser/src/ui/sections/explorer/filter-sidebar/range-section.tsx     (Range mode — existing slider)
#   modules/trace/browser/src/ui/sections/explorer/filter-sidebar/facet-section.tsx     (Discrete mode — reused categorical list)
#   modules/trace/browser/src/ui/elements/explorer/filter-sidebar/sidebar-section.tsx   (header mode-toggle icon)
#   modules/trace/browser/src/ui/sections/explorer/filter-sidebar/facet-manager-popover.tsx  (mode picker in the manager)
#   modules/trace/browser/src/                        (per-project per-facet mode setting, sibling of visibility)
#
# Related specs:
