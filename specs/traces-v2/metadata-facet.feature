...
#
# Implementation:
#   [gone] src/server/app-layer/traces/facet-registry.ts          (TRACE_METADATA_FACET — dynamic_keys, metadata. prefix)
#   [gone] src/server/app-layer/traces/facets/metadata-keys.ts    (prefix-scoped discovery, reused)
#   [gone] src/features/traces-v2/components/FilterSidebar/        (Metadata sidebar section + grouping)
#
# Related specs:
