...
#   modules/trace/browser/src/behavior/preview-formatter.ts (list preview)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/transcript/block-stack.tsx (pretty mode)
