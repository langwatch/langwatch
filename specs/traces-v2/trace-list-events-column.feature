...
# Implementation:
#   modules/trace/browser/src/ui/sections/explorer/trace-table/registry/cells/trace/events-cell.tsx
#   modules/trace/browser/src/ui/sections/explorer/hooks/use-trace-list-events.ts
