...
#
# Implementation:
#   modules/trace/browser/src/view.store.ts        (builtInLenses, lens-group id sets, selectLens)
#   modules/trace/browser/src/ui/sections/explorer/toolbar/lens-tabs.tsx  (lens-group dropdown UI)
#
# Related specs:
