...
#   packages/features/trace/web/src/ui/sections/explorer/hooks/use-conversation-annotations.ts                       (comments grouped by trace and by anchor)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/waterfall-view/tree-row.tsx          (comment on a span)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/waterfall-view/waterfall-view.tsx    (scrolling to an anchored span)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/io-viewer.tsx                       (comment on a span or trace field)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/attribute-table.tsx                 (comment on an attribute row)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/trace-accordions/accordion-shell.tsx (comment on a section)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/transcript/parsing.ts              (stable identity for a message)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/transcript/block-stack.tsx          (comment on a message)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/transcript/message-comments.tsx     (which trace a transcript belongs to)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/conversation-view/chat-turn-row.tsx            (comment on one side of a turn)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/conversation-view/message-annotate-cluster.tsx (the affordance on a message)
#   packages/features/trace/web/src/ui/sections/explorer/trace-table/registry/addons/conversation/bubble.tsx      (the same affordance in bubbles layout)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/conversation-view/annotation-card.tsx        (what a card is about)
#   packages/features/annotation/web/src/ui/blocks/annotation-score-fields.tsx (scores ride any comment)
#   packages/features/trace/web/src/ui/sections/explorer/trace-drawer/trace-header-chips.tsx               (every comment on the trace, with its anchor)
#
