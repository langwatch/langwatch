...
#   modules/annotation/process/src/transport/annotation.trpc.ts                                                    (anchored writes, anchored reads, suggestion hand-off)
#   modules/trace/process/src/services/trace-edit-overlay.service.ts                       (a field suggestion merged into the correction)
#   [gone] src/server/traces/clickhouse-trace.service.ts                                   (trace-level annotation reads for lists and datasets)
#   modules/trace/browser/src/annotation-draft.store.ts                           (what is being written, and about what)
#   modules/trace/browser/src/ui/sections/explorer/hooks/use-conversation-annotations.ts                       (comments grouped by trace and by anchor)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/waterfall-view/tree-row.tsx          (comment on a span)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/waterfall-view/waterfall-view.tsx    (scrolling to an anchored span)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/io-viewer.tsx                       (comment on a span or trace field)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/attribute-table.tsx                 (comment on an attribute row)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/trace-accordions/accordion-shell.tsx (comment on a section)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/transcript/parsing.ts              (stable identity for a message)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/transcript/block-stack.tsx          (comment on a message)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/transcript/message-comments.tsx     (which trace a transcript belongs to)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/chat-turn-row.tsx            (comment on one side of a turn)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/message-annotate-cluster.tsx (the affordance on a message)
#   modules/trace/browser/src/ui/sections/explorer/trace-table/registry/addons/conversation/bubble.tsx      (the same affordance in bubbles layout)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/conversation-view/annotation-card.tsx        (what a card is about)
#   modules/annotation/browser/src/ui/blocks/annotation-score-fields.tsx (scores ride any comment)
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/trace-header-chips.tsx               (every comment on the trace, with its anchor)
#
