...
#
# Implementation:
#   modules/trace/browser/src/ui/sections/editable-trace-name.tsx
#   modules/trace/browser/src/ui/sections/explorer/trace-drawer/drawer-header/drawer-header.tsx  (status orb / StatusChip sibling)
#
