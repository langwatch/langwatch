...
Feature: Agent insight skills, from diagnosis to improvement
  ...
  #   1. agent-improvement (starred, top): what should I do next
  #   2. agent-performance: how is my agent performing
  #   3. agent-best-practices: where can I improve our development practices
  # agent-performance hands off to agent-improvement; agent-improvement uses
  ...
  Scenario: Directory lists the three skills in the insight ladder order
    ...
    Then the first entry is the starred "What should I do next to improve my agent?" installing agent-improvement
  ...
  Scenario: agent-performance produces a full diagnosis from production traces
    ...
    And the skill closes by recommending the agent-improvement skill, including how to install it when missing
  ...
  Scenario: agent-improvement proposes evidence-backed improvements
  ...
  Scenario: agent-improvement turns accepted hypotheses into artifacts
