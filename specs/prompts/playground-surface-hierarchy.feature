Feature: Prompt playground surface hierarchy
  ...
  #
  # Implementation:
  #   modules/prompt/browser/src/screens/prompt-studio/save-prompt-button.tsx
  #   modules/prompt/browser/src/screens/prompt-studio/fields/editing-mode-title.tsx
  #   modules/prompt/browser/src/screens/prompt-studio/sidebar/add-prompt-button.tsx
  #   modules/prompt/browser/src/screens/prompt-studio/browser/prompt-playground-browser.tsx
