...
#
# Implementation:
#   modules/prompt/browser/src/screens/prompt-studio/dialogs/version-history-list-popover.tsx  (the panel)
#   modules/prompt/browser/src/model/prompt-version-diff.ts                                    (what changed between two versions)
#   modules/prompt/browser/src/ui/elements/prompts/version-changes.tsx                         (rendering of a change)
#
# Related specs:
...
# version number, the least informative thing in the row. The save button keeps the labels it
# already had; only the panel changes.
#
# Decisions:
