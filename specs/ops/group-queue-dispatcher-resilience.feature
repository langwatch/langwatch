Feature: GroupQueue dispatcher connection resilience
  ...
  # The Lua squash/dedup primitives are covered in scripts.integration.test.ts,
  # but nothing drives a delayed processor end to end over a squashed pair.
  ...
  # Test-harness behaviour rather than product behaviour, and unasserted. It
  # belongs with the rest of the CI specs if it is kept at all.
  @unit @unimplemented
