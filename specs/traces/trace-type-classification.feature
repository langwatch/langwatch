Feature: Trace origin classification
  ...
  #     the trace has no origin for up to a minute. The evaluation trigger process manager
  ...
  #    - Used by: evaluationTrigger.process.ts (line 46) to skip dev traces
  ...
  #    - Used by: evaluationTrigger.process.ts (line 47) combined with #1
  ...
  # ===========================================================================
  # Step 6: Online evaluation origin handling (process manager + preconditions)
  # ===========================================================================

  # As of 2026-05-01, the evaluationTrigger process manager no longer rejects traces
  ...
  # deferred check via originGate.process.ts.
  ...
  Scenario: Online evaluations dispatch for evaluation-origin traces (preconditions filter)
    ...
    When the evaluation trigger process manager processes the trace
  ...
  Scenario: Online evaluations skip traces with empty origin and no SDK info
    ...
    And a deferred origin-resolution check is scheduled (originGate.process)
