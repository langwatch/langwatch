Feature: Annotation queues
  ...
  # Every scenario is @unimplemented, meaning UNBOUND rather than unbuilt —
  # see the same note in annotations.feature. This file describes what a queue
  # IS and how it fills; annotation-queue-workflow.feature describes moving
  # through one item by item.
