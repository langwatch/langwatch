...
| `app.governance`                                             | Governance configuration.                                                                                                                                                                                                                                                           |                              |
| `app.governance.erasurePseudonymSecret.value`                | Key deriving the stand-in that replaces an erased identifier. Required once anyone has been erased.                                                                                                                                                                                  | `""`                         |
| `app.governance.erasurePseudonymSecret.secretKeyRef`         | Secret ref holding the erasure pseudonym secret.                                                                                                                                                                                                                                    | `{}`                         |
