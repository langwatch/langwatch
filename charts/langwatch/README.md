...
| `global.podAnnotations`                       | Annotations added to every pod whose component does not set its own `pod.annotations`; a component map replaces this rather than merging.                                                                                                                                                           | `{}`         |
