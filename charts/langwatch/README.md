...
| `global.podAnnotations`                       | Annotations added to the app, workers, langwatch_nlp and langevals Deployment pods when that Deployment does not set its own `pod.annotations`; a component map replaces this rather than merging.                                                                                                  | `{}`         |
...
| `global.scheduling.topologySpreadConstraints` | Topology spread constraints applied to all pods. Free-form pass-through list.                                                                                                                                                                                                                       | `[]`         |
...
| `app.service.nodePort`                                           | Explicit NodePort when app.service.type is NodePort; null lets Kubernetes assign one.                                                                                                                                                                                               | `null`                       |
