...
A successful response completes the end-to-end smoke. Once the trace lands and the control plane's budget-debit projection derives the ledger row, the spend shows up in the control-plane budget view.
