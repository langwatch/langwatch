/**
 * Deterministic dogfood seed for the ActivityMonitor / IngestionSource path.
 *
 ...
 * OTLP span.
 *
 * Why deterministic shell + tsx (not pnpm dev clicks): the dogfood loop
 ...
 *   pnpm tsx scripts/dogfood/governance/seed.ts \
