...
Nine dashboard widgets that reproduce the legacy `/analytics`
...
- `platform/app/src/server/analytics/lwql/catalog/postgresOverrides/core.ts` — `annotations` (lines 23-34).
- `platform/app/src/server/analytics/lwql/catalog/postgresOverrides/topics.ts` — `topics` view (`TopicId`, `TopicName`, `ParentTopicId`).
...
- `platform/app/src/pages/[project]/analytics/topics.tsx` — legacy topics chart config (`mostDiscussedTopics`).
