...
import { SCIM_SYNC_AGGREGATE_TYPE } from "@ee/event-sourcing/pipelines/scim-sync/schemas/constants";
import type { ScimSyncEvent } from "@ee/event-sourcing/pipelines/scim-sync/schemas/events";
import {
