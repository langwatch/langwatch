...
import { IDENTITY_CONNECTION_GRANDFATHER_MIGRATION_NAME } from "~/server/app-layer/identity/migration-name";
  ...
  implements SystemMigration
{
  ...
  // Startup runs this automatically; no enrollment or preparatory release.
