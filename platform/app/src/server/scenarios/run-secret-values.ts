...
export function encryptRunSecretValues(
  values: Record<string, string>,
): RunSecretCiphertext {
  return Object.fromEntries(
    Object.entries(values).map(([name, value]) => [name, encrypt(value)]),
  );
}
 ...
 */
export function decryptRunSecretValues(
  values: RunSecretCiphertext,
