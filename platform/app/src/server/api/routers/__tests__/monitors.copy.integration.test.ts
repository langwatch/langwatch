...
describe("monitors.copy", () => {
  ...
  describe("given a monitor linked to a workflow evaluator with no saved version", () => {
    describe("when it is replicated to the target project", () => {
      it("is rejected rather than creating a workflow evaluator with no workflow", async () => {
        // Replicating a workflow evaluator needs its workflow copied too. If the
