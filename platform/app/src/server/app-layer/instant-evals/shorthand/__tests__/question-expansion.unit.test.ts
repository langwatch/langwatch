/**
 * The eval call each kind of question becomes, and the refusals for a question
 * whose fields belong to another kind.
 *
 * Text assertions on the generated SQL, which is what a caller reads on the
 * run and edits. The rest of the expansion (targets, window, naming) is next
 * door in `./expand.unit.test.ts`.
 *
