...
describe("mergeSnapshots", () => {
  describe("given a live and a detail artifact", () => {
    ...
    it("carries the parked tenants that explain the parked count", () => {
      const merged = mergeSnapshots({ live: live(), detail: detail() });
  ...
  describe("given a live artifact but no detail yet", () => {
    it("serves the counts with empty structure rather than fabricated zeroes", () => {
      const merged = mergeSnapshots({ live: live(), detail: null });
