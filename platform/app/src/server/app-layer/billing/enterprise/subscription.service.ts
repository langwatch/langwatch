...
import {
  ...
  type SeatEventSubscriptionService,
  StripeErrorAdapter,
...
type ItemCalculator = Pick<
  ...
  "getItemsToUpdate" | "createItemsToAdd"
...
export class EESubscriptionService implements SubscriptionService {
  ...
  private readonly seatEventFns?: SeatEventSubscriptionService;
  ...
  private constructor({
    ...
    seatEventFns?: SeatEventSubscriptionService;
  }) {
    this.prisma = prisma;
  ...
  static createWithDependencies(options: {
    ...
    return new EESubscriptionService(options);
  }
  ...
  static create({
    ...
    const repository = PostgresBillingAdapter.create(db).build()
