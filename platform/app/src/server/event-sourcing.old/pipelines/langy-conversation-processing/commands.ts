...
// (see ../ephemeral.ts), never dispatched through this pipeline (ADR-098).
//
 ...
 * Beyond the prescribed vocabulary — see ADR-098.
 */
...
/**
 * RecordTurnHandoff → conversation_handoff_pending (ADR-098). Persists the
...
/**
 * ConsumeTurnHandoff → conversation_handoff_consumed (ADR-098). Clears the
