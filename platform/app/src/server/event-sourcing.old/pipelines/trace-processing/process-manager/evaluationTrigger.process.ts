...
/**
 * The `evaluationTrigger` process (a process manager under ADR-098): pure
 ...
 * LOST, because the routing seam has no retry (ADR-098). Nothing
 * data-dependent or fallible is expressed at delivery time
 ...
 * a throw permanently loses this process's job for the event (ADR-098).
 */
