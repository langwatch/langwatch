 ...
 *
 * An **event subscriber** rather than a process manager (ADR-098): nothing here
 ...
 *
 * **The ADR-098 clustering bootstrap used to live here** and now has its own
...
export function createProjectMetadataSubscriber(
  ...
  return {
    ...
    options: {
      ...
      // total predicate, which is the bar the retry-less seam sets (ADR-098).
