  ...
  implements FoldEventHandlers<typeof traceSummaryEvents, TraceSummaryData>
{
   ...
   * window (ADR-104): OccurredAt is the trace's own occurrence time, so drift
   ...
   * gate is the pre-ADR-066 (now ADR-099) behaviour the 2026-07-23
   * `TOO_MANY_PARTS` outage came from — every cache miss paying for the whole
   * history.
   *
