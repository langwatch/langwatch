 ...
 * event (ADR-099 — eval mirror of `traceAnalyticsRollup.mapProjection`).
 *
 ...
 * rollup rows for `evaluation_analytics_rollup` (ADR-099).
 *
 ...
 * systematic over-counting, not ADR-099's accepted rare crash-retry noise.
