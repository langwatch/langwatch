...
/**
 * Shared base class for the ADR-099 analytics rollup projection stores: look
 ...
 * deleted once its last adopter moved to the ADR-099 read-back shape. Its
 * `get` returned `null`, which is the pattern ADR-099 exists to retire.
 */
