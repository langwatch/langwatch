 ...
 * the trace id stands in and the session is a one-trace session (ADR-105).
 */
...
/**
 * Converged totals for one metric SERIES of a session (ADR-105).
 *
