...
/**
 * The coding-agent session fold (ADR-105).
 *
 ...
 * semantics per ADR-105. The converged per-series totals themselves live
 ...
 *  shape. That shape change is exactly what this stamp records (ADR-099). */
 ...
 * the response body — never their contents. The read-back columns (ADR-099)
 ...
 * inverse of {@link projectCodingAgentSessionToRow}'s `toRow` (ADR-099).
 *
