/**
 * The shape of a coding-agent session summary (ADR-105).
 *
 ...
 * (each sums once). Replace-not-increment per ADR-105.
 */
...
export interface CodingAgentSessionData {
   ...
   * adding to it (ADR-105) — the fields below are recomputed from this
