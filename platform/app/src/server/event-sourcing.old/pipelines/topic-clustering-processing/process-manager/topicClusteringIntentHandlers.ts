 ...
 * this constant is the effective clustering concurrency ADR-098 promises,
...
export interface TopicClusteringDispatchDeps {
   ...
   * builds these from command-bus ports (ADR-102), which resolve by class
...
/**
 * The `run` intent executor (ADR-098): one clustering page per dispatch.
 *
