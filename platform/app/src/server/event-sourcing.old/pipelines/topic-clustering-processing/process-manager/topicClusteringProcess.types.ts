...
import { topicClusteringSearchAfterSchema } from "~/server/event-sourcing.old/pipelines/topic-clustering-processing/schemas/events";
...
/**
 * Compact private process state (ADR-098): only what evolve() decisions
