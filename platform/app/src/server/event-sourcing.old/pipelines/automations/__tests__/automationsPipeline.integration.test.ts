...
// The REAL inline pipeline topology (ADR-098) with inert executor deps —
...
describe("automations pipeline", () => {
  ...
  // ADR-099: recordTriggerMatch opts into append coalescing. This suite
...
// ADR-099 — the redis:null suites above never coalesce (the in-memory
