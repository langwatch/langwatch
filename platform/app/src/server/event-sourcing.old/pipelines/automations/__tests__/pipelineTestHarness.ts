import type { ProcessManagerDefinition } from "~/server/event-sourcing.old/pipeline/processManagerDefinition";
import {
 ...
 *  (ADR-098), so tests exercise the exact registered definition instead of
