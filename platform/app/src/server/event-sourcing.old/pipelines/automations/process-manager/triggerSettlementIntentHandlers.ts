 ...
 * dispatcher's deps (ADR-098/031/036/040/041 contracts) minus the
...
/**
 * The ADR-098 cadence digest, dispatched from the process outbox. Behavior
...
/**
 * Persist-class dispatch (ADR-098): one settled match per intent. The
