 ...
 * (ADR-099: ProcessManagerInbox / ProcessManagerInstance /
...
export interface ProcessStore {
  ...
  leaseDueMessages(params: {
     ...
     * intents, fail to find a handler, and retry-churn them (ADR-098).
  ...
  /**
   * Retention for high-frequency recurring intents (ADR-098): deletes
