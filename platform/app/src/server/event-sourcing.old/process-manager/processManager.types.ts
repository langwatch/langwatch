...
/**
 * Generic process-manager domain contracts for ADR-099's Langy pilot.
 *
 * A process is identified by (processName, projectId, processKey) — the
 * ADR-099 uniqueness contract. Its definition is a single pure function:
...
/**
 * The committed event as carried by the queue envelope (ADR-099).
