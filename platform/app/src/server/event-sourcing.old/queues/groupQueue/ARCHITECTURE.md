...
- [ADR-100](../../../../../../dev/docs/adr/100-dispatch-plane-group-keys.md) — the dispatch plane: GroupQueue, group keys, and the blob/payload envelope (GQ1 format, GQ2 content-addressed tiered store, and its hardening)
