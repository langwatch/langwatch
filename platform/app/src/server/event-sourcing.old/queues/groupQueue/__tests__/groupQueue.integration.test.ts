...
describe.skipIf(!hasTestcontainers)(
  ...
  () => {
    ...
    describe("group coalescing", () => {
      ...
      // ADR-099: the drain is bounded by bytes as well as count. These
      ...
      // ADR-099: serialized commands share a group across command types,
      ...
      describe("when a group mixes __jobName (serialized commands)", () => {
        ...
        it("never mixes __jobName within a batch and restages foreign siblings", async () => {
          ...
          // batch-failure restage paths (ADR-099): exactly the one
