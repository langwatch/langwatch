...
/**
 * The columns that were declared without a merge rule before the converge
 * migration, and the merged migrations that still create them that way.
 *
 ...
 * afterwards. Every install therefore ends on the same schema.
 *
