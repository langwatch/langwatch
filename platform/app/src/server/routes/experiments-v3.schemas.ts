...
export const attachComparisonResponseSchema = z.object({
  comparisonTargetId: z
    .string()
    .describe("Identifier of the comparison target that was added"),
  createdTargetIds: z
    .array(z.string())
    .describe("Targets built for variants the experiment did not already have"),
  reusedTargetIds: z
    .array(z.string())
    .describe("Targets a variant matched, and so were used rather than copied"),
  targets: z
    .array(z.record(z.unknown()))
    .describe("The experiment's full target list after the comparison landed"),
});
