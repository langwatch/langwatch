...
import { type BillableEventRecorded, billableEventRecordedSchema } from "./events";
...
export function toBillableEventRow(data: BillableEventRecorded): BillableEventRecorded {
  return data;
}
