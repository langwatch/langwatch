...
/**
 * The billing poke (ADR-082 §5): a billable event happened somewhere in this
 ...
 *
 * Payload-cost shape (ADR-069) — three collapses stack, and they are the
...
>(deps: {
  ...
  /** ADR-082 §5 — the typed cross-pipeline port into billing-reporting. */
