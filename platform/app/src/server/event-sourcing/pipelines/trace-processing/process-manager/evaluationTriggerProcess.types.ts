 ...
 * transition — per span. This is that window, restored (ADR-069 invariant 4).
 *
 ...
 * process's business (ADR-069), and everything here is persisted verbatim into
 * the instance row.
 */
 ...
 *
 * Derived, never minted (ADR-081): the outbox skips a duplicate key on insert,
