...
export const SIMULATION_RUN_EVENT_TYPES = {
  ...
  METADATA_REFRESHED: "lw.simulation_run.metadata_refreshed",
} as const;
...
export const SIMULATION_PROCESSING_EVENT_TYPES = [
  ...
  SIMULATION_RUN_EVENT_TYPES.METADATA_REFRESHED,
...
export const SIMULATION_RUN_COMMAND_TYPES = {
  ...
  REFRESH_METADATA: "lw.simulation_run.refresh_metadata",
} as const;
...
export const SIMULATION_RUN_PROCESSING_COMMAND_TYPES = [
  ...
  SIMULATION_RUN_COMMAND_TYPES.REFRESH_METADATA,
