 ...
 * Sent by the `evaluationTrigger` process manager — one per monitor.
...
export const executeEvaluationCommandDataSchema = z.object({
  ...
  // Trace metadata passed from the evaluationTrigger process manager
 ...
 */
const startEvaluationCommandDataSchema = baseEvaluationSchema;
 ...
 */
const reportEvaluationCommandDataSchema = z.object({
  tenantId: z.string(),
  evaluationId: z.string(),
  evaluatorId: z.string(),
  evaluatorType: z.string(),
