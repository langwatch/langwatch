 ...
 * environment put together, and language detection carries ~95MB of language
 * models. The person who then goes looking for one of these deserves to be
 * told that, rather than shown a working-looking card that fails with
 * "internal error" when they run it.
 *
