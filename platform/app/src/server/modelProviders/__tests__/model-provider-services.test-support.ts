...
function unusedTestDoubleMethod(): never {
  throw new Error("This ModelProviderService test-double method is not used by this test.");
}
...
export class TestModelProviderService extends ModelProviderService {
  constructor(private readonly executionProviders: Record<string, ModelProviderExecution> = {}) {
    super();
  }
  ...
  async findAlternateModel(): Promise<never> {
    return unusedTestDoubleMethod();
  }
