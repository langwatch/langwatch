...
/**
 * The experimental gate over the whole governed SQL surface.
 *
 ...
 * answer.
 */
export const GOVERNED_SQL_FLAG = "release_governed_sql_workbench";

/**
 * Whether the governed SQL surface is open to this project.
 *
 ...
 */
export async function governedSqlEnabled({
  prisma,
  projectId,
}: {
  prisma: PrismaClient;
