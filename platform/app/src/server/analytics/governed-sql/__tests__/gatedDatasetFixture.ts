 ...
 *
 * A dataset gated as a whole is the case `GovernedViewDefinition.gates` exists
 * for, and the shipped catalog deliberately contains none — `governedViewCatalog`
 ...
 */
export const GATED_DATASET: GovernedViewDefinition = {
  name: "transcripts",
