...
describe("lwqlTimeWindowSchema", () => {
  ...
  it("rejects null rather than coercing it to the Unix epoch", () => {
    const parsed = lwqlTimeWindowSchema.safeParse({
      start: null,
      end: VALID_END,
    });
