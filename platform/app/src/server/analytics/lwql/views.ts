...
function postgresTenantPredicate({
  ...
  //
  // Postgres-resident views only exist in the reference/harness setup (a real
  // deploy never renders them — see `productionProvisioning.ts`), so the key
  // map is always `names.database` here.
