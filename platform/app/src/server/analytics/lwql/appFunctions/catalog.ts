...
/** What a function's key resolves to, which decides how it is fetched and capped. */
export const LWQL_APP_FUNCTION_KEY_KINDS = ["trace", "thread", "span"] as const;
...
/**
 * Every app function this API publishes.
 *
