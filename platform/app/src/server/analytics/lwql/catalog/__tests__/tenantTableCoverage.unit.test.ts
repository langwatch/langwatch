/**
 * Every table in the ClickHouse columns manifest must be accounted for.
 *
 ...
 * {@link LWQL_VIEW_CATALOG}), derived (produced by `deriveDefaultCatalog`), or
 * skipped (a key in {@link LWQL_CATALOG_SKIPPED_TABLES}, or matched by
...
// Step 6 (the merge into LWQL_VIEW_CATALOG) must call deriveDefaultCatalog this
// same way — manifest + skip map + the hand-written source tables, no
// overrides yet — so this coverage guard keeps meaning the same thing.
