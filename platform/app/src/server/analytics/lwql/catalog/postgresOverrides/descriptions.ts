 ...
 *
 * {@link ../derivePostgresCatalog#sanitizeDescription} produces a clean first
 ...
 * sentence; the derivation supplies everything else.
 *
 * @see ../derivePostgresCatalog.ts#sanitizeDescription — the default this refines
