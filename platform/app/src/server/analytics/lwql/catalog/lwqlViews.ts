...
/**
 * Coding-agent sessions: one row per coding-agent session (ADR-056).
 *
 * A fold projection into a `ReplacingMergeTree(UpdatedAt)` sorted
 * `(TenantId, StartedAt, SessionId)`. `StartedAt` is second in the sort key and
 * the write path *moves* it — an earlier signal arriving late shifts a
 * session's start — so, exactly like `evaluation_metrics`, `FINAL` would keep
 * two versions of one session under two sort keys and double every aggregate
 * over it. This entry therefore pins the `in-tuple` strategy and deduplicates by
 * the session (`max(UpdatedAt)` per `(TenantId, SessionId)`), whatever
 * `StartedAt` each version carries — the same rule the owning table's comment
 * spells out ("never FINAL").
 *
 * Light by design: every measure is a scalar, a bounded array, or a small map
 * keyed by a low-cardinality name. The internal read-back bookkeeping
 * (`SubAgentIds`, `MetricSeries`, `AppliedEventIds`, `StepStartedAt`, `Steps`,
 * `PreviousCallContextTokens`, `LastEventOccurredAt`, `TraceIds`,
 * `FinalRequestId`) is off-catalog: it describes how a row got written or reaches
 * the heavy data, not what the API promises to keep stable.
 */
const AGENT_SESSIONS: LangWatchQLViewDefinition = {
  name: "agent_sessions",
  sourceTable: "coding_agent_sessions",
  description:
    "One row per coding-agent session, with its shape, cost, tokens, timing, errors and what it shipped.",
  gates: [],
  ...
  columns: [
    ...
    },
    {
      name: "SessionId",
      type: "String",
      description: "The agent's own session identifier.",
      gates: [],
    ...
    },
    {
      name: "UpdatedAt",
      type: "DateTime64(3)",
      description: "When this version of the session row was written.",
      gates: [],
      sourceColumns: ["UpdatedAt"],
    },
    {
    ...
    },
    {
      name: "AgentVersion",
      type: "LowCardinality(String)",
      description: "Version of the agent that produced the session.",
      gates: [],
    ...
    },
    {
      name: "TerminalType",
      type: "LowCardinality(String)",
      description: "Kind of terminal the session ran in.",
      gates: [],
    ...
    },
    {
      name: "ModelCalls",
      type: "UInt32",
      description: "Model API calls made during the session.",
      gates: [],
    ...
    },
    {
      name: "Prompts",
      type: "UInt32",
      description: "User prompts the session received.",
      gates: [],
    ...
    },
    {
      name: "PromptChars",
      type: "UInt64",
      description: "Characters of prompt text across the session.",
      gates: [],
    ...
    },
    {
      name: "ResponseChars",
      type: "UInt64",
      description: "Characters of model response text across the session.",
      gates: [],
      sourceColumns: ["ResponseChars"],
    },
    {
      name: "ToolCounts",
      type: "Map(LowCardinality(String), UInt32)",
      description: "Call count per tool name.",
      gates: [],
    ...
    },
    {
      ...
      unit: "ms",
      description: "Total duration per tool name, in milliseconds.",
      gates: [],
    ...
    },
    {
      name: "SubAgentTypes",
      type: "Array(LowCardinality(String))",
      description: "Kinds of sub-agent the session spawned.",
      gates: [],
    ...
    },
    {
      name: "McpServers",
      type: "Array(LowCardinality(String))",
      description: "Model Context Protocol servers the session connected to.",
      gates: [],
    ...
    },
    {
      name: "McpTools",
      type: "Array(LowCardinality(String))",
      description: "Model Context Protocol tools the session called.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Input tokens consumed across the session.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Output tokens produced across the session.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Tokens served from the prompt cache across the session.",
      gates: [],
      sourceColumns: ["CacheReadTokens"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Tokens written into the prompt cache across the session.",
      gates: [],
    ...
    },
    {
      ...
      type: "Float64",
      unit: "USD",
      description: "Cost the agent reported for the session, in USD.",
      gates: ["costs"],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "ms",
      description: "Time spent in model calls, in milliseconds.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "ms",
      description: "Time spent running tools, in milliseconds.",
      gates: [],
    ...
    },
    {
      ...
      unit: "ms",
      description:
        "Summed time to first token across sampled calls, in milliseconds. Divide by TtftSamples for the mean.",
      gates: [],
    ...
    },
    {
      name: "TtftSamples",
      type: "UInt32",
      description: "Calls that contributed a time-to-first-token sample.",
      gates: [],
    ...
    },
    {
      ...
      unit: "ms",
      description:
        "Time the agent waited for a human to approve a tool, in milliseconds.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      description: "Active time attributed to the user, in seconds.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      description: "Active time attributed to the agent, in seconds.",
      gates: [],
    ...
    },
    {
      name: "ToolInputBytes",
      type: "UInt64",
      description: "Bytes of tool input across the session.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Context tokens before compaction, summed across the session.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Context tokens after compaction, summed across the session.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Largest single call's context, in tokens.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt32",
      description: "Calls that rebuilt most of the context rather than reading it from cache.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "The single worst cache rebuild, in tokens.",
      gates: [],
    ...
    },
    {
      ...
      type: "Map(LowCardinality(String), UInt32)",
      description: "Compaction count per trigger reason.",
      gates: [],
      sourceColumns: ["CompactionTriggers"],
      expression: (source) => contentFilteredMapSql(source("CompactionTriggers")),
    },
    {
      name: "FailedTools",
      type: "UInt32",
    ...
    },
    {
      name: "ErrorTypes",
      type: "Map(LowCardinality(String), UInt32)",
      description: "Error count per failure class.",
      gates: [],
    ...
    },
    {
      name: "ApiErrors",
      type: "UInt32",
      description: "Provider API errors during the session.",
      gates: [],
    ...
    },
    {
      name: "RateLimited",
      type: "UInt32",
      description: "Calls that were rate limited.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt32",
      description: "Rate-limit events the session recorded.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "ms",
      description: "Time spent retrying calls, in milliseconds.",
      gates: [],
    ...
    },
    {
      name: "Attempts",
      type: "UInt32",
      description: "Call attempts across the session, retries included.",
      gates: [],
    ...
    },
    {
      name: "Refusals",
      type: "UInt32",
      description: "Model refusals during the session.",
      gates: [],
    ...
    },
    {
      name: "ToolsDenied",
      type: "UInt32",
      description: "Tool calls a human denied, which therefore never ran.",
      gates: [],
    ...
    },
    {
      name: "ToolsAborted",
      type: "UInt32",
      description: "Tool calls a human aborted.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt32",
      description: "Times the permission mode changed during the session.",
      gates: [],
    ...
    },
    {
      name: "HooksBlocked",
      type: "UInt32",
      description: "Times a hook blocked the agent.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "ms",
      description: "Time spent in hooks, in milliseconds.",
      gates: [],
    ...
    },
    {
      ...
      type: "Array(LowCardinality(String))",
      description: "Programming languages the session edited.",
      gates: [],
    ...
    },
    {
      ...
      type: "String",
      description: "Session this one was forked from, empty when it is not a fork.",
      gates: [],
    ...
    },
    {
      name: "IsFork",
      type: "Bool",
      description: "Whether the session was forked from another.",
      gates: [],
    ...
    },
    {
      name: "RepositoryHost",
      type: "LowCardinality(String)",
      description: "Host of the repository the session worked in.",
      gates: [],
    ...
    },
    {
      ...
      type: "LowCardinality(String)",
      description: "Owner of the repository the session worked in.",
      gates: [],
    ...
    },
    {
      name: "RepositoryName",
      type: "LowCardinality(String)",
      description: "Name of the repository the session worked in.",
      gates: [],
    ...
    },
    {
      name: "GitBranch",
      type: "String",
      description: "Git branch the session started on.",
      gates: [],
    ...
    },
    {
      name: "GitBranches",
      type: "Array(String)",
      description: "Git branches the session touched.",
      gates: [],
    ...
    },
    {
      name: "GitWorktree",
      type: "String",
      description: "Git worktree the session ran in.",
      gates: [],
    ...
    },
    {
      name: "TitleSource",
      type: "LowCardinality(String)",
      description: "How the session's title was derived.",
      gates: [],
...
/**
 * Coding-agent session events: one row per per-call event within a session
 * (ADR-056).
 *
 * The per-call fact `agent_sessions` cannot be — one ordered scan per session
 * yields the interleaved sequence of model calls, compactions, rate limits,
 * tool runs and prompts that the session aggregate's converged totals erase.
 * A `ReplacingMergeTree(UpdatedAt)` sorted `(TenantId, SessionId, TimeUnixMs,
 * RecordId)`, where `RecordId` (the canonical log record's content hash) is the
 * dedup identity; the whole sort key holds still, so the shipped `FINAL`
 * default collapses a re-dispatched record onto the row it supersedes and one
 * row is one event. `TimeUnixMs` is a `DateTime64(3)` despite its name, so it is
 * the partition-pruning time column directly — no conversion needed.
 */
const AGENT_SESSION_EVENTS: LangWatchQLViewDefinition = {
  name: "agent_session_events",
  sourceTable: "coding_agent_session_events",
  description:
    "One row per coding-agent session event — a model call, compaction, rate limit, API error, tool run or prompt — in the order it happened.",
  gates: [],
  grain:
    "one row per (TenantId, SessionId, TimeUnixMs, RecordId), latest version only; one row per session event",
  joinKeys: ["TenantId", "SessionId"],
  ...
  columns: [
    ...
    },
    {
      name: "SessionId",
      type: "String",
      description: "Session the event belongs to. Join key to `agent_sessions`.",
      gates: [],
      sourceColumns: ["SessionId"],
    },
    {
      ...
      unit: "ms",
      description:
        "When the event happened, to millisecond resolution. Filter on this to prune partitions.",
      gates: [],
    ...
    },
    {
      name: "RecordId",
      type: "FixedString(64)",
      description: "Content hash of the event's canonical log record.",
      gates: [],
    ...
    },
    {
      name: "EventKind",
      type: "LowCardinality(String)",
      description: "Kind of event, for example model_call, compaction or tool_result.",
      gates: [],
    ...
    },
    {
      name: "TraceId",
      type: "String",
      description: "Trace the event correlated to, empty when it resolved none.",
      gates: [],
      sourceColumns: ["TraceId"],
    },
    {
      name: "SpanId",
      type: "String",
      description: "Span the event correlated to, empty when it resolved none.",
      gates: [],
      sourceColumns: ["SpanId"],
    },
    {
      name: "PromptId",
      type: "String",
      description: "Per-turn prompt identifier when the agent emitted one, empty otherwise.",
      gates: [],
    ...
    },
    {
      name: "QuerySource",
      type: "LowCardinality(String)",
      description: "Who issued the call, for example the main thread, the SDK, or a sub-agent.",
      gates: [],
    ...
    },
    {
      name: "AgentType",
      type: "LowCardinality(String)",
      description: "Sub-agent type the event carried, when it carried one.",
      gates: [],
    ...
    },
    {
      name: "EventSequence",
      type: "Int64",
      description: "In-session ordering tie-break within one timestamp, -1 when absent.",
      gates: [],
    ...
    },
    {
      name: "RequestId",
      type: "String",
      description: "Provider request identifier of a model call.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Input tokens the call consumed.",
      gates: [],
      sourceColumns: ["InputTokens"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Output tokens the call produced.",
      gates: [],
      sourceColumns: ["OutputTokens"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Tokens the call served from the prompt cache.",
      gates: [],
      sourceColumns: ["CacheReadTokens"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Tokens the call wrote into the prompt cache.",
      gates: [],
      sourceColumns: ["CacheCreationTokens"],
    },
    {
    ...
    },
    {
      ...
      type: "UInt32",
      unit: "ms",
      description: "Time to first token of the call, in milliseconds.",
      gates: [],
    ...
    },
    {
      name: "Attempt",
      type: "UInt16",
      description: "Attempt number of the call, retries included.",
      gates: [],
    ...
    },
    {
      name: "Speed",
      type: "LowCardinality(String)",
      description: "Speed tier of the call, as the agent classified it.",
      gates: [],
      sourceColumns: ["Speed"],
    },
    {
      name: "StopReason",
      type: "LowCardinality(String)",
      description: "Why the call stopped generating.",
      gates: [],
      sourceColumns: ["StopReason"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Context tokens before a compaction event.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Context tokens after a compaction event.",
      gates: [],
    ...
    },
    {
      ...
      type: "LowCardinality(String)",
      description: "What triggered a compaction event.",
      gates: [],
    ...
    },
    {
      ...
      type: "LowCardinality(String)",
      description: "Whether a compaction reused a precomputed result.",
      gates: [],
    ...
    },
    {
      name: "StatusCode",
      type: "LowCardinality(String)",
      description: "Status code of an API error, rate limit or exhausted retry.",
      gates: [],
      sourceColumns: ["StatusCode"],
    },
    {
      name: "ErrorType",
      type: "LowCardinality(String)",
      description: "Class of an error event.",
      gates: [],
    ...
    },
    {
      ...
      type: "UInt64",
      unit: "ms",
      description: "How long a retry waited, in milliseconds.",
      gates: [],
    ...
    },
    {
      name: "Success",
      type: "LowCardinality(String)",
      description: "Whether a tool run or compaction succeeded, as reported on the wire.",
      gates: [],
    ...
    },
    {
      name: "Decision",
      type: "LowCardinality(String)",
      description: "The permission decision on a tool call.",
      gates: [],
    ...
    },
    {
      name: "DecisionSource",
      type: "LowCardinality(String)",
      description: "What made the permission decision.",
      gates: [],
    ...
    },
    {
      name: "ToolInputBytes",
      type: "UInt64",
      description: "Bytes of input a tool call received.",
      gates: [],
      sourceColumns: ["ToolInputBytes"],
    },
    {
      name: "ToolResultBytes",
      type: "UInt64",
      description: "Bytes of output a tool call produced.",
      gates: [],
      sourceColumns: ["ToolResultBytes"],
    },
    {
      name: "PromptChars",
      type: "UInt32",
      description: "Characters in a user prompt event.",
      gates: [],
      sourceColumns: ["PromptChars"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Total tokens a completed sub-agent consumed.",
      gates: [],
    ...
    },
    {
      name: "RepositoryHost",
      type: "LowCardinality(String)",
      description: "Host of the repository the event's session worked in.",
      gates: [],
      sourceColumns: ["RepositoryHost"],
    },
    {
      name: "RepositoryOwner",
      type: "LowCardinality(String)",
      description: "Owner of the repository the event's session worked in.",
      gates: [],
      sourceColumns: ["RepositoryOwner"],
    },
    {
      name: "RepositoryName",
      type: "LowCardinality(String)",
      description: "Name of the repository the event's session worked in.",
      gates: [],
      sourceColumns: ["RepositoryName"],
    },
    {
      name: "Branch",
      type: "String",
      description: "Git branch the event's session worked on.",
      gates: [],
...
/**
 * FinOps usage: the cross-tool AI spend ledger (migration 00091).
 *
 * One row per priced unit of AI spend — a model call, a per-seat licence, cloud
 * compute, or a billed activity — pre-attributed to the person, team and
 * department that owns it. A `ReplacingMergeTree(UpdatedAt)` sorted
 * `(TenantId, Day, RowId)`; `RowId` is the charge's stable identity and `Day`
 * holds still for a `RowId`, so the shipped `FINAL` default collapses a
 * recomputed charge onto the row it supersedes and one row is one charge.
 */
const FINOPS_USAGE: LangWatchQLViewDefinition = {
  name: "finops_usage",
  sourceTable: "finops_usage_ledger",
  description:
    "One row per priced unit of AI spend — seats, tokens, cloud compute or billed activity — attributed to a person, team and department.",
  gates: [],
  grain:
    "one row per (TenantId, RowId), latest version only; one charge per row",
  joinKeys: ["TenantId", "Day"],
  timeColumn: "Day",
  freshness: "as fresh as the spend ledger's last computation",
  dedup: {
    keyColumns: ["TenantId", "Day", "RowId"],
    versionColumn: "UpdatedAt",
  },
  columns: [
    {
      name: "TenantId",
      type: "String",
      description: "Project the charge is attributed to.",
      gates: [],
      sourceColumns: ["TenantId"],
    },
    {
      name: "RowId",
      type: "String",
      description: "Stable identity of the charge.",
      gates: [],
      sourceColumns: ["RowId"],
    },
    {
      name: "Day",
      type: "Date",
      description: "Day the charge covers. Filter on this to prune partitions.",
      gates: [],
      sourceColumns: ["Day"],
    },
    {
      name: "Charge",
      type: "LowCardinality(String)",
      description: "Kind of charge: usage, seat, cloud or activity.",
      gates: [],
      sourceColumns: ["Charge"],
    },
    {
      name: "Tool",
      type: "LowCardinality(String)",
      description: "Tool the charge is for.",
      gates: [],
      sourceColumns: ["Tool"],
    },
    {
      name: "Provider",
      type: "LowCardinality(String)",
      description: "Provider that billed the charge.",
      gates: [],
    ...
    },
    {
      name: "Agent",
      type: "LowCardinality(String)",
      description: "Agent the charge is attributed to.",
      gates: [],
      sourceColumns: ["Agent"],
    },
    {
      name: "Model",
      type: "LowCardinality(String)",
      description: "Model the charge is for.",
      gates: [],
      sourceColumns: ["Model"],
    },
    {
      name: "PersonId",
      type: "String",
      description: "Identifier of the person the charge is attributed to.",
      gates: [],
      sourceColumns: ["PersonId"],
    },
    {
      name: "PersonName",
      type: "String",
      description: "Name of the person the charge is attributed to.",
      gates: [],
      sourceColumns: ["PersonName"],
    },
    {
      name: "TeamId",
      type: "LowCardinality(String)",
      description: "Identifier of the team the charge is attributed to.",
      gates: [],
      sourceColumns: ["TeamId"],
    },
    {
      name: "TeamName",
      type: "LowCardinality(String)",
      description: "Name of the team the charge is attributed to.",
      gates: [],
      sourceColumns: ["TeamName"],
    },
    {
      name: "DepartmentId",
      type: "LowCardinality(String)",
      description: "Identifier of the department the charge is attributed to.",
      gates: [],
    ...
    },
    {
      name: "DepartmentName",
      type: "LowCardinality(String)",
      description: "Name of the department the charge is attributed to.",
      gates: [],
    ...
    },
    {
      name: "Resource",
      type: "LowCardinality(String)",
      description: "Resource the charge is for.",
      gates: [],
      sourceColumns: ["Resource"],
    },
    {
      name: "KeyId",
      type: "String",
      description: "Identifier of the key the charge was billed against.",
      gates: [],
      sourceColumns: ["KeyId"],
    },
    {
      name: "Requests",
      type: "UInt64",
      description: "Requests the charge covers.",
      gates: [],
      sourceColumns: ["Requests"],
    },
    {
      name: "Units",
      type: "Float64",
      description: "Units of usage the charge covers, counted in Unit.",
      gates: [],
      sourceColumns: ["Units"],
    },
    {
      name: "Unit",
      type: "LowCardinality(String)",
      description: "What the Units column is counted in.",
      gates: [],
      sourceColumns: ["Unit"],
    },
    {
      ...
      type: "UInt64",
      unit: "tokens",
      description: "Input tokens the charge covers.",
      gates: [],
      sourceColumns: ["TokensIn"],
    },
    {
      name: "TokensOut",
      type: "UInt64",
      unit: "tokens",
      description: "Output tokens the charge covers.",
      gates: [],
      sourceColumns: ["TokensOut"],
    },
    {
      name: "CacheRead",
      type: "UInt64",
      unit: "tokens",
      description: "Cache-read tokens the charge covers.",
      gates: [],
      sourceColumns: ["CacheRead"],
    },
    {
      name: "CacheWrite",
      type: "UInt64",
      unit: "tokens",
      description: "Cache-write tokens the charge covers.",
      gates: [],
      sourceColumns: ["CacheWrite"],
    },
    {
      name: "Errors",
      type: "UInt64",
      description: "Errored requests the charge covers.",
      gates: [],
      sourceColumns: ["Errors"],
    },
    {
      name: "Cost",
      type: "Float64",
      unit: "USD",
      description: "Billed cost of the charge, in USD.",
      gates: ["costs"],
      sourceColumns: ["Cost"],
    },
    {
      ...
      type: "Float64",
      unit: "USD",
      description: "List-price cost of the charge before discount, in USD.",
      gates: ["costs"],
      sourceColumns: ["ListCost"],
    },
  ],
};
