...
export function useRegisterLangyPageContext(items: LangyContextChip[]) {
  // Read without `useLangy`: a page is also rendered where Langy is not
  // mounted (a test, a surface outside the project layout), and naming its
  // resource for Langy must not be what breaks it there.
