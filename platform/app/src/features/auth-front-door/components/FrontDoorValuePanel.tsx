...
import { BRAND, HEADING_FONT, MONO_FONT } from "../logic/brand";
...
export function FrontDoorValuePanel({
  ...
  return (
    ...
    >
      <div className="lw-front-door-ambient" data-testid="front-door-ambient" />
      <VStack
        position="relative"
        zIndex={1}
...
function AccentedHeadline({ text, accent }: { text: string; accent?: string }) {
  ...
  return (
    <>
      ...
      <Box
        as="span"
        backgroundImage={`linear-gradient(92deg, ${BRAND.action}, ${BRAND.detail})`}
        backgroundClip="text"
        color="transparent"
