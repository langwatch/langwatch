 ...
 * The auth screen is the first LangWatch surface most people see, and it should
    ...
    semanticTokens: {
      colors: {
        auth: {
           ...
           * on paper so the white digit stays readable, the solid orange on
           * ink.
           */
          badge: mode(brand[600], orange(0.92)),
