 ...
 *
 * Spec: specs/traces-v2/explorer-actions.feature ("The read projection
 * answers the page as the user sees it").
 */
import { describe, expect, it } from "vitest";
import { activeFacetsOf, readLiveExplorer } from "../explorerRead";
import { explorerState } from "./explorerFixtures";
