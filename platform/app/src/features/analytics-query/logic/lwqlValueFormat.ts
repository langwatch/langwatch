/**
 * How one cell of a LangWatchQL result becomes something a member can read
 ...
 * `resultSet.json()` (`~/server/analytics/lwql/executor.ts:218-226`),
...
import type { LangWatchQLColumn } from "~/server/analytics/lwql";
 ...
 */
export function duplicateLangWatchQLColumnNames(
