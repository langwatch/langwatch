...
export type LangWatchQLLanguageKind = "keyword" | "function";

/** One language entry of the editor's completion list. */
export interface LangWatchQLLanguageItem {
  readonly label: string;
  readonly kind: LangWatchQLLanguageKind;
  /** The short right-hand annotation shown beside the suggestion. */
  readonly detail: string;
}

/** The clauses and operators of a LangWatchQL read-only SELECT. */
...
/** ClickHouse functions a LangWatchQL analytics query most often reaches for. */
