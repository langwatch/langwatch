...
import type { GovernedVegaConfig } from "./langwatchVegaConfig";
import { isPlainObject, visitJsonObjects } from "./vegaLiteStructure";
import type { GovernedDataset } from "./visualization.types";
...
export interface BuildGovernedVegaSpecInput {
...
export interface GovernedVegaSpecBuild {
...
/**
 * Names every registered dataset the specification reads, in document order.
 *
...
export function buildGovernedVegaSpec({
  spec,
  datasets,
  pinnedConfig,
}: BuildGovernedVegaSpecInput): GovernedVegaSpecBuild {
