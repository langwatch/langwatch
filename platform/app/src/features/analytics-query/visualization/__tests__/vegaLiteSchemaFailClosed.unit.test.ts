 ...
 *
 * @see ../vegaLiteSchema.ts — the function under test
 * @see ./vegaLiteSchemaValidator.unit.test.ts — the real validator's fidelity
 */
...
vi.mock("../vegaLiteSchemaValidator.generated.js", () => {
...
const { validateAgainstVegaLiteSchema } = await import("../vegaLiteSchema");
