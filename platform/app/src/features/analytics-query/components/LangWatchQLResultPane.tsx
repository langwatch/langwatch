 ...
 * LangWatchQLResultPaneProps.renderChartArea}: one render function for both, so
...
import { LangWatchQLResultTable } from "./LangWatchQLResultTable";
 ...
 * joins to change.
 *
 * @see ~/server/analytics/lwql/validation/violations.ts
 */
 ...
 *
 * @see ~/server/analytics/lwql/executor.ts — the two ceilings
 */
