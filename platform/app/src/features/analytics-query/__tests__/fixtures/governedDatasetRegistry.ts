...
} from "~/features/analytics-query/visualization/visualization.types";

export const GOVERNED_FIXTURE_COLUMNS: Readonly<
...
export const GOVERNED_FIXTURE_ROW_COUNTS: DatasetRowCounts = {
  query_result: 500,
  model_catalog: 20,
};
