...
import { LangWatchQLVegaLoadBlockedError } from "../visualization/noNetworkVegaLoader";
import type {
  LangWatchQLDataset,
...
vi.mock("../visualization/buildLangWatchQLVegaSpec", async (importOriginal) => {
  ...
  return {
    ...
    buildLangWatchQLVegaSpec: (
      ...args: Parameters<typeof original.buildLangWatchQLVegaSpec>
    ) => {
      if (build.throwWith !== null) throw build.throwWith;
      return original.buildLangWatchQLVegaSpec(...args);
    },
  };
});
