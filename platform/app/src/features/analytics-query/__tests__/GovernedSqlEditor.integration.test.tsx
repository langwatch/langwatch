...
// synchronously and leaves the real `GovernedSqlEditor`, which is what these
...
const SCHEMA_MODEL = governedSchemaModel(SCHEMA_RESPONSE);
...
describe("the governed SQL editor", () => {
