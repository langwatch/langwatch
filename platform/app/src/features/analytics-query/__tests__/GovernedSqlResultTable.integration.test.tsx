...
import { GovernedSqlResultTable } from "../components/GovernedSqlResultTable";
...
function renderTable(result: GovernedSqlQueryResult) {
  return render(
...
function renderedRowIndexes(): number[] {
  return screen
    .queryAllByTestId("governed-sql-result-row")
...
describe("the governed SQL result table", () => {
  describe("given a result whose columns arrive in a defined order with ClickHouse types", () => {
    describe("when the table renders", () => {
      ...
      it("shows each ClickHouse type without the member opening anything", () => {
        ...
        expect(
          screen
            .getAllByTestId("governed-sql-column-type")
  ...
  describe("given a result whose columns list the same name twice", () => {
    describe("when the table renders", () => {
      ...
      it("warns that the repeated name carries one value per row", () => {
        ...
        const warning = screen.getByTestId("governed-sql-duplicate-columns");
      ...
      it("says nothing when every column name is distinct", () => {
        renderTable(governedSqlResult());

        expect(
          screen.queryByTestId("governed-sql-duplicate-columns"),
