...
} from "../components/GovernedSqlParametersEditor";

/** Renders the editor open, returning the spy holding every change it emits. */
function renderEditor() {
  const onChange = vi.fn<(change: GovernedSqlParametersChange) => void>();
...
describe("given the governed SQL parameters editor", () => {
