...
describe("parsePythonInsideJson", () => {
  it("returns the same object if no python code is found", () => {
    const obj = { a: 1, b: 2 };
    expect(parsePythonInsideJson(obj)).toEqual(obj);
  });

  it("returns the parsed python code if it is found", () => {
  ...
  it("parses a more complex object", () => {
    const obj = {
  ...
  it("parses unquoted uuids, and mix of = and : too", () => {
    const obj = {
