 ...
 *
 * The browser registration of the onboarding experiment property: a variant
 * registers it, no variant clears it.
 *
...
import { registerOnboardingExperiment } from "../onboardingExperimentRegistration";
