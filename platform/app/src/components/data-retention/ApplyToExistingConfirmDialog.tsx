    ...
    >
      <Dialog.Content>
            ...
            <VStack align="stretch" gap={3}>
              {pending.retentionDays === INDEFINITE_RETENTION_DAYS ? (
                <Text>
                  ...
                  indefinitely. No rows are deleted — this removes the retention limit
                ...
                <Text>
                  We will rewrite <strong>this project's</strong> existing data to use its
                  currently resolved retention policy. Rows older than the resolved
                  retention become eligible for deletion on the next background merge.
              ...
              {pending.savedScopeWiderThanCurrentProject && (
                <Alert.Root status="warning">
                  ...
                  <Alert.Content>
                    <Alert.Description>
                      You also saved an organization or team policy. New rows across those
                      scopes will use the new retention, but existing rows in other
                      projects keep their current retention until each project is visited
        ...
        <Dialog.Footer>
          ...
          <Button
            colorPalette={
              pending?.retentionDays === INDEFINITE_RETENTION_DAYS ? "blue" : "red"
            }
            loading={isApplying}
