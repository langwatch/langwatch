...
export const SPAN_TYPE_COLORS: Record<SpanType, string> = {
  llm: "blue.solidMuted",
  agent: "purple.solidMuted",
  tool: "green.solidMuted",
  rag: "teal.solidMuted",
  chain: "orange.solid",
  prompt: "yellow.solidMuted",
  guardrail: "red.solidMuted",
  evaluation: "pink.solidMuted",
  workflow: "blue.solid",
  component: "cyan.solidMuted",
  module: "cyan.solidMuted",
  span: "gray.emphasized",
  server: "gray.emphasized",
  client: "gray.emphasized",
  producer: "gray.emphasized",
  consumer: "gray.emphasized",
  task: "gray.emphasized",
  unknown: "gray.emphasized",
};
