  ...
  return (
    <>
      <Flex
        ...
        color={isSelected ? "orange.solidMuted" : "fg.default"}
      ...
      >
        ...
        <Text flex={1} truncate fontWeight="medium">
          {span.name}
        </Text>
        <Text
          flexShrink={0}
          ...
          color={SPAN_TYPE_COLORS[span.type]}
        >
          {span.type}
        </Text>
        {span.status === "error" && (
          <Text color="red.solidMuted" fontWeight="bold">
            !
          </Text>
        )}
