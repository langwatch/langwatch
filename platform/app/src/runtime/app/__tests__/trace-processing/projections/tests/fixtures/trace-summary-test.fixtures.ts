...
export const traceProjectionRuntime =
  AppTraceProjectionsAdapter.createRuntime(traceCanonicalisation);
const traceSummaryProjection = TraceSummaryFoldProjection.create({
