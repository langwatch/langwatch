      ...
      it("uses root langwatch.input/output for I/O, accumulates tokens and models", () => {
        const agentRunSpan = createTestSpan({
          ...
          spanAttributes: {
            ...
            "langwatch.output": "Quantum computing uses qubits that can exist in superposition.",
          },
        ...
        const modelStepSpan = createTestSpan({
          ...
          spanAttributes: {
            ...
            "gen_ai.input.messages": [{ role: "user", content: "Tell me about quantum computing" }],
            "gen_ai.output.messages": [
              {
                role: "assistant",
      ...
      it("extracts user_id and conversation.id into attributes, computes I/O and cost", () => {
        ...
        const llmSpan = createTestSpan({
          ...
          spanAttributes: {
            ...
            "gen_ai.input.messages": [{ role: "user", content: "Summarize the latest news" }],
            "gen_ai.output.messages": [
              {
                role: "assistant",
        ...
        expect(state.computedOutput).toBe("Here is a summary of the latest news headlines.");
      ...
      it("accumulates model, tokens, I/O, and span count", () => {
        const invokeAgentSpan = createTestSpan({
          ...
          spanAttributes: {
            ...
            "langwatch.output": "The compound interest for $10000 at 5% over 10 years is $6288.95.",
          },
          instrumentationScope: {
        ...
        const chatSpan = createTestSpan({
          ...
          spanAttributes: {
            ...
            "gen_ai.output.messages": [
              {
                role: "assistant",
                content: "The compound interest for $10000 at 5% over 10 years is $6288.95.",
              },
            ],
          },
          instrumentationScope: {
