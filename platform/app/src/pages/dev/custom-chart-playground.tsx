/**
 * Dev-only playground for authoring sandboxed custom HTML charts against the
 * real LangWatchQL endpoint. Two gates: the conditional route registration in
 * `src/routes.tsx` (chunk excluded from prod builds) and the NODE_ENV check
 * below (dead-code-eliminated in prod) — belt and suspenders.
 */
