...
const SubscriptionResponseMaxCreditLimitExtension_1 = require("./SubscriptionResponseMaxCreditLimitExtension");
...
exports.SubscriptionResponse = core.serialization.object({
    ...
    maxCreditLimitExtension: core.serialization.property("max_credit_limit_extension", SubscriptionResponseMaxCreditLimitExtension_1.SubscriptionResponseMaxCreditLimitExtension),
