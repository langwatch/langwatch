...
exports.ReferenceVideo = void 0;
const core = __importStar(require("../../core"));
const StudioClipReference_1 = require("./StudioClipReference");
exports.ReferenceVideo = core.serialization.object({
    ...
    studioClip: core.serialization.property("studio_clip", StudioClipReference_1.StudioClipReference.optional()),
});
