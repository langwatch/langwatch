...
import { type ChatCompletionAudio, ChatCompletionTokenLogprob, type ChatCompletion, type ChatCompletionChunk, type ChatCompletionCreateParams, type ChatCompletionCreateParamsBase, type ChatCompletionMessageParam, type ChatCompletionRole } from "../resources/chat/completions/completions.mjs";
