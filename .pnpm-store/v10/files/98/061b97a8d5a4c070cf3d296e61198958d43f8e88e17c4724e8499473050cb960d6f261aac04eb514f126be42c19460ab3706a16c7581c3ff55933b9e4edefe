...
exports.CreatePrivateKeyJwtRequest = void 0;
const core = __importStar(require("../../core"));
const CreatePrivateKeyJwtRequestAlgorithm_1 = require("./CreatePrivateKeyJwtRequestAlgorithm");
exports.CreatePrivateKeyJwtRequest = core.serialization.object({
    name: core.serialization.string(),
    provider: core.serialization.string(),
    algorithm: CreatePrivateKeyJwtRequestAlgorithm_1.CreatePrivateKeyJwtRequestAlgorithm.optional(),
