...
export type { BatchSpanProcessorOptions, BatchSpanProcessorBrowserOptions, SimpleSpanProcessorOptions, SpanLimits, SpanProcessorOptions, TracerProviderOptions, } from './types';
