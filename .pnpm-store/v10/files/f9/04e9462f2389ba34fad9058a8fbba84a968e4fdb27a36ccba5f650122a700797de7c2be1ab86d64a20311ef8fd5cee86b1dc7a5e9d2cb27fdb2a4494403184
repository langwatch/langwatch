...
exports.ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelOutput = void 0;
const core = __importStar(require("../../core"));
const DynamicVariableUpdateCommonModel_1 = require("./DynamicVariableUpdateCommonModel");
exports.ConversationHistoryTranscriptApiIntegrationWebhookToolsResultCommonModelOutput = core.serialization.object({
    ...
    dynamicVariableUpdates: core.serialization.property("dynamic_variable_updates", core.serialization.list(DynamicVariableUpdateCommonModel_1.DynamicVariableUpdateCommonModel)),
