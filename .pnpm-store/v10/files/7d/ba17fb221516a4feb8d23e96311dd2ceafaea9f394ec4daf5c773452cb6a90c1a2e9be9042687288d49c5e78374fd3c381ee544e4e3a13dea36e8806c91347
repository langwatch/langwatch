...
const ToolInterruptionMode_1 = require("../../../../../../../../types/ToolInterruptionMode");
...
const McpToolConfigOverrideCreateRequestModelToolCallSound_1 = require("../../types/McpToolConfigOverrideCreateRequestModelToolCallSound");
exports.McpToolConfigOverrideCreateRequestModel = core.serialization.object({
    ...
    toolCallSound: core.serialization.property("tool_call_sound", McpToolConfigOverrideCreateRequestModelToolCallSound_1.McpToolConfigOverrideCreateRequestModelToolCallSound.optional()),
