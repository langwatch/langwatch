...
const McpToolConfigOverrideOutputToolCallSound_1 = require("./McpToolConfigOverrideOutputToolCallSound");
...
exports.McpToolConfigOverrideOutput = core.serialization.object({
    ...
    toolCallSound: core.serialization.property("tool_call_sound", McpToolConfigOverrideOutputToolCallSound_1.McpToolConfigOverrideOutputToolCallSound.optional()),
