...
const CustomLlmAuthConnection_1 = require("./CustomLlmAuthConnection");
...
exports.CustomLlm = core.serialization.object({
    ...
    authConnection: core.serialization.property("auth_connection", CustomLlmAuthConnection_1.CustomLlmAuthConnection.optional()),
