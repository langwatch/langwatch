...
exports.SongSourceContext = void 0;
...
exports.SongSourceContext = core.serialization.object({
    ...
    generationSettings: core.serialization.property("generation_settings", core.serialization.record(core.serialization.string(), core.serialization.unknown()).optional()),
});
