...
exports.ToolExecutionResponseModelToolCallDetails = void 0;
const core = __importStar(require("../../core"));
const ConversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput_1 = require("./ConversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput");
...
exports.ToolExecutionResponseModelToolCallDetails = core.serialization
    .union("type", {
    api_integration_webhook: ConversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput_1.ConversationHistoryTranscriptToolCallApiIntegrationWebhookDetailsOutput,
