...
exports.StudioClipReference = void 0;
const core = __importStar(require("../../core"));
const StudioClipReferenceClipType_1 = require("./StudioClipReferenceClipType");
exports.StudioClipReference = core.serialization.object({
    ...
    clipType: core.serialization.property("clip_type", StudioClipReferenceClipType_1.StudioClipReferenceClipType),
