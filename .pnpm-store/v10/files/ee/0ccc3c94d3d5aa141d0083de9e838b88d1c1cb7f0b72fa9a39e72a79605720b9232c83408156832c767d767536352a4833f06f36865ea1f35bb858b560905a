...
exports.ApiIntegrationOAuth2AuthCodeResponse = void 0;
...
exports.ApiIntegrationOAuth2AuthCodeResponse = core.serialization.object({
    ...
    scopeSeparator: core.serialization.property("scope_separator", ApiIntegrationOAuth2AuthCodeResponseScopeSeparator_1.ApiIntegrationOAuth2AuthCodeResponseScopeSeparator.optional()),
