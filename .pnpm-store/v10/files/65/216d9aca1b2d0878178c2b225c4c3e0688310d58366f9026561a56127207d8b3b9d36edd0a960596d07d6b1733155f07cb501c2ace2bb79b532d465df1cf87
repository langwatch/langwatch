...
exports.TransferToAgentToolResultSuccessModelInput = void 0;
const core = __importStar(require("../../core"));
const TransferToAgentToolResultSuccessModelInputBranchInfo_1 = require("./TransferToAgentToolResultSuccessModelInputBranchInfo");
exports.TransferToAgentToolResultSuccessModelInput = core.serialization.object({
    ...
    branchInfo: core.serialization.property("branch_info", TransferToAgentToolResultSuccessModelInputBranchInfo_1.TransferToAgentToolResultSuccessModelInputBranchInfo.optional()),
