...
exports.TransferToAgentToolResultSuccessModelOutput = void 0;
const core = __importStar(require("../../core"));
const TransferToAgentToolResultSuccessModelOutputBranchInfo_1 = require("./TransferToAgentToolResultSuccessModelOutputBranchInfo");
exports.TransferToAgentToolResultSuccessModelOutput = core.serialization.object({
    ...
    branchInfo: core.serialization.property("branch_info", TransferToAgentToolResultSuccessModelOutputBranchInfo_1.TransferToAgentToolResultSuccessModelOutputBranchInfo.optional()),
