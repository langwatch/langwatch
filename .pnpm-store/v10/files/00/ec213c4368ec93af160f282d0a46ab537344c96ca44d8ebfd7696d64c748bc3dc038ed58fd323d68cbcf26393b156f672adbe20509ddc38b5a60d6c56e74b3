...
const AsrConversationalConfigOverride_1 = require("./AsrConversationalConfigOverride");
...
exports.ConversationConfigClientOverrideInput = core.serialization.object({
    asr: AsrConversationalConfigOverride_1.AsrConversationalConfigOverride.optional(),
