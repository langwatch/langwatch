...
exports.CreateExotelPhoneNumberRequest = void 0;
const core = __importStar(require("../../core"));
const ExotelApiSubdomain_1 = require("./ExotelApiSubdomain");
exports.CreateExotelPhoneNumberRequest = core.serialization.object({
    ...
    apiSubdomain: core.serialization.property("api_subdomain", ExotelApiSubdomain_1.ExotelApiSubdomain),
