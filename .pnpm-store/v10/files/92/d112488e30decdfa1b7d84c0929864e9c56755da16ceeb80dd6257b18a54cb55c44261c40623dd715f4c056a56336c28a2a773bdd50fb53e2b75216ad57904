...
const McpToolConfigOverrideInputToolCallSound_1 = require("./McpToolConfigOverrideInputToolCallSound");
...
exports.McpToolConfigOverrideInput = core.serialization.object({
    ...
    toolCallSound: core.serialization.property("tool_call_sound", McpToolConfigOverrideInputToolCallSound_1.McpToolConfigOverrideInputToolCallSound.optional()),
