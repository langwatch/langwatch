...
| 3 | [#5013](./pr-5013-heartbeat-graph-triggers.md) | `pr/04-heartbeat-graph-triggers` | ADR-038 outbox heartbeat primitive + ADR-034 Phase 5 graph triggers via outbox reactor + heartbeat absence-resolve. Flipped per project by `release_es_graph_triggers_firing`; cron coexists for un-flagged projects. |
