...
(`modules/dataset/web/src/screens/datasets/dataset-editor.screen.tsx`);
...
Reference: `modules/dataset/web/src/screens/datasets/dataset-editor.screen.tsx`
...
- Gated dependent read: `src/components/datasets/editor/DatasetEditorTable.tsx`, and its
  package copy `modules/dataset/web/src/ui/sections/dataset-editor-table.tsx`
