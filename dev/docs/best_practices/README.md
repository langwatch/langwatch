...
- **governed-sql-workbench.md** - Governed SQL workbench + governed Vega-Lite chart patterns: request-state discipline, backend-only validation, value fidelity, the chart governance chain, the lazy Vega boundary
