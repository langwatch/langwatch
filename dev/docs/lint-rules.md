...
Every rule the `langwatch` oxlint plugin registers (32 of them), rendered from the
...
- `serverPath`
  - what: `{{path}}` has no home in layout v0. Allowed: services/, ports/, repositories/, stores/, adapters/, projections/, subscribers/, processes/, intents/, rules/, tasks/, transport/<surface>/, migrations/, app/, fixtures/.
