...
commits. Evaluation/Workflow follow from their current review, then Scenario,
Gateway and the shared Model Provider cutover are integrated without mixing
their composition-root hunks.
