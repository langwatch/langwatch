...
(`modules/trace/process/src/services/claude-code-log-enrichment.service.ts`)
...
Components (`modules/trace/browser/src/ui/sections/explorer/trace-drawer/terminal-view/`):
