...
branch's `modules/project/server/src/transport/project.rest.ts` names it
...
ReferenceError: AuthzApi is not defined
    at GatewayApp.<static_initializer> (modules/gateway/server/src/app/gateway.app.ts:477:12)
```
