...
Progress is tracked in one place: the conversion board in
[`strict-feature-layout.md`](../strict-feature-layout.md) section 4. The 2026-09-04
table that stood here (15 of 49 features reviewed, 7 partly enacted) is retired;
stage 3 became the annotation-shape conversion, and a conversion lane reads the
`<feature>.md` review below when one exists.
