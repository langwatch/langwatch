...
| [101](./101-lwql-clickhouse-access-model-ownership.md) | The ClickHouse server owner owns the LangWatchQL access model — rendered config vs. app self-provisioning | Superseded by [141](./141-the-app-owns-the-lwql-access-model.md) |
...
| [136](./136-lwql-postgres-catalog-derived-opt-out.md) | The PostgreSQL half of the LangWatchQL catalog is derived from the Prisma manifest, opt-out | Accepted (inclusion policy amended by [142](./142-lwql-catalog-inclusion-is-opt-in.md); the derivation stands) |
| [141](./141-the-app-owns-the-lwql-access-model.md) | The app owns the LangWatchQL access model — no rendered copy | Accepted |
| [142](./142-lwql-catalog-inclusion-is-opt-in.md) | LangWatchQL catalog inclusion is opt-in — one include list per store is the only way in | Accepted |
