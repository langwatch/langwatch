...
- The ingestion-cost pattern we mirror: `personalUsage.service.ts:87-90,118,199-208` (Claude Code → `gateway_budget_ledger_events` under `Scope='principal'`)
- Spend read surfaces: `spendEvents.clickhouse.repository.ts:24` · `personalUsage.service.ts:171,282` · `analytics/.../field-mappings.ts:222-225`
