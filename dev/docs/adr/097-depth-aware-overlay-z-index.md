# ADR-097: Depth-Aware Z-Index for Portalled Overlay Components

**Date:** 2026-03-26

**Status:** Accepted

> Renumbered from 014 on 2026-07-29. This ADR was written one day after the
> series moved from `docs/adr/` to `dev/docs/adr/` and landed in the old
> directory by mistake, where it sat as a second, parallel "ADR-014" outside
> the series. It now takes the next free number here; `docs/adr/` is gone.
