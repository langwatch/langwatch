...
- `modules/scenario/contract/src/scenario-set-id.ts` -- exports `INTERNAL_SET_PREFIX`, `ON_PLATFORM_SET_SUFFIX`, `ON_PLATFORM_DISPLAY_NAME`, `isInternalSetId()`, `isOnPlatformSet()`, `getOnPlatformSetId()`
...
- Utility modules: `modules/scenario/contract/src/scenario-set-id.ts`, `modules/suite/contract/src/suite-set-id.ts`
- Related issue: #2344
