# ADR-096: durable stored-object offload for evaluation inputs

**Date:** 2026-07-10

**Status:** Proposed

**Relates to:** [ADR-022](./022-event-log-source-of-truth.md) (event_log as source of truth, transient S3 spool for trace payloads), [ADR-007](./007-event-sourcing-architecture.md) (event sourcing), [ADR-089 data-retention](./089-data-retention.md) (row TTL).
