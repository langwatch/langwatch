...
- **Exit:** `grep -ri auth0 platform/app` → changelog only; deploy pipeline green; agents-box QA green. **This is the DONE signal.**
- **Rollback:** none needed — nothing remains that can break.
