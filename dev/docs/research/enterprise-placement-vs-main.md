...
The original `modules/trace/process/src/rules/ingest-key-provenance.rules.ts`
...
[Enterprise Governance](../../../enterprise/modules/governance/process/src/rules/ingest-key-provenance.rules.ts)
