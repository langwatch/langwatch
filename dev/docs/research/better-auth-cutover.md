...
> **Amendment 2026-09-03:** This describes a deploy that already happened
...
> lives in `modules/auth/process/src/transport/better-auth/` and
> `modules/identity/process/src/better-auth/`. Kept as historical
