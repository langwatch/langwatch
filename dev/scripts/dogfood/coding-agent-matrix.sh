...
#
# Usage:
#   LW_API_KEY=sk-lw-... dev/scripts/dogfood/coding-agent-matrix.sh up claude
#   dev/scripts/dogfood/coding-agent-matrix.sh send claude 'say hi and exit'
#   dev/scripts/dogfood/coding-agent-matrix.sh drive-nested   # outer claude spawns children
#   dev/scripts/dogfood/coding-agent-matrix.sh capture claude
#   dev/scripts/dogfood/coding-agent-matrix.sh down
#
# Env:
