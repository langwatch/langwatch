...
export type ParameterRowProps = {
  ...
  /** Optional max override for sliders (e.g. model's maxCompletionTokens or provider limits) */
  maxOverride?: number;
...
function formatParameterValue(value: number | string | undefined, config: ParameterConfig): string {
  ...
  return String(displayValue).replace(/^./, (first) => first.toUpperCase());
}
  ...
  return (
    <Popover.Root
      ...
      positioning={{
        ...
        offset: { mainAxis: 4, crossAxis: 130 },
      }}
    >
