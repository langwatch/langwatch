...
import { WorkflowCodeEditor } from "@langwatch/workflow-web/workflow-code-editor";
          ...
          <Box height="400px">
            {open && (
              <WorkflowCodeEditor
                ...
                // The JSON-schema editor names no secrets: it edits a shape,
                // not a request. `platform/app` reached this component through
                // a transport that fetched the project's secret names for the
                // Python editor's autocomplete; a schema has no use for them.
                secretNames={[]}
              />
            )}
