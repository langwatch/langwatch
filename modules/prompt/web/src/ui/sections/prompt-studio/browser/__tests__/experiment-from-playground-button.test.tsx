...
describe("ExperimentFromPlaygroundButton", () => {
  ...
  describe("experiment creation", () => {
    ...
    it("navigates to experiment workbench after creation", async () => {
      ...
      await waitFor(() => {
        // The application's router push is the host's navigation now, and the
        // slug comes from the project in scope rather than from `router.query`.
        expect(testHost.navigations).toContain("/test-project/experiments/workbench/test-slug-123");
      });
    });
