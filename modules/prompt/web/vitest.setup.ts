 ...
 * `@langwatch/data-retention-web` and `@langwatch/model-provider-web` state for
 * themselves, for the same reasons. `@testing-library/jest-dom` registers the
 * DOM matchers the suites moved from `platform/app` were written against —
