...
export class AwsNlpLambdaFleetChannel implements NlpLambdaFleet {
  static create(options: {
    lambda: LambdaClient;
    logs: CloudWatchLogsClient;
    logger?: Pick<Logger, "warn">;
  }): AwsNlpLambdaFleetChannel {
    return new AwsNlpLambdaFleetChannel(options.lambda, options.logs, options.logger);
  }
