...
export class AwsNlpLambdaArnResolverChannel implements NlpLambdaArnResolver {
  ...
  }): AwsNlpLambdaArnResolverChannel {
    return new AwsNlpLambdaArnResolverChannel(options);
  }
