...
export function buildPoint(args: {
  ...
  const resource = isRecord(args.resourceMetric.resource) ? args.resourceMetric.resource : {};
  ...
  const seriesIdentity = {
    ...
    resource: {
      schemaUrl:
        typeof args.resourceMetric.schemaUrl === "string" ? args.resourceMetric.schemaUrl : "",
      attributes: resourceAttributes,
    },
    scope: {
      schemaUrl: typeof args.scopeMetric.schemaUrl === "string" ? args.scopeMetric.schemaUrl : "",
