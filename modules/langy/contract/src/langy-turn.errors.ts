...
/**
 * The intentional retry signal for a Langy worker dispatch. Initial dispatch runs through the
 * process outbox; heartbeat recovery runs as an event subscriber.
 */
