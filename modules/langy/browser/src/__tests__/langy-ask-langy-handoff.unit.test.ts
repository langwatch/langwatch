...
/**
 * The command bar's "Ask Langy" hands a question to the panel through the store: `askLangy`
 * opens the panel on a fresh conversation and QUEUES the question; the panel's effect auto-sends
 * it and calls `consumePendingPrompt` so it fires exactly once.
 */
