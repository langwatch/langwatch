...
export class RedisLangyConversationProducerRepository {
  static create(options: { processName: string }): RedisLangyConversationProducerRepository {
    return new RedisLangyConversationProducerRepository(options);
  }
