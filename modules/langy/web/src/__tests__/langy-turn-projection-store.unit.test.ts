...
/**
 * The store-level composition of the local turn projection with the turn-phase machine
 * (ADR-059): durable events drive the SAME machine the transport and the fold-flag effect
 * drive — a folded terminal settles it, a folded running turn confirms it, and a snapshot
 * naming an in-flight turn lets a refreshed tab adopt it.
 */
