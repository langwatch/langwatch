...
/** Loading screen that sees itself out with exit animation; reveals app underneath. */
export const LoadingScreen = () => {
  ...
  return (
    <motion.div
      ...
      // No entry fade on a re-mount: flashing the page from zero on every
      // subsequent wait is a wink, not a transition. No `exit` either — it
      // would never run; the way out is the ghost in the layout-effect
      // cleanup above, the only thing that survives an early-returned unmount.
