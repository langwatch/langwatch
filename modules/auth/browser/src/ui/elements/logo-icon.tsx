...
/** The box's silhouette and its interior wireframe, one compound path. */
export const LOGO_LINES_PATH =
...
export function LogoIcon({ width, height }: { width: number; height: number }) {
  return (
    ...
    >
      <path fill="#fff" d={LOGO_PLATE_PATH}></path>
      <path fill="#213B41" d={LOGO_LINES_PATH}></path>
    </svg>
  );
}
