...
export function validCodeEvaluatorFields(fields: CodeEvaluatorField[]): CodeEvaluatorField[] {
    ...
    <>
      ...
      <Field.Root>
        ...
        <Field.HelperText margin={0}>
          Define a Python class with a `__call__` method that takes the inputs and returns the
          outputs (passed, score, label or details).
        </Field.HelperText>
        <Box
          width="full"
          height="320px"
  ...
  return (
    <VStack align="stretch" gap={2}>
      ...
      <Text fontSize="xs" color="fg.muted">
        Return a dictionary from your function with any of these fields. Whichever you return become
      ...
      {fields.map((field, index) => (
        <HStack key={index} gap={2}>
          ...
          <IconButton
            ...
            onClick={() =>
              onFieldsChange(fields.filter((_, candidateIndex) => candidateIndex !== index))
            }
