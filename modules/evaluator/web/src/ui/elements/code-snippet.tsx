 ...
 * Chakra's own `CodeBlock` is what renders it — the gateway and analytics
 * families' usage snippets are the same shape, reached the same way.
 *
 * Highlighting is LAZY by construction: the adapter loads its grammars on first
 * render, so a reader who never opens the API dialog never downloads them.
 */
