...
export function EvaluatorListEmptyState({ onCreateNew, itemLabel }: EvaluatorListEmptyStateProps) {
  return (
    <VStack paddingY={24} gap={4} textAlign="center">
      ...
      <Button colorScheme="blue" onClick={onCreateNew} data-testid="create-first-evaluator-button">
        <Plus size={16} />
