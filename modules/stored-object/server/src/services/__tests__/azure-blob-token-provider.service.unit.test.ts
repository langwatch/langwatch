...
import { AzureTokenExchangeError } from "../azure-blob-token-provider.service.ts";
import { AzureBlobTokenProviderAdapter } from "../azure-blob-token-provider.service.ts";
