...
export class JoinRequestLedgerStore implements JoinRequestLedger {
  ...
  static create(deps: JoinRequestLedgerWriterDeps): JoinRequestLedgerStore {
    return new JoinRequestLedgerStore(deps);
  }
