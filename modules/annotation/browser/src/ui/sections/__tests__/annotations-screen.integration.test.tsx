...
describe("given a named queue's address", () => {
  ...
  describe("when the queue has been deleted", () => {
    it("keeps the annotation shell and names the missing queue", () => {
      mocks.queueError = {
        data: {
          error: {
            code: "annotation_queue_not_found",
            httpStatus: 404,
          },
        },
      };
      ...
      expect(screen.getByText("Annotation queue not found")).toBeInTheDocument();
