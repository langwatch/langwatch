 ...
 *
 * A copy of the one `@langwatch/navigation-web` carries, taken because a
 * feature-web package may not import another's presentation surface without
 * raising the edge every family already carries one of. It was moved there from
 * `platform/app/src/components/ProjectAvatar.tsx`. That file reached
