...
export class IoredisOpsSnapshotRedisAdapter extends OpsSnapshotRedisPort {
  static create(redis: IORedis | Cluster): IoredisOpsSnapshotRedisAdapter {
    return new IoredisOpsSnapshotRedisAdapter(redis);
  }
