...
export abstract class UsageStatsClickHouseClientPort {
...
export abstract class UsageStatsClickHouseClientResolverPort {
...
export abstract class UsageStatsTelemetryClientPort {
...
export abstract class UsageStatsErrorReporterPort {
