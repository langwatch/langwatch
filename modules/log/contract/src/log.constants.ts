...
export const LOG_PROCESSING_EVENT_TYPES = [CANONICAL_LOG_RECORD_RECEIVED_EVENT_TYPE] as const;

export const RECORD_CANONICAL_LOG_COMMAND_TYPE = "lw.obs.log.record_canonical_log" as const;
