// Every test setup: jest-dom matchers for assertions moved from platform/app, plus browser APIs
// jsdom doesn't ship (ResizeObserver, etc) that Chakra's overlays need for positioning.
