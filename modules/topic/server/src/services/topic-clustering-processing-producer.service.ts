...
import {
  ...
  type TopicModelData,
} from "./topic-clustering-eventing.service.ts";
 ...
 */
class ProducerOnlyTopicClusteringRun implements TopicClusteringRun {
...
class ProducerOnlyTopicClusteringMetrics implements TopicClusteringMetrics {
  constructor(private readonly processName: string) {}
