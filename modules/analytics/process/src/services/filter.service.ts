...
export class FilterService {
   ...
   */
  private constructor(private readonly repository: FilterOptionsRepository | null) {}

  static create(options: { repository: FilterOptionsRepository | null }): FilterService {
