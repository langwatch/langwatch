...
describe("given the LangWatchQL schema catalog when it is published for a caller", () => {
...
describe("given the LangWatchQL schema catalog when a column is withheld from the caller", () => {
