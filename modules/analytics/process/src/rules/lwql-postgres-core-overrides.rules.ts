/**
 * The six views that used to be hand-written in `postgresViews.ts`, now as overrides on the
 * derivation.
 */
...
export const CORE_POSTGRES_OVERRIDES: Record<string, PostgresDatasetOverride> = {
  ...
  LlmPromptConfig: {
    ...
    descriptions: {
      ...
      PromptHandle: "Globally unique handle of the prompt, null when it has none.",
  ...
  Experiment: {
    ...
    descriptions: {
      ...
      ExperimentSlug: "URL-safe name of the experiment, unique within the project.",
  ...
  BatchEvaluation: {
    ...
    descriptions: {
      ...
      DatasetSlug: "URL-safe name of the dataset the evaluated row came from.",
