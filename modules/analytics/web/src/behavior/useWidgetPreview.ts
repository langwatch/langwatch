...
import { useDashboardWidgetChartNavigate } from "./useDashboardWidgetChartNavigate.ts";
import { useDashboardWidgetExecutor } from "./useDashboardWidgetExecutor.ts";

/** How long the draft sits idle before the chart preview re-mounts. */
const PREVIEW_DEBOUNCE_MS = 600;

/**
 * Shared across the create drawer, card and in-place editor: a debounced
