...
(function () {
  ...
  // templates, React or Babel. the frame document defines window.__lwActivateAuthor
  ...
  window.addEventListener("message", function (event) {
    ...
    // Only the parent frame that embeds us may initialise the frame: a
    // document opened at top level, or cross-embedded by another window,
    // could otherwise post its own source and run arbitrary code.
