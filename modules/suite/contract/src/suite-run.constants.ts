...
export type SuiteRunProcessingEventType = (typeof SUITE_RUN_PROCESSING_EVENT_TYPES)[number];
...
export type SuiteRunProcessingCommandType = (typeof SUITE_RUN_PROCESSING_COMMAND_TYPES)[number];
