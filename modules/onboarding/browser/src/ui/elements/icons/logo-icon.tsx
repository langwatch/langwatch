/**
 * The LangWatch mark, colour-mode aware. Duplicated from the plain
...
/**
 * The mark for a surface that follows the colour mode: white faces and navy
 * lines on light; on dark the faces drop out and the lines go off-white.
 */
