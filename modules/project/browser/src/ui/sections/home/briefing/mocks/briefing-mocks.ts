...
const SCENARIOS: Record<ScenarioKey, ScenarioShape> = {
  ...
  passing: {
    ...
    bars: [
      bar({ id: "a", label: "refund · within policy", status: "pass", fillPct: 98 }),
      bar({ id: "b", label: "refund · outside policy", status: "pass", fillPct: 96 }),
      bar({ id: "c", label: "partial refund · negotiation", status: "pass", fillPct: 94 }),
    ],
  ...
  mixed: {
    ...
    bars: [
      bar({ id: "a", label: "refund · within policy", status: "pass", fillPct: 97 }),
      bar({ id: "b", label: "refund · outside policy", status: "pass", fillPct: 94 }),
      bar({ id: "c", label: "angry escalation (DE)", status: "fail", fillPct: 100 }),
      bar({ id: "d", label: "partial refund · negotiation", status: "pass", fillPct: 92 }),
    ],
  ...
  failing: {
    ...
    bars: [
      bar({ id: "a", label: "checkout · happy path", status: "pass", fillPct: 95 }),
      bar({ id: "b", label: "checkout · declined card", status: "fail", fillPct: 100 }),
      bar({ id: "c", label: "address · ambiguous", status: "fail", fillPct: 100 }),
