 ...
 * `@langwatch/coding-agent-browser`'s narrow port and the personal-workspace
...
} from "@langwatch/coding-agent-browser/surfaces/activity";
...
class PersonalCodingAgentHost extends CodingAgentActivityHost {
  constructor(private readonly host: PersonalWorkspaceHostApi) {
    super();
  }
