...
export const serverModuleMembers = {
  ...
  auth: ["publicBaseUrl"],
  authz: ["prisma", "redis"],
  automation: ["encryption", "logger", "prisma", "publicBaseUrl", "redis"],
  "coding-agent": [],
  ...
  monitor: ["monitor"],
  notification: [],
  ops: ["clickhouse", "eventing", "logger", "nodeEnvironment", "prisma", "redis"],
  ...
  prompt: ["logger", "prisma", "publicBaseUrl", "rateLimiter"],
  role: ["prisma"],
