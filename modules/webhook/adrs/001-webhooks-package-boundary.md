...
**Behavioural contract:** [Webhook endpoints](../specs/webhooks.feature)

**Placement amended by:** [ADR-134](../../../../dev/docs/adr/134-private-prisma-table-ownership.md).
Outbound delivery is core, shared by Automation and Enterprise callers.
Endpoint-management entitlement checks remain unchanged.
