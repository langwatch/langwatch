 ...
 */
export abstract class McpApiKeyCipher {
 ...
 */
export abstract class McpSessionGrant {
 ...
 * included.
 */
export abstract class McpClientAddress {
 ...
 */
export abstract class McpSessionToolRegistrar {
...
export type HostedMcpDependencies = Readonly<{
  ...
  /** Absent installs no extra tools; see {@link McpSessionToolRegistrar}. */
