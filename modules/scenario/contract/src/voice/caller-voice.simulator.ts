...
export function callerVoiceAudioEffects(effect: CallerVoiceConfig["effects"]): AudioEffect[] {
  switch (effect) {
    case "phone_line":
      return [ScenarioRunner.voice.effects.phoneQuality()];
    case "background_noise":
      return [ScenarioRunner.voice.effects.backgroundNoise(BACKGROUND_NOISE_PRESET)];
    case "none":
      return [];
  }
}
