/** Stable Simulation event and command identifiers. */
...
export const SIMULATION_RUN_EVENT_TYPES = {
  ...
  EVALUATED: "lw.simulation_run.evaluated",
  ...
  AGENT_INSTANCE_RECORDED: "lw.simulation_run.agent_instance_recorded",
  CUT_AT_LIMIT_RECORDED: "lw.simulation_run.cut_at_limit_recorded",
} as const;
...
export const SIMULATION_PROCESSING_EVENT_TYPES = [
  ...
  SIMULATION_RUN_EVENT_TYPES.AGENT_INSTANCE_RECORDED,
  SIMULATION_RUN_EVENT_TYPES.CUT_AT_LIMIT_RECORDED,
  SIMULATION_SET_EVENT_TYPES.ARCHIVED,
] as const;

export type SimulationProcessingEventType = (typeof SIMULATION_PROCESSING_EVENT_TYPES)[number];
...
export const SIMULATION_RUN_COMMAND_TYPES = {
  ...
  RECORD_EVALUATIONS: "lw.simulation_run.record_evaluations",
  DELETE: "lw.simulation_run.delete",
  COMPUTE_METRICS: "lw.simulation_run.compute_metrics",
  CANCEL: "lw.simulation_run.cancel",
  RECORD_AGENT_INSTANCE: "lw.simulation_run.record_agent_instance",
  RECORD_CUT_AT_LIMIT: "lw.simulation_run.record_cut_at_limit",
} as const;
...
export const SIMULATION_RUN_PROCESSING_COMMAND_TYPES = [
  ...
  SIMULATION_RUN_COMMAND_TYPES.RECORD_AGENT_INSTANCE,
  SIMULATION_RUN_COMMAND_TYPES.RECORD_CUT_AT_LIMIT,
...
export const SIMULATION_EVENT_VERSIONS = {
  ...
  AGENT_INSTANCE_RECORDED: "2026-08-30",
  CUT_AT_LIMIT_RECORDED: "2026-09-09",
