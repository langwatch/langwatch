...
/**
 * Authentication strategies mapped by type, each returning headers to add
 * to the request. The discriminated union guarantees required fields per
 * type, but each strategy still narrows at runtime for type safety.
 */
