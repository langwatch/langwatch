...
describe("<ScenarioFormDrawer/>", () => {
  ...
  describe("when clicking Add New Agent", () => {
    ...
    it("opens the agent type selector drawer by address", async () => {
      await clickCreateAgentButton();

      // The type selector is @langwatch/agent-browser's drawer, opened by
      // address rather than mounted inline: a scenario component cannot
      // mount another family's drawer above its own host.
