/**
 * The line under the suite name: fields its scenarios carry, and evaluators
 * every run gets. Shown only when there's something to list; every chip
 * opens the suite editor on that attachment.
