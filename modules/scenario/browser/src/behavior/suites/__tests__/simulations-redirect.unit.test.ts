/**
 * Anything under /simulations that is not a known shape is read as an external SET slug, so
 * a near-miss URL renders an empty run history instead of the page the user meant.
