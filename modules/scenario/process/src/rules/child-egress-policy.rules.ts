...
export function encodeScenarioEgressPolicy(policy: ScenarioEgressPolicy): string {
 ...
 */
export function decodeScenarioEgressPolicy(raw: string | undefined): ScenarioEgressPolicy {
  if (!raw) {
    throw new Error(
