...
/**
 * Where a run's unexpected failure is reported, beyond the log line. The
 * retired application sent these to product-analytics; nothing downstream
 * reads it, so composing none loses no visible behaviour — optional, not a null object.
 */
