/** What a target input reads its value as. @see specs/experiments-v3/attachment-inputs.feature */
import type { ExecutionCell, TargetConfig } from "@langwatch/experiment-contract";
import { describe, expect, it } from "vitest";

import { columnTypeOfInputFor } from "../experiment-attachment-input.rules.ts";
...
const cellWith = ({
  ...
  mappings: TargetConfig["mappings"][string];
