...
/**
 * Hover copy for the "missing variable mappings" alert icon shown on both target
 * headers (target-header.tsx) and evaluator chips (evaluator-chip.tsx).
 */
 ...
 * (`experiment_stale_workbench_state`). Nothing was written and nothing was lost, so
 * the toolbar names this state rather than calling it a failed save.
 */
