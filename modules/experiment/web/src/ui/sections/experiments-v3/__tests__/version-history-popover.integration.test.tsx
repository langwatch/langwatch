...
/** Only the slice the history button and its list actually select. */
type StoreSlice = {
  experimentId: string;
  experimentSlug: string;
  loadState: (state: unknown) => void;
  setWorkbenchVersion: (version: number) => void;
...
const historyTrigger = () => screen.getByRole("button", { name: "Version history" });
