...
<<<<<<< HEAD:modules/experiment/server/src/processes/experiment-cell-workflow.process.ts
...
>>>>>>> origin/main:platform/app/src/server/experiments-v3/execution/workflowBuilder.ts
