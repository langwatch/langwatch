/**
 * What a target or an evaluator is actually handed at dispatch, and whether it should be dispatched
 * at all: a cell's mappings resolve into an input record and the two dispatch guards answer here.
