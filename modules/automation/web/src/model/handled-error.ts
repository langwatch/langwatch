// Handled-error payload subset: code and field rejection info; see platform/app's
// readHandledError for full envelope and presentation registry for code->copy mapping.
