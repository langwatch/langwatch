...
export function EvalFailureDetailedWireframe() {
  return <WireStack rows={["header", "context", "divider", "quote", "quote", "context"]} />;
}
...
export function EvalFailureRichWireframe() {
  return <WireStack rows={["alertError", "context", "divider", "quote", "quote", "context"]} />;
}

export function DigestCompactWireframe() {
  return (
    <WireStack
      rows={["header", "context", "divider", "bullet", "bullet", "bullet", "bullet", "context"]}
    />
  );
}
...
export function ReportDashboardWireframe() {
  return <WireStack rows={["header", "context", "chart", "chart", "section", "context"]} />;
}
