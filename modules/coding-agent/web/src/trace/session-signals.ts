...
interface SignalRule {
  id: string;
  tone: SessionSignalTone;
  applies: (row: CodingAgentSessionDisplay) => boolean;
  title: (row: CodingAgentSessionDisplay) => string;
  detail: (row: CodingAgentSessionDisplay) => string;
}
...
export function deriveSessionSignals(row: CodingAgentSessionDisplay): SessionSignal[] {
