...
export abstract class DatasetStorageDestinationService {
 ...
 * own AWS transport.
 */
export class DatasetObjectStorageS3ClientResolverAdapter implements DatasetS3ClientResolver {
 ...
 * itself.
 */
export class DatasetObjectStorageResolverAdapter implements DatasetStorageResolver {
  private azure: AzureDatasetStorageAdapter | undefined;
  private readonly s3: S3DatasetStorageAdapter;

  private constructor(
    private readonly destination: DatasetStorageDestinationService,
