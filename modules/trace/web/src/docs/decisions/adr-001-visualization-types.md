...
Status: ACCEPTED
Date: 2026-04-22
Relates to: `specs/traces-v2/visualizations.feature`, `modules/trace/specs/flame-graph.feature`, `span-list.feature`
...
- **Shared behavior** (colors, selection, hover, edge cases) is documented in `specs/traces-v2/visualizations.feature` and referenced by `modules/trace/specs/flame-graph.feature` and `span-list.feature`
