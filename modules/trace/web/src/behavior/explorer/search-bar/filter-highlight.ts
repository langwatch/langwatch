...
/**
<<<<<<< HEAD:modules/trace/web/src/behavior/explorer/search-bar/filter-highlight.ts
...
>>>>>>> origin/main:platform/app/src/features/traces-v2/components/SearchBar/filterHighlight.ts
 */
