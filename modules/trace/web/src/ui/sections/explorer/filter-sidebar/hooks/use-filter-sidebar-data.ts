...
<<<<<<< HEAD:modules/trace/web/src/ui/sections/explorer/filter-sidebar/hooks/use-filter-sidebar-data.ts
...
=======
      ...
      // discovered values.
>>>>>>> origin/main:platform/app/src/features/traces-v2/components/FilterSidebar/hooks/useFilterSidebarData.ts
