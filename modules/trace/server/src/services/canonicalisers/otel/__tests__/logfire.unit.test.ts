...
import { createExtractorContext, parseJsonStringAttrs } from "../../__tests__/test-helpers.ts";
...
describe("LogfireCanonicaliserService", () => {
  const extractor = LogfireCanonicaliserService.create();
