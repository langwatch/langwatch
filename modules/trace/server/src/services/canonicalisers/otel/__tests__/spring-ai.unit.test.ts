...
import { createLogExtractorContext } from "../../__tests__/test-helpers.ts";
...
describe("SpringAICanonicaliserService.applyLog", () => {
  it("lifts prompt body onto langwatch.input", () => {
    ...
    SpringAICanonicaliserService.create().applyLog(ctx);
