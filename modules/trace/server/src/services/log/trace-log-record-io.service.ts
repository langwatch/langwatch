...
import { CLAUDE_CODE_SCOPE_NAMES } from "../canonicalisers/coding-agent/claude-code-canonicaliser.service.ts";
import { SPRING_AI_SCOPE_NAMES } from "../canonicalisers/otel/spring-ai-canonicaliser.service.ts";
