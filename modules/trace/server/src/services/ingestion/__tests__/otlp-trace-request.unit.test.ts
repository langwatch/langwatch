...
<<<<<<< HEAD:modules/trace/server/src/services/ingestion/__tests__/otlp-trace-request.unit.test.ts
...
>>>>>>> origin/main:platform/app/src/server/event-sourcing/pipelines/trace-processing/utils/__tests__/traceRequest.utils.test.ts
