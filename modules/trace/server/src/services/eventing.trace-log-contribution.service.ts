...
export class EventingTraceLogContributionAdapter implements CommandHandler<
  ...
  LogContributedEvent
> {
  static create(): EventingTraceLogContributionAdapter {
    return new EventingTraceLogContributionAdapter();
  }
  ...
  async handle(command: Command<RecordLogContributionCommandData>): Promise<LogContributedEvent[]> {
...
export const recordLogContributionCommand = EventingTraceLogContributionAdapter;
