...
import type { ExplorerTransform } from "./types.ts";
 ...
 */
export const select: ExplorerTransform<
  SelectPayload,
...
export const expandRow: ExplorerTransform<ExpandRowPayload, { key: string; expanded: boolean }> = ({
  state,
  payload,
}) => {
