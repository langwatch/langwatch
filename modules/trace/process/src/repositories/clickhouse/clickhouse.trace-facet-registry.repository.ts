...
import { LABEL_FACET } from "./clickhouse.trace-facet-label.repository.ts";
import {
  METADATA_KEYS_FACET,
...
export class ClickHouseFacetRegistryAdapter {
  static create(): ClickHouseFacetRegistryAdapter {
    return new ClickHouseFacetRegistryAdapter();
  }

  static readonly TABLE_TIME_COLUMNS: Record<FacetTable, string> = {
    trace_summaries: "OccurredAt",
    evaluation_runs: "ScheduledAt",
    stored_spans: "StartTime",
  };

  static readonly FACET_REGISTRY: readonly FacetDefinition[] = [
