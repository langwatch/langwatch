Feature: Vertex AI Agent Engine (Google ADK) span canonicalisation
  Google ADK spans keep conversation and tool content in vendor payloads while
  standard gen_ai attributes carry identity and usage. Canonicalisation lifts
  those payloads into the ordinary trace input, output and tool shapes.
