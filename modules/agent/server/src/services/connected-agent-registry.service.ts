...
export class ConnectedAgentRegistryService {
  static create(store: SessionStateStore): ConnectedAgentRegistryService {
    return new ConnectedAgentRegistryService(store);
  }
