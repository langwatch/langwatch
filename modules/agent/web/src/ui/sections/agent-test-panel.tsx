...
<<<<<<< HEAD:modules/agent/web/src/ui/sections/agent-test-panel.tsx
=======
 *
 ...
 *
>>>>>>> origin/main:platform/app/src/components/agents/AgentTestPanel.tsx
...
<<<<<<< HEAD:modules/agent/web/src/ui/sections/agent-test-panel.tsx
export function AgentTestPanel({ agentId, projectId, offline = false }: AgentTestPanelProps) {
  const [message, setMessage] = useState(AGENT_TEST_DEFAULT_MESSAGE);
  const test = agentApi.agents.testTurn.useMutation();
  const instance = test.data?.instance;
=======
...
<<<<<<< HEAD:modules/agent/web/src/ui/sections/agent-test-panel.tsx
              onClick={() => test.mutate({ id: agentId, projectId, message: message.trim() })}
=======
              onClick={() =>
                test.mutate({
                  id: agentId,
