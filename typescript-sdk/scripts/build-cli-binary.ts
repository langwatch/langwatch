...
const result = await Bun.build({
  ...
  // via `noExternal`, or the binary cannot resolve it at runtime.
  // Bun bundles all imports by default, so this is implicit — asserted by the
  // smoke test in scripts/verify-cli-binary.sh rather than a flag here.
  throw: true,
});
