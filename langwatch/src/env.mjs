...
export const env = createEnv({
  ...
  server: {
    ...
    AWS_COMPREHEND_ACCESS_KEY_ID: z.string().min(1).optional(),
    AWS_COMPREHEND_SECRET_ACCESS_KEY: z.string().min(1).optional(),
  ...
  runtimeEnv: {
    ...
    AWS_COMPREHEND_ACCESS_KEY_ID: process.env.AWS_COMPREHEND_ACCESS_KEY_ID,
    AWS_COMPREHEND_SECRET_ACCESS_KEY:
      process.env.AWS_COMPREHEND_SECRET_ACCESS_KEY,
