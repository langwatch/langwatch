...
// NOTE: limits router must be dynamically imported to avoid circular dependency:
// limits router → UsageLimitService → elasticsearch (dynamic import breaks the cycle)
