 ...
 * with the actor set to the resolved API-key user id; service-to-service
 * audit attribution still requires a userId by virtue of the unified
 * AuditLog schema (kept stricter than the legacy gateway-only table).
 */
