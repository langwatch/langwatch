...
describe("TraceIdPeek", () => {
  ...
  describe("when an occurredAtMs hint is supplied", () => {
    it("forwards it to the drawer it opens as the `t` partition hint", async () => {
      render(
    ...
    it("forwards it to the peek summary fetch on hover", async () => {
      render(
        <TraceIdPeek traceId="trace-1" occurredAtMs={1_700_000_000_000} />,
        {
          wrapper: Wrapper,
  ...
  describe("when no occurredAtMs hint is supplied", () => {
