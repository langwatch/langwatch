  ...
  describe("when originalKind is provided", () => {
    describe("when originalKind is SERVER", () => {
      it("returns SpanKind.SERVER", () => {
        const result = convertSpanKind("span" as SpanType, ESpanKind.SPAN_KIND_SERVER);
    ...
    describe("when originalKind is CLIENT", () => {
      it("returns SpanKind.CLIENT", () => {
        const result = convertSpanKind("client" as SpanType, ESpanKind.SPAN_KIND_CLIENT);
    ...
    describe("when originalKind is PRODUCER", () => {
      it("returns SpanKind.PRODUCER", () => {
        const result = convertSpanKind("producer" as SpanType, ESpanKind.SPAN_KIND_PRODUCER);
    ...
    describe("when originalKind is CONSUMER", () => {
      it("returns SpanKind.CONSUMER", () => {
        const result = convertSpanKind("consumer" as SpanType, ESpanKind.SPAN_KIND_CONSUMER);
    ...
    describe("when originalKind is INTERNAL", () => {
      it("returns SpanKind.INTERNAL", () => {
        const result = convertSpanKind("span" as SpanType, ESpanKind.SPAN_KIND_INTERNAL);
