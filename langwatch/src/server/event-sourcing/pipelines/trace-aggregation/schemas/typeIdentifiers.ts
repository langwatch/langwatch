...
export const TRACE_AGGREGATION_COMPLETED_EVENT_TYPE =
  "lw.obs.trace_aggregation.completed" as const;
...
export const TRACE_AGGREGATION_TRIGGER_COMMAND_TYPE =
  "lw.obs.trace_aggregation.trigger" as const;

export const TRACE_AGGREGATION_COMMAND_TYPES = [
  TRACE_AGGREGATION_TRIGGER_COMMAND_TYPE,
] as const;

export type TraceAggregationCommandType =
