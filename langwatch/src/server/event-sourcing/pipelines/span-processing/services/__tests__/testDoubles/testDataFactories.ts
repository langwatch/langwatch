...
export function createMockReadableSpan(
  overrides: MockReadableSpanOverrides = {},
): ReadableSpan {
...
export function createMockTraceForCollection(
  overrides: Partial<TraceForCollection> = {},
): TraceForCollection {
  return {
...
export function createMockExportTraceServiceRequest(
  overrides: Partial<IExportTraceServiceRequest> = {},
): IExportTraceServiceRequest {
  return {
    resourceSpans:
      overrides.resourceSpans ??
      ([
        {
          resource: {
            attributes: [
