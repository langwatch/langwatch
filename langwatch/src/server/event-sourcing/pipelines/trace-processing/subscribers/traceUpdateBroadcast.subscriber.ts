 ...
 *
 * The live path is still `../reactors/traceUpdateBroadcast.reactor.ts`, built
 ...
 * — `.withEventSubscriber("traceUpdateBroadcast", …)` — with the reactor and
 ...
 * summary for this trace is already stored" — which is what the payload has
 * always meant to the client, since it refetches rather than trusting the push.
 */
