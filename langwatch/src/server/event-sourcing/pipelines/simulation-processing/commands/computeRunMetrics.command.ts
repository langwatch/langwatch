...
/**
 * Factory that returns a CommandHandlerClass for computing simulation run metrics.
 *
 * Supports two modes:
 ...
 */
export function createComputeRunMetricsCommandClass(deps: ComputeRunMetricsDeps) {
  return class ComputeRunMetricsCommand
    implements
      CommandHandler<
