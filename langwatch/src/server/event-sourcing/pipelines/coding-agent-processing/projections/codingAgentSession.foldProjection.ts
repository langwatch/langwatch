 ...
 *  turn twice; rejecting that stamp is what rebuilds them. It also re-labels
 *  sessions the registry now detects as Cowork but which first folded under
 *  `claude_code` (identity is first-writer-wins, so only a refold moves it).
 *
