...
export class PipelineRegistry {
  ...
  private registerTracePipeline({
    ...
    // Register the recurring pull-mode ingestion job on the same durable
    // global queue. Self-re-arms at each source's cron next-fire time; seeded
    // at worker start by seedIngestionPullers(). No BullMQ, no Linux cron.
