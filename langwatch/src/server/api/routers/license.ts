...
const planLimitsSchema = z.object({
  ...
  maxOnlineEvaluations: z.number().int().positive("Plan limits must be positive numbers"),
  maxDatasets: z.number().int().positive("Plan limits must be positive numbers"),
  maxDashboards: z.number().int().positive("Plan limits must be positive numbers"),
  maxCustomGraphs: z.number().int().positive("Plan limits must be positive numbers"),
  maxAutomations: z.number().int().positive("Plan limits must be positive numbers"),
    ...
    .mutation(async ({ input }) => {
      ...
      const licenseData: LicenseData = {
        ...
        plan: {
          ...
          maxOnlineEvaluations: plan.maxOnlineEvaluations,
          maxDatasets: plan.maxDatasets,
          maxDashboards: plan.maxDashboards,
          maxCustomGraphs: plan.maxCustomGraphs,
