...
describe("stripOtlpSpanContent", () => {
  describe("given every content category is dropped", () => {
  ...
  describe("given only tool calls are dropped", () => {
  ...
  describe("given input is dropped on a coding-agent span", () => {
  ...
  describe("given a custom blacklisted attribute key", () => {
