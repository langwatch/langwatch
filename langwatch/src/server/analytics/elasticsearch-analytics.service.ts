...
export class ElasticsearchAnalyticsService {
  ...
  async getTimeseries(input: TimeseriesInputType): Promise<TimeseriesResult> {
    return this.tracer.withActiveSpan(
      "ElasticsearchAnalyticsService.getTimeseries",
  ...
  async getDataForFilter(
    ...
    return this.tracer.withActiveSpan(
      "ElasticsearchAnalyticsService.getDataForFilter",
  ...
  async getTopUsedDocuments(
    ...
    return this.tracer.withActiveSpan(
      "ElasticsearchAnalyticsService.getTopUsedDocuments",
      ...
      async (span) => {
        ...
        span.setAttribute("document.count", topDocuments.length);
  ...
  async getFeedbacks(
    ...
    return this.tracer.withActiveSpan(
      "ElasticsearchAnalyticsService.getFeedbacks",
      { attributes: { "tenant.id": projectId } },
      async (span) => {
        const { pivotIndexConditions } = generateTracesPivotQueryConditions({
          projectId,
