/**
 * Governed analytics SQL — the PostgreSQL-resident half of the catalog.
 *
 ...
 * a {@link GovernedPostgresMapping}, and that declaration generates the whole
 * chain: the approved PostgreSQL view, the reader role's grant on it, the
 * PostgreSQL-engine table in the governed database, its row policy, and the
 * governed view a caller names.
 *
 ...
 * governed query. Published so a caller comparing a dimension against a fact
 ...
 */
const PROJECTS: GovernedViewDefinition = {
  name: "projects",
  sourceTable: "projects_pg",
  postgres: {
    baseRelation: "Project",
    approvedView: "governed_projects",
...
const PROMPTS: GovernedViewDefinition = {
  name: "prompts",
  sourceTable: "prompts_pg",
  postgres: {
    baseRelation: "LlmPromptConfig",
    approvedView: "governed_prompts",
    tenantSourceColumn: "projectId",
  },
  description:
...
const PROMPT_VERSIONS: GovernedViewDefinition = {
  name: "prompt_versions",
  sourceTable: "prompt_versions_pg",
  postgres: {
    baseRelation: "LlmPromptConfigVersion",
    approvedView: "governed_prompt_versions",
    tenantSourceColumn: "projectId",
  },
  description:
...
const EXPERIMENTS: GovernedViewDefinition = {
  name: "experiments",
  sourceTable: "experiments_pg",
  postgres: {
    baseRelation: "Experiment",
    approvedView: "governed_experiments",
    tenantSourceColumn: "projectId",
  },
...
const EXPERIMENT_RUNS: GovernedViewDefinition = {
  name: "experiment_runs",
  sourceTable: "experiment_runs_pg",
  postgres: {
    baseRelation: "BatchEvaluation",
    approvedView: "governed_experiment_runs",
    tenantSourceColumn: "projectId",
  },
  description:
 ...
 */
export const GOVERNED_POSTGRES_CATALOG: readonly GovernedViewDefinition[] = [
  ANNOTATIONS,
  EXPERIMENTS,
  EXPERIMENT_RUNS,
  PROJECTS,
