...
-- ============================================================================
-- Drop: processor_checkpoints
-- ============================================================================
-- The processor_checkpoints table is no longer needed.
-- Fold projection state now serves as the checkpoint — the GroupQueue provides
-- per-aggregate ordering, and the fold store IS the resume point.
-- ============================================================================
