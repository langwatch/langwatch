...
(
    ...
    -- Messages stored as parallel arrays for efficient slicing and preview queries.
    -- Array index = message order (position in snapshot). id is an opaque string, not sortable.
