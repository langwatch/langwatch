...
import { NullMonitorRepository } from "./monitors/repositories/monitor.repository";
...
export function createTestApp(overrides?: Partial<AppDependencies>): App {
  ...
  return new App({
    ...
    commands: {
      traces: { recordSpan: noop, assignTopic: noop, recordLog: noop, recordMetric: noop } as AppCommands["traces"],
      evaluations: {
