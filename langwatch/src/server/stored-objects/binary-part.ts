 ...
 *
 * The auto-generated schema (`src/server/tracer/types.generated.ts`) only
 * checks that each field is a string-or-absent; it can't express
 * mutual exclusion without a `.refine`, and we don't own the generator.
 * Wrapping it here keeps the constraint in one place that the extractor
