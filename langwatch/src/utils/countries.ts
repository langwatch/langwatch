...
export const countryCodeToNameUnsorted = {
  AC: "Ascension Island",
  AD: "Andorra",
...
export type CountryMapCode = keyof typeof countryCodeToNameUnsorted;
...
export function countryCodeToFlagEmoji(country: CountryCode): string {
