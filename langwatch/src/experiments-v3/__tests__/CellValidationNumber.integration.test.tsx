...
vi.mock("~/experiments-v3/components/DatasetSuperHeader", () => ({
  DatasetSuperHeader: () => null,
}));
vi.mock("~/experiments-v3/components/TargetSuperHeader", () => ({
  TargetSuperHeader: () => null,
}));
vi.mock("~/experiments-v3/components/SelectionToolbar", () => ({
  SelectionToolbar: () => null,
}));

// Mock heavy hooks that cell validation doesn't exercise
vi.mock("~/experiments-v3/hooks/useDatasetSync", () => ({
  useDatasetSync: () => {},
}));
...
vi.mock("~/experiments-v3/hooks/useOpenTargetEditor", () => ({
  useOpenTargetEditor: () => ({
