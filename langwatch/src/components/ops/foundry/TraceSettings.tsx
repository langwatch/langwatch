...
export function TraceSettings({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <Box p={3}>
      <Text fontSize="xs" fontWeight="medium" textTransform="uppercase" letterSpacing="wider" color="fg.muted" mb={2}>
        Trace Settings
      </Text>
      <VStack gap={2} align="stretch">
        <Box>
          <Text fontSize="xs" color="fg.subtle" mb={1}>service.name</Text>
        ...
        <Box>
          <Text fontSize="xs" color="fg.subtle" mb={1}>user_id</Text>
        ...
        {!compact && (
          <>
            <Box>
              <Text fontSize="xs" color="fg.subtle" mb={1}>thread_id</Text>
            ...
            <Box>
              <Text fontSize="xs" color="fg.subtle" mb={1}>labels</Text>
