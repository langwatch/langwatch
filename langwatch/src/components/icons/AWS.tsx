...
export function AWS() {
  return (
    ...
    >
      <Box
        as="path"
        color={{ _light: "#252F3E", _dark: "white" }}
        fill="currentColor"
      ...
      <g fill="#F90" fillRule="evenodd" clipRule="evenodd">
        <path d="M273.5 143.7c-32.9 24.3-80.7 37.2-121.8 37.2-57.6 0-109.5-21.3-148.7-56.7-3.1-2.8-.3-6.6 3.4-4.4 42.4 24.6 94.7 39.5 148.8 39.5 36.5 0 76.6-7.6 113.5-23.2 5.5-2.5 10.2 3.6 4.8 7.6"></path>
        <path
