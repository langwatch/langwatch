...
export const useProviderSelectionOptions = (
  ...
  const allProviders = providers ? Object.entries(providers) : [];
  ...
  selectOptions.custom = {
    ...
    value: "custom",
    icon:
      modelProviderIcons["custom" as keyof typeof modelProviderIcons] || null,
    isDisabled: false,
  };
...
export const ModelProviderSelector = React.memo(function ModelProviderSelector({
  provider,
  providers,
  onChange,
  size = "md",
  ...
  const { selectOptions } = useProviderSelectionOptions(providers, provider);
