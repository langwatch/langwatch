    ...
    semanticTokens: {
      colors: {
        ...
        orange: {
          ...
          muted: { value: { _light: "{colors.orange.100}", _dark: "{colors.orange.800}" } },
          emphasized: { value: { _light: "{colors.orange.200}", _dark: "{colors.orange.700}" } },
        ...
        green: {
          ...
          muted: { value: { _light: "{colors.green.100}", _dark: "{colors.green.800}" } },
          emphasized: { value: { _light: "{colors.green.200}", _dark: "{colors.green.700}" } },
        ...
        blue: {
          ...
          muted: { value: { _light: "{colors.blue.100}", _dark: "{colors.blue.800}" } },
          emphasized: { value: { _light: "{colors.blue.200}", _dark: "{colors.blue.700}" } },
        ...
        yellow: {
          ...
          muted: { value: { _light: "{colors.yellow.100}", _dark: "{colors.yellow.800}" } },
          emphasized: { value: { _light: "{colors.yellow.200}", _dark: "{colors.yellow.700}" } },
        ...
        red: {
          ...
          muted: { value: { _light: "{colors.red.100}", _dark: "{colors.red.800}" } },
          emphasized: { value: { _light: "{colors.red.200}", _dark: "{colors.red.700}" } },
        ...
        pink: {
          ...
          muted: { value: { _light: "{colors.pink.100}", _dark: "{colors.pink.800}" } },
          emphasized: { value: { _light: "{colors.pink.200}", _dark: "{colors.pink.700}" } },
          fg: { value: { _light: "{colors.pink.700}", _dark: "{colors.pink.200}" } },
          focusRing: { value: "rgb(49, 130, 206)" },
        },
        purple: {
          ...
          muted: { value: { _light: "{colors.purple.100}", _dark: "{colors.purple.800}" } },
          emphasized: { value: { _light: "{colors.purple.200}", _dark: "{colors.purple.700}" } },
          fg: { value: { _light: "{colors.purple.700}", _dark: "{colors.purple.200}" } },
          focusRing: { value: "rgb(49, 130, 206)" },
        },
        teal: {
          ...
          muted: { value: { _light: "{colors.teal.100}", _dark: "{colors.teal.800}" } },
          emphasized: { value: { _light: "{colors.teal.200}", _dark: "{colors.teal.700}" } },
        ...
        cyan: {
          ...
          muted: { value: { _light: "{colors.cyan.100}", _dark: "{colors.cyan.800}" } },
          emphasized: { value: { _light: "{colors.cyan.200}", _dark: "{colors.cyan.700}" } },
          fg: { value: { _light: "{colors.cyan.700}", _dark: "{colors.cyan.200}" } },
          focusRing: { value: "rgb(49, 130, 206)" },
        },
