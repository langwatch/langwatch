...
The trace-processing subsystem uses a small, generic event sourcing library under `src/server/event-sourcing/library`.
...
```typescript
import { EventStream } from "../../../event-sourcing/library";
