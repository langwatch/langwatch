...
const cspHeader = `
    ...
    font-src 'self' data: https://cdn.jsdelivr.net https://cdnjs.cloudflare.com https://client.crisp.chat https://*.frill.co https://frill-prod-app.b-cdn.net https://www.google.com https://*.reo.dev;
    object-src 'none';
    base-uri 'self';
    form-action 'self';
