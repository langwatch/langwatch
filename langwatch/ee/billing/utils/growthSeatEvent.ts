...
const GROWTH_EVENTS_PRICE_IDS = new Set([
  ...
  // Legacy prices (grandfathered customers on old €1/$1 per 100K rate)
  prices.GROWTH_EVENTS_EUR_MONTHLY_LEGACY,
  prices.GROWTH_EVENTS_EUR_ANNUAL_LEGACY,
  prices.GROWTH_EVENTS_USD_MONTHLY_LEGACY,
  prices.GROWTH_EVENTS_USD_ANNUAL_LEGACY,
]);
