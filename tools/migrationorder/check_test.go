	...
	tests := []struct {
		...
		},
		{
			...
			want: []migrationorder.Finding{{
				...
				Problem: "is outside the canonical migration root packages/clickhouse-migrations/migrations",
				Fix: "git mv platform/app/src/server/clickhouse/migrations/00041_old_root.sql " +
					"packages/clickhouse-migrations/migrations/00041_old_root.sql",
			}},
		},
		{
		...
		},
		{
			...
			want: []migrationorder.Finding{{
				...
				Fix: "git mv packages/clickhouse-migrations/migrations/00041_mine.sql " +
					"packages/clickhouse-migrations/migrations/00042_mine.sql",
			}},
		},
		{
			...
			want: []migrationorder.Finding{{
				...
				Fix: "git mv packages/clickhouse-migrations/migrations/00039_mine.sql " +
					"packages/clickhouse-migrations/migrations/00043_mine.sql",
			}},
		},
		{
		...
		},
		{
			...
			want: []migrationorder.Finding{{
				...
				Fix:     "git checkout origin/main -- packages/clickhouse-migrations/migrations/00040_a.sql",
			}},
		},
		{
			...
			want: []migrationorder.Finding{
				{
					...
					Fix: "git mv packages/clickhouse-migrations/migrations/00041_one.sql " +
						"packages/clickhouse-migrations/migrations/00042_one.sql",
				},
				{
					Set:     "ClickHouse",
					Entry:   "00041_two.sql",
					Problem: "shares key 41 with another migration in this branch",
					Fix: "git mv packages/clickhouse-migrations/migrations/00041_two.sql " +
						"packages/clickhouse-migrations/migrations/00043_two.sql",
				},
			},
		},
		{
			...
			want: []migrationorder.Finding{{
				...
				Fix: "git mv 'packages/clickhouse-migrations/migrations/00039_$(curl evil).sql' " +
					"packages/clickhouse-migrations/migrations/00041'_$(curl evil).sql'",
			}},
		},
		{
