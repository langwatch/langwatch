...
// sandbox vs. the unprivileged shared-identity runner).
//
...
const (
	...
	// per-worker UID sandbox inside it (LANGY_WORKER_ISOLATION=none). Every
...
// i.e. whether haven sets LANGY_WORKER_ISOLATION=none on the worker. True
