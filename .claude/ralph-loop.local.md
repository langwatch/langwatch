...
started_at: "2026-04-13T20:50:47Z"
---
...
for the mcp, we do need to concerns ourselves a little bit with progressive discovery, for schemas etc, too many tools and schemas upfront overloads the context unecessesarily
...
the scenarios test on skills/ should always work btw, don't take no as an answer, you MUST REALLY run them, we should have openai credentiasl to run then and my claude code is set up, they are skipped on CI but you need to make sure to actually run them and prove claude can use the skills
