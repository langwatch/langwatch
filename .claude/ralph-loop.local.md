...
started_at: "2026-04-13T19:39:58Z"
---
...
the pages APIs routes should be ALL migrated to hono as much as possible, is there something not possible for hono? then maybe express? trpc       
  should also be independent, all a single (maybe express on top?) backend server, or whatever is easier and more common to do with vite
also some endpoints had mb limitations, and maybe a default one from next, we might want to keep that
