...
| You are... | Read |
| --- | --- |
| Running the detectors (architecture-lint, oxlint, feature-parity, typecheck, tests, the frontend boundary, ast-grep), then the layer inventory, comment-heavy files and single-consumer modules | `references/review-checklist.md` section 1 |
