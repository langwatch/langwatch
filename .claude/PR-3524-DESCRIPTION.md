...
| ⏳ in-PR | 🅑 | **4a-3**: `git mv` governance UI components → `langwatch/ee/governance/dashboard/` using the new `@ee/governance/dashboard/*` alias path (mirrors Sergey's pattern from `160d1a8c8`). Now unblocked. |
