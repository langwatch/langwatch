...
| **Phase 4** | License relocation (4a-1/2/3 + 4c-2/3/4) **deferred to follow-up PR per Vote H** (already locked). **In-PR 4b closed end-to-end on Lane-B + Lane-S**: 4b-1 ✅ (`2c3435e64`) + 4b-2 ✅ narrowed (`2c3435e64`) + 4b-3 ✅ (`26f9a0f67`) + 4b-4 ✅ (`f8eec569b`) + 4b-5 ✅ (`f8eec569b`) + 4b-7 ✅ (`071755498`) + 4c-1 ✅ (`f8eec569b`). **Remaining**: 4b-6 ⏳ CLI 402 envelope (Lane-A only). | No (1 small Lane-A item, non-GA-blocking) | ✓ — Phase 4 closed except 4b-6 |
