...
| **Phase 8 — Sessions/Devices** (NEW) | Architecture-spine row above. Backend ✅ (`82ae4b666` — P8-schema/exchange/refresh-ttl/list-api/int-test landed); BDD specs + docs scaffold ✅ (`bd4875f56`); ⏳ remaining: P8-ui-sessions + P8-ui-admin-ttl + P8-dogfood (Alexis) + P8-fold (Andre). | Yes (rchaves explicit ask) | ✓ — Lane-S backend complete; Lane-B UI consumes `api.personalSessions.{list,revoke,revokeAll}` |
