...
| **H** | CodeRabbit review-driven fixes (waves 1+2+3+3b: 2 critical + 5 major + 7 minor + 5 nitpick across 7 commits + 1 bonus, all verified before fix) | S | `abd5fe5c6` + `0bf5781c4` + `fd800485e` + `49f81be4f` + `565be6b63` + `17047a301` + `7007bfa2b` (+ `a4db4f714` bonus `is80Pct` close-out by lane-B) — see sub-list below |
