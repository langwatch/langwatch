...
//   - modules/model-provider/server/src/transport/api-rest/playground.api.ts
//   - langwatch/src/server/modelProviders/model.factory.ts
//   - modules/model-provider/server/src/services/model-provider-execution-handle.service.ts
//
