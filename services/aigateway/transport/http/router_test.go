...
type mockBudget struct {
	precheckFn func(ctx context.Context, bundle *domain.Bundle) (app.BudgetVerdict, error)
}

func (m *mockBudget) Precheck(ctx context.Context, bundle *domain.Bundle) (app.BudgetVerdict, error) {
	if m.precheckFn != nil {
...
func TestRouter_DispatchError_BudgetExceeded(t *testing.T) {
	...
	budget := &mockBudget{
		precheckFn: func(_ context.Context, _ *domain.Bundle) (app.BudgetVerdict, error) {
