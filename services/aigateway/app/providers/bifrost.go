...
func (a *account) GetKeysForProvider(ctx context.Context, provider bfschemas.ModelProvider) ([]bfschemas.Key, error) {
	...
	key, err := credentialToBifrostKey(cred, provider)
	if err != nil {
		return nil, err
	}
...
func credentialToBifrostKey(cred domain.Credential, provider bfschemas.ModelProvider) (bfschemas.Key, error) {
	k := bfschemas.Key{
		ID:     cred.ID,
		Name:   cred.ID,
		Weight: 1,
...
func (l *bifrostLogger) Debug(msg string, _ ...any) { l.logger.Debug(msg) }
func (l *bifrostLogger) Info(msg string, _ ...any)  { l.logger.Info(msg) }
func (l *bifrostLogger) Warn(msg string, _ ...any)  { l.logger.Warn(msg) }
func (l *bifrostLogger) Error(msg string, _ ...any) { l.logger.Error(msg) }
func (l *bifrostLogger) Fatal(msg string, _ ...any) { l.logger.Fatal(msg) }
