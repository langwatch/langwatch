...
from legacy_ragas._analytics import EvaluationEvent, track
from legacy_ragas.callbacks import new_group
from legacy_ragas.embeddings.base import (
    BaseRagasEmbeddings,
...
from legacy_ragas.llms import llm_factory
from legacy_ragas.llms.base import BaseRagasLLM, LangchainLLMWrapper
from legacy_ragas.metrics._answer_correctness import AnswerCorrectness
from legacy_ragas.metrics.base import Metric, MetricWithEmbeddings, MetricWithLLM
from legacy_ragas.metrics.critique import AspectCritique
from legacy_ragas.run_config import RunConfig
from legacy_ragas.utils import get_feature_language

# from legacy_ragas.metrics.critique import AspectCritique
from legacy_ragas.validation import (
...
def evaluate(
    ...
    # default metrics
    if metrics is None:
        from legacy_ragas.metrics import (
            answer_relevancy,
            context_precision,
            context_recall,
            faithfulness,
