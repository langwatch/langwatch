...
export default function Widget() {
  ...
  // Keep the top 5 tools by total; pivot to one row per month.
  const totals = {};
  ...
  return <Bars data={Object.values(byMonth)} x="month" series={top} stacked colorBy="tool" format="currency" legend />;
}
