...
- a command, before or after you run it, or handed over as the user's next step: the CLI is your interface, not theirs. Point forward in product terms instead.
