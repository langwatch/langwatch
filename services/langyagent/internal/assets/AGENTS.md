...
| a "Guided onboarding kickoff" brief, "Let's set up … then." | `guided-onboarding` | its script, questions included: `code_access`, `question`, `langwatch onboarding complete-path <path>` |
