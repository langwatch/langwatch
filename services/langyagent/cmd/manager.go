...
// Manager owns the composed egress guard (ADR-070 enforcement). It holds the
...
// startEgressAdapter builds the ADR-070 ENFORCING egress guard from config: a
...
// customer sets an allow-list — see the Config defaults and ADR-070.
