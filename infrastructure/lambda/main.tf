...
resource "aws_lambda_function" "this" {
  ...
  memory_size = local.evaluator_package == "presidio" ? 2560 : local.evaluator_package == "lingua" ? 1896 : local.evaluator_package == "langevals" ? 768 : local.evaluator_package == "ragas" ? 512 : 256
