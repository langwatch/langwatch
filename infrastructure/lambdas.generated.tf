...
resource "aws_api_gateway_resource" "basic" {
    rest_api_id = aws_api_gateway_rest_api.this.id
    parent_id   = aws_api_gateway_resource.custom.id
    path_part   = "basic"
}

module "custom-basic-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
    ...
    lambda_invoke_arn = module.custom-evaluator.lambda_invoke_arn
}
...
module "custom-llm_boolean-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
...
module "custom-llm_score-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
...
module "custom-similarity-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
...
module "custom-evaluator" {
    source              = "./lambda"
    evaluator_package   = "custom"
    sns_alarms_topic_arn = aws_sns_topic.alarms.arn
    apigw_execution_arn = aws_api_gateway_rest_api.this.execution_arn
    environment_variables = {
...
resource "aws_api_gateway_resource" "bert_f1" {
    rest_api_id = aws_api_gateway_rest_api.this.id
    parent_id   = aws_api_gateway_resource.huggingface.id
    path_part   = "bert_f1"
}

module "huggingface-bert_f1-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
    apigw_root_resource_id = aws_api_gateway_resource.bert_f1.id
    path                   = "evaluate"
    method                 = "POST"
...
resource "aws_api_gateway_resource" "bert_precision" {
    rest_api_id = aws_api_gateway_rest_api.this.id
    parent_id   = aws_api_gateway_resource.huggingface.id
    path_part   = "bert_precision"
}

module "huggingface-bert_precision-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
    apigw_root_resource_id = aws_api_gateway_resource.bert_precision.id
    path                   = "evaluate"
    method                 = "POST"
...
resource "aws_api_gateway_resource" "bert_recall" {
    rest_api_id = aws_api_gateway_rest_api.this.id
    parent_id   = aws_api_gateway_resource.huggingface.id
    path_part   = "bert_recall"
}

module "huggingface-bert_recall-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
    apigw_root_resource_id = aws_api_gateway_resource.bert_recall.id
    path                   = "evaluate"
    method                 = "POST"
...
resource "aws_api_gateway_resource" "blocklist" {
    rest_api_id = aws_api_gateway_rest_api.this.id
    parent_id   = aws_api_gateway_resource.langevals.id
    path_part   = "blocklist"
}

module "langevals-blocklist-api-gw" {
    source                 = "./api-gw-resource"
    apigw_id               = aws_api_gateway_rest_api.this.id
    apigw_root_resource_id = aws_api_gateway_resource.blocklist.id
    path                   = "evaluate"
    method                 = "POST"
...
resource "aws_api_gateway_deployment" "this" {
    ...
    triggers = {
        redeployment = sha1(jsonencode([module.google_cloud-dlp_pii_detection-api-gw, module.custom-basic-api-gw, module.custom-llm_boolean-api-gw, module.custom-llm_score-api-gw, module.custom-similarity-api-gw, module.openai-moderation-api-gw, module.huggingface-bert_f1-api-gw, module.huggingface-bert_precision-api-gw, module.huggingface-bert_recall-api-gw, module.langevals-blocklist-api-gw, module.langevals-off_topic-api-gw, module.ragas-answer_relevancy-api-gw, module.ragas-context_precision-api-gw, module.ragas-context_recall-api-gw, module.ragas-context_relevancy-api-gw, module.ragas-context_utilization-api-gw, module.ragas-faithfulness-api-gw, module.lingua-language_detection-api-gw, module.aws-comprehend_pii_detection-api-gw, module.azure-content_safety-api-gw, module.azure-jailbreak-api-gw]))
    }

    depends_on = [
        module.google_cloud-dlp_pii_detection-api-gw, module.custom-basic-api-gw, module.custom-llm_boolean-api-gw, module.custom-llm_score-api-gw, module.custom-similarity-api-gw, module.openai-moderation-api-gw, module.huggingface-bert_f1-api-gw, module.huggingface-bert_precision-api-gw, module.huggingface-bert_recall-api-gw, module.langevals-blocklist-api-gw, module.langevals-off_topic-api-gw, module.ragas-answer_relevancy-api-gw, module.ragas-context_precision-api-gw, module.ragas-context_recall-api-gw, module.ragas-context_relevancy-api-gw, module.ragas-context_utilization-api-gw, module.ragas-faithfulness-api-gw, module.lingua-language_detection-api-gw, module.aws-comprehend_pii_detection-api-gw, module.azure-content_safety-api-gw, module.azure-jailbreak-api-gw
    ]
